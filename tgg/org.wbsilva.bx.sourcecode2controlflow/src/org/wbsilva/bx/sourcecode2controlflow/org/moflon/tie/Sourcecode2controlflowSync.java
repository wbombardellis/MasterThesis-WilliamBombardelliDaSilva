...
public class Sourcecode2controlflowSync extends SynchronizationHelper{

   public Sourcecode2controlflowSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		Sourcecode2controlflowSync helper = new Sourcecode2controlflowSync();
