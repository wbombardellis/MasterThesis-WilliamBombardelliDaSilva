/**
 */
package org.wbsilva.bx.sourcecode2controlflow.util;
 ...
 * @generated
 */
public class Sourcecode2controlflowSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Sourcecode2controlflowPackage modelPackage;
	 ...
	 * @generated
	 */
	public Sourcecode2controlflowSwitch() {
		if (modelPackage == null) {
			modelPackage = Sourcecode2controlflowPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Sourcecode2controlflowPackage.S2B: {
			...
			if (result == null)
				result = caseAbstractCorrespondence(s2B);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>S2B</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>S2B</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseS2B(S2B object) {
		return null;
	}
