...
public class firstwhile2rootbranchImpl extends AbstractRuleImpl implements firstwhile2rootbranch {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_1_1_performtransformation_greenBFBBFFF(l, w, g);
		Branch b = (Branch) result1_green[1];
		S2B f2r = (S2B) result1_green[4];
		Command d = (Command) result1_green[5];
		S2N l2d = (S2N) result1_green[6];

		Object[] result2_black = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_1_2_collecttranslatedelements_blackBBBBBB(l, b, w, f2r, d, l2d);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[l] = " + l + ", " + "[b] = " + b + ", " + "[w] = "
							+ w + ", " + "[f2r] = " + f2r + ", " + "[d] = " + d + ", " + "[l2d] = " + l2d + ".");
		}
		Object[] result2_green = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_1_2_collecttranslatedelements_greenFBBBBBB(l, b, w, f2r, d, l2d);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, l, b, p, p2g, w, g,
						f2r, d, l2d);
		...
		firstwhile2rootbranchImpl.pattern_firstwhile2rootbranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
				ruleresult, l, b, p, w, g, f2r, d, l2d);
		...
		//nothing EMoflonEdge f2r__b____target = (EMoflonEdge) result3_green[13];
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_2_2_corematch_blackBBFBFB(l, p, w, match)) {
			P2G p2g = (P2G) result2_black[2];
			Graph g = (Graph) result2_black[4];
			// ForEach 
			for (Object[] result3_black : firstwhile2rootbranchImpl
					.pattern_firstwhile2rootbranch_2_3_findcontext_blackBBBBB(l, p, p2g, w, g)) {
				Object[] result3_green = firstwhile2rootbranchImpl
						.pattern_firstwhile2rootbranch_2_3_findcontext_greenBBBBBFFFFF(l, p, p2g, w, g);
				...
				Object[] result4_bindingAndBlack = firstwhile2rootbranchImpl
						.pattern_firstwhile2rootbranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, l,
								p, p2g, w, g);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[l] = " + l + ", " + "[p] = " + p
							+ ", " + "[p2g] = " + p2g + ", " + "[w] = " + w + ", " + "[g] = " + g + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Assignment l, Program p, P2G p2g, While w,
			Graph g) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject l, EObject b, EObject p, EObject p2g,
			EObject w, EObject g, EObject f2r, EObject d, EObject l2d) {
	...
	public boolean isAppropriate_BWD(Match match, Branch b, Graph g, Command d) {
		...
		Object[] result1_black = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_10_1_initialbindings_blackBBBBB(this, match, b, g, d);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, b, g, d);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[b] = " + b + ", " + "[g] = " + g + ", " + "[d] = " + d + ".");
		}
		...
		if (firstwhile2rootbranchImpl.pattern_firstwhile2rootbranch_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = firstwhile2rootbranchImpl
					.pattern_firstwhile2rootbranch_10_4_collectelementstobetranslated_blackBBBB(match, b, g, d);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[b] = " + b + ", " + "[g] = " + g + ", " + "[d] = " + d + ".");
			}
			firstwhile2rootbranchImpl
					.pattern_firstwhile2rootbranch_10_4_collectelementstobetranslated_greenBBBBFF(match, b, g, d);
			//nothing EMoflonEdge g__b____root = (EMoflonEdge) result4_green[4];
			//nothing EMoflonEdge d__b____next = (EMoflonEdge) result4_green[5];

			Object[] result5_black = firstwhile2rootbranchImpl
					.pattern_firstwhile2rootbranch_10_5_collectcontextelements_blackBBBB(match, b, g, d);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[b] = " + b + ", " + "[g] = " + g + ", " + "[d] = " + d + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_11_1_performtransformation_greenFBBFFBF(b, p, d);
		...
		Object[] result2_black = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_11_2_collecttranslatedelements_blackBBBBBB(l, b, w, f2r, d, l2d);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[l] = " + l + ", " + "[b] = " + b + ", " + "[w] = "
							+ w + ", " + "[f2r] = " + f2r + ", " + "[d] = " + d + ", " + "[l2d] = " + l2d + ".");
		...
		Object[] result2_green = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_11_2_collecttranslatedelements_greenFBBBBBB(l, b, w, f2r, d, l2d);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, l, b, p, p2g, w, g,
						f2r, d, l2d);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[l] = " + l + ", " + "[b] = " + b + ", " + "[p] = " + p + ", " + "[p2g] = " + p2g + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_12_2_corematch_blackBFFBBB(b, g, d, match)) {
			Program p = (Program) result2_black[1];
			P2G p2g = (P2G) result2_black[2];
			// ForEach 
			for (Object[] result3_black : firstwhile2rootbranchImpl
					.pattern_firstwhile2rootbranch_12_3_findcontext_blackBBBBB(b, p, p2g, g, d)) {
				Object[] result3_green = firstwhile2rootbranchImpl
						.pattern_firstwhile2rootbranch_12_3_findcontext_greenBBBBBFFFFF(b, p, p2g, g, d);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge p2g__p____source = (EMoflonEdge) result3_green[6];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[b] = " + b + ", " + "[p] = " + p
							+ ", " + "[p2g] = " + p2g + ", " + "[g] = " + g + ", " + "[d] = " + d + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch b, Program p, P2G p2g, Graph g,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject l, EObject b, EObject p, EObject p2g,
			EObject w, EObject g, EObject f2r, EObject d, EObject l2d) {
		ruleresult.registerObject("l", l);
		ruleresult.registerObject("b", b);
		ruleresult.registerObject("p", p);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_81(EMoflonEdge _edge_root) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, l, b, p, w, g, d,
		...
		if (firstwhile2rootbranchImpl.pattern_firstwhile2rootbranch_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : firstwhile2rootbranchImpl
				...
				Object[] result6_black = firstwhile2rootbranchImpl
						.pattern_firstwhile2rootbranch_24_6_createcorrespondence_blackBBBBBBB(l, b, p, w, g, d,
								ccMatch);
				if (result6_black == null) {
				...
				firstwhile2rootbranchImpl.pattern_firstwhile2rootbranch_24_6_createcorrespondence_greenBBBFBFB(l, b, w,
						d, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Assignment l, Branch b, Program p, While w, Graph g, Command d,
	...
	public boolean checkDEC_BWD(Branch b, Graph g, Command d) {// 
		Object[] result1_black = firstwhile2rootbranchImpl
				.pattern_firstwhile2rootbranch_28_1_matchtggpattern_blackBBB(b, g, d);
		if (result1_black != null) {
		...
		for (Object[] result2_black : firstwhile2rootbranchImpl
			...
			if (firstwhile2rootbranchImpl.pattern_firstwhile2rootbranch_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					firstwhile2rootbranchImpl.pattern_firstwhile2rootbranch_29_6_perform_greenFFBFBFFFB(p, g,
							ruleResult);
					...
					//nothing S2N l2d = (S2N) result6_green[7];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASSIGNMENT_PROGRAM_P2G_WHILE_GRAPH:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Assignment) arguments.get(1),
					(Program) arguments.get(2), (P2G) arguments.get(3), (While) arguments.get(4),
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPROPRIATE_BWD__MATCH_BRANCH_GRAPH_COMMAND:
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_BRANCH_GRAPH_COMMAND:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Branch) arguments.get(1), (Graph) arguments.get(2),
					(Command) arguments.get(3));
			return null;
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_BRANCH_GRAPH_COMMAND:
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_PROGRAM_P2G_GRAPH_COMMAND:
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_81__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_81((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_87__EMOFLONEDGE:
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___IS_APPLICABLE_SOLVE_CSP_CC__ASSIGNMENT_BRANCH_PROGRAM_WHILE_GRAPH_COMMAND_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Assignment) arguments.get(0), (Branch) arguments.get(1),
					(Program) arguments.get(2), (While) arguments.get(3), (Graph) arguments.get(4),
		...
		case RulesPackage.FIRSTWHILE2ROOTBRANCH___CHECK_DEC_BWD__BRANCH_GRAPH_COMMAND:
	...
	public static final Object[] pattern_firstwhile2rootbranch_0_4_collectelementstobetranslated_greenBBBBFF(
		...
		return new Object[] { match, l, p, w, w__l____last, p__w____first };
	}
				...
				if (tmpP2g instanceof P2G) {
					...
					if (tmpW instanceof While) {
						...
						if (tmpG instanceof Graph) {
							Graph g = (Graph) tmpG;
							return new Object[] { l, p, p2g, w, g, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_firstwhile2rootbranch_1_1_performtransformation_blackBBBBBFBB(Assignment l,
			Program p, P2G p2g, While w, Graph g, firstwhile2rootbranch _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { l, p, p2g, w, g, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_firstwhile2rootbranch_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_firstwhile2rootbranch_1_1_performtransformation_binding != null) {
			Assignment l = (Assignment) result_pattern_firstwhile2rootbranch_1_1_performtransformation_binding[0];
			Program p = (Program) result_pattern_firstwhile2rootbranch_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_firstwhile2rootbranch_1_1_performtransformation_black = pattern_firstwhile2rootbranch_1_1_performtransformation_blackBBBBBFBB(
					l, p, p2g, w, g, _this, isApplicableMatch);
	...
	public static final Object[] pattern_firstwhile2rootbranch_1_1_performtransformation_greenBFBBFFF(Assignment l,
			While w, Graph g) {
		...
		l2d.setSource(l);
		l2d.setTarget(d);
		return new Object[] { l, b, w, g, f2r, d, l2d };
	}

	public static final Object[] pattern_firstwhile2rootbranch_1_2_collecttranslatedelements_blackBBBBBB(Assignment l,
			Branch b, While w, S2B f2r, Command d, S2N l2d) {
		return new Object[] { l, b, w, f2r, d, l2d };
	}

	public static final Object[] pattern_firstwhile2rootbranch_1_2_collecttranslatedelements_greenFBBBBBB(Assignment l,
			Branch b, While w, S2B f2r, Command d, S2N l2d) {
		...
		return new Object[] { ruleresult, l, b, w, f2r, d, l2d };
	}

	public static final Object[] pattern_firstwhile2rootbranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject l, EObject b, EObject p, EObject p2g, EObject w, EObject g,
			EObject f2r, EObject d, EObject l2d) {
		if (!l.equals(p)) {
			if (!l.equals(p2g)) {
				if (!l.equals(w)) {
					if (!l.equals(l2d)) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject l, EObject b, EObject p, EObject w, EObject g, EObject f2r, EObject d,
			EObject l2d) {
		EMoflonEdge w__l____last = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, l, b, p, w, g, f2r, d, l2d, w__l____last, g__b____root, f2r__w____source,
				p__w____first, f2r__b____target, d__b____next, l2d__l____source, l2d__d____target };
	}

	public static final void pattern_firstwhile2rootbranch_1_5_registerobjects_expressionBBBBBBBBBBB(
			firstwhile2rootbranch _this, PerformRuleResult ruleresult, EObject l, EObject b, EObject p, EObject p2g,
			EObject w, EObject g, EObject f2r, EObject d, EObject l2d) {
		_this.registerObjects_FWD(ruleresult, l, b, p, p2g, w, g, f2r, d, l2d);
	...
	public static final Iterable<Object[]> pattern_firstwhile2rootbranch_2_2_corematch_blackBBFBFB(Assignment l,
		...
		for (P2G p2g : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(p, P2G.class, "source")) {
			...
			if (g != null) {
				_result.add(new Object[] { l, p, p2g, w, g, match });
			}
	...
	public static final Iterable<Object[]> pattern_firstwhile2rootbranch_2_3_findcontext_blackBBBBB(Assignment l,
			Program p, P2G p2g, While w, Graph g) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (p.equals(p2g.getSource())) {
			if (l.equals(w.getLast())) {
				if (g.equals(p2g.getTarget())) {
					if (w.equals(p.getFirst())) {
						_result.add(new Object[] { l, p, p2g, w, g });
					}
				}
			}
		}
	...
	public static final Object[] pattern_firstwhile2rootbranch_2_3_findcontext_greenBBBBBFFFFF(Assignment l, Program p,
			P2G p2g, While w, Graph g) {
		...
		p__w____first.setName(p__w____first_name_prime);
		return new Object[] { l, p, p2g, w, g, isApplicableMatch, p2g__p____source, w__l____last, p2g__g____target,
				p__w____first };
	}

	public static final Object[] pattern_firstwhile2rootbranch_2_4_solveCSP_bindingFBBBBBBB(firstwhile2rootbranch _this,
			IsApplicableMatch isApplicableMatch, Assignment l, Program p, P2G p2g, While w, Graph g) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, l, p, p2g, w, g);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, l, p, p2g, w, g };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstwhile2rootbranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(
			firstwhile2rootbranch _this, IsApplicableMatch isApplicableMatch, Assignment l, Program p, P2G p2g, While w,
			Graph g) {
		Object[] result_pattern_firstwhile2rootbranch_2_4_solveCSP_binding = pattern_firstwhile2rootbranch_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, l, p, p2g, w, g);
	...
	public static final Object[] pattern_firstwhile2rootbranch_10_1_initialbindings_blackBBBBB(
			firstwhile2rootbranch _this, Match match, Branch b, Graph g, Command d) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_10_4_collectelementstobetranslated_greenBBBBFF(
		...
		g__b____root.setName(g__b____root_name_prime);
		d__b____next.setName(d__b____next_name_prime);
		return new Object[] { match, b, g, d, g__b____root, d__b____next };
	}
				...
				if (tmpP2g instanceof P2G) {
					...
					if (tmpG instanceof Graph) {
						...
						if (tmpD instanceof Command) {
							...
							return new Object[] { b, p, p2g, g, d, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_firstwhile2rootbranch_11_1_performtransformation_blackBBBBBFBB(Branch b,
			Program p, P2G p2g, Graph g, Command d, firstwhile2rootbranch _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { b, p, p2g, g, d, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_firstwhile2rootbranch_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_firstwhile2rootbranch_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_firstwhile2rootbranch_11_1_performtransformation_black = pattern_firstwhile2rootbranch_11_1_performtransformation_blackBBBBBFBB(
					b, p, p2g, g, d, _this, isApplicableMatch);
	...
	public static final Object[] pattern_firstwhile2rootbranch_11_1_performtransformation_greenFBBFFBF(Branch b,
			Program p, Command d) {
		...
		l2d.setSource(l);
		l2d.setTarget(d);
		return new Object[] { l, b, p, w, f2r, d, l2d };
	}

	public static final Object[] pattern_firstwhile2rootbranch_11_2_collecttranslatedelements_blackBBBBBB(Assignment l,
			Branch b, While w, S2B f2r, Command d, S2N l2d) {
		return new Object[] { l, b, w, f2r, d, l2d };
	}

	public static final Object[] pattern_firstwhile2rootbranch_11_2_collecttranslatedelements_greenFBBBBBB(Assignment l,
			Branch b, While w, S2B f2r, Command d, S2N l2d) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_firstwhile2rootbranch_11_5_registerobjects_expressionBBBBBBBBBBB(
			firstwhile2rootbranch _this, PerformRuleResult ruleresult, EObject l, EObject b, EObject p, EObject p2g,
			EObject w, EObject g, EObject f2r, EObject d, EObject l2d) {
		_this.registerObjects_BWD(ruleresult, l, b, p, p2g, w, g, f2r, d, l2d);
	...
	public static final Iterable<Object[]> pattern_firstwhile2rootbranch_12_2_corematch_blackBFFBBB(Branch b, Graph g,
		...
		for (P2G p2g : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(g, P2G.class, "target")) {
			...
			if (p != null) {
				_result.add(new Object[] { b, p, p2g, g, d, match });
			}
	...
	public static final Iterable<Object[]> pattern_firstwhile2rootbranch_12_3_findcontext_blackBBBBB(Branch b,
			Program p, P2G p2g, Graph g, Command d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (p.equals(p2g.getSource())) {
			if (g.equals(p2g.getTarget())) {
				if (b.equals(g.getRoot())) {
					if (b.equals(d.getNext())) {
						_result.add(new Object[] { b, p, p2g, g, d });
					}
				}
			}
		}
	...
	public static final Object[] pattern_firstwhile2rootbranch_12_3_findcontext_greenBBBBBFFFFF(Branch b, Program p,
			P2G p2g, Graph g, Command d) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge p2g__p____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge p2g__g____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge g__b____root = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		g__b____root.setName(g__b____root_name_prime);
		d__b____next.setName(d__b____next_name_prime);
		return new Object[] { b, p, p2g, g, d, isApplicableMatch, p2g__p____source, p2g__g____target, g__b____root,
				d__b____next };
	}

	public static final Object[] pattern_firstwhile2rootbranch_12_4_solveCSP_bindingFBBBBBBB(
			firstwhile2rootbranch _this, IsApplicableMatch isApplicableMatch, Branch b, Program p, P2G p2g, Graph g,
			Command d) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, b, p, p2g, g, d);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b, p, p2g, g, d };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstwhile2rootbranch_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_firstwhile2rootbranch_12_4_solveCSP_binding = pattern_firstwhile2rootbranch_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, b, p, p2g, g, d);
	...
	public static final Object[] pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_0BB(Branch b,
			Graph g) {
		for (Graph __DEC_b_root_816374 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Graph.class, "root")) {
			if (!g.equals(__DEC_b_root_816374)) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_1B(Branch b) {
		for (Branch __DEC_b_positive_74411 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_b_positive_74411)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_2B(Branch b) {
		for (Branch __DEC_b_negative_205312 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_b_negative_205312)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_3BB(Command d,
			Graph g) {
		for (Graph __DEC_d_root_200766 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			if (!g.equals(__DEC_d_root_200766)) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_4BB(Command d,
			Branch b) {
		for (Branch __DEC_d_positive_430894 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_d_positive_430894)) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_5BB(Command d,
			Branch b) {
		for (Branch __DEC_d_negative_535312 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_d_negative_535312)) {
				return new Object[] { d, b };
			}
		}
		return null;
													...
													if (pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_6BB(
														...
														if (pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_7BB(
															...
															if (pattern_firstwhile2rootbranch_20_2_testcorematchandDECs_black_nac_8BB(
																	b, d) == null) {
																_result.add(new Object[] { b, g, d, _edge_root });
															}
														}
													}
												}
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_0B(Assignment l) {
		for (Decision __DEC_l_positive_774021 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_1B(Assignment l) {
		for (Decision __DEC_l_negative_274830 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_2BB(Assignment l,
			While w) {
		for (While __DEC_l_first_942419 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!w.equals(__DEC_l_first_942419)) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_3BB(Assignment l,
			While w) {
		for (While __DEC_l_last_667730 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!w.equals(__DEC_l_last_667730)) {
				return new Object[] { l, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_4BB(Assignment l,
			Program p) {
		for (Program __DEC_l_first_500910 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			if (!p.equals(__DEC_l_first_500910)) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_5B(While w) {
		for (Decision __DEC_w_positive_480721 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Decision.class, "positive")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_6B(While w) {
		for (Decision __DEC_w_negative_159895 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Decision.class, "negative")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_7B(While w) {
		for (While __DEC_w_first_987837 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "first")) {
			if (!w.equals(__DEC_w_first_987837)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_8B(While w) {
		for (While __DEC_w_last_71516 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "last")) {
			if (!w.equals(__DEC_w_last_71516)) {
				return new Object[] { w };
			}
		}
		return null;
														...
														for (Program p : org.moflon.core.utilities.eMoflonEMFUtil
															...
															if (pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_4BB(
																...
																if (pattern_firstwhile2rootbranch_21_2_testcorematchandDECs_black_nac_10BB(
																		p, l) == null) {
																	_result.add(new Object[] { l, p, w, _edge_last });
																}
															}
														}
													}
				...
				if (tmpP instanceof Program) {
					...
					if (tmpW instanceof While) {
						...
						if (tmpG instanceof Graph) {
							...
							if (tmpD instanceof Command) {
								Command d = (Command) tmpD;
								return new Object[] { l, b, p, w, g, d, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_blackBBBBBBBB(Assignment l,
			Branch b, Program p, While w, Graph g, Command d, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding != null) {
			Assignment l = (Assignment) result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding[0];
			Branch b = (Branch) result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding[1];
			Program p = (Program) result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding[2];
			While w = (While) result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding[3];
			Graph g = (Graph) result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding[4];
			Command d = (Command) result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_black = pattern_firstwhile2rootbranch_24_2_matchsrctrgcontext_blackBBBBBBBB(
					l, b, p, w, g, d, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_firstwhile2rootbranch_24_3_solvecsp_bindingFBBBBBBBBB(
			firstwhile2rootbranch _this, Assignment l, Branch b, Program p, While w, Graph g, Command d,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(l, b, p, w, g, d, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, l, b, p, w, g, d, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstwhile2rootbranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_firstwhile2rootbranch_24_3_solvecsp_binding = pattern_firstwhile2rootbranch_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, l, b, p, w, g, d, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_firstwhile2rootbranch_24_6_createcorrespondence_blackBBBBBBB(Assignment l,
			Branch b, Program p, While w, Graph g, Command d, CCMatch ccMatch) {
		return new Object[] { l, b, p, w, g, d, ccMatch };
	}

	public static final Object[] pattern_firstwhile2rootbranch_24_6_createcorrespondence_greenBBBFBFB(Assignment l,
			Branch b, While w, Command d, CCMatch ccMatch) {
		S2B f2r = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N l2d = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		f2r.setSource(w);
		f2r.setTarget(b);
		...
		return new Object[] { l, b, w, f2r, d, l2d, ccMatch };
	}
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_0B(Assignment l) {
		for (Decision __DEC_l_positive_552545 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_1B(Assignment l) {
		for (Decision __DEC_l_negative_726408 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_2BB(Assignment l,
			While w) {
		for (While __DEC_l_first_152174 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!w.equals(__DEC_l_first_152174)) {
				return new Object[] { l, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_3BB(Assignment l,
			While w) {
		for (While __DEC_l_last_336003 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!w.equals(__DEC_l_last_336003)) {
				return new Object[] { l, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_4BB(Assignment l,
			Program p) {
		for (Program __DEC_l_first_171226 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			if (!p.equals(__DEC_l_first_171226)) {
				return new Object[] { l, p };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_5B(While w) {
		for (Decision __DEC_w_positive_879970 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Decision.class, "positive")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_6B(While w) {
		for (Decision __DEC_w_negative_758696 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Decision.class, "negative")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_7B(While w) {
		for (While __DEC_w_first_633349 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "first")) {
			if (!w.equals(__DEC_w_first_633349)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_27_1_matchtggpattern_black_nac_8B(While w) {
		for (While __DEC_w_last_820179 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "last")) {
			if (!w.equals(__DEC_w_last_820179)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_black_nac_0BB(Branch b, Graph g) {
		for (Graph __DEC_b_root_771424 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Graph.class, "root")) {
			if (!g.equals(__DEC_b_root_771424)) {
				return new Object[] { b, g };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_black_nac_1B(Branch b) {
		for (Branch __DEC_b_positive_74424 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_b_positive_74424)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_black_nac_2B(Branch b) {
		for (Branch __DEC_b_negative_607538 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_b_negative_607538)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_black_nac_3BB(Command d, Graph g) {
		for (Graph __DEC_d_root_935464 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			if (!g.equals(__DEC_d_root_935464)) {
				return new Object[] { d, g };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_black_nac_4BB(Command d, Branch b) {
		for (Branch __DEC_d_positive_556957 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_d_positive_556957)) {
				return new Object[] { d, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_black_nac_5BB(Command d, Branch b) {
		for (Branch __DEC_d_negative_665010 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_d_negative_665010)) {
				return new Object[] { d, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstwhile2rootbranch_28_1_matchtggpattern_blackBBB(Branch b, Graph g,
			Command d) {
		if (b.equals(g.getRoot())) {
			if (b.equals(d.getNext())) {
	...
	public static final Object[] pattern_firstwhile2rootbranch_29_6_perform_greenFFBFBFFFB(Program p, Graph g,
			ModelgeneratorRuleResult ruleResult) {
		Assignment l = SourcecodeFactory.eINSTANCE.createAssignment();
		Branch b = ControlflowFactory.eINSTANCE.createBranch();
		While w = SourcecodeFactory.eINSTANCE.createWhile();
		...
		return new Object[] { l, b, p, w, g, f2r, d, l2d, ruleResult };
	}
