...
public class decdul2branchbubImpl extends AbstractRuleImpl implements decdul2branchbub {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdul2branchbubImpl
				.pattern_decdul2branchbub_1_1_performtransformation_greenFBBFFFBFFB(b, a, l, c);
		...
		Object[] result2_black = decdul2branchbubImpl
				.pattern_decdul2branchbub_1_2_collecttranslatedelements_blackBBBBBBBBB(l2z, b, a, y, z, x, l, a2x, b2y);
		...
		Object[] result2_green = decdul2branchbubImpl
				.pattern_decdul2branchbub_1_2_collecttranslatedelements_greenFBBBBBBBBB(l2z, b, a, y, z, x, l, a2x,
						b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdul2branchbubImpl
				.pattern_decdul2branchbub_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, l2z, b, a, y, d2c, z,
						x, l, d, a2x, b2y, c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[l2z] = " + l2z + ", " + "[b] = " + b + ", " + "[a] = " + a + ", " + "[y] = " + y + ", "
					+ "[d2c] = " + d2c + ", " + "[z] = " + z + ", " + "[x] = " + x + ", " + "[l] = " + l + ", "
					+ "[d] = " + d + ", " + "[a2x] = " + a2x + ", " + "[b2y] = " + b2y + ", " + "[c] = " + c + ".");
		}
		decdul2branchbubImpl.pattern_decdul2branchbub_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, l2z, b, a, y, z, x, l, d, a2x, b2y, c);
		//nothing EMoflonEdge b__l____last = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge y__z____positive = (EMoflonEdge) result3_green[13];
		...
		decdul2branchbubImpl.pattern_decdul2branchbub_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult,
				l2z, b, a, y, d2c, z, x, l, d, a2x, b2y, c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdul2branchbubImpl.pattern_decdul2branchbub_2_2_corematch_blackBBFBBFB(b, a, l,
				d, match)) {
			...
			for (Object[] result3_black : decdul2branchbubImpl.pattern_decdul2branchbub_2_3_findcontext_blackBBBBBB(b,
				...
				Object[] result3_green = decdul2branchbubImpl
						.pattern_decdul2branchbub_2_3_findcontext_greenBBBBBBFFFFFFF(b, a, d2c, l, d, c);
				...
				Object[] result4_bindingAndBlack = decdul2branchbubImpl
						.pattern_decdul2branchbub_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, b, a,
								d2c, l, d, c);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While b, Decision a, S2B d2c,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject y,
			EObject d2c, EObject z, EObject x, EObject l, EObject d, EObject a2x, EObject b2y, EObject c) {
	...
	public boolean isAppropriate_BWD(Match match, Branch y, Command z, Branch x, Branch c) {
		...
		Object[] result2_bindingAndBlack = decdul2branchbubImpl
				.pattern_decdul2branchbub_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, y, z, x, c);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[y] = " + y + ", " + "[z] = " + z + ", " + "[x] = " + x + ", "
					+ "[c] = " + c + ".");
		...
		if (decdul2branchbubImpl.pattern_decdul2branchbub_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decdul2branchbubImpl
					.pattern_decdul2branchbub_10_4_collectelementstobetranslated_blackBBBBB(match, y, z, x, c);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[y] = " + y + ", " + "[z] = " + z + ", " + "[x] = " + x + ", " + "[c] = " + c + ".");
			}
			decdul2branchbubImpl.pattern_decdul2branchbub_10_4_collectelementstobetranslated_greenBBBBBFFFF(match, y, z,
					x, c);
			...
			Object[] result5_black = decdul2branchbubImpl
					.pattern_decdul2branchbub_10_5_collectcontextelements_blackBBBBB(match, y, z, x, c);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[y] = " + y + ", " + "[z] = " + z + ", " + "[x] = " + x + ", " + "[c] = " + c + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decdul2branchbubImpl
				.pattern_decdul2branchbub_11_1_performtransformation_greenFFFBBBFBFF(y, z, x, d);
		S2N l2z = (S2N) result1_green[0];
		...
		Object[] result2_black = decdul2branchbubImpl
				.pattern_decdul2branchbub_11_2_collecttranslatedelements_blackBBBBBBBBB(l2z, b, a, y, z, x, l, a2x,
						b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[l2z] = " + l2z + ", " + "[b] = "
					+ b + ", " + "[a] = " + a + ", " + "[y] = " + y + ", " + "[z] = " + z + ", " + "[x] = " + x + ", "
		...
		Object[] result2_green = decdul2branchbubImpl
				.pattern_decdul2branchbub_11_2_collecttranslatedelements_greenFBBBBBBBBB(l2z, b, a, y, z, x, l, a2x,
						b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdul2branchbubImpl
				.pattern_decdul2branchbub_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, l2z, b, a, y, d2c, z,
						x, l, d, a2x, b2y, c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[l2z] = " + l2z + ", " + "[b] = " + b + ", " + "[a] = " + a + ", " + "[y] = " + y + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdul2branchbubImpl.pattern_decdul2branchbub_12_2_corematch_blackBFBBFBB(y, z, x,
				c, match)) {
			...
			for (Object[] result3_black : decdul2branchbubImpl.pattern_decdul2branchbub_12_3_findcontext_blackBBBBBB(y,
					d2c, z, x, d, c)) {
				Object[] result3_green = decdul2branchbubImpl
						.pattern_decdul2branchbub_12_3_findcontext_greenBBBBBBFFFFFFF(y, d2c, z, x, d, c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch y, S2B d2c, Command z, Branch x,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject y,
			EObject d2c, EObject z, EObject x, EObject l, EObject d, EObject a2x, EObject b2y, EObject c) {
		ruleresult.registerObject("l2z", l2z);
		ruleresult.registerObject("b", b);
		ruleresult.registerObject("a", a);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_119(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_119(EMoflonEdge _edge_last) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdul2branchbubImpl
				.pattern_decdul2branchbub_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, b, a, y, z, x, l, d, c,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[b] = " + b + ", " + "[a] = " + a + ", " + "[y] = " + y + ", " + "[z] = " + z + ", " + "[x] = "
					+ x + ", " + "[l] = " + l + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[sourceMatch] = "
		...
		if (decdul2branchbubImpl.pattern_decdul2branchbub_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decdul2branchbubImpl
				...
				Object[] result6_black = decdul2branchbubImpl
						.pattern_decdul2branchbub_24_6_createcorrespondence_blackBBBBBBBBB(b, a, y, z, x, l, d, c,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[b] = " + b + ", "
							+ "[a] = " + a + ", " + "[y] = " + y + ", " + "[z] = " + z + ", " + "[x] = " + x + ", "
							+ "[l] = " + l + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				decdul2branchbubImpl.pattern_decdul2branchbub_24_6_createcorrespondence_greenFBBBBBBFFB(b, a, y, z, x,
						l, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(While b, Decision a, Branch y, Command z, Branch x, Assignment l, Decision d,
	...
	public boolean checkDEC_BWD(Branch y, Command z, Branch x, Branch c) {// 
		Object[] result1_black = decdul2branchbubImpl.pattern_decdul2branchbub_28_1_matchtggpattern_blackBBBB(y, z, x,
				c);
		if (result1_black != null) {
		...
		for (Object[] result2_black : decdul2branchbubImpl
			...
			if (decdul2branchbubImpl.pattern_decdul2branchbub_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					decdul2branchbubImpl.pattern_decdul2branchbub_29_6_perform_greenFFFFFFFBFFBB(d, c, ruleResult);
					//nothing S2N l2z = (S2N) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDUL2BRANCHBUB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_DECISION_S2B_ASSIGNMENT_DECISION_BRANCH:
		...
		case RulesPackage.DECDUL2BRANCHBUB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_S2B_COMMAND_BRANCH_DECISION_BRANCH:
		...
		case RulesPackage.DECDUL2BRANCHBUB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_119__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_119((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDUL2BRANCHBUB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_119__EMOFLONEDGE:
		...
		case RulesPackage.DECDUL2BRANCHBUB___IS_APPLICABLE_SOLVE_CSP_CC__WHILE_DECISION_BRANCH_COMMAND_BRANCH_ASSIGNMENT_DECISION_BRANCH_MATCH_MATCH:
	...
	public static final Object[] pattern_decdul2branchbub_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, b, a, l, d, b__l____last, b__l____first, d__a____positive, d__b____negative };
	}
					...
					if (tmpL instanceof Assignment) {
						...
						if (tmpD instanceof Decision) {
							...
							if (tmpC instanceof Branch) {
								...
								return new Object[] { b, a, d2c, l, d, c, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdul2branchbub_1_1_performtransformation_blackBBBBBBFBB(While b, Decision a,
			S2B d2c, Assignment l, Decision d, Branch c, decdul2branchbub _this, IsApplicableMatch isApplicableMatch) {
		if (!a.equals(d)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { b, a, d2c, l, d, c, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decdul2branchbub_1_1_performtransformation_binding != null) {
			...
			Decision a = (Decision) result_pattern_decdul2branchbub_1_1_performtransformation_binding[1];
			S2B d2c = (S2B) result_pattern_decdul2branchbub_1_1_performtransformation_binding[2];
			...
			Object[] result_pattern_decdul2branchbub_1_1_performtransformation_black = pattern_decdul2branchbub_1_1_performtransformation_blackBBBBBBFBB(
					b, a, d2c, l, d, c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdul2branchbub_1_1_performtransformation_greenFBBFFFBFFB(While b, Decision a,
		...
		b2y.setSource(b);
		b2y.setTarget(y);
		return new Object[] { l2z, b, a, y, z, x, l, a2x, b2y, c };
	}

	public static final Object[] pattern_decdul2branchbub_1_2_collecttranslatedelements_blackBBBBBBBBB(S2N l2z, While b,
			Decision a, Branch y, Command z, Branch x, Assignment l, S2B a2x, S2B b2y) {
		if (!x.equals(y)) {
			if (!a2x.equals(b2y)) {
				return new Object[] { l2z, b, a, y, z, x, l, a2x, b2y };
			}
		}
		return null;
	}

	public static final Object[] pattern_decdul2branchbub_1_2_collecttranslatedelements_greenFBBBBBBBBB(S2N l2z,
			While b, Decision a, Branch y, Command z, Branch x, Assignment l, S2B a2x, S2B b2y) {
		...
		return new Object[] { ruleresult, l2z, b, a, y, z, x, l, a2x, b2y };
	}

	public static final Object[] pattern_decdul2branchbub_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject y, EObject d2c, EObject z,
			EObject x, EObject l, EObject d, EObject a2x, EObject b2y, EObject c) {
		if (!l2z.equals(y)) {
			if (!l2z.equals(z)) {
				if (!l2z.equals(x)) {
					if (!b.equals(l2z)) {
	...
	public static final Object[] pattern_decdul2branchbub_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject y, EObject z, EObject x, EObject l,
			EObject d, EObject a2x, EObject b2y, EObject c) {
		EMoflonEdge b__l____last = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, l2z, b, a, y, z, x, l, d, a2x, b2y, c, b__l____last, y__z____positive,
				b__l____first, z__y____next, l2z__z____target, a2x__x____target, l2z__l____source, a2x__a____source,
				d__a____positive, b2y__b____source, b2y__y____target, d__b____negative, c__y____negative,
				c__x____positive };
	}

	public static final void pattern_decdul2branchbub_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			decdul2branchbub _this, PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject y,
			EObject d2c, EObject z, EObject x, EObject l, EObject d, EObject a2x, EObject b2y, EObject c) {
		_this.registerObjects_FWD(ruleresult, l2z, b, a, y, d2c, z, x, l, d, a2x, b2y, c);
	...
	public static final Iterable<Object[]> pattern_decdul2branchbub_2_2_corematch_blackBBFBBFB(While b, Decision a,
		...
		if (!a.equals(d)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { b, a, d2c, l, d, c, match });
				}
	...
	public static final Iterable<Object[]> pattern_decdul2branchbub_2_3_findcontext_blackBBBBBB(While b, Decision a,
			S2B d2c, Assignment l, Decision d, Branch c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(d)) {
						...
						if (a.equals(d.getPositive())) {
							if (b.equals(d.getNegative())) {
								if (c.equals(d2c.getTarget())) {
									_result.add(new Object[] { b, a, d2c, l, d, c });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decdul2branchbub_2_3_findcontext_greenBBBBBBFFFFFFF(While b, Decision a,
			S2B d2c, Assignment l, Decision d, Branch c) {
		...
		return new Object[] { b, a, d2c, l, d, c, isApplicableMatch, b__l____last, b__l____first, d2c__d____source,
	...
	public static final Object[] pattern_decdul2branchbub_2_4_solveCSP_bindingFBBBBBBBB(decdul2branchbub _this,
			IsApplicableMatch isApplicableMatch, While b, Decision a, S2B d2c, Assignment l, Decision d, Branch c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, b, a, d2c, l, d, c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b, a, d2c, l, d, c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdul2branchbub_2_4_solveCSP_bindingAndBlackFBBBBBBBB(decdul2branchbub _this,
		...
		Object[] result_pattern_decdul2branchbub_2_4_solveCSP_binding = pattern_decdul2branchbub_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, b, a, d2c, l, d, c);
	...
	public static final Object[] pattern_decdul2branchbub_10_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		c__x____positive.setName(c__x____positive_name_prime);
		return new Object[] { match, y, z, x, c, y__z____positive, z__y____next, c__y____negative, c__x____positive };
	}
	...
	public static final void pattern_decdul2branchbub_10_6_registerobjectstomatch_expressionBBBBBB(
			decdul2branchbub _this, Match match, Branch y, Command z, Branch x, Branch c) {
				...
				if (tmpZ instanceof Command) {
					...
					if (tmpX instanceof Branch) {
						...
						if (tmpD instanceof Decision) {
							...
							if (tmpC instanceof Branch) {
								Branch c = (Branch) tmpC;
								return new Object[] { y, d2c, z, x, d, c, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdul2branchbub_11_1_performtransformation_blackBBBBBBFBB(Branch y, S2B d2c,
			Command z, Branch x, Decision d, Branch c, decdul2branchbub _this, IsApplicableMatch isApplicableMatch) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { y, d2c, z, x, d, c, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdul2branchbub_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decdul2branchbub_11_1_performtransformation_binding != null) {
			...
			Command z = (Command) result_pattern_decdul2branchbub_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_decdul2branchbub_11_1_performtransformation_black = pattern_decdul2branchbub_11_1_performtransformation_blackBBBBBBFBB(
					y, d2c, z, x, d, c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdul2branchbub_11_1_performtransformation_greenFFFBBBFBFF(Branch y,
		...
		b2y.setSource(b);
		b2y.setTarget(y);
		return new Object[] { l2z, b, a, y, z, x, l, d, a2x, b2y };
	}

	public static final Object[] pattern_decdul2branchbub_11_2_collecttranslatedelements_blackBBBBBBBBB(S2N l2z,
			While b, Decision a, Branch y, Command z, Branch x, Assignment l, S2B a2x, S2B b2y) {
		if (!x.equals(y)) {
			if (!a2x.equals(b2y)) {
				return new Object[] { l2z, b, a, y, z, x, l, a2x, b2y };
	...
	public static final Object[] pattern_decdul2branchbub_11_2_collecttranslatedelements_greenFBBBBBBBBB(S2N l2z,
			While b, Decision a, Branch y, Command z, Branch x, Assignment l, S2B a2x, S2B b2y) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(l2z);
	...
	public static final void pattern_decdul2branchbub_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			decdul2branchbub _this, PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject y,
			EObject d2c, EObject z, EObject x, EObject l, EObject d, EObject a2x, EObject b2y, EObject c) {
		_this.registerObjects_BWD(ruleresult, l2z, b, a, y, d2c, z, x, l, d, a2x, b2y, c);
	...
	public static final Iterable<Object[]> pattern_decdul2branchbub_12_2_corematch_blackBFBBFBB(Branch y, Command z,
			...
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							_result.add(new Object[] { y, d2c, z, x, d, c, match });
						}
	...
	public static final Iterable<Object[]> pattern_decdul2branchbub_12_3_findcontext_blackBBBBBB(Branch y, S2B d2c,
			Command z, Branch x, Decision d, Branch c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
								...
								if (c.equals(d2c.getTarget())) {
									if (y.equals(c.getNegative())) {
										if (x.equals(c.getPositive())) {
											_result.add(new Object[] { y, d2c, z, x, d, c });
										}
									}
								}
							}
	...
	public static final Object[] pattern_decdul2branchbub_12_3_findcontext_greenBBBBBBFFFFFFF(Branch y, S2B d2c,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		c__x____positive.setName(c__x____positive_name_prime);
		return new Object[] { y, d2c, z, x, d, c, isApplicableMatch, y__z____positive, z__y____next, d2c__d____source,
	...
	public static final Object[] pattern_decdul2branchbub_12_4_solveCSP_bindingFBBBBBBBB(decdul2branchbub _this,
			IsApplicableMatch isApplicableMatch, Branch y, S2B d2c, Command z, Branch x, Decision d, Branch c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, y, d2c, z, x, d, c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, y, d2c, z, x, d, c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdul2branchbub_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decdul2branchbub _this,
		...
		Object[] result_pattern_decdul2branchbub_12_4_solveCSP_binding = pattern_decdul2branchbub_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, y, d2c, z, x, d, c);
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_0B(Branch y) {
		for (Graph __DEC_y_root_803921 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_1BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_539674 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_539674)) {
							if (!x.equals(__DEC_y_positive_539674)) {
								if (!c.equals(__DEC_y_positive_539674)) {
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_2BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_464368 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_464368)) {
							if (!x.equals(__DEC_y_negative_464368)) {
								if (!c.equals(__DEC_y_negative_464368)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_425220 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_4BBBB(Command z, Branch y,
			Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_positive_185251 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!y.equals(__DEC_z_positive_185251)) {
							if (!x.equals(__DEC_z_positive_185251)) {
								if (!c.equals(__DEC_z_positive_185251)) {
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_5BBBB(Command z, Branch y,
			Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_negative_576624 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!y.equals(__DEC_z_negative_576624)) {
							if (!x.equals(__DEC_z_negative_576624)) {
								if (!c.equals(__DEC_z_negative_576624)) {
									return new Object[] { z, y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_502484 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_7BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_772940 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_772940)) {
							if (!y.equals(__DEC_x_positive_772940)) {
								if (!c.equals(__DEC_x_positive_772940)) {
	...
	public static final Object[] pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_8BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_197894 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_197894)) {
							if (!y.equals(__DEC_x_negative_197894)) {
								if (!c.equals(__DEC_x_negative_197894)) {
									return new Object[] { x, y, c };
								}
							}
						}
				...
				if (z.equals(y.getPositive())) {
					if (y.equals(z.getNext())) {
						if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_0B(y) == null) {
							if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_3B(z) == null) {
															...
															if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_13BB(
																...
																if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_1BBB(
																	...
																	if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_2BBB(
																			y, x, c) == null) {
																		if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_4BBBB(
																				z, y, x, c) == null) {
																			if (pattern_decdul2branchbub_20_2_testcorematchandDECs_black_nac_5BBBB(
																					z, y, x, c) == null) {
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_0BBB(While b, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_894323 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_894323)) {
					if (!d.equals(__DEC_b_positive_894323)) {
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_1B(While b) {
		for (While __DEC_b_first_135119 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_135119)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_2B(While b) {
		for (While __DEC_b_last_284615 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_284615)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_3B(While b) {
		for (Program __DEC_b_first_567222 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_4BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_951603 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_951603)) {
					if (!d.equals(__DEC_a_negative_951603)) {
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_5BB(Decision a, While b) {
		for (While __DEC_a_first_491316 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_491316)) {
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_6BB(Decision a, While b) {
		for (While __DEC_a_last_611452 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_611452)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_7B(Decision a) {
		for (Program __DEC_a_first_210624 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_8BBB(Assignment l,
		...
		if (!a.equals(d)) {
			for (Decision __DEC_l_positive_774573 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "positive")) {
				if (!a.equals(__DEC_l_positive_774573)) {
					if (!d.equals(__DEC_l_positive_774573)) {
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_9BBB(Assignment l,
			Decision a, Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_l_negative_146472 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "negative")) {
				if (!a.equals(__DEC_l_negative_146472)) {
					if (!d.equals(__DEC_l_negative_146472)) {
						return new Object[] { l, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_10BB(Assignment l,
			While b) {
		for (While __DEC_l_last_427977 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_427977)) {
	...
	public static final Object[] pattern_decdul2branchbub_21_2_testcorematchandDECs_black_nac_11B(Assignment l) {
		for (Program __DEC_l_first_332734 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
						...
						if (tmpX instanceof Branch) {
							...
							if (tmpL instanceof Assignment) {
								...
								if (tmpD instanceof Decision) {
									...
									if (tmpC instanceof Branch) {
										Branch c = (Branch) tmpC;
										return new Object[] { b, a, y, z, x, l, d, c, sourceMatch, targetMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_24_2_matchsrctrgcontext_blackBBBBBBBBBB(While b, Decision a,
			Branch y, Command z, Branch x, Assignment l, Decision d, Branch c, Match sourceMatch, Match targetMatch) {
		if (!a.equals(d)) {
			if (!x.equals(y)) {
				if (!c.equals(y)) {
					if (!c.equals(x)) {
	...
	public static final Object[] pattern_decdul2branchbub_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding != null) {
			While b = (While) result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding[0];
			Decision a = (Decision) result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding[1];
			Branch y = (Branch) result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding[2];
			Command z = (Command) result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding[3];
			Branch x = (Branch) result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding[4];
			Assignment l = (Assignment) result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_decdul2branchbub_24_2_matchsrctrgcontext_black = pattern_decdul2branchbub_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					b, a, y, z, x, l, d, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdul2branchbub_24_3_solvecsp_bindingFBBBBBBBBBBB(decdul2branchbub _this,
			While b, Decision a, Branch y, Command z, Branch x, Assignment l, Decision d, Branch c, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(b, a, y, z, x, l, d, c, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, b, a, y, z, x, l, d, c, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdul2branchbub_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			decdul2branchbub _this, While b, Decision a, Branch y, Command z, Branch x, Assignment l, Decision d,
		...
		Object[] result_pattern_decdul2branchbub_24_3_solvecsp_binding = pattern_decdul2branchbub_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, b, a, y, z, x, l, d, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdul2branchbub_24_6_createcorrespondence_blackBBBBBBBBB(While b, Decision a,
			Branch y, Command z, Branch x, Assignment l, Decision d, Branch c, CCMatch ccMatch) {
		if (!a.equals(d)) {
			if (!x.equals(y)) {
				if (!c.equals(y)) {
					if (!c.equals(x)) {
						return new Object[] { b, a, y, z, x, l, d, c, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decdul2branchbub_24_6_createcorrespondence_greenFBBBBBBFFB(While b, Decision a,
			Branch y, Command z, Branch x, Assignment l, CCMatch ccMatch) {
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		l2z.setTarget(z);
		...
		return new Object[] { l2z, b, a, y, z, x, l, a2x, b2y, ccMatch };
	}
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_0BBB(While b, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_489753 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_489753)) {
					if (!d.equals(__DEC_b_positive_489753)) {
						return new Object[] { b, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_1B(While b) {
		for (While __DEC_b_first_923406 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_923406)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_2B(While b) {
		for (While __DEC_b_last_259436 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_259436)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_3B(While b) {
		for (Program __DEC_b_first_335469 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_4BB(Decision a, Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_852943 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_852943)) {
					if (!d.equals(__DEC_a_negative_852943)) {
						return new Object[] { a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_5BB(Decision a, While b) {
		for (While __DEC_a_first_479084 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_479084)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_6BB(Decision a, While b) {
		for (While __DEC_a_last_368105 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_368105)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_7B(Decision a) {
		for (Program __DEC_a_first_861559 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_8BBB(Assignment l, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_l_positive_217789 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "positive")) {
				if (!a.equals(__DEC_l_positive_217789)) {
					if (!d.equals(__DEC_l_positive_217789)) {
						return new Object[] { l, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_9BBB(Assignment l, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_l_negative_665247 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "negative")) {
				if (!a.equals(__DEC_l_negative_665247)) {
					if (!d.equals(__DEC_l_negative_665247)) {
						return new Object[] { l, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_10BB(Assignment l, While b) {
		for (While __DEC_l_last_894778 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_894778)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_27_1_matchtggpattern_black_nac_11B(Assignment l) {
		for (Program __DEC_l_first_425377 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_0B(Branch y) {
		for (Graph __DEC_y_root_238678 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_1BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_185284 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_185284)) {
							if (!x.equals(__DEC_y_positive_185284)) {
								if (!c.equals(__DEC_y_positive_185284)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_2BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_347337 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_347337)) {
							if (!x.equals(__DEC_y_negative_347337)) {
								if (!c.equals(__DEC_y_negative_347337)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_356409 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_4BBBB(Command z, Branch y,
			Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_positive_521767 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!y.equals(__DEC_z_positive_521767)) {
							if (!x.equals(__DEC_z_positive_521767)) {
								if (!c.equals(__DEC_z_positive_521767)) {
									return new Object[] { z, y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_5BBBB(Command z, Branch y,
			Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_negative_499030 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!y.equals(__DEC_z_negative_499030)) {
							if (!x.equals(__DEC_z_negative_499030)) {
								if (!c.equals(__DEC_z_negative_499030)) {
									return new Object[] { z, y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_307938 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_7BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_303080 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_303080)) {
							if (!y.equals(__DEC_x_positive_303080)) {
								if (!c.equals(__DEC_x_positive_303080)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_8BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_629949 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_629949)) {
							if (!y.equals(__DEC_x_negative_629949)) {
								if (!c.equals(__DEC_x_negative_629949)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdul2branchbub_28_1_matchtggpattern_blackBBBB(Branch y, Command z, Branch x,
			Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
										...
										if (pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_1BBB(y, x,
											...
											if (pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_2BBB(y, x,
												...
												if (pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_3B(
														z) == null) {
													if (pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_4BBBB(z,
															y, x, c) == null) {
														if (pattern_decdul2branchbub_28_1_matchtggpattern_black_nac_5BBBB(
																z, y, x, c) == null) {
	...
	public static final Object[] pattern_decdul2branchbub_29_6_perform_greenFFFFFFFBFFBB(Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		While b = SourcecodeFactory.eINSTANCE.createWhile();
		Decision a = SourcecodeFactory.eINSTANCE.createDecision();
		...
		return new Object[] { l2z, b, a, y, z, x, l, d, a2x, b2y, c, ruleResult };
	}
