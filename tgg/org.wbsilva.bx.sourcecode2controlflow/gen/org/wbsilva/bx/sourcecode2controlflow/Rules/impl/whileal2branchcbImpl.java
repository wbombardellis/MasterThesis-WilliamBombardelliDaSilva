...
public class whileal2branchcbImpl extends AbstractRuleImpl implements whileal2branchcb {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While w, While c, Assignment b, Assignment a) {
		...
		Object[] result2_bindingAndBlack = whileal2branchcbImpl
				.pattern_whileal2branchcb_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, w, c, b, a);
		...
		if (whileal2branchcbImpl.pattern_whileal2branchcb_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileal2branchcbImpl
					.pattern_whileal2branchcb_0_4_collectelementstobetranslated_blackBBBBB(match, w, c, b, a);
			...
			Object[] result5_black = whileal2branchcbImpl
					.pattern_whileal2branchcb_0_5_collectcontextelements_blackBBBBB(match, w, c, b, a);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whileal2branchcbImpl
				.pattern_whileal2branchcb_1_1_performtransformation_greenFFBFFBFFBB(c, b, i, a);
		...
		Object[] result2_black = whileal2branchcbImpl
				.pattern_whileal2branchcb_1_2_collecttranslatedelements_blackBBBBBBBBB(x, b2y, c, a2x, z, b, c2z, y, a);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[x] = " + x + ", " + "[b2y] = "
					+ b2y + ", " + "[c] = " + c + ", " + "[a2x] = " + a2x + ", " + "[z] = " + z + ", " + "[b] = " + b
					+ ", " + "[c2z] = " + c2z + ", " + "[y] = " + y + ", " + "[a] = " + a + ".");
		}
		Object[] result2_green = whileal2branchcbImpl
				.pattern_whileal2branchcb_1_2_collecttranslatedelements_greenFBBBBBBBBB(x, b2y, c, a2x, z, b, c2z, y,
						a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileal2branchcbImpl
				.pattern_whileal2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, x, w, b2y, c, a2x, z,
						b, c2z, y, i, a, w2i);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[x] = " + x + ", " + "[w] = " + w + ", " + "[b2y] = " + b2y + ", " + "[c] = " + c + ", "
					+ "[a2x] = " + a2x + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[c2z] = " + c2z + ", "
					+ "[y] = " + y + ", " + "[i] = " + i + ", " + "[a] = " + a + ", " + "[w2i] = " + w2i + ".");
		}
		whileal2branchcbImpl.pattern_whileal2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(ruleresult,
				x, w, b2y, c, a2x, z, b, c2z, y, i, a);
		...
		// 
		// 
		whileal2branchcbImpl.pattern_whileal2branchcb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, x,
				w, b2y, c, a2x, z, b, c2z, y, i, a, w2i);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whileal2branchcbImpl.pattern_whileal2branchcb_2_2_corematch_blackBBBFBFB(w, c, b,
				a, match)) {
			Branch i = (Branch) result2_black[3];
			S2B w2i = (S2B) result2_black[5];
			// ForEach 
			for (Object[] result3_black : whileal2branchcbImpl.pattern_whileal2branchcb_2_3_findcontext_blackBBBBBB(w,
					c, b, i, a, w2i)) {
				Object[] result3_green = whileal2branchcbImpl
						.pattern_whileal2branchcb_2_3_findcontext_greenBBBBBBFFFFFF(w, c, b, i, a, w2i);
				...
				Object[] result4_bindingAndBlack = whileal2branchcbImpl
						.pattern_whileal2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, w, c,
								b, i, a, w2i);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While w, While c, Assignment b, Assignment a) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While w, While c, Assignment b, Assignment a) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While w, While c, Assignment b, Branch i,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject x, EObject w, EObject b2y, EObject c,
			EObject a2x, EObject z, EObject b, EObject c2z, EObject y, EObject i, EObject a, EObject w2i) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Command x, Branch z, Command y, Branch i) {
		...
		Object[] result2_bindingAndBlack = whileal2branchcbImpl
				.pattern_whileal2branchcb_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, x, z, y, i);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", "
					+ "[i] = " + i + ".");
		...
		if (whileal2branchcbImpl.pattern_whileal2branchcb_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileal2branchcbImpl
					.pattern_whileal2branchcb_10_4_collectelementstobetranslated_blackBBBBB(match, x, z, y, i);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ".");
			}
			...
			Object[] result5_black = whileal2branchcbImpl
					.pattern_whileal2branchcb_10_5_collectcontextelements_blackBBBBB(match, x, z, y, i);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = whileal2branchcbImpl
				.pattern_whileal2branchcb_11_1_performtransformation_greenBBFFFBFFBF(x, w, z, y);
		...
		Object[] result2_black = whileal2branchcbImpl
				.pattern_whileal2branchcb_11_2_collecttranslatedelements_blackBBBBBBBBB(x, b2y, c, a2x, z, b, c2z, y,
						a);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[x] = " + x + ", " + "[b2y] = "
					+ b2y + ", " + "[c] = " + c + ", " + "[a2x] = " + a2x + ", " + "[z] = " + z + ", " + "[b] = " + b
		...
		Object[] result2_green = whileal2branchcbImpl
				.pattern_whileal2branchcb_11_2_collecttranslatedelements_greenFBBBBBBBBB(x, b2y, c, a2x, z, b, c2z, y,
						a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileal2branchcbImpl
				.pattern_whileal2branchcb_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, x, w, b2y, c, a2x, z,
						b, c2z, y, i, a, w2i);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[x] = " + x + ", " + "[w] = " + w + ", " + "[b2y] = " + b2y + ", " + "[c] = " + c + ", "
		...
		// 
		// 
		whileal2branchcbImpl.pattern_whileal2branchcb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, x,
				w, b2y, c, a2x, z, b, c2z, y, i, a, w2i);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whileal2branchcbImpl.pattern_whileal2branchcb_12_2_corematch_blackBFBBBFB(x, z, y,
				i, match)) {
			...
			for (Object[] result3_black : whileal2branchcbImpl.pattern_whileal2branchcb_12_3_findcontext_blackBBBBBB(x,
					w, z, y, i, w2i)) {
				Object[] result3_green = whileal2branchcbImpl
						.pattern_whileal2branchcb_12_3_findcontext_greenBBBBBBFFFFFF(x, w, z, y, i, w2i);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = whileal2branchcbImpl
						.pattern_whileal2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, x, w,
								z, y, i, w2i);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Command x, Branch z, Command y, Branch i) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Command x, Branch z, Command y, Branch i) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Command x, While w, Branch z, Command y,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject x, EObject w, EObject b2y, EObject c,
			EObject a2x, EObject z, EObject b, EObject c2z, EObject y, EObject i, EObject a, EObject w2i) {
		ruleresult.registerObject("x", x);
		ruleresult.registerObject("w", w);
		ruleresult.registerObject("b2y", b2y);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_133(EMoflonEdge _edge_positive) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whileal2branchcbImpl
				.pattern_whileal2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, x, w, c, z, b, y, i, a,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[x] = " + x + ", " + "[w] = " + w + ", " + "[c] = " + c + ", " + "[z] = " + z + ", " + "[b] = "
					+ b + ", " + "[y] = " + y + ", " + "[i] = " + i + ", " + "[a] = " + a + ", " + "[sourceMatch] = "
		...
		if (whileal2branchcbImpl.pattern_whileal2branchcb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whileal2branchcbImpl
					.pattern_whileal2branchcb_24_5_matchcorrcontext_blackBBFBB(w, i, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = whileal2branchcbImpl
						.pattern_whileal2branchcb_24_6_createcorrespondence_blackBBBBBBBBB(x, w, c, z, b, y, i, a,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[x] = " + x + ", "
							+ "[w] = " + w + ", " + "[c] = " + c + ", " + "[z] = " + z + ", " + "[b] = " + b + ", "
							+ "[y] = " + y + ", " + "[i] = " + i + ", " + "[a] = " + a + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				whileal2branchcbImpl.pattern_whileal2branchcb_24_6_createcorrespondence_greenBFBFBBFBBB(x, c, z, b, y,
						a, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Command x, While w, While c, Branch z, Assignment b, Command y, Branch i,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While w, While c, Assignment b, Assignment a) {// 
		Object[] result1_black = whileal2branchcbImpl.pattern_whileal2branchcb_27_1_matchtggpattern_blackBBBB(w, c, b,
				a);
		if (result1_black != null) {
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Command x, Branch z, Command y, Branch i) {// 
		Object[] result1_black = whileal2branchcbImpl.pattern_whileal2branchcb_28_1_matchtggpattern_blackBBBB(x, z, y,
				i);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B w2iParameter) {
		...
		for (Object[] result2_black : whileal2branchcbImpl
			...
			Object[] result3_bindingAndBlack = whileal2branchcbImpl
					.pattern_whileal2branchcb_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, w, i, w2i,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (whileal2branchcbImpl.pattern_whileal2branchcb_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = whileal2branchcbImpl.pattern_whileal2branchcb_29_5_checknacs_blackBBB(w, i,
						w2i);
				if (result5_black != null) {

					Object[] result6_black = whileal2branchcbImpl.pattern_whileal2branchcb_29_6_perform_blackBBBB(w, i,
							w2i, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[w] = " + w + ", "
								+ "[i] = " + i + ", " + "[w2i] = " + w2i + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					whileal2branchcbImpl.pattern_whileal2branchcb_29_6_perform_greenFBFFFFFFFBFB(w, i, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILEAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_WHILE_ASSIGNMENT_BRANCH_ASSIGNMENT_S2B:
		...
		case RulesPackage.WHILEAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMMAND_WHILE_BRANCH_COMMAND_BRANCH_S2B:
		...
		case RulesPackage.WHILEAL2BRANCHCB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_133__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_133((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEAL2BRANCHCB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_133__EMOFLONEDGE:
		...
		case RulesPackage.WHILEAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_CC__COMMAND_WHILE_WHILE_BRANCH_ASSIGNMENT_COMMAND_BRANCH_ASSIGNMENT_MATCH_MATCH:
		...
		case RulesPackage.WHILEAL2BRANCHCB___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_WHILE_BRANCH_S2B_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_whileal2branchcb_0_1_initialbindings_blackBBBBBB(whileal2branchcb _this,
			Match match, While w, While c, Assignment b, Assignment a) {
		if (!c.equals(w)) {
			if (!a.equals(b)) {
	...
	public static final Object[] pattern_whileal2branchcb_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			While w, While c, Assignment b, Assignment a) {
		if (!c.equals(w)) {
			if (!a.equals(b)) {
	...
	public static final void pattern_whileal2branchcb_0_6_registerobjectstomatch_expressionBBBBBB(
			whileal2branchcb _this, Match match, While w, While c, Assignment b, Assignment a) {
					...
					if (tmpI instanceof Branch) {
						...
						if (tmpA instanceof Assignment) {
							...
							if (tmpW2i instanceof S2B) {
								S2B w2i = (S2B) tmpW2i;
								return new Object[] { w, c, b, i, a, w2i, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileal2branchcb_1_1_performtransformation_blackBBBBBBFBB(While w, While c,
			Assignment b, Branch i, Assignment a, S2B w2i, whileal2branchcb _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(w)) {
			if (!a.equals(b)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { w, c, b, i, a, w2i, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileal2branchcb_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileal2branchcb_1_1_performtransformation_binding != null) {
			While w = (While) result_pattern_whileal2branchcb_1_1_performtransformation_binding[0];
			While c = (While) result_pattern_whileal2branchcb_1_1_performtransformation_binding[1];
			Assignment b = (Assignment) result_pattern_whileal2branchcb_1_1_performtransformation_binding[2];
			Branch i = (Branch) result_pattern_whileal2branchcb_1_1_performtransformation_binding[3];
			Assignment a = (Assignment) result_pattern_whileal2branchcb_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_whileal2branchcb_1_1_performtransformation_black = pattern_whileal2branchcb_1_1_performtransformation_blackBBBBBBFBB(
					w, c, b, i, a, w2i, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileal2branchcb_1_1_performtransformation_greenFFBFFBFFBB(While c,
			Assignment b, Branch i, Assignment a) {
		...
		b2y.setTarget(y);
		y.setNext(z);
		return new Object[] { x, b2y, c, a2x, z, b, c2z, y, i, a };
	}

	public static final Object[] pattern_whileal2branchcb_1_2_collecttranslatedelements_blackBBBBBBBBB(Command x,
			S2N b2y, While c, S2N a2x, Branch z, Assignment b, S2B c2z, Command y, Assignment a) {
		if (!x.equals(y)) {
			if (!a2x.equals(b2y)) {
				if (!a.equals(b)) {
					return new Object[] { x, b2y, c, a2x, z, b, c2z, y, a };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_1_2_collecttranslatedelements_greenFBBBBBBBBB(Command x,
		...
		return new Object[] { ruleresult, x, b2y, c, a2x, z, b, c2z, y, a };
	}

	public static final Object[] pattern_whileal2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject x, EObject w, EObject b2y, EObject c, EObject a2x, EObject z,
			EObject b, EObject c2z, EObject y, EObject i, EObject a, EObject w2i) {
		if (!x.equals(z)) {
			if (!x.equals(y)) {
				if (!w.equals(x)) {
					if (!w.equals(z)) {
	...
	public static final Object[] pattern_whileal2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject x, EObject w, EObject b2y, EObject c, EObject a2x, EObject z,
			EObject b, EObject c2z, EObject y, EObject i, EObject a) {
		EMoflonEdge w__a____first = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, x, w, b2y, c, a2x, z, b, c2z, y, i, a, w__a____first, a2x__x____target,
				b2y__b____source, c2z__z____target, c__b____last, w__c____next, c2z__c____source, b2y__y____target,
				i__x____positive, a2x__a____source, y__z____next, i__z____negative };
	}

	public static final void pattern_whileal2branchcb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileal2branchcb _this, PerformRuleResult ruleresult, EObject x, EObject w, EObject b2y, EObject c,
			EObject a2x, EObject z, EObject b, EObject c2z, EObject y, EObject i, EObject a, EObject w2i) {
		_this.registerObjects_FWD(ruleresult, x, w, b2y, c, a2x, z, b, c2z, y, i, a, w2i);
	...
	public static final Iterable<Object[]> pattern_whileal2branchcb_2_2_corematch_blackBBBFBFB(While w, While c,
			Assignment b, Assignment a, Match match) {
		...
		if (!c.equals(w)) {
			if (!a.equals(b)) {
				for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class,
					...
					if (i != null) {
						_result.add(new Object[] { w, c, b, i, a, w2i, match });
					}
	...
	public static final Iterable<Object[]> pattern_whileal2branchcb_2_3_findcontext_blackBBBBBB(While w, While c,
			Assignment b, Branch i, Assignment a, S2B w2i) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(w)) {
			if (!a.equals(b)) {
						...
						if (c.equals(w.getNext())) {
							if (w.equals(w2i.getSource())) {
								if (i.equals(w2i.getTarget())) {
									_result.add(new Object[] { w, c, b, i, a, w2i });
								}
							}
						}
					}
	...
	public static final Object[] pattern_whileal2branchcb_2_3_findcontext_greenBBBBBBFFFFFF(While w, While c,
			Assignment b, Branch i, Assignment a, S2B w2i) {
		...
		return new Object[] { w, c, b, i, a, w2i, isApplicableMatch, w__a____first, c__b____last, w__c____next,
	...
	public static final Object[] pattern_whileal2branchcb_2_4_solveCSP_bindingFBBBBBBBB(whileal2branchcb _this,
			IsApplicableMatch isApplicableMatch, While w, While c, Assignment b, Branch i, Assignment a, S2B w2i) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, w, c, b, i, a, w2i);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, w, c, b, i, a, w2i };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileal2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(whileal2branchcb _this,
		...
		Object[] result_pattern_whileal2branchcb_2_4_solveCSP_binding = pattern_whileal2branchcb_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, w, c, b, i, a, w2i);
	...
	public static final Object[] pattern_whileal2branchcb_10_1_initialbindings_blackBBBBBB(whileal2branchcb _this,
			Match match, Command x, Branch z, Command y, Branch i) {
		if (!x.equals(y)) {
			if (!i.equals(z)) {
	...
	public static final Object[] pattern_whileal2branchcb_10_4_collectelementstobetranslated_blackBBBBB(Match match,
			Command x, Branch z, Command y, Branch i) {
		if (!x.equals(y)) {
			if (!i.equals(z)) {
	...
	public static final Object[] pattern_whileal2branchcb_10_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		y__z____next.setName(y__z____next_name_prime);
		i__z____negative.setName(i__z____negative_name_prime);
		return new Object[] { match, x, z, y, i, i__x____positive, y__z____next, i__z____negative };
	}
	...
	public static final void pattern_whileal2branchcb_10_6_registerobjectstomatch_expressionBBBBBB(
			whileal2branchcb _this, Match match, Command x, Branch z, Command y, Branch i) {
				...
				if (tmpZ instanceof Branch) {
					...
					if (tmpY instanceof Command) {
						...
						if (tmpI instanceof Branch) {
							...
							if (tmpW2i instanceof S2B) {
								S2B w2i = (S2B) tmpW2i;
								return new Object[] { x, w, z, y, i, w2i, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileal2branchcb_11_1_performtransformation_blackBBBBBBFBB(Command x, While w,
			Branch z, Command y, Branch i, S2B w2i, whileal2branchcb _this, IsApplicableMatch isApplicableMatch) {
		if (!x.equals(y)) {
			if (!i.equals(z)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { x, w, z, y, i, w2i, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileal2branchcb_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileal2branchcb_11_1_performtransformation_binding != null) {
			...
			Branch z = (Branch) result_pattern_whileal2branchcb_11_1_performtransformation_binding[2];
			Command y = (Command) result_pattern_whileal2branchcb_11_1_performtransformation_binding[3];
			Branch i = (Branch) result_pattern_whileal2branchcb_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_whileal2branchcb_11_1_performtransformation_black = pattern_whileal2branchcb_11_1_performtransformation_blackBBBBBBFBB(
					x, w, z, y, i, w2i, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileal2branchcb_11_1_performtransformation_greenBBFFFBFFBF(Command x, While w,
			Branch z, Command y) {
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		w.setFirst(a);
		a2x.setSource(a);
		return new Object[] { x, w, b2y, c, a2x, z, b, c2z, y, a };
	}
	...
	public static final void pattern_whileal2branchcb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileal2branchcb _this, PerformRuleResult ruleresult, EObject x, EObject w, EObject b2y, EObject c,
			EObject a2x, EObject z, EObject b, EObject c2z, EObject y, EObject i, EObject a, EObject w2i) {
		_this.registerObjects_BWD(ruleresult, x, w, b2y, c, a2x, z, b, c2z, y, i, a, w2i);
	...
	public static final Iterable<Object[]> pattern_whileal2branchcb_12_2_corematch_blackBFBBBFB(Command x, Branch z,
		...
		if (!x.equals(y)) {
			if (!i.equals(z)) {
				for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(i, S2B.class,
					...
					if (tmpW instanceof While) {
						While w = (While) tmpW;
						_result.add(new Object[] { x, w, z, y, i, w2i, match });
					}
	...
	public static final Iterable<Object[]> pattern_whileal2branchcb_12_3_findcontext_blackBBBBBB(Command x, While w,
			Branch z, Command y, Branch i, S2B w2i) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!x.equals(y)) {
			if (!i.equals(z)) {
						...
						if (i.equals(w2i.getTarget())) {
							if (z.equals(y.getNext())) {
								if (z.equals(i.getNegative())) {
									_result.add(new Object[] { x, w, z, y, i, w2i });
								}
							}
						}
					}
	...
	public static final Object[] pattern_whileal2branchcb_12_3_findcontext_greenBBBBBBFFFFFF(Command x, While w,
			Branch z, Command y, Branch i, S2B w2i) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge i__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge w2i__w____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		y__z____next.setName(y__z____next_name_prime);
		i__z____negative.setName(i__z____negative_name_prime);
		return new Object[] { x, w, z, y, i, w2i, isApplicableMatch, i__x____positive, w2i__w____source,
	...
	public static final Object[] pattern_whileal2branchcb_12_4_solveCSP_bindingFBBBBBBBB(whileal2branchcb _this,
			IsApplicableMatch isApplicableMatch, Command x, While w, Branch z, Command y, Branch i, S2B w2i) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, x, w, z, y, i, w2i);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, x, w, z, y, i, w2i };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileal2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(whileal2branchcb _this,
		...
		Object[] result_pattern_whileal2branchcb_12_4_solveCSP_binding = pattern_whileal2branchcb_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, x, w, z, y, i, w2i);
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_526993 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_1BBB(Command x, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_998327 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_x_positive_998327)) {
					if (!i.equals(__DEC_x_positive_998327)) {
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_2BBB(Command x, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_281988 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_x_negative_281988)) {
					if (!i.equals(__DEC_x_negative_281988)) {
						return new Object[] { x, z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_3B(Branch z) {
		for (Graph __DEC_z_root_871500 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_4BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_486887 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_486887)) {
					if (!i.equals(__DEC_z_positive_486887)) {
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_5BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_534335 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_534335)) {
					if (!i.equals(__DEC_z_negative_534335)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_247796 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_7BBB(Command y, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_y_positive_151506 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_y_positive_151506)) {
					if (!i.equals(__DEC_y_positive_151506)) {
	...
	public static final Object[] pattern_whileal2branchcb_20_2_testcorematchandDECs_black_nac_8BBB(Command y, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_y_negative_163271 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_y_negative_163271)) {
					if (!i.equals(__DEC_y_negative_163271)) {
						return new Object[] { y, z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_0B(While c) {
		for (Decision __DEC_c_positive_753647 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_1B(While c) {
		for (Decision __DEC_c_negative_631397 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_2BB(While c, While w) {
		if (!c.equals(w)) {
			for (While __DEC_c_first_937904 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!c.equals(__DEC_c_first_937904)) {
					if (!w.equals(__DEC_c_first_937904)) {
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_3BB(While c, While w) {
		if (!c.equals(w)) {
			for (While __DEC_c_last_745113 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!c.equals(__DEC_c_last_745113)) {
					if (!w.equals(__DEC_c_last_745113)) {
						return new Object[] { c, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_4B(While c) {
		for (Program __DEC_c_first_19651 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_5B(Assignment b) {
		for (Decision __DEC_b_positive_135627 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_6B(Assignment b) {
		for (Decision __DEC_b_negative_906389 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_7BBB(Assignment b,
			While w, While c) {
		if (!c.equals(w)) {
			for (While __DEC_b_first_215631 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "first")) {
				if (!w.equals(__DEC_b_first_215631)) {
					if (!c.equals(__DEC_b_first_215631)) {
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_8BBB(Assignment b,
			While w, While c) {
		if (!c.equals(w)) {
			for (While __DEC_b_last_597393 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!w.equals(__DEC_b_last_597393)) {
					if (!c.equals(__DEC_b_last_597393)) {
						return new Object[] { b, w, c };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_9B(Assignment b) {
		for (Program __DEC_b_first_417464 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_10B(Assignment a) {
		for (Decision __DEC_a_positive_590539 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_11B(Assignment a) {
		for (Decision __DEC_a_negative_495621 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_12BBB(Assignment a,
			While w, While c) {
		if (!c.equals(w)) {
			for (While __DEC_a_last_528656 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!w.equals(__DEC_a_last_528656)) {
					if (!c.equals(__DEC_a_last_528656)) {
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_13B(Assignment a) {
		for (Program __DEC_a_first_247855 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_19BB(While w,
			Assignment a) {
	...
	public static final Object[] pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_20BB(While c,
			Assignment a) {
					...
					if (tmpC instanceof While) {
						...
						if (!c.equals(w)) {
							...
							if (tmpB instanceof Assignment) {
								Assignment b = (Assignment) tmpB;
								if (!a.equals(b)) {
									if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_10B(a) == null) {
										if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_11B(
											...
											if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_13B(
													a) == null) {
												if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_19BB(w,
														a) == null) {
																						...
																						if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_5B(
																							...
																							if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_6B(
																								...
																								if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_7BBB(
																										b, w,
																										c) == null) {
																									if (pattern_whileal2branchcb_21_2_testcorematchandDECs_black_nac_8BBB(
																											b, w,
																											c) == null) {
						...
						if (tmpB instanceof Assignment) {
							...
							if (tmpY instanceof Command) {
								...
								if (tmpI instanceof Branch) {
									...
									if (tmpA instanceof Assignment) {
										Assignment a = (Assignment) tmpA;
										return new Object[] { x, w, c, z, b, y, i, a, targetMatch, sourceMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileal2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Command x, While w,
			While c, Branch z, Assignment b, Command y, Branch i, Assignment a, Match sourceMatch, Match targetMatch) {
		if (!x.equals(y)) {
			if (!c.equals(w)) {
				if (!i.equals(z)) {
					if (!a.equals(b)) {
						if (!sourceMatch.equals(targetMatch)) {
							return new Object[] { x, w, c, z, b, y, i, a, sourceMatch, targetMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_whileal2branchcb_24_2_matchsrctrgcontext_binding != null) {
			...
			Assignment b = (Assignment) result_pattern_whileal2branchcb_24_2_matchsrctrgcontext_binding[4];
			Command y = (Command) result_pattern_whileal2branchcb_24_2_matchsrctrgcontext_binding[5];
			Branch i = (Branch) result_pattern_whileal2branchcb_24_2_matchsrctrgcontext_binding[6];
			...
			Object[] result_pattern_whileal2branchcb_24_2_matchsrctrgcontext_black = pattern_whileal2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					x, w, c, z, b, y, i, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileal2branchcb_24_3_solvecsp_bindingFBBBBBBBBBBB(whileal2branchcb _this,
			Command x, While w, While c, Branch z, Assignment b, Command y, Branch i, Assignment a, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(x, w, c, z, b, y, i, a, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, x, w, c, z, b, y, i, a, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileal2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			whileal2branchcb _this, Command x, While w, While c, Branch z, Assignment b, Command y, Branch i,
		...
		Object[] result_pattern_whileal2branchcb_24_3_solvecsp_binding = pattern_whileal2branchcb_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, x, w, c, z, b, y, i, a, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_whileal2branchcb_24_5_matchcorrcontext_blackBBFBB(While w, Branch i,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_whileal2branchcb_24_6_createcorrespondence_blackBBBBBBBBB(Command x, While w,
			While c, Branch z, Assignment b, Command y, Branch i, Assignment a, CCMatch ccMatch) {
		if (!x.equals(y)) {
			if (!c.equals(w)) {
				if (!i.equals(z)) {
					if (!a.equals(b)) {
						return new Object[] { x, w, c, z, b, y, i, a, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileal2branchcb_24_6_createcorrespondence_greenBFBFBBFBBB(Command x, While c,
			Branch z, Assignment b, Command y, Assignment a, CCMatch ccMatch) {
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		b2y.setSource(b);
		...
		return new Object[] { x, b2y, c, a2x, z, b, c2z, y, a, ccMatch };
	}
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_0B(While c) {
		for (Decision __DEC_c_positive_838460 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_1B(While c) {
		for (Decision __DEC_c_negative_789158 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_2BB(While c, While w) {
		if (!c.equals(w)) {
			for (While __DEC_c_first_24569 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!c.equals(__DEC_c_first_24569)) {
					if (!w.equals(__DEC_c_first_24569)) {
						return new Object[] { c, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_3BB(While c, While w) {
		if (!c.equals(w)) {
			for (While __DEC_c_last_477159 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!c.equals(__DEC_c_last_477159)) {
					if (!w.equals(__DEC_c_last_477159)) {
						return new Object[] { c, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_4B(While c) {
		for (Program __DEC_c_first_344044 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_5B(Assignment b) {
		for (Decision __DEC_b_positive_256324 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_6B(Assignment b) {
		for (Decision __DEC_b_negative_458101 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_7BBB(Assignment b, While w,
			While c) {
		if (!c.equals(w)) {
			for (While __DEC_b_first_291627 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "first")) {
				if (!w.equals(__DEC_b_first_291627)) {
					if (!c.equals(__DEC_b_first_291627)) {
						return new Object[] { b, w, c };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_8BBB(Assignment b, While w,
			While c) {
		if (!c.equals(w)) {
			for (While __DEC_b_last_257299 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!w.equals(__DEC_b_last_257299)) {
					if (!c.equals(__DEC_b_last_257299)) {
						return new Object[] { b, w, c };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_9B(Assignment b) {
		for (Program __DEC_b_first_953714 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_10B(Assignment a) {
		for (Decision __DEC_a_positive_950375 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_11B(Assignment a) {
		for (Decision __DEC_a_negative_841373 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_12BBB(Assignment a, While w,
			While c) {
		if (!c.equals(w)) {
			for (While __DEC_a_last_434305 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!w.equals(__DEC_a_last_434305)) {
					if (!c.equals(__DEC_a_last_434305)) {
						return new Object[] { a, w, c };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_13B(Assignment a) {
		for (Program __DEC_a_first_101831 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_17BB(While c, Assignment b) {
		if (b.equals(c.getFirst())) {
			return new Object[] { c, b };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_19BB(While w, Assignment a) {
		if (a.equals(w.getLast())) {
			return new Object[] { w, a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_20BB(While c, Assignment a) {
		if (a.equals(c.getLast())) {
			return new Object[] { c, a };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_27_1_matchtggpattern_blackBBBB(While w, While c, Assignment b,
			Assignment a) {
		if (!c.equals(w)) {
			if (!a.equals(b)) {
				if (a.equals(w.getFirst())) {
												...
												if (pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_5B(
													...
													if (pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_6B(
														...
														if (pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_7BBB(
																b, w, c) == null) {
															if (pattern_whileal2branchcb_27_1_matchtggpattern_black_nac_8BBB(
																	b, w, c) == null) {
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_2705 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_1BBB(Command x, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_772655 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_x_positive_772655)) {
					if (!i.equals(__DEC_x_positive_772655)) {
						return new Object[] { x, z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_2BBB(Command x, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_699960 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_x_negative_699960)) {
					if (!i.equals(__DEC_x_negative_699960)) {
						return new Object[] { x, z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_3B(Branch z) {
		for (Graph __DEC_z_root_861137 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_4BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_655703 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_655703)) {
					if (!i.equals(__DEC_z_positive_655703)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_5BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_351644 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_351644)) {
					if (!i.equals(__DEC_z_negative_351644)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_578355 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_7BBB(Command y, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_y_positive_992662 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_y_positive_992662)) {
					if (!i.equals(__DEC_y_positive_992662)) {
						return new Object[] { y, z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_black_nac_8BBB(Command y, Branch z,
			Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_y_negative_678258 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_y_negative_678258)) {
					if (!i.equals(__DEC_y_negative_678258)) {
						return new Object[] { y, z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileal2branchcb_28_1_matchtggpattern_blackBBBB(Command x, Branch z, Command y,
			Branch i) {
		if (!x.equals(y)) {
			if (!i.equals(z)) {
				if (x.equals(i.getPositive())) {
	...
	public static final Object[] pattern_whileal2branchcb_29_5_checknacs_blackBBB(While w, Branch i, S2B w2i) {
		return new Object[] { w, i, w2i };
	}

	public static final Object[] pattern_whileal2branchcb_29_6_perform_blackBBBB(While w, Branch i, S2B w2i,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { w, i, w2i, ruleResult };
	}

	public static final Object[] pattern_whileal2branchcb_29_6_perform_greenFBFFFFFFFBFB(While w, Branch i,
			ModelgeneratorRuleResult ruleResult) {
		Command x = ControlflowFactory.eINSTANCE.createCommand();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		While c = SourcecodeFactory.eINSTANCE.createWhile();
		...
		return new Object[] { x, w, b2y, c, a2x, z, b, c2z, y, i, a, ruleResult };
	}
