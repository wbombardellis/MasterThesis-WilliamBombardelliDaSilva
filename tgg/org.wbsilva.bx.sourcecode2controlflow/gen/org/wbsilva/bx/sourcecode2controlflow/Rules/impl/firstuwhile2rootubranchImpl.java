...
public class firstuwhile2rootubranchImpl extends AbstractRuleImpl implements firstuwhile2rootubranch {
	...
	public boolean isAppropriate_FWD(Match match, While w, Program p, Assignment l) {
		...
		if (firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			//nothing EMoflonEdge w__l____first = (EMoflonEdge) result4_green[5];
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_1_1_performtransformation_greenFBBFFFB(w, g, l);
		...
		Object[] result2_black = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_1_2_collecttranslatedelements_blackBBBBBB(b, w, l2d, d, f2r, l);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[l2d] = "
							+ l2d + ", " + "[d] = " + d + ", " + "[f2r] = " + f2r + ", " + "[l] = " + l + ".");
		}
		Object[] result2_green = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_1_2_collecttranslatedelements_greenFBBBBBB(b, w, l2d, d, f2r, l);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, b, w, p, g, l2d, d,
						p2g, f2r, l);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[p] = " + p + ", " + "[g] = " + g + ", "
					+ "[l2d] = " + l2d + ", " + "[d] = " + d + ", " + "[p2g] = " + p2g + ", " + "[f2r] = " + f2r + ", "
					+ "[l] = " + l + ".");
		}
		firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFF(
				ruleresult, b, w, p, g, l2d, d, f2r, l);
		...
		//nothing EMoflonEdge f2r__b____target = (EMoflonEdge) result3_green[12];
		...
		//nothing EMoflonEdge b__d____positive = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge g__b____root = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge p__w____first = (EMoflonEdge) result3_green[18];

		// 
		// 
		firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, b, w, p, g, l2d, d, p2g, f2r, l);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_2_2_corematch_blackBBFFBB(w, p, l, match)) {
			Graph g = (Graph) result2_black[2];
			P2G p2g = (P2G) result2_black[3];
			// ForEach 
			for (Object[] result3_black : firstuwhile2rootubranchImpl
					.pattern_firstuwhile2rootubranch_2_3_findcontext_blackBBBBB(w, p, g, p2g, l)) {
				Object[] result3_green = firstuwhile2rootubranchImpl
						.pattern_firstuwhile2rootubranch_2_3_findcontext_greenBBBBBFFFFFF(w, p, g, p2g, l);
				...
				//nothing EMoflonEdge w__l____first = (EMoflonEdge) result3_green[8];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[w] = " + w + ", " + "[p] = " + p
							+ ", " + "[g] = " + g + ", " + "[p2g] = " + p2g + ", " + "[l] = " + l + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While w, Program p, Graph g, P2G p2g,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject b, EObject w, EObject p, EObject g,
			EObject l2d, EObject d, EObject p2g, EObject f2r, EObject l) {
	...
	public boolean isAppropriate_BWD(Match match, Branch b, Graph g, Command d) {
		...
		if (firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			//nothing EMoflonEdge b__d____positive = (EMoflonEdge) result4_green[5];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_11_1_performtransformation_greenBFBFBFF(b, p, d);
		...
		Object[] result2_black = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_11_2_collecttranslatedelements_blackBBBBBB(b, w, l2d, d, f2r, l);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[l2d] = "
							+ l2d + ", " + "[d] = " + d + ", " + "[f2r] = " + f2r + ", " + "[l] = " + l + ".");
		...
		Object[] result2_green = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_11_2_collecttranslatedelements_greenFBBBBBB(b, w, l2d, d, f2r, l);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, b, w, p, g, l2d,
						d, p2g, f2r, l);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[p] = " + p + ", " + "[g] = " + g + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_12_2_corematch_blackBFBBFB(b, g, d, match)) {
			Program p = (Program) result2_black[1];
			P2G p2g = (P2G) result2_black[4];
			// ForEach 
			for (Object[] result3_black : firstuwhile2rootubranchImpl
					.pattern_firstuwhile2rootubranch_12_3_findcontext_blackBBBBB(b, p, g, d, p2g)) {
				Object[] result3_green = firstuwhile2rootubranchImpl
						.pattern_firstuwhile2rootubranch_12_3_findcontext_greenBBBBBFFFFFF(b, p, g, d, p2g);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				...
				//nothing EMoflonEdge b__d____positive = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch b, Program p, Graph g, Command d,
			P2G p2g) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject b, EObject w, EObject p, EObject g,
			EObject l2d, EObject d, EObject p2g, EObject f2r, EObject l) {
		ruleresult.registerObject("b", b);
		ruleresult.registerObject("w", w);
		ruleresult.registerObject("p", p);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_2(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_2(EMoflonEdge _edge_last) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = firstuwhile2rootubranchImpl
				.pattern_firstuwhile2rootubranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, b, w, p, g, d, l,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[b] = " + b + ", " + "[w] = " + w + ", " + "[p] = " + p + ", " + "[g] = " + g + ", " + "[d] = "
					+ d + ", " + "[l] = " + l + ", " + "[sourceMatch] = " + sourceMatch + ", " + "[targetMatch] = "
					+ targetMatch + ".");
		}
		...
		if (firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : firstuwhile2rootubranchImpl
					.pattern_firstuwhile2rootubranch_24_5_matchcorrcontext_blackBBFBB(p, g, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = firstuwhile2rootubranchImpl
						.pattern_firstuwhile2rootubranch_24_6_createcorrespondence_blackBBBBBBB(b, w, p, g, d, l,
								ccMatch);
				if (result6_black == null) {
				...
				firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_24_6_createcorrespondence_greenBBFBFBB(b, w,
						d, l, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Branch b, While w, Program p, Graph g, Command d, Assignment l,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, P2G p2gParameter) {
		...
		for (Object[] result2_black : firstuwhile2rootubranchImpl
			...
			Object[] result3_bindingAndBlack = firstuwhile2rootubranchImpl
					.pattern_firstuwhile2rootubranch_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, p, g,
							p2g, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = firstuwhile2rootubranchImpl
						.pattern_firstuwhile2rootubranch_29_5_checknacs_blackBBB(p, g, p2g);
				if (result5_black != null) {

					Object[] result6_black = firstuwhile2rootubranchImpl
							.pattern_firstuwhile2rootubranch_29_6_perform_blackBBBB(p, g, p2g, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[p] = " + p + ", "
								+ "[g] = " + g + ", " + "[p2g] = " + p2g + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					firstuwhile2rootubranchImpl.pattern_firstuwhile2rootubranch_29_6_perform_greenFFBBFFFFB(p, g,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIRSTUWHILE2ROOTUBRANCH___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_PROGRAM_GRAPH_P2G_ASSIGNMENT:
		...
		case RulesPackage.FIRSTUWHILE2ROOTUBRANCH___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_PROGRAM_GRAPH_COMMAND_P2G:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Branch) arguments.get(1),
					(Program) arguments.get(2), (Graph) arguments.get(3), (Command) arguments.get(4),
					(P2G) arguments.get(5));
		...
		case RulesPackage.FIRSTUWHILE2ROOTUBRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_2__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_2((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIRSTUWHILE2ROOTUBRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_2__EMOFLONEDGE:
		...
		case RulesPackage.FIRSTUWHILE2ROOTUBRANCH___IS_APPLICABLE_SOLVE_CSP_CC__BRANCH_WHILE_PROGRAM_GRAPH_COMMAND_ASSIGNMENT_MATCH_MATCH:
		...
		case RulesPackage.FIRSTUWHILE2ROOTUBRANCH___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PROGRAM_GRAPH_P2G_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_firstuwhile2rootubranch_0_4_collectelementstobetranslated_greenBBBBFFF(
		...
		return new Object[] { match, w, p, l, w__l____last, w__l____first, p__w____first };
	}
				...
				if (tmpG instanceof Graph) {
					...
					if (tmpP2g instanceof P2G) {
						...
						if (tmpL instanceof Assignment) {
							...
							return new Object[] { w, p, g, p2g, l, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_1_1_performtransformation_blackBBBBBFBB(While w,
			Program p, Graph g, P2G p2g, Assignment l, firstuwhile2rootubranch _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { w, p, g, p2g, l, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_firstuwhile2rootubranch_1_1_performtransformation_binding != null) {
			...
			Program p = (Program) result_pattern_firstuwhile2rootubranch_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_firstuwhile2rootubranch_1_1_performtransformation_black = pattern_firstuwhile2rootubranch_1_1_performtransformation_blackBBBBBFBB(
					w, p, g, p2g, l, _this, isApplicableMatch);
	...
	public static final Object[] pattern_firstuwhile2rootubranch_1_1_performtransformation_greenFBBFFFB(While w,
		...
		f2r.setSource(w);
		f2r.setTarget(b);
		return new Object[] { b, w, g, l2d, d, f2r, l };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_1_2_collecttranslatedelements_blackBBBBBB(Branch b,
			While w, S2N l2d, Command d, S2B f2r, Assignment l) {
		return new Object[] { b, w, l2d, d, f2r, l };
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_1_2_collecttranslatedelements_greenFBBBBBB(Branch b,
		...
		return new Object[] { ruleresult, b, w, l2d, d, f2r, l };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject b, EObject w, EObject p, EObject g, EObject l2d, EObject d,
			EObject p2g, EObject f2r, EObject l) {
		if (!b.equals(w)) {
			if (!b.equals(p)) {
				if (!b.equals(g)) {
					if (!b.equals(l2d)) {
	...
	public static final Object[] pattern_firstuwhile2rootubranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFF(
		...
		p__w____first.setName(p__w____first_name_prime);
		return new Object[] { ruleresult, b, w, p, g, l2d, d, f2r, l, w__l____last, l2d__d____target, f2r__w____source,
				f2r__b____target, d__b____next, l2d__l____source, w__l____first, b__d____positive, g__b____root,
				p__w____first };
	}

	public static final void pattern_firstuwhile2rootubranch_1_5_registerobjects_expressionBBBBBBBBBBB(
			firstuwhile2rootubranch _this, PerformRuleResult ruleresult, EObject b, EObject w, EObject p, EObject g,
			EObject l2d, EObject d, EObject p2g, EObject f2r, EObject l) {
		_this.registerObjects_FWD(ruleresult, b, w, p, g, l2d, d, p2g, f2r, l);
	...
	public static final Iterable<Object[]> pattern_firstuwhile2rootubranch_2_2_corematch_blackBBFFBB(While w, Program p,
		...
		for (P2G p2g : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(p, P2G.class, "source")) {
			...
			if (g != null) {
				_result.add(new Object[] { w, p, g, p2g, l, match });
			}
	...
	public static final Iterable<Object[]> pattern_firstuwhile2rootubranch_2_3_findcontext_blackBBBBB(While w,
			Program p, Graph g, P2G p2g, Assignment l) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (l.equals(w.getFirst())) {
					if (g.equals(p2g.getTarget())) {
						if (w.equals(p.getFirst())) {
							_result.add(new Object[] { w, p, g, p2g, l });
						}
					}
				}
			}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_2_3_findcontext_greenBBBBBFFFFFF(While w, Program p,
			Graph g, P2G p2g, Assignment l) {
		...
		p__w____first.setName(p__w____first_name_prime);
		return new Object[] { w, p, g, p2g, l, isApplicableMatch, w__l____last, p2g__p____source, w__l____first,
				p2g__g____target, p__w____first };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_2_4_solveCSP_bindingFBBBBBBB(
			firstuwhile2rootubranch _this, IsApplicableMatch isApplicableMatch, While w, Program p, Graph g, P2G p2g,
			Assignment l) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, w, p, g, p2g, l);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, w, p, g, p2g, l };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_firstuwhile2rootubranch_2_4_solveCSP_binding = pattern_firstuwhile2rootubranch_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, w, p, g, p2g, l);
	...
	public static final Object[] pattern_firstuwhile2rootubranch_10_4_collectelementstobetranslated_greenBBBBFFF(
		...
		b__d____positive.setName(b__d____positive_name_prime);
		g__b____root.setName(g__b____root_name_prime);
		return new Object[] { match, b, g, d, d__b____next, b__d____positive, g__b____root };
	}
			...
			if (tmpP instanceof Program) {
				...
				if (tmpG instanceof Graph) {
					...
					if (tmpD instanceof Command) {
						...
						if (tmpP2g instanceof P2G) {
							P2G p2g = (P2G) tmpP2g;
							return new Object[] { b, p, g, d, p2g, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_11_1_performtransformation_blackBBBBBFBB(Branch b,
			Program p, Graph g, Command d, P2G p2g, firstuwhile2rootubranch _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { b, p, g, d, p2g, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_firstuwhile2rootubranch_11_1_performtransformation_binding != null) {
			Branch b = (Branch) result_pattern_firstuwhile2rootubranch_11_1_performtransformation_binding[0];
			Program p = (Program) result_pattern_firstuwhile2rootubranch_11_1_performtransformation_binding[1];
			Graph g = (Graph) result_pattern_firstuwhile2rootubranch_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_firstuwhile2rootubranch_11_1_performtransformation_black = pattern_firstuwhile2rootubranch_11_1_performtransformation_blackBBBBBFBB(
					b, p, g, d, p2g, _this, isApplicableMatch);
	...
	public static final Object[] pattern_firstuwhile2rootubranch_11_1_performtransformation_greenBFBFBFF(Branch b,
			Program p, Command d) {
		...
		l2d.setSource(l);
		w.setFirst(l);
		return new Object[] { b, w, p, l2d, d, f2r, l };
	}
	...
	public static final void pattern_firstuwhile2rootubranch_11_5_registerobjects_expressionBBBBBBBBBBB(
			firstuwhile2rootubranch _this, PerformRuleResult ruleresult, EObject b, EObject w, EObject p, EObject g,
			EObject l2d, EObject d, EObject p2g, EObject f2r, EObject l) {
		_this.registerObjects_BWD(ruleresult, b, w, p, g, l2d, d, p2g, f2r, l);
	...
	public static final Iterable<Object[]> pattern_firstuwhile2rootubranch_12_2_corematch_blackBFBBFB(Branch b, Graph g,
		...
		for (P2G p2g : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(g, P2G.class, "target")) {
			...
			if (p != null) {
				_result.add(new Object[] { b, p, g, d, p2g, match });
			}
	...
	public static final Iterable<Object[]> pattern_firstuwhile2rootubranch_12_3_findcontext_blackBBBBB(Branch b,
			Program p, Graph g, Command d, P2G p2g) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (p.equals(p2g.getSource())) {
			if (b.equals(d.getNext())) {
				if (d.equals(b.getPositive())) {
					if (b.equals(g.getRoot())) {
						if (g.equals(p2g.getTarget())) {
							_result.add(new Object[] { b, p, g, d, p2g });
						}
					}
				}
			}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_12_3_findcontext_greenBBBBBFFFFFF(Branch b, Program p,
			Graph g, Command d, P2G p2g) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge p2g__p____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d__b____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge b__d____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		g__b____root.setName(g__b____root_name_prime);
		p2g__g____target.setName(p2g__g____target_name_prime);
		return new Object[] { b, p, g, d, p2g, isApplicableMatch, p2g__p____source, d__b____next, b__d____positive,
				g__b____root, p2g__g____target };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_12_4_solveCSP_bindingFBBBBBBB(
			firstuwhile2rootubranch _this, IsApplicableMatch isApplicableMatch, Branch b, Program p, Graph g, Command d,
			P2G p2g) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, b, p, g, d, p2g);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b, p, g, d, p2g };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_firstuwhile2rootubranch_12_4_solveCSP_binding = pattern_firstuwhile2rootubranch_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, b, p, g, d, p2g);
	...
	public static final Object[] pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_0BB(Branch b,
			Graph g) {
		for (Graph __DEC_b_root_291870 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Graph.class, "root")) {
			if (!g.equals(__DEC_b_root_291870)) {
	...
	public static final Object[] pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_1B(Branch b) {
		for (Branch __DEC_b_positive_198085 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_b_positive_198085)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_2B(Branch b) {
		for (Branch __DEC_b_negative_96031 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_b_negative_96031)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_3BB(Command d,
			Graph g) {
		for (Graph __DEC_d_root_690302 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			if (!g.equals(__DEC_d_root_690302)) {
	...
	public static final Object[] pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_4BB(Command d,
			Branch b) {
		for (Branch __DEC_d_positive_818624 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_d_positive_818624)) {
	...
	public static final Object[] pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_5BB(Command d,
			Branch b) {
		for (Branch __DEC_d_negative_569380 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_d_negative_569380)) {
				return new Object[] { d, b };
			}
		}
		return null;
												...
												if (pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_0BB(
													...
													if (pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_3BB(
														...
														if (pattern_firstuwhile2rootubranch_20_2_testcorematchandDECs_black_nac_6BB(
																g, d) == null) {
															_result.add(new Object[] { b, g, d, _edge_next });
														}
													}
												}
											}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_0B(While w) {
		for (Decision __DEC_w_positive_948501 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_1B(While w) {
		for (Decision __DEC_w_negative_126163 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_2B(While w) {
		for (While __DEC_w_first_333692 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "first")) {
			if (!w.equals(__DEC_w_first_333692)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_3B(While w) {
		for (While __DEC_w_last_673306 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "last")) {
			if (!w.equals(__DEC_w_last_673306)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_4B(Assignment l) {
		for (Decision __DEC_l_positive_859069 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_5B(Assignment l) {
		for (Decision __DEC_l_negative_337393 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_6BB(Assignment l,
			While w) {
		for (While __DEC_l_last_502330 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!w.equals(__DEC_l_last_502330)) {
	...
	public static final Object[] pattern_firstuwhile2rootubranch_21_2_testcorematchandDECs_black_nac_7BB(Assignment l,
			Program p) {
		for (Program __DEC_l_first_383966 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			if (!p.equals(__DEC_l_first_383966)) {
				...
				if (tmpP instanceof Program) {
					...
					if (tmpG instanceof Graph) {
						...
						if (tmpD instanceof Command) {
							...
							if (tmpL instanceof Assignment) {
								Assignment l = (Assignment) tmpL;
								return new Object[] { b, w, p, g, d, l, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_blackBBBBBBBB(Branch b,
			While w, Program p, Graph g, Command d, Assignment l, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { b, w, p, g, d, l, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_binding != null) {
			Branch b = (Branch) result_pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_binding[0];
			While w = (While) result_pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_binding[1];
			Program p = (Program) result_pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_black = pattern_firstuwhile2rootubranch_24_2_matchsrctrgcontext_blackBBBBBBBB(
					b, w, p, g, d, l, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_firstuwhile2rootubranch_24_3_solvecsp_bindingFBBBBBBBBB(
			firstuwhile2rootubranch _this, Branch b, While w, Program p, Graph g, Command d, Assignment l,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(b, w, p, g, d, l, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, b, w, p, g, d, l, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_firstuwhile2rootubranch_24_3_solvecsp_binding = pattern_firstuwhile2rootubranch_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, b, w, p, g, d, l, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_firstuwhile2rootubranch_24_5_matchcorrcontext_blackBBFBB(Program p,
	...
	public static final Object[] pattern_firstuwhile2rootubranch_24_6_createcorrespondence_blackBBBBBBB(Branch b,
			While w, Program p, Graph g, Command d, Assignment l, CCMatch ccMatch) {
		return new Object[] { b, w, p, g, d, l, ccMatch };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_24_6_createcorrespondence_greenBBFBFBB(Branch b,
			While w, Command d, Assignment l, CCMatch ccMatch) {
		S2N l2d = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B f2r = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		l2d.setTarget(d);
		l2d.setSource(l);
		...
		return new Object[] { b, w, l2d, d, f2r, l, ccMatch };
	}
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_0B(While w) {
		for (Decision __DEC_w_positive_963042 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Decision.class, "positive")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_1B(While w) {
		for (Decision __DEC_w_negative_486219 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Decision.class, "negative")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_2B(While w) {
		for (While __DEC_w_first_265265 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "first")) {
			if (!w.equals(__DEC_w_first_265265)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_3B(While w) {
		for (While __DEC_w_last_28643 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				While.class, "last")) {
			if (!w.equals(__DEC_w_last_28643)) {
				return new Object[] { w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_4B(Assignment l) {
		for (Decision __DEC_l_positive_453112 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_5B(Assignment l) {
		for (Decision __DEC_l_negative_97714 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_6BB(Assignment l,
			While w) {
		for (While __DEC_l_last_50141 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!w.equals(__DEC_l_last_50141)) {
				return new Object[] { l, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_27_1_matchtggpattern_black_nac_7BB(Assignment l,
			Program p) {
		for (Program __DEC_l_first_332795 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			if (!p.equals(__DEC_l_first_332795)) {
				return new Object[] { l, p };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_28_1_matchtggpattern_black_nac_0BB(Branch b, Graph g) {
		for (Graph __DEC_b_root_293769 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Graph.class, "root")) {
			if (!g.equals(__DEC_b_root_293769)) {
				return new Object[] { b, g };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_28_1_matchtggpattern_black_nac_1B(Branch b) {
		for (Branch __DEC_b_positive_876194 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_b_positive_876194)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_28_1_matchtggpattern_black_nac_2B(Branch b) {
		for (Branch __DEC_b_negative_927516 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_b_negative_927516)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_28_1_matchtggpattern_black_nac_3BB(Command d,
			Graph g) {
		for (Graph __DEC_d_root_207348 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			if (!g.equals(__DEC_d_root_207348)) {
				return new Object[] { d, g };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_28_1_matchtggpattern_black_nac_4BB(Command d,
			Branch b) {
		for (Branch __DEC_d_positive_411037 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_d_positive_411037)) {
				return new Object[] { d, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_28_1_matchtggpattern_black_nac_5BB(Command d,
			Branch b) {
		for (Branch __DEC_d_negative_980338 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_d_negative_980338)) {
				return new Object[] { d, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstuwhile2rootubranch_29_3_solveCSP_bindingFBBBBBB(
			firstuwhile2rootubranch _this, IsApplicableMatch isApplicableMatch, Program p, Graph g, P2G p2g,
	...
	public static final Object[] pattern_firstuwhile2rootubranch_29_5_checknacs_blackBBB(Program p, Graph g, P2G p2g) {
		return new Object[] { p, g, p2g };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_29_6_perform_blackBBBB(Program p, Graph g, P2G p2g,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { p, g, p2g, ruleResult };
	}

	public static final Object[] pattern_firstuwhile2rootubranch_29_6_perform_greenFFBBFFFFB(Program p, Graph g,
			ModelgeneratorRuleResult ruleResult) {
		Branch b = ControlflowFactory.eINSTANCE.createBranch();
		While w = SourcecodeFactory.eINSTANCE.createWhile();
		S2N l2d = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		return new Object[] { b, w, p, g, l2d, d, f2r, l, ruleResult };
	}
