...
public class RulesAdapterFactory extends AdapterFactoryImpl {
	...
	protected RulesSwitch<Adapter> modelSwitch = new RulesSwitch<Adapter>() {
		...
		@Override
		public Adapter casenextd2nextb(nextd2nextb object) {
			return createnextd2nextbAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.wbsilva.bx.sourcecode2controlflow.Rules.nextd2nextb <em>nextd2nextb</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.wbsilva.bx.sourcecode2controlflow.Rules.nextd2nextb
	 * @generated
	 */
	public Adapter createnextd2nextbAdapter() {
		return null;
	}
