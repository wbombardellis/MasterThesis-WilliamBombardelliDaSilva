...
public class decdl2branchbbImpl extends AbstractRuleImpl implements decdl2branchbb {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While b, Assignment l, Decision a, Decision d) {
		...
		Object[] result2_bindingAndBlack = decdl2branchbbImpl
				.pattern_decdl2branchbb_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, b, l, a, d);
		...
		if (decdl2branchbbImpl.pattern_decdl2branchbb_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decdl2branchbbImpl
					.pattern_decdl2branchbb_0_4_collectelementstobetranslated_blackBBBBB(match, b, l, a, d);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[b] = " + b + ", " + "[l] = " + l + ", " + "[a] = " + a + ", " + "[d] = " + d + ".");
			}
			decdl2branchbbImpl.pattern_decdl2branchbb_0_4_collectelementstobetranslated_greenBBBBBFFF(match, b, l, a,
					d);
			...
			Object[] result5_black = decdl2branchbbImpl
					.pattern_decdl2branchbb_0_5_collectcontextelements_blackBBBBB(match, b, l, a, d);
			...
			// 
			decdl2branchbbImpl.pattern_decdl2branchbb_0_6_registerobjectstomatch_expressionBBBBBB(this, match, b, l, a,
					d);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdl2branchbbImpl.pattern_decdl2branchbb_1_1_performtransformation_greenFFBBFBFBFF(b,
				l, a, c);
		...
		Object[] result2_black = decdl2branchbbImpl
				.pattern_decdl2branchbb_1_2_collecttranslatedelements_blackBBBBBBBBB(x, z, b, l, a2x, a, l2z, y, b2y);
		...
		Object[] result2_green = decdl2branchbbImpl
				.pattern_decdl2branchbb_1_2_collecttranslatedelements_greenFBBBBBBBBB(x, z, b, l, a2x, a, l2z, y, b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdl2branchbbImpl.pattern_decdl2branchbb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
				ruleresult, x, z, b, l, a2x, a, d2c, l2z, c, d, y, b2y);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[l] = " + l + ", "
					+ "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[d2c] = " + d2c + ", " + "[l2z] = " + l2z + ", "
					+ "[c] = " + c + ", " + "[d] = " + d + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ".");
		}
		decdl2branchbbImpl.pattern_decdl2branchbb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(ruleresult, x,
				z, b, l, a2x, a, l2z, c, d, y, b2y);
		...
		// 
		// 
		decdl2branchbbImpl.pattern_decdl2branchbb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, x, z,
				b, l, a2x, a, d2c, l2z, c, d, y, b2y);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdl2branchbbImpl.pattern_decdl2branchbb_2_2_corematch_blackBBBFFBB(b, l, a, d,
				match)) {
			S2B d2c = (S2B) result2_black[3];
			Branch c = (Branch) result2_black[4];
			// ForEach 
			for (Object[] result3_black : decdl2branchbbImpl.pattern_decdl2branchbb_2_3_findcontext_blackBBBBBB(b, l, a,
					d2c, c, d)) {
				...
				Object[] result4_bindingAndBlack = decdl2branchbbImpl
						.pattern_decdl2branchbb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, b, l, a,
								d2c, c, d);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While b, Assignment l, Decision a, Decision d) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While b, Assignment l, Decision a, Decision d) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While b, Assignment l, Decision a,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject x, EObject z, EObject b, EObject l,
			EObject a2x, EObject a, EObject d2c, EObject l2z, EObject c, EObject d, EObject y, EObject b2y) {
	...
	public boolean isAppropriate_BWD(Match match, Branch x, Command z, Branch c, Branch y) {
		...
		Object[] result2_bindingAndBlack = decdl2branchbbImpl
				.pattern_decdl2branchbb_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, x, z, c, y);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[c] = " + c + ", "
					+ "[y] = " + y + ".");
		...
		if (decdl2branchbbImpl.pattern_decdl2branchbb_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decdl2branchbbImpl
					.pattern_decdl2branchbb_10_4_collectelementstobetranslated_blackBBBBB(match, x, z, c, y);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[c] = " + c + ", " + "[y] = " + y + ".");
			}
			decdl2branchbbImpl.pattern_decdl2branchbb_10_4_collectelementstobetranslated_greenBBBBBFFF(match, x, z, c,
					y);
			...
			Object[] result5_black = decdl2branchbbImpl
					.pattern_decdl2branchbb_10_5_collectcontextelements_blackBBBBB(match, x, z, c, y);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[c] = " + c + ", " + "[y] = " + y + ".");
			}
			...
			// 
			decdl2branchbbImpl.pattern_decdl2branchbb_10_6_registerobjectstomatch_expressionBBBBBB(this, match, x, z, c,
					y);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decdl2branchbbImpl.pattern_decdl2branchbb_11_1_performtransformation_greenBBFFFFFBBF(x,
				z, d, y);
		...
		Object[] result2_black = decdl2branchbbImpl
				.pattern_decdl2branchbb_11_2_collecttranslatedelements_blackBBBBBBBBB(x, z, b, l, a2x, a, l2z, y, b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[x] = " + x + ", " + "[z] = " + z
					+ ", " + "[b] = " + b + ", " + "[l] = " + l + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", "
					+ "[l2z] = " + l2z + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ".");
		...
		Object[] result2_green = decdl2branchbbImpl
				.pattern_decdl2branchbb_11_2_collecttranslatedelements_greenFBBBBBBBBB(x, z, b, l, a2x, a, l2z, y, b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		decdl2branchbbImpl.pattern_decdl2branchbb_11_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(ruleresult, x,
				z, b, l, a2x, a, l2z, c, d, y, b2y);
		//nothing EMoflonEdge a2x__x____target = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge a2x__a____source = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge l2z__z____target = (EMoflonEdge) result3_green[14];
		...
		// 
		// 
		decdl2branchbbImpl.pattern_decdl2branchbb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, x, z,
				b, l, a2x, a, d2c, l2z, c, d, y, b2y);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdl2branchbbImpl.pattern_decdl2branchbb_12_2_corematch_blackBBFBFBB(x, z, c, y,
				match)) {
			S2B d2c = (S2B) result2_black[2];
			Decision d = (Decision) result2_black[4];
			// ForEach 
			for (Object[] result3_black : decdl2branchbbImpl.pattern_decdl2branchbb_12_3_findcontext_blackBBBBBB(x, z,
					d2c, c, d, y)) {
				Object[] result3_green = decdl2branchbbImpl.pattern_decdl2branchbb_12_3_findcontext_greenBBBBBBFFFFFF(x,
						z, d2c, c, d, y);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = decdl2branchbbImpl
						.pattern_decdl2branchbb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, x, z,
								d2c, c, d, y);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch x, Command z, S2B d2c, Branch c,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject x, EObject z, EObject b, EObject l,
			EObject a2x, EObject a, EObject d2c, EObject l2z, EObject c, EObject d, EObject y, EObject b2y) {
		ruleresult.registerObject("x", x);
		ruleresult.registerObject("z", z);
		ruleresult.registerObject("b", b);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_39(EMoflonEdge _edge_negative) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdl2branchbbImpl
				.pattern_decdl2branchbb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, x, z, b, l, a, c, d, y,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[l] = " + l + ", " + "[a] = "
					+ a + ", " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[y] = " + y + ", " + "[sourceMatch] = "
		...
		if (decdl2branchbbImpl.pattern_decdl2branchbb_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : decdl2branchbbImpl.pattern_decdl2branchbb_24_5_matchcorrcontext_blackFBBBB(c,
				...
				Object[] result6_black = decdl2branchbbImpl
						.pattern_decdl2branchbb_24_6_createcorrespondence_blackBBBBBBBBB(x, z, b, l, a, c, d, y,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[x] = " + x + ", "
							+ "[z] = " + z + ", " + "[b] = " + b + ", " + "[l] = " + l + ", " + "[a] = " + a + ", "
							+ "[c] = " + c + ", " + "[d] = " + d + ", " + "[y] = " + y + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				decdl2branchbbImpl.pattern_decdl2branchbb_24_6_createcorrespondence_greenBBBBFBFBFB(x, z, b, l, a, y,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Branch x, Command z, While b, Assignment l, Decision a, Branch c, Decision d,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While b, Assignment l, Decision a, Decision d) {// 
		Object[] result1_black = decdl2branchbbImpl.pattern_decdl2branchbb_27_1_matchtggpattern_blackBBBB(b, l, a, d);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(Branch x, Command z, Branch c, Branch y) {// 
		Object[] result1_black = decdl2branchbbImpl.pattern_decdl2branchbb_28_1_matchtggpattern_blackBBBB(x, z, c, y);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B d2cParameter) {
		...
		for (Object[] result2_black : decdl2branchbbImpl
			...
			Object[] result3_bindingAndBlack = decdl2branchbbImpl
					.pattern_decdl2branchbb_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, d2c, c, d,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (decdl2branchbbImpl.pattern_decdl2branchbb_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = decdl2branchbbImpl.pattern_decdl2branchbb_29_5_checknacs_blackBBB(d2c, c, d);
				if (result5_black != null) {

					Object[] result6_black = decdl2branchbbImpl.pattern_decdl2branchbb_29_6_perform_blackBBBB(d2c, c, d,
							ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[d2c] = " + d2c + ", "
								+ "[c] = " + c + ", " + "[d] = " + d + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					decdl2branchbbImpl.pattern_decdl2branchbb_29_6_perform_greenFFFFFFFBBFFB(c, d, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDL2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_ASSIGNMENT_DECISION_S2B_BRANCH_DECISION:
		...
		case RulesPackage.DECDL2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_COMMAND_S2B_BRANCH_DECISION_BRANCH:
		...
		case RulesPackage.DECDL2BRANCHBB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_39__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_39((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDL2BRANCHBB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_39__EMOFLONEDGE:
		...
		case RulesPackage.DECDL2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_CC__BRANCH_COMMAND_WHILE_ASSIGNMENT_DECISION_BRANCH_DECISION_BRANCH_MATCH_MATCH:
		...
		case RulesPackage.DECDL2BRANCHBB___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_BRANCH_DECISION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_decdl2branchbb_0_1_initialbindings_blackBBBBBB(decdl2branchbb _this,
			Match match, While b, Assignment l, Decision a, Decision d) {
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdl2branchbb_0_2_SolveCSP_bindingFBBBBBB(decdl2branchbb _this, Match match,
			While b, Assignment l, Decision a, Decision d) {
	...
	public static final Object[] pattern_decdl2branchbb_0_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		return new Object[] { match, b, l, a, d, d__b____negative, d__a____positive, b__l____last };
	}

	public static final Object[] pattern_decdl2branchbb_0_5_collectcontextelements_blackBBBBB(Match match, While b,
			Assignment l, Decision a, Decision d) {
		if (!a.equals(d)) {
			return new Object[] { match, b, l, a, d };
		}
		return null;
					...
					if (tmpD2c instanceof S2B) {
						...
						if (tmpC instanceof Branch) {
							...
							if (tmpD instanceof Decision) {
								...
								return new Object[] { b, l, a, d2c, c, d, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdl2branchbb_1_1_performtransformation_blackBBBBBBFBB(While b, Assignment l,
			Decision a, S2B d2c, Branch c, Decision d, decdl2branchbb _this, IsApplicableMatch isApplicableMatch) {
		if (!a.equals(d)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { b, l, a, d2c, c, d, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decdl2branchbb_1_1_performtransformation_binding != null) {
			...
			Assignment l = (Assignment) result_pattern_decdl2branchbb_1_1_performtransformation_binding[1];
			Decision a = (Decision) result_pattern_decdl2branchbb_1_1_performtransformation_binding[2];
			...
			Decision d = (Decision) result_pattern_decdl2branchbb_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_decdl2branchbb_1_1_performtransformation_black = pattern_decdl2branchbb_1_1_performtransformation_blackBBBBBBFBB(
					b, l, a, d2c, c, d, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdl2branchbb_1_1_performtransformation_greenFFBBFBFBFF(While b, Assignment l,
			Decision a, Branch c) {
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { x, z, b, l, a2x, a, l2z, c, y, b2y };
	}

	public static final Object[] pattern_decdl2branchbb_1_2_collecttranslatedelements_blackBBBBBBBBB(Branch x,
			Command z, While b, Assignment l, S2B a2x, Decision a, S2N l2z, Branch y, S2B b2y) {
		if (!x.equals(y)) {
			if (!a2x.equals(b2y)) {
				return new Object[] { x, z, b, l, a2x, a, l2z, y, b2y };
			}
		}
		return null;
	}

	public static final Object[] pattern_decdl2branchbb_1_2_collecttranslatedelements_greenFBBBBBBBBB(Branch x,
			Command z, While b, Assignment l, S2B a2x, Decision a, S2N l2z, Branch y, S2B b2y) {
		...
		return new Object[] { ruleresult, x, z, b, l, a2x, a, l2z, y, b2y };
	}

	public static final Object[] pattern_decdl2branchbb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject x, EObject z, EObject b, EObject l, EObject a2x, EObject a,
			EObject d2c, EObject l2z, EObject c, EObject d, EObject y, EObject b2y) {
		if (!x.equals(z)) {
			if (!x.equals(y)) {
				if (!b.equals(x)) {
					if (!b.equals(z)) {
	...
	public static final Object[] pattern_decdl2branchbb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject x, EObject z, EObject b, EObject l, EObject a2x, EObject a,
			EObject l2z, EObject c, EObject d, EObject y, EObject b2y) {
		...
		b__l____last.setName(b__l____last_name_prime);
		return new Object[] { ruleresult, x, z, b, l, a2x, a, l2z, c, d, y, b2y, a2x__x____target, a2x__a____source,
				l2z__z____target, z__y____next, l2z__l____source, d__b____negative, c__y____negative, c__x____positive,
				d__a____positive, b2y__y____target, b2y__b____source, b__l____last };
	}

	public static final void pattern_decdl2branchbb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(decdl2branchbb _this,
			PerformRuleResult ruleresult, EObject x, EObject z, EObject b, EObject l, EObject a2x, EObject a,
			EObject d2c, EObject l2z, EObject c, EObject d, EObject y, EObject b2y) {
		_this.registerObjects_FWD(ruleresult, x, z, b, l, a2x, a, d2c, l2z, c, d, y, b2y);
	...
	public static final Iterable<Object[]> pattern_decdl2branchbb_2_2_corematch_blackBBBFFBB(While b, Assignment l,
		...
		if (!a.equals(d)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { b, l, a, d2c, c, d, match });
				}
	...
	public static final Iterable<Object[]> pattern_decdl2branchbb_2_3_findcontext_blackBBBBBB(While b, Assignment l,
			Decision a, S2B d2c, Branch c, Decision d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(d)) {
					...
					if (a.equals(d.getPositive())) {
						if (d.equals(d2c.getSource())) {
							if (l.equals(b.getLast())) {
								_result.add(new Object[] { b, l, a, d2c, c, d });
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdl2branchbb_2_3_findcontext_greenBBBBBBFFFFFF(While b, Assignment l,
			Decision a, S2B d2c, Branch c, Decision d) {
		...
		b__l____last.setName(b__l____last_name_prime);
		return new Object[] { b, l, a, d2c, c, d, isApplicableMatch, d2c__c____target, d__b____negative,
				d__a____positive, d2c__d____source, b__l____last };
	}

	public static final Object[] pattern_decdl2branchbb_2_4_solveCSP_bindingFBBBBBBBB(decdl2branchbb _this,
			IsApplicableMatch isApplicableMatch, While b, Assignment l, Decision a, S2B d2c, Branch c, Decision d) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, b, l, a, d2c, c, d);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b, l, a, d2c, c, d };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdl2branchbb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(decdl2branchbb _this,
		...
		Object[] result_pattern_decdl2branchbb_2_4_solveCSP_binding = pattern_decdl2branchbb_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, b, l, a, d2c, c, d);
	...
	public static final Object[] pattern_decdl2branchbb_10_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		c__x____positive.setName(c__x____positive_name_prime);
		return new Object[] { match, x, z, c, y, z__y____next, c__y____negative, c__x____positive };
	}

	public static final Object[] pattern_decdl2branchbb_10_5_collectcontextelements_blackBBBBB(Match match, Branch x,
					...
					if (tmpC instanceof Branch) {
						...
						if (tmpD instanceof Decision) {
							...
							if (tmpY instanceof Branch) {
								...
								return new Object[] { x, z, d2c, c, d, y, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdl2branchbb_11_1_performtransformation_blackBBBBBBFBB(Branch x, Command z,
			S2B d2c, Branch c, Decision d, Branch y, decdl2branchbb _this, IsApplicableMatch isApplicableMatch) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { x, z, d2c, c, d, y, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decdl2branchbb_11_1_performtransformation_binding != null) {
			Branch x = (Branch) result_pattern_decdl2branchbb_11_1_performtransformation_binding[0];
			...
			Decision d = (Decision) result_pattern_decdl2branchbb_11_1_performtransformation_binding[4];
			Branch y = (Branch) result_pattern_decdl2branchbb_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_decdl2branchbb_11_1_performtransformation_black = pattern_decdl2branchbb_11_1_performtransformation_blackBBBBBBFBB(
					x, z, d2c, c, d, y, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdl2branchbb_11_1_performtransformation_greenBBFFFFFBBF(Branch x, Command z,
			Decision d, Branch y) {
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { x, z, b, l, a2x, a, l2z, d, y, b2y };
	}

	public static final Object[] pattern_decdl2branchbb_11_2_collecttranslatedelements_blackBBBBBBBBB(Branch x,
			Command z, While b, Assignment l, S2B a2x, Decision a, S2N l2z, Branch y, S2B b2y) {
		if (!x.equals(y)) {
			if (!a2x.equals(b2y)) {
				return new Object[] { x, z, b, l, a2x, a, l2z, y, b2y };
	...
	public static final Object[] pattern_decdl2branchbb_11_2_collecttranslatedelements_greenFBBBBBBBBB(Branch x,
			Command z, While b, Assignment l, S2B a2x, Decision a, S2N l2z, Branch y, S2B b2y) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_decdl2branchbb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(decdl2branchbb _this,
			PerformRuleResult ruleresult, EObject x, EObject z, EObject b, EObject l, EObject a2x, EObject a,
			EObject d2c, EObject l2z, EObject c, EObject d, EObject y, EObject b2y) {
		_this.registerObjects_BWD(ruleresult, x, z, b, l, a2x, a, d2c, l2z, c, d, y, b2y);
	...
	public static final Iterable<Object[]> pattern_decdl2branchbb_12_2_corematch_blackBBFBFBB(Branch x, Command z,
			...
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							_result.add(new Object[] { x, z, d2c, c, d, y, match });
						}
	...
	public static final Iterable<Object[]> pattern_decdl2branchbb_12_3_findcontext_blackBBBBBB(Branch x, Command z,
			S2B d2c, Branch c, Decision d, Branch y) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
						...
						if (c.equals(d2c.getTarget())) {
							if (y.equals(c.getNegative())) {
								if (x.equals(c.getPositive())) {
									if (d.equals(d2c.getSource())) {
										_result.add(new Object[] { x, z, d2c, c, d, y });
									}
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_12_3_findcontext_greenBBBBBBFFFFFF(Branch x, Command z, S2B d2c,
			Branch c, Decision d, Branch y) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge z__y____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d2c__c____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__y____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		c__x____positive.setName(c__x____positive_name_prime);
		d2c__d____source.setName(d2c__d____source_name_prime);
		return new Object[] { x, z, d2c, c, d, y, isApplicableMatch, z__y____next, d2c__c____target, c__y____negative,
	...
	public static final Object[] pattern_decdl2branchbb_12_4_solveCSP_bindingFBBBBBBBB(decdl2branchbb _this,
			IsApplicableMatch isApplicableMatch, Branch x, Command z, S2B d2c, Branch c, Decision d, Branch y) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, x, z, d2c, c, d, y);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, x, z, d2c, c, d, y };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdl2branchbb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decdl2branchbb _this,
		...
		Object[] result_pattern_decdl2branchbb_12_4_solveCSP_binding = pattern_decdl2branchbb_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, x, z, d2c, c, d, y);
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_249664 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_1BBB(Branch x, Branch c,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_864540 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_864540)) {
							if (!c.equals(__DEC_x_positive_864540)) {
								if (!y.equals(__DEC_x_positive_864540)) {
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_2BBB(Branch x, Branch c,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_426304 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_426304)) {
							if (!c.equals(__DEC_x_negative_426304)) {
								if (!y.equals(__DEC_x_negative_426304)) {
									return new Object[] { x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_64665 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_4BBBB(Command z, Branch x,
			Branch c, Branch y) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_positive_191073 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!x.equals(__DEC_z_positive_191073)) {
							if (!c.equals(__DEC_z_positive_191073)) {
								if (!y.equals(__DEC_z_positive_191073)) {
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_5BBBB(Command z, Branch x,
			Branch c, Branch y) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_negative_217097 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!x.equals(__DEC_z_negative_217097)) {
							if (!c.equals(__DEC_z_negative_217097)) {
								if (!y.equals(__DEC_z_negative_217097)) {
									return new Object[] { z, x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_6B(Branch y) {
		for (Graph __DEC_y_root_249883 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_7BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_678416 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_678416)) {
							if (!x.equals(__DEC_y_positive_678416)) {
								if (!c.equals(__DEC_y_positive_678416)) {
	...
	public static final Object[] pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_8BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_194972 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_194972)) {
							if (!x.equals(__DEC_y_negative_194972)) {
								if (!c.equals(__DEC_y_negative_194972)) {
									return new Object[] { y, x, c };
								}
							}
						}
				...
				if (y.equals(z.getNext())) {
					if (pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_3B(z) == null) {
						if (pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_6B(y) == null) {
							if (pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_11BB(y, z) == null) {
								if (pattern_decdl2branchbb_20_2_testcorematchandDECs_black_nac_14BB(y, z) == null) {
	...
	public static final boolean pattern_decdl2branchbb_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decdl2branchbb _this, Match match, Branch x, Command z, Branch c, Branch y) {
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_0BBB(While b, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_692111 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_692111)) {
					if (!d.equals(__DEC_b_positive_692111)) {
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_1B(While b) {
		for (While __DEC_b_first_282672 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_282672)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_2B(While b) {
		for (While __DEC_b_last_933884 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_933884)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_3B(While b) {
		for (Program __DEC_b_first_965105 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_4BBB(Assignment l,
		...
		if (!a.equals(d)) {
			for (Decision __DEC_l_positive_93863 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
					Decision.class, "positive")) {
				if (!a.equals(__DEC_l_positive_93863)) {
					if (!d.equals(__DEC_l_positive_93863)) {
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_5BBB(Assignment l,
			Decision a, Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_l_negative_772611 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "negative")) {
				if (!a.equals(__DEC_l_negative_772611)) {
					if (!d.equals(__DEC_l_negative_772611)) {
						return new Object[] { l, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_6BB(Assignment l, While b) {
		for (While __DEC_l_first_915103 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!b.equals(__DEC_l_first_915103)) {
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_7BB(Assignment l, While b) {
		for (While __DEC_l_last_817558 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_817558)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_8B(Assignment l) {
		for (Program __DEC_l_first_309878 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_9BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_289158 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_289158)) {
					if (!d.equals(__DEC_a_negative_289158)) {
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_10BB(Decision a, While b) {
		for (While __DEC_a_first_10752 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_10752)) {
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_11BB(Decision a, While b) {
		for (While __DEC_a_last_317263 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_317263)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_12B(Decision a) {
		for (Program __DEC_a_first_604918 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
								...
								if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_1B(b) == null) {
									if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_2B(b) == null) {
										if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_3B(b) == null) {
											if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_14BB(d,
													b) == null) {
												if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_0BBB(b,
														a, d) == null) {
																				...
																				if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_4BBB(
																					...
																					if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_5BBB(
																						...
																						if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_6BB(
																								l, b) == null) {
																							if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_7BB(
																									l, b) == null) {
																								if (pattern_decdl2branchbb_21_2_testcorematchandDECs_black_nac_8B(
																										l) == null) {
	...
	public static final boolean pattern_decdl2branchbb_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decdl2branchbb _this, Match match, While b, Assignment l, Decision a, Decision d) {
						...
						if (tmpA instanceof Decision) {
							...
							if (tmpC instanceof Branch) {
								...
								if (tmpD instanceof Decision) {
									...
									if (tmpY instanceof Branch) {
										Branch y = (Branch) tmpY;
										return new Object[] { x, z, b, l, a, c, d, y, targetMatch, sourceMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Branch x, Command z,
			While b, Assignment l, Decision a, Branch c, Decision d, Branch y, Match sourceMatch, Match targetMatch) {
		if (!x.equals(y)) {
			if (!a.equals(d)) {
				if (!c.equals(x)) {
					if (!c.equals(y)) {
						if (!sourceMatch.equals(targetMatch)) {
							return new Object[] { x, z, b, l, a, c, d, y, sourceMatch, targetMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decdl2branchbb_24_2_matchsrctrgcontext_binding != null) {
			Branch x = (Branch) result_pattern_decdl2branchbb_24_2_matchsrctrgcontext_binding[0];
			...
			Decision d = (Decision) result_pattern_decdl2branchbb_24_2_matchsrctrgcontext_binding[6];
			...
			Object[] result_pattern_decdl2branchbb_24_2_matchsrctrgcontext_black = pattern_decdl2branchbb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					x, z, b, l, a, c, d, y, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdl2branchbb_24_3_solvecsp_bindingFBBBBBBBBBBB(decdl2branchbb _this,
			Branch x, Command z, While b, Assignment l, Decision a, Branch c, Decision d, Branch y, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(x, z, b, l, a, c, d, y, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, x, z, b, l, a, c, d, y, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdl2branchbb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(decdl2branchbb _this,
		...
		Object[] result_pattern_decdl2branchbb_24_3_solvecsp_binding = pattern_decdl2branchbb_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, x, z, b, l, a, c, d, y, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_decdl2branchbb_24_5_matchcorrcontext_blackFBBBB(Branch c, Decision d,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_decdl2branchbb_24_6_createcorrespondence_blackBBBBBBBBB(Branch x, Command z,
			While b, Assignment l, Decision a, Branch c, Decision d, Branch y, CCMatch ccMatch) {
		if (!x.equals(y)) {
			if (!a.equals(d)) {
				if (!c.equals(x)) {
					if (!c.equals(y)) {
						return new Object[] { x, z, b, l, a, c, d, y, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decdl2branchbb_24_6_createcorrespondence_greenBBBBFBFBFB(Branch x, Command z,
			While b, Assignment l, Decision a, Branch y, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		a2x.setTarget(x);
		...
		return new Object[] { x, z, b, l, a2x, a, l2z, y, b2y, ccMatch };
	}
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_0BBB(While b, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_136620 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_136620)) {
					if (!d.equals(__DEC_b_positive_136620)) {
						return new Object[] { b, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_1B(While b) {
		for (While __DEC_b_first_869146 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_869146)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_2B(While b) {
		for (While __DEC_b_last_392216 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_392216)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_3B(While b) {
		for (Program __DEC_b_first_819810 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_4BBB(Assignment l, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_l_positive_961283 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "positive")) {
				if (!a.equals(__DEC_l_positive_961283)) {
					if (!d.equals(__DEC_l_positive_961283)) {
						return new Object[] { l, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_5BBB(Assignment l, Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_l_negative_972928 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "negative")) {
				if (!a.equals(__DEC_l_negative_972928)) {
					if (!d.equals(__DEC_l_negative_972928)) {
						return new Object[] { l, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_6BB(Assignment l, While b) {
		for (While __DEC_l_first_85962 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!b.equals(__DEC_l_first_85962)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_7BB(Assignment l, While b) {
		for (While __DEC_l_last_954958 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_954958)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_8B(Assignment l) {
		for (Program __DEC_l_first_662160 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_9BB(Decision a, Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_352190 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_352190)) {
					if (!d.equals(__DEC_a_negative_352190)) {
						return new Object[] { a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_10BB(Decision a, While b) {
		for (While __DEC_a_first_253698 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_253698)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_11BB(Decision a, While b) {
		for (While __DEC_a_last_768341 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_768341)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_12B(Decision a) {
		for (Program __DEC_a_first_935608 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
							...
							if (pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_1B(b) == null) {
								if (pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_2B(b) == null) {
									if (pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_3B(b) == null) {
										if (pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_4BBB(l, a,
												d) == null) {
											if (pattern_decdl2branchbb_27_1_matchtggpattern_black_nac_5BBB(l, a,
													d) == null) {
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_938865 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_1BBB(Branch x, Branch c,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_367844 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_367844)) {
							if (!c.equals(__DEC_x_positive_367844)) {
								if (!y.equals(__DEC_x_positive_367844)) {
									return new Object[] { x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_2BBB(Branch x, Branch c,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_705595 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_705595)) {
							if (!c.equals(__DEC_x_negative_705595)) {
								if (!y.equals(__DEC_x_negative_705595)) {
									return new Object[] { x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_255845 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_4BBBB(Command z, Branch x,
			Branch c, Branch y) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_positive_322830 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!x.equals(__DEC_z_positive_322830)) {
							if (!c.equals(__DEC_z_positive_322830)) {
								if (!y.equals(__DEC_z_positive_322830)) {
									return new Object[] { z, x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_5BBBB(Command z, Branch x,
			Branch c, Branch y) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_negative_200043 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!x.equals(__DEC_z_negative_200043)) {
							if (!c.equals(__DEC_z_negative_200043)) {
								if (!y.equals(__DEC_z_negative_200043)) {
									return new Object[] { z, x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_6B(Branch y) {
		for (Graph __DEC_y_root_130974 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_7BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_678054 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_678054)) {
							if (!x.equals(__DEC_y_positive_678054)) {
								if (!c.equals(__DEC_y_positive_678054)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_8BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_191109 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_191109)) {
							if (!x.equals(__DEC_y_negative_191109)) {
								if (!c.equals(__DEC_y_negative_191109)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdl2branchbb_28_1_matchtggpattern_blackBBBB(Branch x, Command z, Branch c,
			Branch y) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
									...
									if (pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_1BBB(x, c, y) == null) {
										if (pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_2BBB(x, c,
											...
											if (pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_3B(z) == null) {
												if (pattern_decdl2branchbb_28_1_matchtggpattern_black_nac_4BBBB(z, x, c,
														y) == null) {
			...
			for (EObject tmpD2c : d2cList.getEntryObjects()) {
				if (tmpD2c instanceof S2B) {
					...
					if (c != null) {
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							if (pattern_decdl2branchbb_29_2_isapplicablecore_black_nac_0BB(ruleResult, d2c) == null) {
								if (pattern_decdl2branchbb_29_2_isapplicablecore_black_nac_1BB(ruleResult, c) == null) {
	...
	public static final Object[] pattern_decdl2branchbb_29_5_checknacs_blackBBB(S2B d2c, Branch c, Decision d) {
		return new Object[] { d2c, c, d };
	}

	public static final Object[] pattern_decdl2branchbb_29_6_perform_blackBBBB(S2B d2c, Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { d2c, c, d, ruleResult };
	}

	public static final Object[] pattern_decdl2branchbb_29_6_perform_greenFFFFFFFBBFFB(Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		Branch x = ControlflowFactory.eINSTANCE.createBranch();
		Command z = ControlflowFactory.eINSTANCE.createCommand();
		While b = SourcecodeFactory.eINSTANCE.createWhile();
		...
		return new Object[] { x, z, b, l, a2x, a, l2z, c, d, y, b2y, ruleResult };
	}
