...
public class while2branchImpl extends AbstractRuleImpl implements while2branch {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = while2branchImpl.pattern_while2branch_1_2_collecttranslatedelements_blackBBBBBB(c, d,
				a2c, b2d, b, a);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[a2c] = "
							+ a2c + ", " + "[b2d] = " + b2d + ", " + "[b] = " + b + ", " + "[a] = " + a + ".");
		}
		Object[] result2_green = while2branchImpl.pattern_while2branch_1_2_collecttranslatedelements_greenFBBBBBB(c, d,
				a2c, b2d, b, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = while2branchImpl.pattern_while2branch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, s, c, d, a2c, b2d, b, n, s2n, a);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[s] = " + s + ", " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[a2c] = " + a2c + ", "
					+ "[b2d] = " + b2d + ", " + "[b] = " + b + ", " + "[n] = " + n + ", " + "[s2n] = " + s2n + ", "
					+ "[a] = " + a + ".");
		}
		while2branchImpl.pattern_while2branch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, s, c, d, a2c,
				b2d, b, n, a);
		//nothing EMoflonEdge b2d__d____target = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge b2d__b____source = (EMoflonEdge) result3_green[10];
		...
		// 
		// 
		while2branchImpl.pattern_while2branch_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, s, c, d, a2c,
				b2d, b, n, s2n, a);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : while2branchImpl.pattern_while2branch_2_2_corematch_blackBBFFBB(s, b, a, match)) {
			Node n = (Node) result2_black[2];
			S2N s2n = (S2N) result2_black[3];
			// ForEach 
			for (Object[] result3_black : while2branchImpl.pattern_while2branch_2_3_findcontext_blackBBBBB(s, b, n, s2n,
					a)) {
				Object[] result3_green = while2branchImpl.pattern_while2branch_2_3_findcontext_greenBBBBBFFFFF(s, b, n,
						s2n, a);
				...
				Object[] result4_bindingAndBlack = while2branchImpl
						.pattern_while2branch_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, s, b, n,
								s2n, a);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Statement s, Assignment b, Node n,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject s, EObject c, EObject d, EObject a2c,
			EObject b2d, EObject b, EObject n, EObject s2n, EObject a) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = while2branchImpl.pattern_while2branch_11_1_performtransformation_greenBBBFFFF(s, c, d);
		...
		Object[] result2_black = while2branchImpl.pattern_while2branch_11_2_collecttranslatedelements_blackBBBBBB(c, d,
				a2c, b2d, b, a);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[a2c] = "
		...
		Object[] result2_green = while2branchImpl.pattern_while2branch_11_2_collecttranslatedelements_greenFBBBBBB(c, d,
				a2c, b2d, b, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		while2branchImpl.pattern_while2branch_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, s, c, d, a2c,
				b2d, b, n, a);
		//nothing EMoflonEdge b2d__d____target = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge b2d__b____source = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge a2c__c____target = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		while2branchImpl.pattern_while2branch_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, s, c, d, a2c,
				b2d, b, n, s2n, a);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : while2branchImpl.pattern_while2branch_12_2_corematch_blackFBBBFB(c, d, n,
				match)) {
			Statement s = (Statement) result2_black[0];
			S2N s2n = (S2N) result2_black[4];
			// ForEach 
			for (Object[] result3_black : while2branchImpl.pattern_while2branch_12_3_findcontext_blackBBBBB(s, c, d, n,
					s2n)) {
				Object[] result3_green = while2branchImpl.pattern_while2branch_12_3_findcontext_greenBBBBBFFFFF(s, c, d,
						n, s2n);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge n__c____next = (EMoflonEdge) result3_green[6];
				//nothing EMoflonEdge d__c____next = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge s2n__n____target = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge s2n__s____source = (EMoflonEdge) result3_green[9];

				Object[] result4_bindingAndBlack = while2branchImpl
						.pattern_while2branch_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, s, c, d, n,
								s2n);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Statement s, Branch c, Command d, Node n,
			S2N s2n) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject s, EObject c, EObject d, EObject a2c,
			EObject b2d, EObject b, EObject n, EObject s2n, EObject a) {
		ruleresult.registerObject("s", s);
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("d", d);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_118(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_118(EMoflonEdge _edge_next) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = while2branchImpl
				.pattern_while2branch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, s, c, d, b, n, a, sourceMatch,
						targetMatch);
		...
		if (while2branchImpl.pattern_while2branch_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : while2branchImpl.pattern_while2branch_24_5_matchcorrcontext_blackBBFBB(s, n,
				...
				Object[] result6_black = while2branchImpl.pattern_while2branch_24_6_createcorrespondence_blackBBBBBBB(s,
						c, d, b, n, a, ccMatch);
				if (result6_black == null) {
				...
				while2branchImpl.pattern_while2branch_24_6_createcorrespondence_greenBBFFBBB(c, d, b, a, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Statement s, Branch c, Command d, Assignment b, Node n, While a,
		...
		for (Object[] result2_black : while2branchImpl
			...
			if (while2branchImpl.pattern_while2branch_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					while2branchImpl.pattern_while2branch_29_6_perform_greenBFFFFFBFB(s, n, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILE2BRANCH___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_STATEMENT_ASSIGNMENT_NODE_S2N_WHILE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Statement) arguments.get(1),
					(Assignment) arguments.get(2), (Node) arguments.get(3), (S2N) arguments.get(4),
		...
		case RulesPackage.WHILE2BRANCH___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STATEMENT_BRANCH_COMMAND_NODE_S2N:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Statement) arguments.get(1),
					(Branch) arguments.get(2), (Command) arguments.get(3), (Node) arguments.get(4),
					(S2N) arguments.get(5));
		...
		case RulesPackage.WHILE2BRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_118__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_118((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILE2BRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_118__EMOFLONEDGE:
		...
		case RulesPackage.WHILE2BRANCH___IS_APPLICABLE_SOLVE_CSP_CC__STATEMENT_BRANCH_COMMAND_ASSIGNMENT_NODE_WHILE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Statement) arguments.get(0), (Branch) arguments.get(1),
				...
				if (tmpN instanceof Node) {
					...
					if (tmpS2n instanceof S2N) {
						...
						if (tmpA instanceof While) {
							While a = (While) tmpA;
							return new Object[] { s, b, n, s2n, a, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_1_1_performtransformation_blackBBBBBFBB(Statement s, Assignment b,
			Node n, S2N s2n, While a, while2branch _this, IsApplicableMatch isApplicableMatch) {
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { s, b, n, s2n, a, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_while2branch_1_1_performtransformation_binding != null) {
			...
			S2N s2n = (S2N) result_pattern_while2branch_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_while2branch_1_1_performtransformation_black = pattern_while2branch_1_1_performtransformation_blackBBBBBFBB(
					s, b, n, s2n, a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_while2branch_1_1_performtransformation_greenFFFFBBB(Assignment b, Node n,
		...
		b2d.setTarget(d);
		b2d.setSource(b);
		return new Object[] { c, d, a2c, b2d, b, n, a };
	}

	public static final Object[] pattern_while2branch_1_2_collecttranslatedelements_blackBBBBBB(Branch c, Command d,
			S2B a2c, S2N b2d, Assignment b, While a) {
		return new Object[] { c, d, a2c, b2d, b, a };
	}

	public static final Object[] pattern_while2branch_1_2_collecttranslatedelements_greenFBBBBBB(Branch c, Command d,
			S2B a2c, S2N b2d, Assignment b, While a) {
		...
		return new Object[] { ruleresult, c, d, a2c, b2d, b, a };
	}

	public static final Object[] pattern_while2branch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject s, EObject c, EObject d, EObject a2c, EObject b2d, EObject b,
			EObject n, EObject s2n, EObject a) {
		if (!s.equals(s2n)) {
			if (!c.equals(s)) {
				if (!c.equals(d)) {
					if (!c.equals(n)) {
	...
	public static final Object[] pattern_while2branch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
		...
		a__b____last.setName(a__b____last_name_prime);
		return new Object[] { ruleresult, s, c, d, a2c, b2d, b, n, a, b2d__d____target, b2d__b____source,
				a2c__c____target, n__c____next, s__a____next, d__c____next, a2c__a____source, a__b____last };
	}

	public static final void pattern_while2branch_1_5_registerobjects_expressionBBBBBBBBBBB(while2branch _this,
			PerformRuleResult ruleresult, EObject s, EObject c, EObject d, EObject a2c, EObject b2d, EObject b,
			EObject n, EObject s2n, EObject a) {
		_this.registerObjects_FWD(ruleresult, s, c, d, a2c, b2d, b, n, s2n, a);
	...
	public static final Iterable<Object[]> pattern_while2branch_2_2_corematch_blackBBFFBB(Statement s, Assignment b,
			While a, Match match) {
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (S2N s2n : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(s, S2N.class,
					...
					if (n != null) {
						_result.add(new Object[] { s, b, n, s2n, a, match });
					}
					...
					if (n.equals(s2n.getTarget())) {
						if (b.equals(a.getLast())) {
							if (s.equals(s2n.getSource())) {
								_result.add(new Object[] { s, b, n, s2n, a });
							}
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_2_3_findcontext_greenBBBBBFFFFF(Statement s, Assignment b, Node n,
			S2N s2n, While a) {
		...
		return new Object[] { s, b, n, s2n, a, isApplicableMatch, s__a____next, s2n__n____target, a__b____last,
				s2n__s____source };
	}

	public static final Object[] pattern_while2branch_2_4_solveCSP_bindingFBBBBBBB(while2branch _this,
			IsApplicableMatch isApplicableMatch, Statement s, Assignment b, Node n, S2N s2n, While a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, s, b, n, s2n, a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, s, b, n, s2n, a };
		}
		return null;
	}
	...
	public static final Object[] pattern_while2branch_2_4_solveCSP_bindingAndBlackFBBBBBBB(while2branch _this,
		...
		Object[] result_pattern_while2branch_2_4_solveCSP_binding = pattern_while2branch_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, s, b, n, s2n, a);
			...
			if (tmpC instanceof Branch) {
				...
				if (tmpD instanceof Command) {
					...
					if (tmpN instanceof Node) {
						...
						if (tmpS2n instanceof S2N) {
							S2N s2n = (S2N) tmpS2n;
							return new Object[] { s, c, d, n, s2n, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_11_1_performtransformation_blackBBBBBFBB(Statement s, Branch c,
			Command d, Node n, S2N s2n, while2branch _this, IsApplicableMatch isApplicableMatch) {
		if (!c.equals(n)) {
			if (!d.equals(n)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { s, c, d, n, s2n, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_while2branch_11_1_performtransformation_binding != null) {
			Statement s = (Statement) result_pattern_while2branch_11_1_performtransformation_binding[0];
			Branch c = (Branch) result_pattern_while2branch_11_1_performtransformation_binding[1];
			Command d = (Command) result_pattern_while2branch_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_while2branch_11_1_performtransformation_black = pattern_while2branch_11_1_performtransformation_blackBBBBBFBB(
					s, c, d, n, s2n, _this, isApplicableMatch);
	...
	public static final Object[] pattern_while2branch_11_1_performtransformation_greenBBBFFFF(Statement s, Branch c,
			Command d) {
		S2B a2c = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N b2d = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		a2c.setSource(a);
		a.setLast(b);
		return new Object[] { s, c, d, a2c, b2d, b, a };
	}

	public static final Object[] pattern_while2branch_11_2_collecttranslatedelements_blackBBBBBB(Branch c, Command d,
			S2B a2c, S2N b2d, Assignment b, While a) {
		return new Object[] { c, d, a2c, b2d, b, a };
	}

	public static final Object[] pattern_while2branch_11_2_collecttranslatedelements_greenFBBBBBB(Branch c, Command d,
			S2B a2c, S2N b2d, Assignment b, While a) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_while2branch_11_5_registerobjects_expressionBBBBBBBBBBB(while2branch _this,
			PerformRuleResult ruleresult, EObject s, EObject c, EObject d, EObject a2c, EObject b2d, EObject b,
			EObject n, EObject s2n, EObject a) {
		_this.registerObjects_BWD(ruleresult, s, c, d, a2c, b2d, b, n, s2n, a);
	...
	public static final Iterable<Object[]> pattern_while2branch_12_2_corematch_blackFBBBFB(Branch c, Command d, Node n,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(n)) {
			if (!d.equals(n)) {
				for (S2N s2n : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(n, S2N.class,
					...
					if (s != null) {
						_result.add(new Object[] { s, c, d, n, s2n, match });
					}
	...
	public static final Iterable<Object[]> pattern_while2branch_12_3_findcontext_blackBBBBB(Statement s, Branch c,
			Command d, Node n, S2N s2n) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(n)) {
			if (!d.equals(n)) {
				if (c.equals(n.getNext())) {
					if (c.equals(d.getNext())) {
						if (n.equals(s2n.getTarget())) {
							if (s.equals(s2n.getSource())) {
								_result.add(new Object[] { s, c, d, n, s2n });
							}
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_12_3_findcontext_greenBBBBBFFFFF(Statement s, Branch c, Command d,
			Node n, S2N s2n) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge n__c____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d__c____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		s2n__n____target.setName(s2n__n____target_name_prime);
		s2n__s____source.setName(s2n__s____source_name_prime);
		return new Object[] { s, c, d, n, s2n, isApplicableMatch, n__c____next, d__c____next, s2n__n____target,
				s2n__s____source };
	}

	public static final Object[] pattern_while2branch_12_4_solveCSP_bindingFBBBBBBB(while2branch _this,
			IsApplicableMatch isApplicableMatch, Statement s, Branch c, Command d, Node n, S2N s2n) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, s, c, d, n, s2n);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, s, c, d, n, s2n };
		}
		return null;
	}
	...
	public static final Object[] pattern_while2branch_12_4_solveCSP_bindingAndBlackFBBBBBBB(while2branch _this,
		...
		Object[] result_pattern_while2branch_12_4_solveCSP_binding = pattern_while2branch_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, s, c, d, n, s2n);
	...
	public static final Object[] pattern_while2branch_20_2_testcorematchandDECs_black_nac_0B(Branch c) {
		for (Graph __DEC_c_root_770468 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Graph.class, "root")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_20_2_testcorematchandDECs_black_nac_1BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_positive_690834 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_c_positive_690834)) {
					if (!n.equals(__DEC_c_positive_690834)) {
	...
	public static final Object[] pattern_while2branch_20_2_testcorematchandDECs_black_nac_2BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_negative_5813 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_c_negative_5813)) {
					if (!n.equals(__DEC_c_negative_5813)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_20_2_testcorematchandDECs_black_nac_3B(Command d) {
		for (Graph __DEC_d_root_477182 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_20_2_testcorematchandDECs_black_nac_4BBB(Command d, Branch c,
		...
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_positive_775248 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "positive")) {
					if (!c.equals(__DEC_d_positive_775248)) {
						if (!n.equals(__DEC_d_positive_775248)) {
	...
	public static final Object[] pattern_while2branch_20_2_testcorematchandDECs_black_nac_5BBB(Command d, Branch c,
		...
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_negative_708871 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "negative")) {
					if (!c.equals(__DEC_d_negative_708871)) {
						if (!n.equals(__DEC_d_negative_708871)) {
							return new Object[] { d, c, n };
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_0BB(Assignment b,
			Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_positive_734078 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!s.equals(__DEC_b_positive_734078)) {
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_1BB(Assignment b,
			Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_negative_365351 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "negative")) {
				if (!s.equals(__DEC_b_negative_365351)) {
					return new Object[] { b, s };
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_2BBB(Assignment b,
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (While __DEC_b_first_535223 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
						While.class, "first")) {
					if (!s.equals(__DEC_b_first_535223)) {
						if (!a.equals(__DEC_b_first_535223)) {
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_3BBB(Assignment b,
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (While __DEC_b_last_141933 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
						While.class, "last")) {
					if (!s.equals(__DEC_b_last_141933)) {
						if (!a.equals(__DEC_b_last_141933)) {
							return new Object[] { b, s, a };
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_4B(Assignment b) {
		for (Program __DEC_b_first_409201 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_5BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_positive_583833 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "positive")) {
				if (!s.equals(__DEC_a_positive_583833)) {
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_6BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_negative_93940 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					Decision.class, "negative")) {
				if (!s.equals(__DEC_a_negative_93940)) {
					return new Object[] { a, s };
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_7BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_first_974001 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "first")) {
				if (!a.equals(__DEC_a_first_974001)) {
					if (!s.equals(__DEC_a_first_974001)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_8BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_last_271649 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_271649)) {
					if (!s.equals(__DEC_a_last_271649)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_21_2_testcorematchandDECs_black_nac_9B(While a) {
		for (Program __DEC_a_first_590801 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
				...
				if (tmpD instanceof Command) {
					...
					if (tmpB instanceof Assignment) {
						...
						if (tmpN instanceof Node) {
							...
							if (tmpA instanceof While) {
								While a = (While) tmpA;
								return new Object[] { s, c, d, b, n, a, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_24_2_matchsrctrgcontext_blackBBBBBBBB(Statement s, Branch c,
	...
	public static final Object[] pattern_while2branch_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(Match sourceMatch,
		...
		if (result_pattern_while2branch_24_2_matchsrctrgcontext_binding != null) {
			Statement s = (Statement) result_pattern_while2branch_24_2_matchsrctrgcontext_binding[0];
			...
			Object[] result_pattern_while2branch_24_2_matchsrctrgcontext_black = pattern_while2branch_24_2_matchsrctrgcontext_blackBBBBBBBB(
					s, c, d, b, n, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_while2branch_24_3_solvecsp_bindingFBBBBBBBBB(while2branch _this, Statement s,
			Branch c, Command d, Assignment b, Node n, While a, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(s, c, d, b, n, a, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, s, c, d, b, n, a, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_while2branch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(while2branch _this,
			Statement s, Branch c, Command d, Assignment b, Node n, While a, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_while2branch_24_3_solvecsp_binding = pattern_while2branch_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, s, c, d, b, n, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_while2branch_24_6_createcorrespondence_blackBBBBBBB(Statement s, Branch c,
			Command d, Assignment b, Node n, While a, CCMatch ccMatch) {
		if (!c.equals(n)) {
			if (!d.equals(n)) {
				if (!b.equals(s)) {
					if (!a.equals(s)) {
						return new Object[] { s, c, d, b, n, a, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_24_6_createcorrespondence_greenBBFFBBB(Branch c, Command d,
		...
		return new Object[] { c, d, a2c, b2d, b, a, ccMatch };
	}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_0BB(Assignment b, Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_positive_635108 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!s.equals(__DEC_b_positive_635108)) {
					return new Object[] { b, s };
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_1BB(Assignment b, Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_negative_199373 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "negative")) {
				if (!s.equals(__DEC_b_negative_199373)) {
					return new Object[] { b, s };
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_2BBB(Assignment b, Statement s,
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (While __DEC_b_first_617552 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
						While.class, "first")) {
					if (!s.equals(__DEC_b_first_617552)) {
						if (!a.equals(__DEC_b_first_617552)) {
							return new Object[] { b, s, a };
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_3BBB(Assignment b, Statement s,
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (While __DEC_b_last_935229 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
						While.class, "last")) {
					if (!s.equals(__DEC_b_last_935229)) {
						if (!a.equals(__DEC_b_last_935229)) {
							return new Object[] { b, s, a };
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_4B(Assignment b) {
		for (Program __DEC_b_first_760907 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_5BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_positive_183345 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "positive")) {
				if (!s.equals(__DEC_a_positive_183345)) {
					return new Object[] { a, s };
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_6BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_negative_399062 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!s.equals(__DEC_a_negative_399062)) {
					return new Object[] { a, s };
				}
			}
		}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_7BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_first_354294 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "first")) {
				if (!a.equals(__DEC_a_first_354294)) {
					if (!s.equals(__DEC_a_first_354294)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_8BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_last_385063 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_385063)) {
					if (!s.equals(__DEC_a_last_385063)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_27_1_matchtggpattern_black_nac_9B(While a) {
		for (Program __DEC_a_first_488878 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_28_1_matchtggpattern_black_nac_0B(Branch c) {
		for (Graph __DEC_c_root_801888 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Graph.class, "root")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_28_1_matchtggpattern_black_nac_1BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_positive_389502 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_c_positive_389502)) {
					if (!n.equals(__DEC_c_positive_389502)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_28_1_matchtggpattern_black_nac_2BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_negative_643418 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_c_negative_643418)) {
					if (!n.equals(__DEC_c_negative_643418)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_while2branch_28_1_matchtggpattern_black_nac_3B(Command d) {
		for (Graph __DEC_d_root_536170 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_while2branch_28_1_matchtggpattern_black_nac_4BBB(Command d, Branch c, Node n) {
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_positive_530142 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "positive")) {
					if (!c.equals(__DEC_d_positive_530142)) {
						if (!n.equals(__DEC_d_positive_530142)) {
							return new Object[] { d, c, n };
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_28_1_matchtggpattern_black_nac_5BBB(Command d, Branch c, Node n) {
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_negative_317131 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "negative")) {
					if (!c.equals(__DEC_d_negative_317131)) {
						if (!n.equals(__DEC_d_negative_317131)) {
							return new Object[] { d, c, n };
						}
					}
				}
	...
	public static final Object[] pattern_while2branch_29_6_perform_greenBFFFFFBFB(Statement s, Node n,
			ModelgeneratorRuleResult ruleResult) {
		Branch c = ControlflowFactory.eINSTANCE.createBranch();
		Command d = ControlflowFactory.eINSTANCE.createCommand();
		S2B a2c = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		return new Object[] { s, c, d, a2c, b2d, b, n, a, ruleResult };
	}
