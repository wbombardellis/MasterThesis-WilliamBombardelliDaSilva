...
public class whileda2branchbcImpl extends AbstractRuleImpl implements whileda2branchbc {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While w, Assignment c, Decision a) {
		...
		Object[] result2_bindingAndBlack = whileda2branchbcImpl
				.pattern_whileda2branchbc_0_2_SolveCSP_bindingAndBlackFBBBBB(this, match, w, c, a);
		...
		if (whileda2branchbcImpl.pattern_whileda2branchbc_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileda2branchbcImpl
					.pattern_whileda2branchbc_0_4_collectelementstobetranslated_blackBBBB(match, w, c, a);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[w] = " + w + ", " + "[c] = " + c + ", " + "[a] = " + a + ".");
			}
			whileda2branchbcImpl.pattern_whileda2branchbc_0_4_collectelementstobetranslated_greenBBBBFF(match, w, c, a);
			...
			Object[] result5_black = whileda2branchbcImpl
					.pattern_whileda2branchbc_0_5_collectcontextelements_blackBBBB(match, w, c, a);
			...
			// 
			whileda2branchbcImpl.pattern_whileda2branchbc_0_6_registerobjectstomatch_expressionBBBBB(this, match, w, c,
					a);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whileda2branchbcImpl.pattern_whileda2branchbc_1_1_performtransformation_greenFBBBFFF(i,
				c, a);
		...
		Object[] result2_black = whileda2branchbcImpl
				.pattern_whileda2branchbc_1_2_collecttranslatedelements_blackBBBBBB(a2x, c, a, x, z, c2z);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a2x] = " + a2x + ", " + "[c] = " + c + ", "
							+ "[a] = " + a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[c2z] = " + c2z + ".");
		}
		Object[] result2_green = whileda2branchbcImpl
				.pattern_whileda2branchbc_1_2_collecttranslatedelements_greenFBBBBBB(a2x, c, a, x, z, c2z);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileda2branchbcImpl.pattern_whileda2branchbc_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, a2x, w2i, i, w, c, a, x, z, c2z);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2x] = " + a2x + ", " + "[w2i] = " + w2i + ", " + "[i] = " + i + ", " + "[w] = " + w
					+ ", " + "[c] = " + c + ", " + "[a] = " + a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", "
					+ "[c2z] = " + c2z + ".");
		}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whileda2branchbcImpl.pattern_whileda2branchbc_2_2_corematch_blackFFBBBB(w, c, a,
				match)) {
			...
			for (Object[] result3_black : whileda2branchbcImpl.pattern_whileda2branchbc_2_3_findcontext_blackBBBBB(w2i,
				...
				Object[] result3_green = whileda2branchbcImpl
						.pattern_whileda2branchbc_2_3_findcontext_greenBBBBBFFFFF(w2i, i, w, c, a);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While w, Assignment c, Decision a) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While w, Assignment c, Decision a) {// Create CSP
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject a2x, EObject w2i, EObject i, EObject w,
			EObject c, EObject a, EObject x, EObject z, EObject c2z) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = whileda2branchbcImpl
				.pattern_whileda2branchbc_11_1_performtransformation_greenFBFFBBF(w, x, z);
		S2B a2x = (S2B) result1_green[0];
		...
		Object[] result2_black = whileda2branchbcImpl
				.pattern_whileda2branchbc_11_2_collecttranslatedelements_blackBBBBBB(a2x, c, a, x, z, c2z);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a2x] = " + a2x + ", " + "[c] = " + c + ", "
							+ "[a] = " + a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[c2z] = " + c2z + ".");
		...
		Object[] result2_green = whileda2branchbcImpl
				.pattern_whileda2branchbc_11_2_collecttranslatedelements_greenFBBBBBB(a2x, c, a, x, z, c2z);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whileda2branchbcImpl.pattern_whileda2branchbc_12_2_corematch_blackFBFBBB(i, x, z,
				match)) {
			S2B w2i = (S2B) result2_black[0];
			...
			for (Object[] result3_black : whileda2branchbcImpl.pattern_whileda2branchbc_12_3_findcontext_blackBBBBB(w2i,
					i, w, x, z)) {
				Object[] result3_green = whileda2branchbcImpl
						.pattern_whileda2branchbc_12_3_findcontext_greenBBBBBFFFFF(w2i, i, w, x, z);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge w2i__i____target = (EMoflonEdge) result3_green[6];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, S2B w2i, Branch i, While w, Branch x,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject a2x, EObject w2i, EObject i, EObject w,
			EObject c, EObject a, EObject x, EObject z, EObject c2z) {
		ruleresult.registerObject("a2x", a2x);
		ruleresult.registerObject("w2i", w2i);
		ruleresult.registerObject("i", i);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_12(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_12(EMoflonEdge _edge_next) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whileda2branchbcImpl
				.pattern_whileda2branchbc_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, i, w, c, a, x, z, sourceMatch,
						targetMatch);
		...
		if (whileda2branchbcImpl.pattern_whileda2branchbc_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whileda2branchbcImpl
				...
				Object[] result6_black = whileda2branchbcImpl
						.pattern_whileda2branchbc_24_6_createcorrespondence_blackBBBBBBB(i, w, c, a, x, z, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[i] = " + i + ", "
							+ "[w] = " + w + ", " + "[c] = " + c + ", " + "[a] = " + a + ", " + "[x] = " + x + ", "
							+ "[z] = " + z + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				whileda2branchbcImpl.pattern_whileda2branchbc_24_6_createcorrespondence_greenFBBBBFB(c, a, x, z,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Branch i, While w, Assignment c, Decision a, Branch x, Command z,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While w, Assignment c, Decision a) {// 
		Object[] result1_black = whileda2branchbcImpl.pattern_whileda2branchbc_27_1_matchtggpattern_blackBBB(w, c, a);
		if (result1_black != null) {
		...
		for (Object[] result2_black : whileda2branchbcImpl
			...
			if (whileda2branchbcImpl.pattern_whileda2branchbc_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					whileda2branchbcImpl.pattern_whileda2branchbc_29_6_perform_greenFBBFFFFFB(i, w, ruleResult);
					//nothing S2B a2x = (S2B) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPROPRIATE_FWD__MATCH_WHILE_ASSIGNMENT_DECISION:
		...
		case RulesPackage.WHILEDA2BRANCHBC___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_WHILE_ASSIGNMENT_DECISION:
			...
			return null;
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_WHILE_ASSIGNMENT_DECISION:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (While) arguments.get(1),
					(Assignment) arguments.get(2), (Decision) arguments.get(3));
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2B_BRANCH_WHILE_ASSIGNMENT_DECISION:
		...
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_BRANCH_WHILE_BRANCH_COMMAND:
		...
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPROPRIATE_BWD_EMOFLON_EDGE_12__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_12((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPROPRIATE_FWD_EMOFLON_EDGE_12__EMOFLONEDGE:
		...
		case RulesPackage.WHILEDA2BRANCHBC___IS_APPLICABLE_SOLVE_CSP_CC__BRANCH_WHILE_ASSIGNMENT_DECISION_BRANCH_COMMAND_MATCH_MATCH:
		...
		case RulesPackage.WHILEDA2BRANCHBC___CHECK_DEC_FWD__WHILE_ASSIGNMENT_DECISION:
	...
	public static final Object[] pattern_whileda2branchbc_0_1_initialbindings_blackBBBBB(whileda2branchbc _this,
			Match match, While w, Assignment c, Decision a) {
	...
	public static final Object[] pattern_whileda2branchbc_0_4_collectelementstobetranslated_blackBBBB(Match match,
			While w, Assignment c, Decision a) {
	...
	public static final Object[] pattern_whileda2branchbc_1_1_performtransformation_blackBBBBBFBB(S2B w2i, Branch i,
			While w, Assignment c, Decision a, whileda2branchbc _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_whileda2branchbc_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whileda2branchbc_1_1_performtransformation_binding != null) {
			...
			Assignment c = (Assignment) result_pattern_whileda2branchbc_1_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_whileda2branchbc_1_1_performtransformation_greenFBBBFFF(Branch i, Assignment c,
			Decision a) {
		...
		c2z.setTarget(z);
		c2z.setSource(c);
		return new Object[] { a2x, i, c, a, x, z, c2z };
	}

	public static final Object[] pattern_whileda2branchbc_1_2_collecttranslatedelements_blackBBBBBB(S2B a2x,
			Assignment c, Decision a, Branch x, Command z, S2N c2z) {
		return new Object[] { a2x, c, a, x, z, c2z };
	}

	public static final Object[] pattern_whileda2branchbc_1_2_collecttranslatedelements_greenFBBBBBB(S2B a2x,
			Assignment c, Decision a, Branch x, Command z, S2N c2z) {
		...
		return new Object[] { ruleresult, a2x, c, a, x, z, c2z };
	}

	public static final Object[] pattern_whileda2branchbc_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject a2x, EObject w2i, EObject i, EObject w, EObject c, EObject a,
			EObject x, EObject z, EObject c2z) {
		if (!a2x.equals(w2i)) {
			if (!a2x.equals(i)) {
				if (!a2x.equals(w)) {
					if (!a2x.equals(c)) {
	...
	public static final Object[] pattern_whileda2branchbc_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject a2x, EObject i, EObject w, EObject c, EObject a, EObject x, EObject z,
			EObject c2z) {
		...
		return new Object[] { ruleresult, a2x, i, w, c, a, x, z, c2z, i__x____positive, i__z____negative,
				a2x__a____source, w__c____next, w__a____first, a2x__x____target, c2z__z____target, c2z__c____source };
	}

	public static final void pattern_whileda2branchbc_1_5_registerobjects_expressionBBBBBBBBBBB(whileda2branchbc _this,
			PerformRuleResult ruleresult, EObject a2x, EObject w2i, EObject i, EObject w, EObject c, EObject a,
			EObject x, EObject z, EObject c2z) {
		_this.registerObjects_FWD(ruleresult, a2x, w2i, i, w, c, a, x, z, c2z);
	...
	public static final Iterable<Object[]> pattern_whileda2branchbc_2_2_corematch_blackFFBBBB(While w, Assignment c,
	...
	public static final Object[] pattern_whileda2branchbc_2_3_findcontext_greenBBBBBFFFFF(S2B w2i, Branch i, While w,
		...
		return new Object[] { w2i, i, w, c, a, isApplicableMatch, w2i__i____target, w__c____next, w__a____first,
				w2i__w____source };
	}

	public static final Object[] pattern_whileda2branchbc_2_4_solveCSP_bindingFBBBBBBB(whileda2branchbc _this,
			IsApplicableMatch isApplicableMatch, S2B w2i, Branch i, While w, Assignment c, Decision a) {
				...
				if (tmpW instanceof While) {
					...
					if (tmpX instanceof Branch) {
						...
						if (tmpZ instanceof Command) {
							...
							return new Object[] { w2i, i, w, x, z, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_11_1_performtransformation_blackBBBBBFBB(S2B w2i, Branch i,
			While w, Branch x, Command z, whileda2branchbc _this, IsApplicableMatch isApplicableMatch) {
		if (!i.equals(x)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { w2i, i, w, x, z, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whileda2branchbc_11_1_performtransformation_binding != null) {
			...
			While w = (While) result_pattern_whileda2branchbc_11_1_performtransformation_binding[2];
			Branch x = (Branch) result_pattern_whileda2branchbc_11_1_performtransformation_binding[3];
			...
			Object[] result_pattern_whileda2branchbc_11_1_performtransformation_black = pattern_whileda2branchbc_11_1_performtransformation_blackBBBBBFBB(
					w2i, i, w, x, z, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileda2branchbc_11_1_performtransformation_greenFBFFBBF(While w, Branch x,
			Command z) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		c2z.setTarget(z);
		c2z.setSource(c);
		return new Object[] { a2x, w, c, a, x, z, c2z };
	}

	public static final Object[] pattern_whileda2branchbc_11_2_collecttranslatedelements_blackBBBBBB(S2B a2x,
			Assignment c, Decision a, Branch x, Command z, S2N c2z) {
		return new Object[] { a2x, c, a, x, z, c2z };
	}

	public static final Object[] pattern_whileda2branchbc_11_2_collecttranslatedelements_greenFBBBBBB(S2B a2x,
			Assignment c, Decision a, Branch x, Command z, S2N c2z) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(a2x);
	...
	public static final void pattern_whileda2branchbc_11_5_registerobjects_expressionBBBBBBBBBBB(whileda2branchbc _this,
			PerformRuleResult ruleresult, EObject a2x, EObject w2i, EObject i, EObject w, EObject c, EObject a,
			EObject x, EObject z, EObject c2z) {
		_this.registerObjects_BWD(ruleresult, a2x, w2i, i, w, c, a, x, z, c2z);
	...
	public static final Iterable<Object[]> pattern_whileda2branchbc_12_2_corematch_blackFBFBBB(Branch i, Branch x,
		...
		if (!i.equals(x)) {
			for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(i, S2B.class, "target")) {
				...
				if (tmpW instanceof While) {
					While w = (While) tmpW;
					_result.add(new Object[] { w2i, i, w, x, z, match });
				}
			...
			if (i.equals(w2i.getTarget())) {
				if (x.equals(i.getPositive())) {
					if (z.equals(i.getNegative())) {
						if (w.equals(w2i.getSource())) {
							_result.add(new Object[] { w2i, i, w, x, z });
						}
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_12_3_findcontext_greenBBBBBFFFFF(S2B w2i, Branch i, While w,
			Branch x, Command z) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge w2i__i____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge i__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		i__z____negative.setName(i__z____negative_name_prime);
		w2i__w____source.setName(w2i__w____source_name_prime);
		return new Object[] { w2i, i, w, x, z, isApplicableMatch, w2i__i____target, i__x____positive, i__z____negative,
				w2i__w____source };
	}

	public static final Object[] pattern_whileda2branchbc_12_4_solveCSP_bindingFBBBBBBB(whileda2branchbc _this,
			IsApplicableMatch isApplicableMatch, S2B w2i, Branch i, While w, Branch x, Command z) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, w2i, i, w, x, z);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, w2i, i, w, x, z };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileda2branchbc_12_4_solveCSP_bindingAndBlackFBBBBBBB(whileda2branchbc _this,
		...
		Object[] result_pattern_whileda2branchbc_12_4_solveCSP_binding = pattern_whileda2branchbc_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, w2i, i, w, x, z);
	...
	public static final Object[] pattern_whileda2branchbc_20_2_testcorematchandDECs_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_849407 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_20_2_testcorematchandDECs_black_nac_1BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_positive_18135 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_18135)) {
					if (!i.equals(__DEC_x_positive_18135)) {
	...
	public static final Object[] pattern_whileda2branchbc_20_2_testcorematchandDECs_black_nac_2BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_negative_445319 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_445319)) {
					if (!i.equals(__DEC_x_negative_445319)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_20_2_testcorematchandDECs_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_493035 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_20_2_testcorematchandDECs_black_nac_4BBB(Command z, Branch i,
			Branch x) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_positive_51423 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_z_positive_51423)) {
					if (!x.equals(__DEC_z_positive_51423)) {
	...
	public static final Object[] pattern_whileda2branchbc_20_2_testcorematchandDECs_black_nac_5BBB(Command z, Branch i,
			Branch x) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_negative_697180 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_z_negative_697180)) {
					if (!x.equals(__DEC_z_negative_697180)) {
						return new Object[] { z, i, x };
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_0BB(Assignment c,
			Decision a) {
		for (Decision __DEC_c_positive_283459 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!a.equals(__DEC_c_positive_283459)) {
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_1BB(Assignment c,
			Decision a) {
		for (Decision __DEC_c_negative_394502 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!a.equals(__DEC_c_negative_394502)) {
				return new Object[] { c, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_2BB(Assignment c,
			While w) {
		for (While __DEC_c_first_171635 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_171635)) {
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_3BB(Assignment c,
			While w) {
		for (While __DEC_c_last_849619 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_849619)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_4B(Assignment c) {
		for (Program __DEC_c_first_12565 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_5B(Decision a) {
		for (Decision __DEC_a_positive_946839 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!a.equals(__DEC_a_positive_946839)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_6B(Decision a) {
		for (Decision __DEC_a_negative_389391 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!a.equals(__DEC_a_negative_389391)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_7BB(Decision a, While w) {
		for (While __DEC_a_last_988230 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_988230)) {
	...
	public static final Object[] pattern_whileda2branchbc_21_2_testcorematchandDECs_black_nac_8B(Decision a) {
		for (Program __DEC_a_first_753074 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final boolean pattern_whileda2branchbc_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			whileda2branchbc _this, Match match, While w, Assignment c, Decision a) {
				...
				if (tmpC instanceof Assignment) {
					...
					if (tmpA instanceof Decision) {
						...
						if (tmpX instanceof Branch) {
							...
							if (tmpZ instanceof Command) {
								Command z = (Command) tmpZ;
								return new Object[] { i, w, c, a, x, z, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileda2branchbc_24_2_matchsrctrgcontext_blackBBBBBBBB(Branch i, While w,
			Assignment c, Decision a, Branch x, Command z, Match sourceMatch, Match targetMatch) {
		if (!i.equals(x)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { i, w, c, a, x, z, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_whileda2branchbc_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whileda2branchbc_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_whileda2branchbc_24_2_matchsrctrgcontext_black = pattern_whileda2branchbc_24_2_matchsrctrgcontext_blackBBBBBBBB(
					i, w, c, a, x, z, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileda2branchbc_24_3_solvecsp_bindingFBBBBBBBBB(whileda2branchbc _this,
			Branch i, While w, Assignment c, Decision a, Branch x, Command z, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(i, w, c, a, x, z, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, i, w, c, a, x, z, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileda2branchbc_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			whileda2branchbc _this, Branch i, While w, Assignment c, Decision a, Branch x, Command z, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_whileda2branchbc_24_3_solvecsp_binding = pattern_whileda2branchbc_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, i, w, c, a, x, z, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileda2branchbc_24_6_createcorrespondence_blackBBBBBBB(Branch i, While w,
			Assignment c, Decision a, Branch x, Command z, CCMatch ccMatch) {
		if (!i.equals(x)) {
			return new Object[] { i, w, c, a, x, z, ccMatch };
		}
		return null;
	}

	public static final Object[] pattern_whileda2branchbc_24_6_createcorrespondence_greenFBBBBFB(Assignment c,
			Decision a, Branch x, Command z, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		a2x.setSource(a);
		a2x.setTarget(x);
		...
		return new Object[] { a2x, c, a, x, z, c2z, ccMatch };
	}
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_0BB(Assignment c, Decision a) {
		for (Decision __DEC_c_positive_228301 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!a.equals(__DEC_c_positive_228301)) {
				return new Object[] { c, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_1BB(Assignment c, Decision a) {
		for (Decision __DEC_c_negative_707040 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!a.equals(__DEC_c_negative_707040)) {
				return new Object[] { c, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_2BB(Assignment c, While w) {
		for (While __DEC_c_first_382035 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_382035)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_3BB(Assignment c, While w) {
		for (While __DEC_c_last_758555 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_758555)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_4B(Assignment c) {
		for (Program __DEC_c_first_593970 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_5B(Decision a) {
		for (Decision __DEC_a_positive_614209 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!a.equals(__DEC_a_positive_614209)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_6B(Decision a) {
		for (Decision __DEC_a_negative_157146 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!a.equals(__DEC_a_negative_157146)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_7BB(Decision a, While w) {
		for (While __DEC_a_last_869539 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_869539)) {
				return new Object[] { a, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_black_nac_8B(Decision a) {
		for (Program __DEC_a_first_447924 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_27_1_matchtggpattern_blackBBB(While w, Assignment c,
			Decision a) {
		if (c.equals(w.getNext())) {
			if (a.equals(w.getFirst())) {
	...
	public static final Object[] pattern_whileda2branchbc_28_1_matchtggpattern_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_546262 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_28_1_matchtggpattern_black_nac_1BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_positive_547662 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_547662)) {
					if (!i.equals(__DEC_x_positive_547662)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_28_1_matchtggpattern_black_nac_2BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_negative_701152 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_701152)) {
					if (!i.equals(__DEC_x_negative_701152)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_28_1_matchtggpattern_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_114850 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileda2branchbc_28_1_matchtggpattern_black_nac_4BBB(Command z, Branch i,
			Branch x) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_positive_615166 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_z_positive_615166)) {
					if (!x.equals(__DEC_z_positive_615166)) {
						return new Object[] { z, i, x };
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_28_1_matchtggpattern_black_nac_5BBB(Command z, Branch i,
			Branch x) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_negative_467037 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_z_negative_467037)) {
					if (!x.equals(__DEC_z_negative_467037)) {
						return new Object[] { z, i, x };
					}
				}
			}
	...
	public static final Object[] pattern_whileda2branchbc_29_6_perform_greenFBBFFFFFB(Branch i, While w,
			ModelgeneratorRuleResult ruleResult) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Assignment c = SourcecodeFactory.eINSTANCE.createAssignment();
		Decision a = SourcecodeFactory.eINSTANCE.createDecision();
		...
		return new Object[] { a2x, i, w, c, a, x, z, c2z, ruleResult };
	}
