...
public class decal2branchcbImpl extends AbstractRuleImpl implements decal2branchcb {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Decision d, Assignment l, While b, Assignment a) {
		...
		Object[] result2_bindingAndBlack = decal2branchcbImpl
				.pattern_decal2branchcb_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, d, l, b, a);
		...
		if (decal2branchcbImpl.pattern_decal2branchcb_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decal2branchcbImpl
					.pattern_decal2branchcb_0_4_collectelementstobetranslated_blackBBBBB(match, d, l, b, a);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[d] = " + d + ", " + "[l] = " + l + ", " + "[b] = " + b + ", " + "[a] = " + a + ".");
			}
			decal2branchcbImpl.pattern_decal2branchcb_0_4_collectelementstobetranslated_greenBBBBBFFF(match, d, l, b,
					a);
			...
			Object[] result5_black = decal2branchcbImpl
					.pattern_decal2branchcb_0_5_collectcontextelements_blackBBBBB(match, d, l, b, a);
			...
			// 
			decal2branchcbImpl.pattern_decal2branchcb_0_6_registerobjectstomatch_expressionBBBBBB(this, match, d, l, b,
					a);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decal2branchcbImpl.pattern_decal2branchcb_1_1_performtransformation_greenBFBBBFFFFF(l,
				b, c, a);
		...
		// 
		// 
		decal2branchcbImpl.pattern_decal2branchcb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, d, l,
				d2c, a2x, b, c, a, l2z, z, b2y, y, x);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decal2branchcbImpl.pattern_decal2branchcb_2_2_corematch_blackBBFBFBB(d, l, b, a,
				match)) {
			S2B d2c = (S2B) result2_black[2];
			Branch c = (Branch) result2_black[4];
			// ForEach 
			for (Object[] result3_black : decal2branchcbImpl.pattern_decal2branchcb_2_3_findcontext_blackBBBBBB(d, l,
					d2c, b, c, a)) {
				...
				Object[] result4_bindingAndBlack = decal2branchcbImpl
						.pattern_decal2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, d, l,
								d2c, b, c, a);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Decision d, Assignment l, While b, Assignment a) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Decision d, Assignment l, While b, Assignment a) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Decision d, Assignment l, S2B d2c,
			While b, Branch c, Assignment a) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject d, EObject l, EObject d2c, EObject a2x,
			EObject b, EObject c, EObject a, EObject l2z, EObject z, EObject b2y, EObject y, EObject x) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Branch c, Command z, Branch y, Command x) {
		...
		Object[] result2_bindingAndBlack = decal2branchcbImpl
				.pattern_decal2branchcb_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, c, z, y, x);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[c] = " + c + ", " + "[z] = " + z + ", " + "[y] = " + y + ", "
					+ "[x] = " + x + ".");
		...
		if (decal2branchcbImpl.pattern_decal2branchcb_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decal2branchcbImpl
					.pattern_decal2branchcb_10_4_collectelementstobetranslated_blackBBBBB(match, c, z, y, x);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
			}
			decal2branchcbImpl.pattern_decal2branchcb_10_4_collectelementstobetranslated_greenBBBBBFFF(match, c, z, y,
					x);
			...
			Object[] result5_black = decal2branchcbImpl
					.pattern_decal2branchcb_10_5_collectcontextelements_blackBBBBB(match, c, z, y, x);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
			}
			...
			// 
			decal2branchcbImpl.pattern_decal2branchcb_10_6_registerobjectstomatch_expressionBBBBBB(this, match, c, z, y,
					x);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decal2branchcbImpl.pattern_decal2branchcb_11_1_performtransformation_greenBFFFFFBFBB(d,
				z, y, x);
		...
		Object[] result2_black = decal2branchcbImpl
				.pattern_decal2branchcb_11_2_collecttranslatedelements_blackBBBBBBBBB(l, a2x, b, a, l2z, z, b2y, y, x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[l] = " + l + ", " + "[a2x] = "
					+ a2x + ", " + "[b] = " + b + ", " + "[a] = " + a + ", " + "[l2z] = " + l2z + ", " + "[z] = " + z
					+ ", " + "[b2y] = " + b2y + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
		...
		Object[] result2_green = decal2branchcbImpl
				.pattern_decal2branchcb_11_2_collecttranslatedelements_greenFBBBBBBBBB(l, a2x, b, a, l2z, z, b2y, y, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		// 
		// 
		decal2branchcbImpl.pattern_decal2branchcb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, d, l,
				d2c, a2x, b, c, a, l2z, z, b2y, y, x);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decal2branchcbImpl.pattern_decal2branchcb_12_2_corematch_blackFFBBBBB(c, z, y, x,
				match)) {
			Decision d = (Decision) result2_black[0];
			S2B d2c = (S2B) result2_black[1];
			// ForEach 
			for (Object[] result3_black : decal2branchcbImpl.pattern_decal2branchcb_12_3_findcontext_blackBBBBBB(d, d2c,
					c, z, y, x)) {
				...
				Object[] result4_bindingAndBlack = decal2branchcbImpl
						.pattern_decal2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, d, d2c,
								c, z, y, x);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Branch c, Command z, Branch y, Command x) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Branch c, Command z, Branch y, Command x) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Decision d, S2B d2c, Branch c, Command z,
			Branch y, Command x) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject d, EObject l, EObject d2c, EObject a2x,
			EObject b, EObject c, EObject a, EObject l2z, EObject z, EObject b2y, EObject y, EObject x) {
		ruleresult.registerObject("d", d);
		ruleresult.registerObject("l", l);
		ruleresult.registerObject("d2c", d2c);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_46(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_47(EMoflonEdge _edge_positive) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decal2branchcbImpl
				.pattern_decal2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, d, l, b, c, a, z, y, x,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[d] = " + d + ", " + "[l] = " + l + ", " + "[b] = " + b + ", " + "[c] = " + c + ", " + "[a] = "
					+ a + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[sourceMatch] = "
		...
		if (decal2branchcbImpl.pattern_decal2branchcb_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : decal2branchcbImpl.pattern_decal2branchcb_24_5_matchcorrcontext_blackBFBBB(d,
				...
				Object[] result6_black = decal2branchcbImpl
						.pattern_decal2branchcb_24_6_createcorrespondence_blackBBBBBBBBB(d, l, b, c, a, z, y, x,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[d] = " + d + ", "
							+ "[l] = " + l + ", " + "[b] = " + b + ", " + "[c] = " + c + ", " + "[a] = " + a + ", "
							+ "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				decal2branchcbImpl.pattern_decal2branchcb_24_6_createcorrespondence_greenBFBBFBFBBB(l, b, a, z, y, x,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Decision d, Assignment l, While b, Branch c, Assignment a, Command z, Branch y,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Decision d, Assignment l, While b, Assignment a) {// 
		Object[] result1_black = decal2branchcbImpl.pattern_decal2branchcb_27_1_matchtggpattern_blackBBBB(d, l, b, a);
		if (result1_black != null) {
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Branch c, Command z, Branch y, Command x) {// 
		Object[] result1_black = decal2branchcbImpl.pattern_decal2branchcb_28_1_matchtggpattern_blackBBBB(c, z, y, x);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B d2cParameter) {
		...
		for (Object[] result2_black : decal2branchcbImpl
			...
			Object[] result3_bindingAndBlack = decal2branchcbImpl
					.pattern_decal2branchcb_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, d, d2c, c,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (decal2branchcbImpl.pattern_decal2branchcb_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = decal2branchcbImpl.pattern_decal2branchcb_29_5_checknacs_blackBBB(d, d2c, c);
				if (result5_black != null) {

					Object[] result6_black = decal2branchcbImpl.pattern_decal2branchcb_29_6_perform_blackBBBB(d, d2c, c,
							ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[d] = " + d + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_FWD__MATCH_DECISION_ASSIGNMENT_WHILE_ASSIGNMENT:
		...
		case RulesPackage.DECAL2BRANCHCB___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_DECISION_ASSIGNMENT_WHILE_ASSIGNMENT:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Decision) arguments.get(1),
					(Assignment) arguments.get(2), (While) arguments.get(3), (Assignment) arguments.get(4));
			return null;
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_DECISION_ASSIGNMENT_WHILE_ASSIGNMENT:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_DECISION_ASSIGNMENT_S2B_WHILE_BRANCH_ASSIGNMENT:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_BWD__MATCH_BRANCH_COMMAND_BRANCH_COMMAND:
		...
		case RulesPackage.DECAL2BRANCHCB___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_BRANCH_COMMAND_BRANCH_COMMAND:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Branch) arguments.get(1), (Command) arguments.get(2),
					(Branch) arguments.get(3), (Command) arguments.get(4));
			return null;
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_BRANCH_COMMAND_BRANCH_COMMAND:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_DECISION_S2B_BRANCH_COMMAND_BRANCH_COMMAND:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_46__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_46((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_47__EMOFLONEDGE:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_CC__DECISION_ASSIGNMENT_WHILE_BRANCH_ASSIGNMENT_COMMAND_BRANCH_COMMAND_MATCH_MATCH:
		...
		case RulesPackage.DECAL2BRANCHCB___CHECK_DEC_FWD__DECISION_ASSIGNMENT_WHILE_ASSIGNMENT:
			return checkDEC_FWD((Decision) arguments.get(0), (Assignment) arguments.get(1), (While) arguments.get(2),
					(Assignment) arguments.get(3));
		case RulesPackage.DECAL2BRANCHCB___CHECK_DEC_BWD__BRANCH_COMMAND_BRANCH_COMMAND:
		...
		case RulesPackage.DECAL2BRANCHCB___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_DECISION_S2B_BRANCH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_decal2branchcb_0_1_initialbindings_blackBBBBBB(decal2branchcb _this,
			Match match, Decision d, Assignment l, While b, Assignment a) {
		if (!a.equals(l)) {
	...
	public static final Object[] pattern_decal2branchcb_0_2_SolveCSP_bindingFBBBBBB(decal2branchcb _this, Match match,
			Decision d, Assignment l, While b, Assignment a) {
	...
	public static final Object[] pattern_decal2branchcb_0_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		return new Object[] { match, d, l, b, a, d__a____positive, d__b____negative, b__l____last };
	}
					...
					if (tmpB instanceof While) {
						...
						if (tmpC instanceof Branch) {
							...
							if (tmpA instanceof Assignment) {
								...
								return new Object[] { d, l, d2c, b, c, a, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decal2branchcb_1_1_performtransformation_blackBBBBBBFBB(Decision d,
			Assignment l, S2B d2c, While b, Branch c, Assignment a, decal2branchcb _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(l)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { d, l, d2c, b, c, a, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decal2branchcb_1_1_performtransformation_binding != null) {
			...
			Branch c = (Branch) result_pattern_decal2branchcb_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_decal2branchcb_1_1_performtransformation_black = pattern_decal2branchcb_1_1_performtransformation_blackBBBBBBFBB(
					d, l, d2c, b, c, a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decal2branchcb_1_1_performtransformation_greenBFBBBFFFFF(Assignment l, While b,
		...
		c.setPositive(x);
		a2x.setTarget(x);
		return new Object[] { l, a2x, b, c, a, l2z, z, b2y, y, x };
	}

	public static final Object[] pattern_decal2branchcb_1_2_collecttranslatedelements_blackBBBBBBBBB(Assignment l,
			S2N a2x, While b, Assignment a, S2N l2z, Command z, S2B b2y, Branch y, Command x) {
		if (!a2x.equals(l2z)) {
			if (!a.equals(l)) {
				if (!x.equals(z)) {
					return new Object[] { l, a2x, b, a, l2z, z, b2y, y, x };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_1_2_collecttranslatedelements_greenFBBBBBBBBB(Assignment l,
		...
		return new Object[] { ruleresult, l, a2x, b, a, l2z, z, b2y, y, x };
	}

	public static final Object[] pattern_decal2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject d, EObject l, EObject d2c, EObject a2x, EObject b, EObject c,
			EObject a, EObject l2z, EObject z, EObject b2y, EObject y, EObject x) {
		if (!d.equals(l)) {
			if (!d.equals(d2c)) {
				if (!d.equals(l2z)) {
					if (!d.equals(z)) {
	...
	public static final Object[] pattern_decal2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject d, EObject l, EObject a2x, EObject b, EObject c, EObject a,
			EObject l2z, EObject z, EObject b2y, EObject y, EObject x) {
		EMoflonEdge d__a____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d__b____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, d, l, a2x, b, c, a, l2z, z, b2y, y, x, d__a____positive, d__b____negative,
				c__x____positive, c__y____negative, l2z__l____source, a2x__a____source, l2z__z____target, z__y____next,
				b__l____last, b2y__y____target, b2y__b____source, a2x__x____target };
	}

	public static final void pattern_decal2branchcb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(decal2branchcb _this,
			PerformRuleResult ruleresult, EObject d, EObject l, EObject d2c, EObject a2x, EObject b, EObject c,
			EObject a, EObject l2z, EObject z, EObject b2y, EObject y, EObject x) {
		_this.registerObjects_FWD(ruleresult, d, l, d2c, a2x, b, c, a, l2z, z, b2y, y, x);
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_2_2_corematch_blackBBFBFBB(Decision d, Assignment l,
		...
		if (!a.equals(l)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { d, l, d2c, b, c, a, match });
				}
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_2_3_findcontext_blackBBBBBB(Decision d, Assignment l,
			S2B d2c, While b, Branch c, Assignment a) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(l)) {
					...
					if (b.equals(d.getNegative())) {
						if (c.equals(d2c.getTarget())) {
							if (l.equals(b.getLast())) {
								_result.add(new Object[] { d, l, d2c, b, c, a });
							}
						}
					}
				}
	...
	public static final Object[] pattern_decal2branchcb_2_3_findcontext_greenBBBBBBFFFFFF(Decision d, Assignment l,
			S2B d2c, While b, Branch c, Assignment a) {
		...
		b__l____last.setName(b__l____last_name_prime);
		return new Object[] { d, l, d2c, b, c, a, isApplicableMatch, d__a____positive, d2c__d____source,
				d__b____negative, d2c__c____target, b__l____last };
	}

	public static final Object[] pattern_decal2branchcb_2_4_solveCSP_bindingFBBBBBBBB(decal2branchcb _this,
			IsApplicableMatch isApplicableMatch, Decision d, Assignment l, S2B d2c, While b, Branch c, Assignment a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, d, l, d2c, b, c, a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d, l, d2c, b, c, a };
		}
		return null;
	}
	...
	public static final Object[] pattern_decal2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(decal2branchcb _this,
		...
		Object[] result_pattern_decal2branchcb_2_4_solveCSP_binding = pattern_decal2branchcb_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, d, l, d2c, b, c, a);
	...
	public static final Object[] pattern_decal2branchcb_10_1_initialbindings_blackBBBBBB(decal2branchcb _this,
			Match match, Branch c, Command z, Branch y, Command x) {
		if (!c.equals(y)) {
			if (!x.equals(z)) {
	...
	public static final Object[] pattern_decal2branchcb_10_2_SolveCSP_bindingFBBBBBB(decal2branchcb _this, Match match,
			Branch c, Command z, Branch y, Command x) {
					...
					if (tmpZ instanceof Command) {
						...
						if (tmpY instanceof Branch) {
							...
							if (tmpX instanceof Command) {
								...
								return new Object[] { d, d2c, c, z, y, x, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decal2branchcb_11_1_performtransformation_blackBBBBBBFBB(Decision d, S2B d2c,
			Branch c, Command z, Branch y, Command x, decal2branchcb _this, IsApplicableMatch isApplicableMatch) {
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { d, d2c, c, z, y, x, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decal2branchcb_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decal2branchcb_11_1_performtransformation_binding != null) {
			...
			S2B d2c = (S2B) result_pattern_decal2branchcb_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_decal2branchcb_11_1_performtransformation_black = pattern_decal2branchcb_11_1_performtransformation_blackBBBBBBFBB(
					d, d2c, c, z, y, x, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decal2branchcb_11_1_performtransformation_greenBFFFFFBFBB(Decision d,
			Command z, Branch y, Command x) {
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { d, l, a2x, b, a, l2z, z, b2y, y, x };
	}
	...
	public static final void pattern_decal2branchcb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(decal2branchcb _this,
			PerformRuleResult ruleresult, EObject d, EObject l, EObject d2c, EObject a2x, EObject b, EObject c,
			EObject a, EObject l2z, EObject z, EObject b2y, EObject y, EObject x) {
		_this.registerObjects_BWD(ruleresult, d, l, d2c, a2x, b, c, a, l2z, z, b2y, y, x);
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_12_2_corematch_blackFFBBBBB(Branch c, Command z,
			Branch y, Command x, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
					...
					if (tmpD instanceof Decision) {
						Decision d = (Decision) tmpD;
						_result.add(new Object[] { d, d2c, c, z, y, x, match });
					}
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_12_3_findcontext_blackBBBBBB(Decision d, S2B d2c,
			Branch c, Command z, Branch y, Command x) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(y)) {
			if (!x.equals(z)) {
						...
						if (y.equals(c.getNegative())) {
							if (c.equals(d2c.getTarget())) {
								if (y.equals(z.getNext())) {
									_result.add(new Object[] { d, d2c, c, z, y, x });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decal2branchcb_12_3_findcontext_greenBBBBBBFFFFFF(Decision d, S2B d2c,
			Branch c, Command z, Branch y, Command x) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge d2c__d____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		d2c__c____target.setName(d2c__c____target_name_prime);
		z__y____next.setName(z__y____next_name_prime);
		return new Object[] { d, d2c, c, z, y, x, isApplicableMatch, d2c__d____source, c__x____positive,
				c__y____negative, d2c__c____target, z__y____next };
	}

	public static final Object[] pattern_decal2branchcb_12_4_solveCSP_bindingFBBBBBBBB(decal2branchcb _this,
			IsApplicableMatch isApplicableMatch, Decision d, S2B d2c, Branch c, Command z, Branch y, Command x) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d, d2c, c, z, y, x);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d, d2c, c, z, y, x };
		}
		return null;
	}
	...
	public static final Object[] pattern_decal2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decal2branchcb _this,
		...
		Object[] result_pattern_decal2branchcb_12_4_solveCSP_binding = pattern_decal2branchcb_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, d, d2c, c, z, y, x);
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_151721 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_1BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_positive_736668 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_736668)) {
					if (!y.equals(__DEC_z_positive_736668)) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_2BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_negative_771266 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_771266)) {
					if (!y.equals(__DEC_z_negative_771266)) {
						return new Object[] { z, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_3B(Branch y) {
		for (Graph __DEC_y_root_499046 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_4BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_positive_983965 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!y.equals(__DEC_y_positive_983965)) {
					if (!c.equals(__DEC_y_positive_983965)) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_5BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_negative_800239 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!y.equals(__DEC_y_negative_800239)) {
					if (!c.equals(__DEC_y_negative_800239)) {
						return new Object[] { y, c };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_6B(Command x) {
		for (Graph __DEC_x_root_821047 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_7BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_positive_240872 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_x_positive_240872)) {
					if (!y.equals(__DEC_x_positive_240872)) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_8BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_negative_483623 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_x_negative_483623)) {
					if (!y.equals(__DEC_x_negative_483623)) {
						return new Object[] { x, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_9BB(Branch c, Command z) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_10BB(Branch y, Command z) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_11BB(Branch c, Command z) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_13BB(Branch c, Branch y) {
						...
						if (!c.equals(y)) {
							if (pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_6B(x) == null) {
								if (pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_15BB(c, x) == null) {
									if (pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_3B(y) == null) {
										if (pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_4BB(y,
												c) == null) {
											if (pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_5BB(y,
													c) == null) {
	...
	public static final boolean pattern_decal2branchcb_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decal2branchcb _this, Match match, Branch c, Command z, Branch y, Command x) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_0BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_positive_949704 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_949704)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_1BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_negative_589204 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_589204)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_2BB(Assignment l, While b) {
		for (While __DEC_l_first_296563 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!b.equals(__DEC_l_first_296563)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_3BB(Assignment l, While b) {
		for (While __DEC_l_last_738793 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_738793)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_4B(Assignment l) {
		for (Program __DEC_l_first_671643 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_5BB(While b, Decision d) {
		for (Decision __DEC_b_positive_947889 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_947889)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_6B(While b) {
		for (While __DEC_b_first_953731 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_953731)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_7B(While b) {
		for (While __DEC_b_last_332395 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_332395)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_8B(While b) {
		for (Program __DEC_b_first_70228 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_9BB(Assignment a,
			Decision d) {
		for (Decision __DEC_a_negative_855543 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_855543)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_10BB(Assignment a,
			While b) {
		for (While __DEC_a_first_632411 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_632411)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_11BB(Assignment a,
			While b) {
		for (While __DEC_a_last_203823 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_203823)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_12B(Assignment a) {
		for (Program __DEC_a_first_407147 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
								...
								if (pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_9BB(a, d) == null) {
									if (pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_12B(a) == null) {
										if (pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_17BB(d,
												a) == null) {
											if (pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_5BB(b,
													d) == null) {
												if (pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_6B(
														b) == null) {
	...
	public static final boolean pattern_decal2branchcb_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decal2branchcb _this, Match match, Decision d, Assignment l, While b, Assignment a) {
						...
						if (tmpA instanceof Assignment) {
							...
							if (tmpZ instanceof Command) {
								...
								if (tmpY instanceof Branch) {
									...
									if (tmpX instanceof Command) {
										Command x = (Command) tmpX;
										return new Object[] { d, l, b, c, a, z, y, x, sourceMatch, targetMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decal2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Decision d,
			Assignment l, While b, Branch c, Assignment a, Command z, Branch y, Command x, Match sourceMatch,
			Match targetMatch) {
		if (!c.equals(y)) {
			if (!a.equals(l)) {
				if (!x.equals(z)) {
	...
	public static final Object[] pattern_decal2branchcb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decal2branchcb_24_2_matchsrctrgcontext_binding != null) {
			...
			Branch y = (Branch) result_pattern_decal2branchcb_24_2_matchsrctrgcontext_binding[6];
			...
			Object[] result_pattern_decal2branchcb_24_2_matchsrctrgcontext_black = pattern_decal2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					d, l, b, c, a, z, y, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decal2branchcb_24_3_solvecsp_bindingFBBBBBBBBBBB(decal2branchcb _this,
			Decision d, Assignment l, While b, Branch c, Assignment a, Command z, Branch y, Command x,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(d, l, b, c, a, z, y, x, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, d, l, b, c, a, z, y, x, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decal2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(decal2branchcb _this,
		...
		Object[] result_pattern_decal2branchcb_24_3_solvecsp_binding = pattern_decal2branchcb_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, d, l, b, c, a, z, y, x, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_24_5_matchcorrcontext_blackBFBBB(Decision d, Branch c,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
	...
	public static final Object[] pattern_decal2branchcb_24_6_createcorrespondence_blackBBBBBBBBB(Decision d,
			Assignment l, While b, Branch c, Assignment a, Command z, Branch y, Command x, CCMatch ccMatch) {
		if (!c.equals(y)) {
			if (!a.equals(l)) {
				if (!x.equals(z)) {
					return new Object[] { d, l, b, c, a, z, y, x, ccMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_24_6_createcorrespondence_greenBFBBFBFBBB(Assignment l, While b,
			Assignment a, Command z, Branch y, Command x, CCMatch ccMatch) {
		S2N a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		a2x.setSource(a);
		...
		return new Object[] { l, a2x, b, a, l2z, z, b2y, y, x, ccMatch };
	}
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_0BB(Assignment l, Decision d) {
		for (Decision __DEC_l_positive_325852 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_325852)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_1BB(Assignment l, Decision d) {
		for (Decision __DEC_l_negative_209088 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_209088)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_2BB(Assignment l, While b) {
		for (While __DEC_l_first_284650 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!b.equals(__DEC_l_first_284650)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_3BB(Assignment l, While b) {
		for (While __DEC_l_last_350179 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_350179)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_4B(Assignment l) {
		for (Program __DEC_l_first_863692 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_5BB(While b, Decision d) {
		for (Decision __DEC_b_positive_666714 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_666714)) {
				return new Object[] { b, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_6B(While b) {
		for (While __DEC_b_first_378026 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_378026)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_7B(While b) {
		for (While __DEC_b_last_965028 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_965028)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_8B(While b) {
		for (Program __DEC_b_first_395351 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_9BB(Assignment a, Decision d) {
		for (Decision __DEC_a_negative_932879 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_932879)) {
				return new Object[] { a, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_10BB(Assignment a, While b) {
		for (While __DEC_a_first_708525 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_708525)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_11BB(Assignment a, While b) {
		for (While __DEC_a_last_474107 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_474107)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_12B(Assignment a) {
		for (Program __DEC_a_first_796072 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_blackBBBB(Decision d, Assignment l,
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_934495 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_1BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_positive_438643 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_438643)) {
					if (!y.equals(__DEC_z_positive_438643)) {
						return new Object[] { z, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_2BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_negative_759611 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_759611)) {
					if (!y.equals(__DEC_z_negative_759611)) {
						return new Object[] { z, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_3B(Branch y) {
		for (Graph __DEC_y_root_158220 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_4BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_positive_126392 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!y.equals(__DEC_y_positive_126392)) {
					if (!c.equals(__DEC_y_positive_126392)) {
						return new Object[] { y, c };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_5BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_negative_759584 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!y.equals(__DEC_y_negative_759584)) {
					if (!c.equals(__DEC_y_negative_759584)) {
						return new Object[] { y, c };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_6B(Command x) {
		for (Graph __DEC_x_root_949651 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_7BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_positive_660766 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_x_positive_660766)) {
					if (!y.equals(__DEC_x_positive_660766)) {
						return new Object[] { x, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_8BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_negative_852347 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_x_negative_852347)) {
					if (!y.equals(__DEC_x_negative_852347)) {
						return new Object[] { x, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_9BB(Branch c, Command z) {
		if (z.equals(c.getPositive())) {
			return new Object[] { c, z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_10BB(Branch y, Command z) {
		if (z.equals(y.getPositive())) {
			return new Object[] { y, z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_11BB(Branch c, Command z) {
		if (z.equals(c.getNegative())) {
			return new Object[] { c, z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_13BB(Branch c, Branch y) {
		if (y.equals(c.getPositive())) {
			return new Object[] { c, y };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_blackBBBB(Branch c, Command z, Branch y,
			Command x) {
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				if (x.equals(c.getPositive())) {
					if (y.equals(c.getNegative())) {
						if (y.equals(z.getNext())) {
							if (pattern_decal2branchcb_28_1_matchtggpattern_black_nac_0B(z) == null) {
								if (pattern_decal2branchcb_28_1_matchtggpattern_black_nac_1BBB(z, c, y) == null) {
									if (pattern_decal2branchcb_28_1_matchtggpattern_black_nac_2BBB(z, c, y) == null) {
	...
	public static final Object[] pattern_decal2branchcb_29_5_checknacs_blackBBB(Decision d, S2B d2c, Branch c) {
		return new Object[] { d, d2c, c };
	}

	public static final Object[] pattern_decal2branchcb_29_6_perform_blackBBBB(Decision d, S2B d2c, Branch c,
	...
	public static final Object[] pattern_decal2branchcb_29_6_perform_greenBFFFBFFFFFFB(Decision d, Branch c,
		...
		return new Object[] { d, l, a2x, b, c, a, l2z, z, b2y, y, x, ruleResult };
	}
