...
public class decal2branchcbImpl extends AbstractRuleImpl implements decal2branchcb {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While b, Assignment a, Assignment l, Decision d) {
		...
		Object[] result2_bindingAndBlack = decal2branchcbImpl
				.pattern_decal2branchcb_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, b, a, l, d);
		...
		if (decal2branchcbImpl.pattern_decal2branchcb_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decal2branchcbImpl
					.pattern_decal2branchcb_0_4_collectelementstobetranslated_blackBBBBB(match, b, a, l, d);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[b] = " + b + ", " + "[a] = " + a + ", " + "[l] = " + l + ", " + "[d] = " + d + ".");
			}
			decal2branchcbImpl.pattern_decal2branchcb_0_4_collectelementstobetranslated_greenBBBBBFFF(match, b, a, l,
					d);
			...
			Object[] result5_black = decal2branchcbImpl
					.pattern_decal2branchcb_0_5_collectcontextelements_blackBBBBB(match, b, a, l, d);
			...
			// 
			decal2branchcbImpl.pattern_decal2branchcb_0_6_registerobjectstomatch_expressionBBBBBB(this, match, b, a, l,
					d);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decal2branchcbImpl.pattern_decal2branchcb_1_1_performtransformation_greenFBBBFFBFFF(b,
				a, c, l);
		...
		//nothing EMoflonEdge z__y____next = (EMoflonEdge) result3_green[16];
		...
		// 
		// 
		decal2branchcbImpl.pattern_decal2branchcb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, d2c,
				l2z, b, a, c, x, a2x, l, y, z, d, b2y);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decal2branchcbImpl.pattern_decal2branchcb_2_2_corematch_blackFBBFBBB(b, a, l, d,
				match)) {
			S2B d2c = (S2B) result2_black[0];
			Branch c = (Branch) result2_black[3];
			// ForEach 
			for (Object[] result3_black : decal2branchcbImpl.pattern_decal2branchcb_2_3_findcontext_blackBBBBBB(d2c, b,
					a, c, l, d)) {
				Object[] result3_green = decal2branchcbImpl
						.pattern_decal2branchcb_2_3_findcontext_greenBBBBBBFFFFFF(d2c, b, a, c, l, d);
				...
				Object[] result4_bindingAndBlack = decal2branchcbImpl
						.pattern_decal2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, d2c, b,
								a, c, l, d);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While b, Assignment a, Assignment l, Decision d) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While b, Assignment a, Assignment l, Decision d) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2B d2c, While b, Assignment a, Branch c,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject d2c, EObject l2z, EObject b, EObject a,
			EObject c, EObject x, EObject a2x, EObject l, EObject y, EObject z, EObject d, EObject b2y) {
	...
	public boolean isAppropriate_BWD(Match match, Branch c, Command x, Branch y, Command z) {
		...
		Object[] result2_bindingAndBlack = decal2branchcbImpl
				.pattern_decal2branchcb_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, c, x, y, z);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[c] = " + c + ", " + "[x] = " + x + ", " + "[y] = " + y + ", "
					+ "[z] = " + z + ".");
		...
		if (decal2branchcbImpl.pattern_decal2branchcb_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decal2branchcbImpl
					.pattern_decal2branchcb_10_4_collectelementstobetranslated_blackBBBBB(match, c, x, y, z);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[z] = " + z + ".");
			}
			decal2branchcbImpl.pattern_decal2branchcb_10_4_collectelementstobetranslated_greenBBBBBFFF(match, c, x, y,
					z);
			...
			Object[] result5_black = decal2branchcbImpl
					.pattern_decal2branchcb_10_5_collectcontextelements_blackBBBBB(match, c, x, y, z);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[z] = " + z + ".");
			}
			...
			// 
			decal2branchcbImpl.pattern_decal2branchcb_10_6_registerobjectstomatch_expressionBBBBBB(this, match, c, x, y,
					z);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Decision d = (Decision) result1_bindingAndBlack[5];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decal2branchcbImpl.pattern_decal2branchcb_11_1_performtransformation_greenFFFBFFBBBF(x,
				y, z, d);
		S2N l2z = (S2N) result1_green[0];
		...
		Object[] result2_black = decal2branchcbImpl
				.pattern_decal2branchcb_11_2_collecttranslatedelements_blackBBBBBBBBB(l2z, b, a, x, a2x, l, y, z, b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[l2z] = " + l2z + ", " + "[b] = "
					+ b + ", " + "[a] = " + a + ", " + "[x] = " + x + ", " + "[a2x] = " + a2x + ", " + "[l] = " + l
					+ ", " + "[y] = " + y + ", " + "[z] = " + z + ", " + "[b2y] = " + b2y + ".");
		...
		Object[] result2_green = decal2branchcbImpl
				.pattern_decal2branchcb_11_2_collecttranslatedelements_greenFBBBBBBBBB(l2z, b, a, x, a2x, l, y, z, b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		// 
		// 
		decal2branchcbImpl.pattern_decal2branchcb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, d2c,
				l2z, b, a, c, x, a2x, l, y, z, d, b2y);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decal2branchcbImpl.pattern_decal2branchcb_12_2_corematch_blackFBBBBFB(c, x, y, z,
				match)) {
			S2B d2c = (S2B) result2_black[0];
			Decision d = (Decision) result2_black[5];
			// ForEach 
			for (Object[] result3_black : decal2branchcbImpl.pattern_decal2branchcb_12_3_findcontext_blackBBBBBB(d2c, c,
					x, y, z, d)) {
				Object[] result3_green = decal2branchcbImpl
						.pattern_decal2branchcb_12_3_findcontext_greenBBBBBBFFFFFF(d2c, c, x, y, z, d);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge d2c__c____target = (EMoflonEdge) result3_green[7];
				...
				Object[] result4_bindingAndBlack = decal2branchcbImpl
						.pattern_decal2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, d2c, c,
								x, y, z, d);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, S2B d2c, Branch c, Command x, Branch y,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject d2c, EObject l2z, EObject b, EObject a,
			EObject c, EObject x, EObject a2x, EObject l, EObject y, EObject z, EObject d, EObject b2y) {
		ruleresult.registerObject("d2c", d2c);
		ruleresult.registerObject("l2z", l2z);
		ruleresult.registerObject("b", b);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_106(EMoflonEdge _edge_negative) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decal2branchcbImpl
				.pattern_decal2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, b, a, c, x, l, y, z, d,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[b] = " + b + ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[x] = " + x + ", " + "[l] = "
					+ l + ", " + "[y] = " + y + ", " + "[z] = " + z + ", " + "[d] = " + d + ", " + "[sourceMatch] = "
		...
		if (decal2branchcbImpl.pattern_decal2branchcb_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : decal2branchcbImpl.pattern_decal2branchcb_24_5_matchcorrcontext_blackFBBBB(c,
				...
				Object[] result6_black = decal2branchcbImpl
						.pattern_decal2branchcb_24_6_createcorrespondence_blackBBBBBBBBB(b, a, c, x, l, y, z, d,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[b] = " + b + ", "
							+ "[a] = " + a + ", " + "[c] = " + c + ", " + "[x] = " + x + ", " + "[l] = " + l + ", "
							+ "[y] = " + y + ", " + "[z] = " + z + ", " + "[d] = " + d + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				decal2branchcbImpl.pattern_decal2branchcb_24_6_createcorrespondence_greenFBBBFBBBFB(b, a, x, l, y, z,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(While b, Assignment a, Branch c, Command x, Assignment l, Branch y, Command z,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While b, Assignment a, Assignment l, Decision d) {// 
		Object[] result1_black = decal2branchcbImpl.pattern_decal2branchcb_27_1_matchtggpattern_blackBBBB(b, a, l, d);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(Branch c, Command x, Branch y, Command z) {// 
		Object[] result1_black = decal2branchcbImpl.pattern_decal2branchcb_28_1_matchtggpattern_blackBBBB(c, x, y, z);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B d2cParameter) {
		...
		for (Object[] result2_black : decal2branchcbImpl
			...
			Object[] result3_bindingAndBlack = decal2branchcbImpl
					.pattern_decal2branchcb_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, d2c, c, d,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (decal2branchcbImpl.pattern_decal2branchcb_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = decal2branchcbImpl.pattern_decal2branchcb_29_5_checknacs_blackBBB(d2c, c, d);
				if (result5_black != null) {

					Object[] result6_black = decal2branchcbImpl.pattern_decal2branchcb_29_6_perform_blackBBBB(d2c, c, d,
							ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[d2c] = " + d2c + ", "
								+ "[c] = " + c + ", " + "[d] = " + d + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					decal2branchcbImpl.pattern_decal2branchcb_29_6_perform_greenFFFBFFFFFBFB(c, d, ruleResult);
					//nothing S2N l2z = (S2N) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_DECISION:
		...
		case RulesPackage.DECAL2BRANCHCB___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_DECISION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (While) arguments.get(1),
					(Assignment) arguments.get(2), (Assignment) arguments.get(3), (Decision) arguments.get(4));
			return null;
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_DECISION:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (While) arguments.get(1),
					(Assignment) arguments.get(2), (Assignment) arguments.get(3), (Decision) arguments.get(4));
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.DECAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2B_WHILE_ASSIGNMENT_BRANCH_ASSIGNMENT_DECISION:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_BRANCH_COMMAND_BRANCH_COMMAND_DECISION:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_106__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_106((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECAL2BRANCHCB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_106__EMOFLONEDGE:
		...
		case RulesPackage.DECAL2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_CC__WHILE_ASSIGNMENT_BRANCH_COMMAND_ASSIGNMENT_BRANCH_COMMAND_DECISION_MATCH_MATCH:
		...
		case RulesPackage.DECAL2BRANCHCB___CHECK_DEC_FWD__WHILE_ASSIGNMENT_ASSIGNMENT_DECISION:
		...
		case RulesPackage.DECAL2BRANCHCB___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_BRANCH_DECISION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_decal2branchcb_0_1_initialbindings_blackBBBBBB(decal2branchcb _this,
			Match match, While b, Assignment a, Assignment l, Decision d) {
		if (!a.equals(l)) {
	...
	public static final Object[] pattern_decal2branchcb_0_2_SolveCSP_bindingFBBBBBB(decal2branchcb _this, Match match,
			While b, Assignment a, Assignment l, Decision d) {
	...
	public static final Object[] pattern_decal2branchcb_0_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		return new Object[] { match, b, a, l, d, d__b____negative, d__a____positive, b__l____last };
	}

	public static final Object[] pattern_decal2branchcb_0_5_collectcontextelements_blackBBBBB(Match match, While b,
			Assignment a, Assignment l, Decision d) {
		if (!a.equals(l)) {
			return new Object[] { match, b, a, l, d };
		}
		return null;
					...
					if (tmpC instanceof Branch) {
						...
						if (tmpL instanceof Assignment) {
							...
							if (tmpD instanceof Decision) {
								...
								return new Object[] { d2c, b, a, c, l, d, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decal2branchcb_1_1_performtransformation_blackBBBBBBFBB(S2B d2c, While b,
			Assignment a, Branch c, Assignment l, Decision d, decal2branchcb _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(l)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { d2c, b, a, c, l, d, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decal2branchcb_1_1_performtransformation_binding != null) {
			S2B d2c = (S2B) result_pattern_decal2branchcb_1_1_performtransformation_binding[0];
			While b = (While) result_pattern_decal2branchcb_1_1_performtransformation_binding[1];
			Assignment a = (Assignment) result_pattern_decal2branchcb_1_1_performtransformation_binding[2];
			Branch c = (Branch) result_pattern_decal2branchcb_1_1_performtransformation_binding[3];
			Assignment l = (Assignment) result_pattern_decal2branchcb_1_1_performtransformation_binding[4];
			Decision d = (Decision) result_pattern_decal2branchcb_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_decal2branchcb_1_1_performtransformation_black = pattern_decal2branchcb_1_1_performtransformation_blackBBBBBBFBB(
					d2c, b, a, c, l, d, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decal2branchcb_1_1_performtransformation_greenFBBBFFBFFF(While b, Assignment a,
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { l2z, b, a, c, x, a2x, l, y, z, b2y };
	}

	public static final Object[] pattern_decal2branchcb_1_2_collecttranslatedelements_blackBBBBBBBBB(S2N l2z, While b,
			Assignment a, Command x, S2N a2x, Assignment l, Branch y, Command z, S2B b2y) {
		if (!a.equals(l)) {
			if (!x.equals(z)) {
				if (!a2x.equals(l2z)) {
					return new Object[] { l2z, b, a, x, a2x, l, y, z, b2y };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_1_2_collecttranslatedelements_greenFBBBBBBBBB(S2N l2z, While b,
		...
		return new Object[] { ruleresult, l2z, b, a, x, a2x, l, y, z, b2y };
	}

	public static final Object[] pattern_decal2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject d2c, EObject l2z, EObject b, EObject a, EObject c, EObject x,
			EObject a2x, EObject l, EObject y, EObject z, EObject d, EObject b2y) {
		if (!d2c.equals(l2z)) {
			if (!d2c.equals(x)) {
				if (!d2c.equals(l)) {
					if (!d2c.equals(y)) {
	...
	public static final Object[] pattern_decal2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject l2z, EObject b, EObject a, EObject c, EObject x, EObject a2x,
			EObject l, EObject y, EObject z, EObject d, EObject b2y) {
		...
		b__l____last.setName(b__l____last_name_prime);
		return new Object[] { ruleresult, l2z, b, a, c, x, a2x, l, y, z, d, b2y, c__x____positive, a2x__x____target,
				a2x__a____source, l2z__l____source, z__y____next, l2z__z____target, d__b____negative, c__y____negative,
	...
	public static final void pattern_decal2branchcb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(decal2branchcb _this,
			PerformRuleResult ruleresult, EObject d2c, EObject l2z, EObject b, EObject a, EObject c, EObject x,
			EObject a2x, EObject l, EObject y, EObject z, EObject d, EObject b2y) {
		_this.registerObjects_FWD(ruleresult, d2c, l2z, b, a, c, x, a2x, l, y, z, d, b2y);
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_2_2_corematch_blackFBBFBBB(While b, Assignment a,
		...
		if (!a.equals(l)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { d2c, b, a, c, l, d, match });
				}
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_2_3_findcontext_blackBBBBBB(S2B d2c, While b,
			Assignment a, Branch c, Assignment l, Decision d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(l)) {
					...
					if (a.equals(d.getPositive())) {
						if (l.equals(b.getLast())) {
							if (d.equals(d2c.getSource())) {
								_result.add(new Object[] { d2c, b, a, c, l, d });
							}
						}
					}
				}
	...
	public static final Object[] pattern_decal2branchcb_2_3_findcontext_greenBBBBBBFFFFFF(S2B d2c, While b,
			Assignment a, Branch c, Assignment l, Decision d) {
		...
		return new Object[] { d2c, b, a, c, l, d, isApplicableMatch, d2c__c____target, d__b____negative,
				d__a____positive, b__l____last, d2c__d____source };
	}

	public static final Object[] pattern_decal2branchcb_2_4_solveCSP_bindingFBBBBBBBB(decal2branchcb _this,
			IsApplicableMatch isApplicableMatch, S2B d2c, While b, Assignment a, Branch c, Assignment l, Decision d) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, d2c, b, a, c, l, d);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, b, a, c, l, d };
		}
		return null;
	}
	...
	public static final Object[] pattern_decal2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(decal2branchcb _this,
		...
		Object[] result_pattern_decal2branchcb_2_4_solveCSP_binding = pattern_decal2branchcb_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, d2c, b, a, c, l, d);
	...
	public static final Object[] pattern_decal2branchcb_10_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		z__y____next.setName(z__y____next_name_prime);
		c__y____negative.setName(c__y____negative_name_prime);
		return new Object[] { match, c, x, y, z, c__x____positive, z__y____next, c__y____negative };
	}
				...
				if (tmpX instanceof Command) {
					...
					if (tmpY instanceof Branch) {
						...
						if (tmpZ instanceof Command) {
							...
							if (tmpD instanceof Decision) {
								Decision d = (Decision) tmpD;
								return new Object[] { d2c, c, x, y, z, d, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decal2branchcb_11_1_performtransformation_blackBBBBBBFBB(S2B d2c, Branch c,
			Command x, Branch y, Command z, Decision d, decal2branchcb _this, IsApplicableMatch isApplicableMatch) {
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { d2c, c, x, y, z, d, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decal2branchcb_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decal2branchcb_11_1_performtransformation_binding != null) {
			S2B d2c = (S2B) result_pattern_decal2branchcb_11_1_performtransformation_binding[0];
			...
			Branch y = (Branch) result_pattern_decal2branchcb_11_1_performtransformation_binding[3];
			Command z = (Command) result_pattern_decal2branchcb_11_1_performtransformation_binding[4];
			Decision d = (Decision) result_pattern_decal2branchcb_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_decal2branchcb_11_1_performtransformation_black = pattern_decal2branchcb_11_1_performtransformation_blackBBBBBBFBB(
					d2c, c, x, y, z, d, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decal2branchcb_11_1_performtransformation_greenFFFBFFBBBF(Command x, Branch y,
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { l2z, b, a, x, a2x, l, y, z, d, b2y };
	}
	...
	public static final void pattern_decal2branchcb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(decal2branchcb _this,
			PerformRuleResult ruleresult, EObject d2c, EObject l2z, EObject b, EObject a, EObject c, EObject x,
			EObject a2x, EObject l, EObject y, EObject z, EObject d, EObject b2y) {
		_this.registerObjects_BWD(ruleresult, d2c, l2z, b, a, c, x, a2x, l, y, z, d, b2y);
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_12_2_corematch_blackFBBBBFB(Branch c, Command x,
		...
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
					...
					if (tmpD instanceof Decision) {
						Decision d = (Decision) tmpD;
						_result.add(new Object[] { d2c, c, x, y, z, d, match });
					}
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_12_3_findcontext_blackBBBBBB(S2B d2c, Branch c,
			Command x, Branch y, Command z, Decision d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				if (c.equals(d2c.getTarget())) {
					if (x.equals(c.getPositive())) {
						if (y.equals(z.getNext())) {
							if (y.equals(c.getNegative())) {
								if (d.equals(d2c.getSource())) {
									_result.add(new Object[] { d2c, c, x, y, z, d });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decal2branchcb_12_3_findcontext_greenBBBBBBFFFFFF(S2B d2c, Branch c, Command x,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		d2c__d____source.setName(d2c__d____source_name_prime);
		return new Object[] { d2c, c, x, y, z, d, isApplicableMatch, d2c__c____target, c__x____positive, z__y____next,
	...
	public static final Object[] pattern_decal2branchcb_12_4_solveCSP_bindingFBBBBBBBB(decal2branchcb _this,
			IsApplicableMatch isApplicableMatch, S2B d2c, Branch c, Command x, Branch y, Command z, Decision d) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d2c, c, x, y, z, d);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, c, x, y, z, d };
		}
		return null;
	}
	...
	public static final Object[] pattern_decal2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decal2branchcb _this,
		...
		Object[] result_pattern_decal2branchcb_12_4_solveCSP_binding = pattern_decal2branchcb_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, d2c, c, x, y, z, d);
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_108729 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_1BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_positive_873780 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_x_positive_873780)) {
					if (!y.equals(__DEC_x_positive_873780)) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_2BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_negative_267595 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_x_negative_267595)) {
					if (!y.equals(__DEC_x_negative_267595)) {
						return new Object[] { x, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_3B(Branch y) {
		for (Graph __DEC_y_root_240245 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_4BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_positive_380972 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!y.equals(__DEC_y_positive_380972)) {
					if (!c.equals(__DEC_y_positive_380972)) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_5BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_negative_600783 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!y.equals(__DEC_y_negative_600783)) {
					if (!c.equals(__DEC_y_negative_600783)) {
						return new Object[] { y, c };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_6B(Command z) {
		for (Graph __DEC_z_root_919371 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_7BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_positive_106030 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_106030)) {
					if (!y.equals(__DEC_z_positive_106030)) {
	...
	public static final Object[] pattern_decal2branchcb_20_2_testcorematchandDECs_black_nac_8BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_negative_829492 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_829492)) {
					if (!y.equals(__DEC_z_negative_829492)) {
						return new Object[] { z, c, y };
					}
				}
			}
	...
	public static final boolean pattern_decal2branchcb_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decal2branchcb _this, Match match, Branch c, Command x, Branch y, Command z) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_0BB(While b, Decision d) {
		for (Decision __DEC_b_positive_341605 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_341605)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_1B(While b) {
		for (While __DEC_b_first_80250 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_80250)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_2B(While b) {
		for (While __DEC_b_last_617487 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_617487)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_3B(While b) {
		for (Program __DEC_b_first_801735 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_4BB(Assignment a,
			Decision d) {
		for (Decision __DEC_a_negative_989474 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_989474)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_5BB(Assignment a, While b) {
		for (While __DEC_a_first_501852 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_501852)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_6BB(Assignment a, While b) {
		for (While __DEC_a_last_769202 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_769202)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_7B(Assignment a) {
		for (Program __DEC_a_first_843597 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_8BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_positive_649529 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_649529)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_9BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_negative_444925 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_444925)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_10BB(Assignment l,
			While b) {
		for (While __DEC_l_first_232258 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!b.equals(__DEC_l_first_232258)) {
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_11BB(Assignment l,
			While b) {
		for (While __DEC_l_last_665868 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_665868)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_21_2_testcorematchandDECs_black_nac_12B(Assignment l) {
		for (Program __DEC_l_first_596935 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final boolean pattern_decal2branchcb_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decal2branchcb _this, Match match, While b, Assignment a, Assignment l, Decision d) {
						...
						if (tmpL instanceof Assignment) {
							...
							if (tmpY instanceof Branch) {
								...
								if (tmpZ instanceof Command) {
									...
									if (tmpD instanceof Decision) {
										Decision d = (Decision) tmpD;
										return new Object[] { b, a, c, x, l, y, z, d, sourceMatch, targetMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decal2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(While b, Assignment a,
			Branch c, Command x, Assignment l, Branch y, Command z, Decision d, Match sourceMatch, Match targetMatch) {
		if (!a.equals(l)) {
			if (!c.equals(y)) {
				if (!x.equals(z)) {
	...
	public static final Object[] pattern_decal2branchcb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decal2branchcb_24_2_matchsrctrgcontext_binding != null) {
			...
			Decision d = (Decision) result_pattern_decal2branchcb_24_2_matchsrctrgcontext_binding[7];
			...
			Object[] result_pattern_decal2branchcb_24_2_matchsrctrgcontext_black = pattern_decal2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					b, a, c, x, l, y, z, d, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decal2branchcb_24_3_solvecsp_bindingFBBBBBBBBBBB(decal2branchcb _this, While b,
			Assignment a, Branch c, Command x, Assignment l, Branch y, Command z, Decision d, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(b, a, c, x, l, y, z, d, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, b, a, c, x, l, y, z, d, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decal2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(decal2branchcb _this,
			While b, Assignment a, Branch c, Command x, Assignment l, Branch y, Command z, Decision d,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_decal2branchcb_24_3_solvecsp_binding = pattern_decal2branchcb_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, b, a, c, x, l, y, z, d, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_decal2branchcb_24_5_matchcorrcontext_blackFBBBB(Branch c, Decision d,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_decal2branchcb_24_6_createcorrespondence_blackBBBBBBBBB(While b, Assignment a,
			Branch c, Command x, Assignment l, Branch y, Command z, Decision d, CCMatch ccMatch) {
		if (!a.equals(l)) {
			if (!c.equals(y)) {
				if (!x.equals(z)) {
					return new Object[] { b, a, c, x, l, y, z, d, ccMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_24_6_createcorrespondence_greenFBBBFBBBFB(While b, Assignment a,
			Command x, Assignment l, Branch y, Command z, CCMatch ccMatch) {
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		l2z.setSource(l);
		...
		return new Object[] { l2z, b, a, x, a2x, l, y, z, b2y, ccMatch };
	}
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_0BB(While b, Decision d) {
		for (Decision __DEC_b_positive_705664 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_705664)) {
				return new Object[] { b, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_1B(While b) {
		for (While __DEC_b_first_807878 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!b.equals(__DEC_b_first_807878)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_2B(While b) {
		for (While __DEC_b_last_624203 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!b.equals(__DEC_b_last_624203)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_3B(While b) {
		for (Program __DEC_b_first_513711 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_4BB(Assignment a, Decision d) {
		for (Decision __DEC_a_negative_611722 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_611722)) {
				return new Object[] { a, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_5BB(Assignment a, While b) {
		for (While __DEC_a_first_315817 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!b.equals(__DEC_a_first_315817)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_6BB(Assignment a, While b) {
		for (While __DEC_a_last_718172 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!b.equals(__DEC_a_last_718172)) {
				return new Object[] { a, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_7B(Assignment a) {
		for (Program __DEC_a_first_491737 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_8BB(Assignment l, Decision d) {
		for (Decision __DEC_l_positive_432958 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_432958)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_9BB(Assignment l, Decision d) {
		for (Decision __DEC_l_negative_660382 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_660382)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_10BB(Assignment l, While b) {
		for (While __DEC_l_first_296960 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!b.equals(__DEC_l_first_296960)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_11BB(Assignment l, While b) {
		for (While __DEC_l_last_997539 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!b.equals(__DEC_l_last_997539)) {
				return new Object[] { l, b };
			}
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_27_1_matchtggpattern_black_nac_12B(Assignment l) {
		for (Program __DEC_l_first_253104 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_740750 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_1BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_positive_14774 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_x_positive_14774)) {
					if (!y.equals(__DEC_x_positive_14774)) {
						return new Object[] { x, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_2BBB(Command x, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_x_negative_881536 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_x_negative_881536)) {
					if (!y.equals(__DEC_x_negative_881536)) {
						return new Object[] { x, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_3B(Branch y) {
		for (Graph __DEC_y_root_43317 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_4BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_positive_139006 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!y.equals(__DEC_y_positive_139006)) {
					if (!c.equals(__DEC_y_positive_139006)) {
						return new Object[] { y, c };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_5BB(Branch y, Branch c) {
		if (!c.equals(y)) {
			for (Branch __DEC_y_negative_277043 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!y.equals(__DEC_y_negative_277043)) {
					if (!c.equals(__DEC_y_negative_277043)) {
						return new Object[] { y, c };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_6B(Command z) {
		for (Graph __DEC_z_root_289719 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_7BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_positive_608168 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_608168)) {
					if (!y.equals(__DEC_z_positive_608168)) {
						return new Object[] { z, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_black_nac_8BBB(Command z, Branch c,
			Branch y) {
		if (!c.equals(y)) {
			for (Branch __DEC_z_negative_859228 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_859228)) {
					if (!y.equals(__DEC_z_negative_859228)) {
						return new Object[] { z, c, y };
					}
				}
			}
	...
	public static final Object[] pattern_decal2branchcb_28_1_matchtggpattern_blackBBBB(Branch c, Command x, Branch y,
			Command z) {
		if (!c.equals(y)) {
			if (!x.equals(z)) {
				if (x.equals(c.getPositive())) {
			...
			for (EObject tmpD2c : d2cList.getEntryObjects()) {
				if (tmpD2c instanceof S2B) {
					...
					if (c != null) {
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							if (pattern_decal2branchcb_29_2_isapplicablecore_black_nac_0BB(ruleResult, d2c) == null) {
								if (pattern_decal2branchcb_29_2_isapplicablecore_black_nac_1BB(ruleResult, c) == null) {
	...
	public static final Object[] pattern_decal2branchcb_29_5_checknacs_blackBBB(S2B d2c, Branch c, Decision d) {
		return new Object[] { d2c, c, d };
	}

	public static final Object[] pattern_decal2branchcb_29_6_perform_blackBBBB(S2B d2c, Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { d2c, c, d, ruleResult };
	}

	public static final Object[] pattern_decal2branchcb_29_6_perform_greenFFFBFFFFFBFB(Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		While b = SourcecodeFactory.eINSTANCE.createWhile();
		Assignment a = SourcecodeFactory.eINSTANCE.createAssignment();
		...
		return new Object[] { l2z, b, a, c, x, a2x, l, y, z, d, b2y, ruleResult };
	}
