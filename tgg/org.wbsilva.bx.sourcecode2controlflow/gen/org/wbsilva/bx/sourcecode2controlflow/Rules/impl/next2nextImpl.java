...
public class next2nextImpl extends AbstractRuleImpl implements next2next {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = next2nextImpl.pattern_next2next_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, s, n,
				a, c, s2n, a2c);
		...
		next2nextImpl.pattern_next2next_1_3_bookkeepingforedges_greenBBBBBFF(ruleresult, s, n, a, c);
		//nothing EMoflonEdge n__c____next = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge s__a____next = (EMoflonEdge) result3_green[6];

		// 
		// 
		next2nextImpl.pattern_next2next_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, s, n, a, c, s2n, a2c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : next2nextImpl.pattern_next2next_2_2_corematch_blackBFBFFFB(s, a, match)) {
			Node n = (Node) result2_black[1];
			Command c = (Command) result2_black[3];
			S2N s2n = (S2N) result2_black[4];
			S2N a2c = (S2N) result2_black[5];
			// ForEach 
			for (Object[] result3_black : next2nextImpl.pattern_next2next_2_3_findcontext_blackBBBBBB(s, n, a, c, s2n,
					a2c)) {
				Object[] result3_green = next2nextImpl.pattern_next2next_2_3_findcontext_greenBBBBBBFFFFFF(s, n, a, c,
						s2n, a2c);
				...
				Object[] result4_bindingAndBlack = next2nextImpl
						.pattern_next2next_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, s, n, a, c,
								s2n, a2c);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject s, EObject n, EObject a, EObject c,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = next2nextImpl.pattern_next2next_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, s, n,
				a, c, s2n, a2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[s] = " + s + ", " + "[n] = " + n + ", " + "[a] = " + a + ", " + "[c] = " + c + ", "
		...
		next2nextImpl.pattern_next2next_11_3_bookkeepingforedges_greenBBBBBFF(ruleresult, s, n, a, c);
		//nothing EMoflonEdge n__c____next = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge s__a____next = (EMoflonEdge) result3_green[6];

		// 
		// 
		next2nextImpl.pattern_next2next_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, s, n, a, c, s2n, a2c);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : next2nextImpl.pattern_next2next_12_2_corematch_blackFBFBFFB(n, c, match)) {
			Statement s = (Statement) result2_black[0];
			Assignment a = (Assignment) result2_black[2];
			S2N s2n = (S2N) result2_black[4];
			S2N a2c = (S2N) result2_black[5];
			// ForEach 
			for (Object[] result3_black : next2nextImpl.pattern_next2next_12_3_findcontext_blackBBBBBB(s, n, a, c, s2n,
					a2c)) {
				Object[] result3_green = next2nextImpl.pattern_next2next_12_3_findcontext_greenBBBBBBFFFFFF(s, n, a, c,
						s2n, a2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = next2nextImpl
						.pattern_next2next_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, s, n, a, c,
								s2n, a2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[s] = " + s + ", " + "[n] = " + n
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject s, EObject n, EObject a, EObject c,
			EObject s2n, EObject a2c) {
		ruleresult.registerObject("s", s);
		ruleresult.registerObject("n", n);
		ruleresult.registerObject("a", a);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_132(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_132(EMoflonEdge _edge_next) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = next2nextImpl.pattern_next2next_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				s, n, a, c, sourceMatch, targetMatch);
		...
		if (next2nextImpl.pattern_next2next_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : next2nextImpl.pattern_next2next_24_5_matchcorrcontext_blackBBBBFFBB(s, n, a,
				...
				Object[] result6_black = next2nextImpl.pattern_next2next_24_6_createcorrespondence_blackBBBBB(s, n, a,
						c, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Statement s, Node n, Assignment a, Command c, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2N s2nParameter,
		...
		for (Object[] result2_black : next2nextImpl
			...
			Object[] result3_bindingAndBlack = next2nextImpl.pattern_next2next_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
					this, isApplicableMatch, s, n, a, c, s2n, a2c, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[s] = " + s + ", " + "[n] = " + n
						+ ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[s2n] = " + s2n + ", " + "[a2c] = " + a2c
			...
			if (next2nextImpl.pattern_next2next_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = next2nextImpl.pattern_next2next_29_5_checknacs_blackBBBBBB(s, n, a, c, s2n,
						a2c);
				if (result5_black != null) {

					Object[] result6_black = next2nextImpl.pattern_next2next_29_6_perform_blackBBBBBBB(s, n, a, c, s2n,
							a2c, ruleResult);
					if (result6_black == null) {
					...
					next2nextImpl.pattern_next2next_29_6_perform_greenBBBBB(s, n, a, c, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.NEXT2NEXT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_STATEMENT_NODE_ASSIGNMENT_COMMAND_S2N_S2N:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Statement) arguments.get(1),
					(Node) arguments.get(2), (Assignment) arguments.get(3), (Command) arguments.get(4),
		...
		case RulesPackage.NEXT2NEXT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STATEMENT_NODE_ASSIGNMENT_COMMAND_S2N_S2N:
		...
		case RulesPackage.NEXT2NEXT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_132__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_132((EMoflonEdge) arguments.get(0));
		case RulesPackage.NEXT2NEXT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_132__EMOFLONEDGE:
		...
		case RulesPackage.NEXT2NEXT___IS_APPLICABLE_SOLVE_CSP_CC__STATEMENT_NODE_ASSIGNMENT_COMMAND_MATCH_MATCH:
		...
		case RulesPackage.NEXT2NEXT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STATEMENT_NODE_ASSIGNMENT_COMMAND_S2N_S2N_MODELGENERATORRULERESULT:
					...
					if (tmpC instanceof Command) {
						...
						if (tmpS2n instanceof S2N) {
							...
							if (tmpA2c instanceof S2N) {
								S2N a2c = (S2N) tmpA2c;
								return new Object[] { s, n, a, c, s2n, a2c, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_next2next_1_1_performtransformation_blackBBBBBBFBB(Statement s, Node n,
			Assignment a, Command c, S2N s2n, S2N a2c, next2next _this, IsApplicableMatch isApplicableMatch) {
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				if (!a2c.equals(s2n)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { s, n, a, c, s2n, a2c, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_next2next_1_1_performtransformation_bindingAndBlackFFFFFFFBB(next2next _this,
		...
		if (result_pattern_next2next_1_1_performtransformation_binding != null) {
			...
			Node n = (Node) result_pattern_next2next_1_1_performtransformation_binding[1];
			...
			S2N a2c = (S2N) result_pattern_next2next_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_next2next_1_1_performtransformation_black = pattern_next2next_1_1_performtransformation_blackBBBBBBFBB(
					s, n, a, c, s2n, a2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_next2next_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject s, EObject n, EObject a, EObject c, EObject s2n, EObject a2c) {
		if (!s.equals(s2n)) {
			if (!n.equals(s)) {
				if (!n.equals(s2n)) {
					if (!a.equals(s)) {
												...
												if (!c.equals(s2n)) {
													if (!a2c.equals(s)) {
														if (!a2c.equals(n)) {
															if (!a2c.equals(c)) {
																if (!a2c.equals(s2n)) {
																	return new Object[] { ruleresult, s, n, a, c, s2n,
																			a2c };
																}
															}
														}
	...
	public static final Object[] pattern_next2next_1_3_bookkeepingforedges_greenBBBBBFF(PerformRuleResult ruleresult,
			EObject s, EObject n, EObject a, EObject c) {
		...
		s__a____next.setName(s__a____next_name_prime);
		return new Object[] { ruleresult, s, n, a, c, n__c____next, s__a____next };
	}

	public static final void pattern_next2next_1_5_registerobjects_expressionBBBBBBBB(next2next _this,
			PerformRuleResult ruleresult, EObject s, EObject n, EObject a, EObject c, EObject s2n, EObject a2c) {
		_this.registerObjects_FWD(ruleresult, s, n, a, c, s2n, a2c);
	...
	public static final Iterable<Object[]> pattern_next2next_2_2_corematch_blackBFBFFFB(Statement s, Assignment a,
			Match match) {
					...
					for (S2N a2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a, S2N.class,
						...
						if (!a2c.equals(s2n)) {
							...
							if (tmpC instanceof Command) {
								Command c = (Command) tmpC;
								if (!c.equals(n)) {
									_result.add(new Object[] { s, n, a, c, s2n, a2c, match });
								}
							}
	...
	public static final Iterable<Object[]> pattern_next2next_2_3_findcontext_blackBBBBBB(Statement s, Node n,
			Assignment a, Command c, S2N s2n, S2N a2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				if (!a2c.equals(s2n)) {
							...
							if (n.equals(s2n.getTarget())) {
								if (a.equals(a2c.getSource())) {
									if (c.equals(a2c.getTarget())) {
										_result.add(new Object[] { s, n, a, c, s2n, a2c });
									}
								}
							}
						}
	...
	public static final Object[] pattern_next2next_2_3_findcontext_greenBBBBBBFFFFFF(Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c) {
		...
		return new Object[] { s, n, a, c, s2n, a2c, isApplicableMatch, s2n__s____source, s__a____next, s2n__n____target,
				a2c__a____source, a2c__c____target };
	}

	public static final Object[] pattern_next2next_2_4_solveCSP_bindingFBBBBBBBB(next2next _this,
			IsApplicableMatch isApplicableMatch, Statement s, Node n, Assignment a, Command c, S2N s2n, S2N a2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, s, n, a, c, s2n, a2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, s, n, a, c, s2n, a2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_next2next_2_4_solveCSP_bindingAndBlackFBBBBBBBB(next2next _this,
		...
		Object[] result_pattern_next2next_2_4_solveCSP_binding = pattern_next2next_2_4_solveCSP_bindingFBBBBBBBB(_this,
				isApplicableMatch, s, n, a, c, s2n, a2c);
	...
	public static final Object[] pattern_next2next_11_1_performtransformation_blackBBBBBBFBB(Statement s, Node n,
			Assignment a, Command c, S2N s2n, S2N a2c, next2next _this, IsApplicableMatch isApplicableMatch) {
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				if (!a2c.equals(s2n)) {
	...
	public static final Object[] pattern_next2next_11_1_performtransformation_bindingAndBlackFFFFFFFBB(next2next _this,
		...
		if (result_pattern_next2next_11_1_performtransformation_binding != null) {
			...
			Node n = (Node) result_pattern_next2next_11_1_performtransformation_binding[1];
			...
			S2N a2c = (S2N) result_pattern_next2next_11_1_performtransformation_binding[5];
	...
	public static final void pattern_next2next_11_5_registerobjects_expressionBBBBBBBB(next2next _this,
			PerformRuleResult ruleresult, EObject s, EObject n, EObject a, EObject c, EObject s2n, EObject a2c) {
		_this.registerObjects_BWD(ruleresult, s, n, a, c, s2n, a2c);
	...
	public static final Iterable<Object[]> pattern_next2next_12_2_corematch_blackFBFBFFB(Node n, Command c,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(n)) {
	...
	public static final Iterable<Object[]> pattern_next2next_12_3_findcontext_blackBBBBBB(Statement s, Node n,
			Assignment a, Command c, S2N s2n, S2N a2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(s)) {
			if (!c.equals(n)) {
	...
	public static final Object[] pattern_next2next_12_3_findcontext_greenBBBBBBFFFFFF(Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge n__c____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge s2n__s____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		a2c__a____source.setName(a2c__a____source_name_prime);
		a2c__c____target.setName(a2c__c____target_name_prime);
		return new Object[] { s, n, a, c, s2n, a2c, isApplicableMatch, n__c____next, s2n__s____source, s2n__n____target,
				a2c__a____source, a2c__c____target };
	}

	public static final Object[] pattern_next2next_12_4_solveCSP_bindingFBBBBBBBB(next2next _this,
			IsApplicableMatch isApplicableMatch, Statement s, Node n, Assignment a, Command c, S2N s2n, S2N a2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, s, n, a, c, s2n, a2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, s, n, a, c, s2n, a2c };
		}
	...
	public static final Object[] pattern_next2next_12_4_solveCSP_bindingAndBlackFBBBBBBBB(next2next _this,
		...
		Object[] result_pattern_next2next_12_4_solveCSP_binding = pattern_next2next_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, s, n, a, c, s2n, a2c);
		...
		if (tmpS instanceof Statement) {
			...
			if (tmpN instanceof Node) {
				...
				if (tmpA instanceof Assignment) {
					...
					if (tmpC instanceof Command) {
						Command c = (Command) tmpC;
						return new Object[] { s, n, a, c, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_next2next_24_2_matchsrctrgcontext_blackBBBBBB(Statement s, Node n,
	...
	public static final Object[] pattern_next2next_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(Match sourceMatch,
		...
		if (result_pattern_next2next_24_2_matchsrctrgcontext_binding != null) {
			...
			Node n = (Node) result_pattern_next2next_24_2_matchsrctrgcontext_binding[1];
			Assignment a = (Assignment) result_pattern_next2next_24_2_matchsrctrgcontext_binding[2];
			Command c = (Command) result_pattern_next2next_24_2_matchsrctrgcontext_binding[3];
	...
	public static final Object[] pattern_next2next_24_3_solvecsp_bindingFBBBBBBB(next2next _this, Statement s, Node n,
			Assignment a, Command c, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(s, n, a, c, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, s, n, a, c, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_next2next_24_3_solvecsp_bindingAndBlackFBBBBBBB(next2next _this, Statement s,
			Node n, Assignment a, Command c, Match sourceMatch, Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_next2next_24_5_matchcorrcontext_blackBBBBFFBB(Statement s, Node n,
			Assignment a, Command c, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				if (!sourceMatch.equals(targetMatch)) {
					for (S2N s2n : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(s, S2N.class,
							"source")) {
						if (n.equals(s2n.getTarget())) {
							for (S2N a2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
									S2N.class, "source")) {
								if (!a2c.equals(s2n)) {
									if (c.equals(a2c.getTarget())) {
										_result.add(new Object[] { s, n, a, c, s2n, a2c, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_next2next_24_6_createcorrespondence_blackBBBBB(Statement s, Node n,
			Assignment a, Command c, CCMatch ccMatch) {
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				return new Object[] { s, n, a, c, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_next2next_29_3_solveCSP_bindingFBBBBBBBBB(next2next _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, s, n, a, c, s2n, a2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, s, n, a, c, s2n, a2c, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_next2next_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(next2next _this,
		...
		Object[] result_pattern_next2next_29_3_solveCSP_binding = pattern_next2next_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, s, n, a, c, s2n, a2c, ruleResult);
	...
	public static final Object[] pattern_next2next_29_5_checknacs_blackBBBBBB(Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c) {
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				if (!a2c.equals(s2n)) {
					return new Object[] { s, n, a, c, s2n, a2c };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_next2next_29_6_perform_blackBBBBBBB(Statement s, Node n, Assignment a,
			Command c, S2N s2n, S2N a2c, ModelgeneratorRuleResult ruleResult) {
		if (!a.equals(s)) {
			if (!c.equals(n)) {
				if (!a2c.equals(s2n)) {
					return new Object[] { s, n, a, c, s2n, a2c, ruleResult };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_next2next_29_6_perform_greenBBBBB(Statement s, Node n, Assignment a, Command c,
			ModelgeneratorRuleResult ruleResult) {
		n.setNext(c);
		s.setNext(a);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { s, n, a, c, ruleResult };
	}
