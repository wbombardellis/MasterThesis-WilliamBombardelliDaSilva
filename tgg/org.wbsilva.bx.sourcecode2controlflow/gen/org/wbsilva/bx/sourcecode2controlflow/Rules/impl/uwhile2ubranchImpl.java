...
public class uwhile2ubranchImpl extends AbstractRuleImpl implements uwhile2ubranch {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = uwhile2ubranchImpl.pattern_uwhile2ubranch_1_1_performtransformation_greenFFBFFBB(n, b,
				a);
		...
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[a2c] = "
							+ a2c + ", " + "[b2d] = " + b2d + ", " + "[b] = " + b + ", " + "[a] = " + a + ".");
		}
		...
		Object[] result3_black = uwhile2ubranchImpl.pattern_uwhile2ubranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, d, c, s2n, n, a2c, b2d, b, s, a);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[s2n] = " + s2n + ", " + "[n] = " + n + ", "
					+ "[a2c] = " + a2c + ", " + "[b2d] = " + b2d + ", " + "[b] = " + b + ", " + "[s] = " + s + ", "
					+ "[a] = " + a + ".");
		}
		uwhile2ubranchImpl.pattern_uwhile2ubranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFF(ruleresult, d, c, n,
				a2c, b2d, b, s, a);
		...
		//nothing EMoflonEdge a2c__c____target = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		uwhile2ubranchImpl.pattern_uwhile2ubranch_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, d, c, s2n,
				n, a2c, b2d, b, s, a);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : uwhile2ubranchImpl.pattern_uwhile2ubranch_2_2_corematch_blackFFBBBB(b, s, a,
				match)) {
			S2N s2n = (S2N) result2_black[0];
			Node n = (Node) result2_black[1];
			// ForEach 
			for (Object[] result3_black : uwhile2ubranchImpl.pattern_uwhile2ubranch_2_3_findcontext_blackBBBBB(s2n, n,
					b, s, a)) {
				Object[] result3_green = uwhile2ubranchImpl.pattern_uwhile2ubranch_2_3_findcontext_greenBBBBBFFFFFF(s2n,
						n, b, s, a);
				...
				Object[] result4_bindingAndBlack = uwhile2ubranchImpl
						.pattern_uwhile2ubranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, s2n, n, b,
								s, a);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2N s2n, Node n, Assignment b,
			Statement s, While a) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject d, EObject c, EObject s2n, EObject n,
			EObject a2c, EObject b2d, EObject b, EObject s, EObject a) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = uwhile2ubranchImpl.pattern_uwhile2ubranch_11_1_performtransformation_greenBBFFFBF(d, c,
				s);
		...
		Object[] result2_green = uwhile2ubranchImpl
				.pattern_uwhile2ubranch_11_2_collecttranslatedelements_greenFBBBBBB(d, c, a2c, b2d, b, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		uwhile2ubranchImpl.pattern_uwhile2ubranch_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFF(ruleresult, d, c, n,
				a2c, b2d, b, s, a);
		//nothing EMoflonEdge n__c____next = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge c__d____positive = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge a2c__c____target = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		uwhile2ubranchImpl.pattern_uwhile2ubranch_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, d, c,
				s2n, n, a2c, b2d, b, s, a);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : uwhile2ubranchImpl.pattern_uwhile2ubranch_12_2_corematch_blackBBFBFB(d, c, n,
				match)) {
			S2N s2n = (S2N) result2_black[2];
			Statement s = (Statement) result2_black[4];
			// ForEach 
			for (Object[] result3_black : uwhile2ubranchImpl.pattern_uwhile2ubranch_12_3_findcontext_blackBBBBB(d, c,
					s2n, n, s)) {
				...
				//nothing EMoflonEdge d__c____next = (EMoflonEdge) result3_green[8];
				...
				Object[] result4_bindingAndBlack = uwhile2ubranchImpl
						.pattern_uwhile2ubranch_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, d, c,
								s2n, n, s);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Command d, Branch c, S2N s2n, Node n,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject d, EObject c, EObject s2n, EObject n,
			EObject a2c, EObject b2d, EObject b, EObject s, EObject a) {
		ruleresult.registerObject("d", d);
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("s2n", s2n);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_75(EMoflonEdge _edge_last) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = uwhile2ubranchImpl
				.pattern_uwhile2ubranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, d, c, n, b, s, a, sourceMatch,
						targetMatch);
		...
		if (uwhile2ubranchImpl.pattern_uwhile2ubranch_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : uwhile2ubranchImpl.pattern_uwhile2ubranch_24_5_matchcorrcontext_blackFBBBB(n,
				...
				Object[] result6_black = uwhile2ubranchImpl
						.pattern_uwhile2ubranch_24_6_createcorrespondence_blackBBBBBBB(d, c, n, b, s, a, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[d] = " + d + ", "
							+ "[c] = " + c + ", " + "[n] = " + n + ", " + "[b] = " + b + ", " + "[s] = " + s + ", "
							+ "[a] = " + a + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				uwhile2ubranchImpl.pattern_uwhile2ubranch_24_6_createcorrespondence_greenBBFFBBB(d, c, b, a, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Command d, Branch c, Node n, Assignment b, Statement s, While a,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2N s2nParameter) {
		...
		for (Object[] result2_black : uwhile2ubranchImpl
			...
			Object[] result3_bindingAndBlack = uwhile2ubranchImpl
					.pattern_uwhile2ubranch_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, s2n, n, s,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (uwhile2ubranchImpl.pattern_uwhile2ubranch_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = uwhile2ubranchImpl.pattern_uwhile2ubranch_29_5_checknacs_blackBBB(s2n, n, s);
				if (result5_black != null) {

					Object[] result6_black = uwhile2ubranchImpl.pattern_uwhile2ubranch_29_6_perform_blackBBBB(s2n, n, s,
							ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[s2n] = " + s2n + ", "
								+ "[n] = " + n + ", " + "[s] = " + s + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					uwhile2ubranchImpl.pattern_uwhile2ubranch_29_6_perform_greenFFBFFFBFB(n, s, ruleResult);
					//nothing Command d = (Command) result6_green[0];
					//nothing Branch c = (Branch) result6_green[1];
					//nothing S2B a2c = (S2B) result6_green[3];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UWHILE2UBRANCH___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2N_NODE_ASSIGNMENT_STATEMENT_WHILE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (S2N) arguments.get(1),
					(Node) arguments.get(2), (Assignment) arguments.get(3), (Statement) arguments.get(4),
		...
		case RulesPackage.UWHILE2UBRANCH___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMMAND_BRANCH_S2N_NODE_STATEMENT:
		...
		case RulesPackage.UWHILE2UBRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_75__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_75((EMoflonEdge) arguments.get(0));
		case RulesPackage.UWHILE2UBRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_75__EMOFLONEDGE:
		...
		case RulesPackage.UWHILE2UBRANCH___IS_APPLICABLE_SOLVE_CSP_CC__COMMAND_BRANCH_NODE_ASSIGNMENT_STATEMENT_WHILE_MATCH_MATCH:
		...
		case RulesPackage.UWHILE2UBRANCH___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2N_NODE_STATEMENT_MODELGENERATORRULERESULT:
				...
				if (tmpB instanceof Assignment) {
					...
					if (tmpS instanceof Statement) {
						...
						if (tmpA instanceof While) {
							While a = (While) tmpA;
							return new Object[] { s2n, n, b, s, a, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_1_1_performtransformation_blackBBBBBFBB(S2N s2n, Node n,
			Assignment b, Statement s, While a, uwhile2ubranch _this, IsApplicableMatch isApplicableMatch) {
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { s2n, n, b, s, a, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_uwhile2ubranch_1_1_performtransformation_binding != null) {
			S2N s2n = (S2N) result_pattern_uwhile2ubranch_1_1_performtransformation_binding[0];
			Node n = (Node) result_pattern_uwhile2ubranch_1_1_performtransformation_binding[1];
			Assignment b = (Assignment) result_pattern_uwhile2ubranch_1_1_performtransformation_binding[2];
			Statement s = (Statement) result_pattern_uwhile2ubranch_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_uwhile2ubranch_1_1_performtransformation_black = pattern_uwhile2ubranch_1_1_performtransformation_blackBBBBBFBB(
					s2n, n, b, s, a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_uwhile2ubranch_1_1_performtransformation_greenFFBFFBB(Node n, Assignment b,
			While a) {
		...
		b2d.setTarget(d);
		b2d.setSource(b);
		return new Object[] { d, c, n, a2c, b2d, b, a };
	}

	public static final Object[] pattern_uwhile2ubranch_1_2_collecttranslatedelements_blackBBBBBB(Command d, Branch c,
			S2B a2c, S2N b2d, Assignment b, While a) {
		return new Object[] { d, c, a2c, b2d, b, a };
	}

	public static final Object[] pattern_uwhile2ubranch_1_2_collecttranslatedelements_greenFBBBBBB(Command d, Branch c,
			S2B a2c, S2N b2d, Assignment b, While a) {
		...
		return new Object[] { ruleresult, d, c, a2c, b2d, b, a };
	}

	public static final Object[] pattern_uwhile2ubranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject d, EObject c, EObject s2n, EObject n, EObject a2c, EObject b2d,
			EObject b, EObject s, EObject a) {
		if (!d.equals(s2n)) {
			if (!d.equals(n)) {
				if (!d.equals(s)) {
					if (!c.equals(d)) {
	...
	public static final Object[] pattern_uwhile2ubranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject d, EObject c, EObject n, EObject a2c, EObject b2d, EObject b,
			EObject s, EObject a) {
		...
		s__a____next.setName(s__a____next_name_prime);
		a__b____first.setName(a__b____first_name_prime);
		return new Object[] { ruleresult, d, c, n, a2c, b2d, b, s, a, n__c____next, c__d____positive, a2c__c____target,
				b2d__d____target, b2d__b____source, d__c____next, a__b____last, a2c__a____source, s__a____next,
				a__b____first };
	}
	...
	public static final void pattern_uwhile2ubranch_1_5_registerobjects_expressionBBBBBBBBBBB(uwhile2ubranch _this,
			PerformRuleResult ruleresult, EObject d, EObject c, EObject s2n, EObject n, EObject a2c, EObject b2d,
			EObject b, EObject s, EObject a) {
		_this.registerObjects_FWD(ruleresult, d, c, s2n, n, a2c, b2d, b, s, a);
	...
	public static final Iterable<Object[]> pattern_uwhile2ubranch_2_2_corematch_blackFFBBBB(Assignment b, Statement s,
			While a, Match match) {
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (S2N s2n : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(s, S2N.class,
					...
					if (n != null) {
						_result.add(new Object[] { s2n, n, b, s, a, match });
					}
	...
	public static final Iterable<Object[]> pattern_uwhile2ubranch_2_3_findcontext_blackBBBBB(S2N s2n, Node n,
			Assignment b, Statement s, While a) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!b.equals(s)) {
			if (!a.equals(s)) {
						...
						if (b.equals(a.getLast())) {
							if (a.equals(s.getNext())) {
								if (b.equals(a.getFirst())) {
									_result.add(new Object[] { s2n, n, b, s, a });
								}
							}
						}
					}
	...
	public static final Object[] pattern_uwhile2ubranch_2_3_findcontext_greenBBBBBFFFFFF(S2N s2n, Node n, Assignment b,
			Statement s, While a) {
		...
		s__a____next.setName(s__a____next_name_prime);
		a__b____first.setName(a__b____first_name_prime);
		return new Object[] { s2n, n, b, s, a, isApplicableMatch, s2n__n____target, s2n__s____source, a__b____last,
	...
	public static final Object[] pattern_uwhile2ubranch_2_4_solveCSP_bindingFBBBBBBB(uwhile2ubranch _this,
			IsApplicableMatch isApplicableMatch, S2N s2n, Node n, Assignment b, Statement s, While a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, s2n, n, b, s, a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, s2n, n, b, s, a };
		}
		return null;
	}
	...
	public static final Object[] pattern_uwhile2ubranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(uwhile2ubranch _this,
		...
		Object[] result_pattern_uwhile2ubranch_2_4_solveCSP_binding = pattern_uwhile2ubranch_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, s2n, n, b, s, a);
	...
	public static final Object[] pattern_uwhile2ubranch_10_4_collectelementstobetranslated_greenBBBBFFF(Match match,
		...
		c__d____positive.setName(c__d____positive_name_prime);
		d__c____next.setName(d__c____next_name_prime);
		return new Object[] { match, d, c, n, n__c____next, c__d____positive, d__c____next };
	}
			...
			if (tmpC instanceof Branch) {
				...
				if (tmpS2n instanceof S2N) {
					...
					if (tmpN instanceof Node) {
						...
						if (tmpS instanceof Statement) {
							Statement s = (Statement) tmpS;
							return new Object[] { d, c, s2n, n, s, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_11_1_performtransformation_blackBBBBBFBB(Command d, Branch c,
			S2N s2n, Node n, Statement s, uwhile2ubranch _this, IsApplicableMatch isApplicableMatch) {
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { d, c, s2n, n, s, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_uwhile2ubranch_11_1_performtransformation_binding != null) {
			...
			Statement s = (Statement) result_pattern_uwhile2ubranch_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_uwhile2ubranch_11_1_performtransformation_black = pattern_uwhile2ubranch_11_1_performtransformation_blackBBBBBFBB(
					d, c, s2n, n, s, _this, isApplicableMatch);
	...
	public static final Object[] pattern_uwhile2ubranch_11_1_performtransformation_greenBBFFFBF(Command d, Branch c,
			Statement s) {
		S2B a2c = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N b2d = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		s.setNext(a);
		a.setFirst(b);
		return new Object[] { d, c, a2c, b2d, b, s, a };
	}

	public static final Object[] pattern_uwhile2ubranch_11_2_collecttranslatedelements_blackBBBBBB(Command d, Branch c,
			S2B a2c, S2N b2d, Assignment b, While a) {
		return new Object[] { d, c, a2c, b2d, b, a };
	}

	public static final Object[] pattern_uwhile2ubranch_11_2_collecttranslatedelements_greenFBBBBBB(Command d, Branch c,
			S2B a2c, S2N b2d, Assignment b, While a) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_uwhile2ubranch_11_5_registerobjects_expressionBBBBBBBBBBB(uwhile2ubranch _this,
			PerformRuleResult ruleresult, EObject d, EObject c, EObject s2n, EObject n, EObject a2c, EObject b2d,
			EObject b, EObject s, EObject a) {
		_this.registerObjects_BWD(ruleresult, d, c, s2n, n, a2c, b2d, b, s, a);
	...
	public static final Iterable<Object[]> pattern_uwhile2ubranch_12_2_corematch_blackBBFBFB(Command d, Branch c,
			Node n, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (S2N s2n : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(n, S2N.class,
					...
					if (s != null) {
						_result.add(new Object[] { d, c, s2n, n, s, match });
					}
				...
				if (c.equals(n.getNext())) {
					if (d.equals(c.getPositive())) {
						if (c.equals(d.getNext())) {
							if (n.equals(s2n.getTarget())) {
								if (s.equals(s2n.getSource())) {
									_result.add(new Object[] { d, c, s2n, n, s });
								}
							}
						}
					}
	...
	public static final Object[] pattern_uwhile2ubranch_12_3_findcontext_greenBBBBBFFFFFF(Command d, Branch c, S2N s2n,
			Node n, Statement s) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge n__c____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__d____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		s2n__n____target.setName(s2n__n____target_name_prime);
		s2n__s____source.setName(s2n__s____source_name_prime);
		return new Object[] { d, c, s2n, n, s, isApplicableMatch, n__c____next, c__d____positive, d__c____next,
	...
	public static final Object[] pattern_uwhile2ubranch_12_4_solveCSP_bindingFBBBBBBB(uwhile2ubranch _this,
			IsApplicableMatch isApplicableMatch, Command d, Branch c, S2N s2n, Node n, Statement s) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d, c, s2n, n, s);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d, c, s2n, n, s };
		}
		return null;
	}
	...
	public static final Object[] pattern_uwhile2ubranch_12_4_solveCSP_bindingAndBlackFBBBBBBB(uwhile2ubranch _this,
		...
		Object[] result_pattern_uwhile2ubranch_12_4_solveCSP_binding = pattern_uwhile2ubranch_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, d, c, s2n, n, s);
	...
	public static final Object[] pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_0B(Command d) {
		for (Graph __DEC_d_root_655959 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_1BBB(Command d, Branch c,
		...
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_positive_480023 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "positive")) {
					if (!c.equals(__DEC_d_positive_480023)) {
						if (!n.equals(__DEC_d_positive_480023)) {
	...
	public static final Object[] pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_2BBB(Command d, Branch c,
		...
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_negative_399736 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "negative")) {
					if (!c.equals(__DEC_d_negative_399736)) {
						if (!n.equals(__DEC_d_negative_399736)) {
							return new Object[] { d, c, n };
						}
					}
				}
	...
	public static final Object[] pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_3B(Branch c) {
		for (Graph __DEC_c_root_363216 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Graph.class, "root")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_4BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_positive_929158 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_c_positive_929158)) {
					if (!n.equals(__DEC_c_positive_929158)) {
	...
	public static final Object[] pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_5BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_negative_412205 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_c_negative_412205)) {
					if (!n.equals(__DEC_c_negative_412205)) {
						return new Object[] { c, n };
					}
				}
			}
							...
							if (!d.equals(n)) {
								if (c.equals(d.getNext())) {
									if (pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_3B(c) == null) {
										if (pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_4BB(c,
												n) == null) {
											if (pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_5BB(c,
													n) == null) {
												if (pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_0B(
														d) == null) {
													if (pattern_uwhile2ubranch_20_2_testcorematchandDECs_black_nac_1BBB(
															d, c, n) == null) {
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_0BB(Assignment b,
			Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_positive_582736 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!s.equals(__DEC_b_positive_582736)) {
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_1BB(Assignment b,
			Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_negative_956236 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "negative")) {
				if (!s.equals(__DEC_b_negative_956236)) {
					return new Object[] { b, s };
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_2BBB(Assignment b,
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (While __DEC_b_last_838425 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
						While.class, "last")) {
					if (!s.equals(__DEC_b_last_838425)) {
						if (!a.equals(__DEC_b_last_838425)) {
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_3B(Assignment b) {
		for (Program __DEC_b_first_909229 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_4BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_positive_910563 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "positive")) {
				if (!s.equals(__DEC_a_positive_910563)) {
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_5BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_negative_41748 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					Decision.class, "negative")) {
				if (!s.equals(__DEC_a_negative_41748)) {
					return new Object[] { a, s };
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_6BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_first_926137 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "first")) {
				if (!a.equals(__DEC_a_first_926137)) {
					if (!s.equals(__DEC_a_first_926137)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_7BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_last_51457 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_51457)) {
					if (!s.equals(__DEC_a_last_51457)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_21_2_testcorematchandDECs_black_nac_8B(While a) {
		for (Program __DEC_a_first_139521 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
				...
				if (tmpN instanceof Node) {
					...
					if (tmpB instanceof Assignment) {
						...
						if (tmpS instanceof Statement) {
							...
							if (tmpA instanceof While) {
								While a = (While) tmpA;
								return new Object[] { d, c, n, b, s, a, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_uwhile2ubranch_24_2_matchsrctrgcontext_blackBBBBBBBB(Command d, Branch c,
			Node n, Assignment b, Statement s, While a, Match sourceMatch, Match targetMatch) {
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				if (!b.equals(s)) {
					if (!a.equals(s)) {
						if (!sourceMatch.equals(targetMatch)) {
							return new Object[] { d, c, n, b, s, a, sourceMatch, targetMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_uwhile2ubranch_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_uwhile2ubranch_24_2_matchsrctrgcontext_black = pattern_uwhile2ubranch_24_2_matchsrctrgcontext_blackBBBBBBBB(
					d, c, n, b, s, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_uwhile2ubranch_24_3_solvecsp_bindingFBBBBBBBBB(uwhile2ubranch _this, Command d,
			Branch c, Node n, Assignment b, Statement s, While a, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(d, c, n, b, s, a, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, d, c, n, b, s, a, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_uwhile2ubranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(uwhile2ubranch _this,
			Command d, Branch c, Node n, Assignment b, Statement s, While a, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_uwhile2ubranch_24_3_solvecsp_binding = pattern_uwhile2ubranch_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, d, c, n, b, s, a, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_uwhile2ubranch_24_5_matchcorrcontext_blackFBBBB(Node n, Statement s,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_uwhile2ubranch_24_6_createcorrespondence_blackBBBBBBB(Command d, Branch c,
			Node n, Assignment b, Statement s, While a, CCMatch ccMatch) {
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				if (!b.equals(s)) {
					if (!a.equals(s)) {
						return new Object[] { d, c, n, b, s, a, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_24_6_createcorrespondence_greenBBFFBBB(Command d, Branch c,
		...
		return new Object[] { d, c, a2c, b2d, b, a, ccMatch };
	}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_0BB(Assignment b, Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_positive_784629 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!s.equals(__DEC_b_positive_784629)) {
					return new Object[] { b, s };
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_1BB(Assignment b, Statement s) {
		if (!b.equals(s)) {
			for (Decision __DEC_b_negative_652588 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "negative")) {
				if (!s.equals(__DEC_b_negative_652588)) {
					return new Object[] { b, s };
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_2BBB(Assignment b, Statement s,
		...
		if (!b.equals(s)) {
			if (!a.equals(s)) {
				for (While __DEC_b_last_726637 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
						While.class, "last")) {
					if (!s.equals(__DEC_b_last_726637)) {
						if (!a.equals(__DEC_b_last_726637)) {
							return new Object[] { b, s, a };
						}
					}
				}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_3B(Assignment b) {
		for (Program __DEC_b_first_295771 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_4BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_positive_988339 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "positive")) {
				if (!s.equals(__DEC_a_positive_988339)) {
					return new Object[] { a, s };
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_5BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (Decision __DEC_a_negative_382370 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!s.equals(__DEC_a_negative_382370)) {
					return new Object[] { a, s };
				}
			}
		}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_6BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_first_745974 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "first")) {
				if (!a.equals(__DEC_a_first_745974)) {
					if (!s.equals(__DEC_a_first_745974)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_7BB(While a, Statement s) {
		if (!a.equals(s)) {
			for (While __DEC_a_last_881935 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_881935)) {
					if (!s.equals(__DEC_a_last_881935)) {
						return new Object[] { a, s };
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_27_1_matchtggpattern_black_nac_8B(While a) {
		for (Program __DEC_a_first_187686 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_28_1_matchtggpattern_black_nac_0B(Command d) {
		for (Graph __DEC_d_root_402273 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Graph.class, "root")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_28_1_matchtggpattern_black_nac_1BBB(Command d, Branch c,
		...
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_positive_825048 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "positive")) {
					if (!c.equals(__DEC_d_positive_825048)) {
						if (!n.equals(__DEC_d_positive_825048)) {
							return new Object[] { d, c, n };
						}
					}
				}
	...
	public static final Object[] pattern_uwhile2ubranch_28_1_matchtggpattern_black_nac_2BBB(Command d, Branch c,
		...
		if (!d.equals(n)) {
			if (!c.equals(n)) {
				for (Branch __DEC_d_negative_13758 : org.moflon.core.utilities.eMoflonEMFUtil
						.getOppositeReferenceTyped(d, Branch.class, "negative")) {
					if (!c.equals(__DEC_d_negative_13758)) {
						if (!n.equals(__DEC_d_negative_13758)) {
							return new Object[] { d, c, n };
						}
					}
				}
	...
	public static final Object[] pattern_uwhile2ubranch_28_1_matchtggpattern_black_nac_3B(Branch c) {
		for (Graph __DEC_c_root_226996 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Graph.class, "root")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_uwhile2ubranch_28_1_matchtggpattern_black_nac_4BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_positive_868500 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_c_positive_868500)) {
					if (!n.equals(__DEC_c_positive_868500)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_uwhile2ubranch_28_1_matchtggpattern_black_nac_5BB(Branch c, Node n) {
		if (!c.equals(n)) {
			for (Branch __DEC_c_negative_917254 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_c_negative_917254)) {
					if (!n.equals(__DEC_c_negative_917254)) {
						return new Object[] { c, n };
					}
				}
			}
			...
			for (EObject tmpS2n : s2nList.getEntryObjects()) {
				if (tmpS2n instanceof S2N) {
					...
					if (n != null) {
						Statement s = s2n.getSource();
						if (s != null) {
							if (pattern_uwhile2ubranch_29_2_isapplicablecore_black_nac_0BB(ruleResult, s2n) == null) {
								if (pattern_uwhile2ubranch_29_2_isapplicablecore_black_nac_1BB(ruleResult, n) == null) {
	...
	public static final Object[] pattern_uwhile2ubranch_29_5_checknacs_blackBBB(S2N s2n, Node n, Statement s) {
		return new Object[] { s2n, n, s };
	}

	public static final Object[] pattern_uwhile2ubranch_29_6_perform_blackBBBB(S2N s2n, Node n, Statement s,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { s2n, n, s, ruleResult };
	}

	public static final Object[] pattern_uwhile2ubranch_29_6_perform_greenFFBFFFBFB(Node n, Statement s,
			ModelgeneratorRuleResult ruleResult) {
		Command d = ControlflowFactory.eINSTANCE.createCommand();
		Branch c = ControlflowFactory.eINSTANCE.createBranch();
		S2B a2c = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		return new Object[] { d, c, n, a2c, b2d, b, s, a, ruleResult };
	}
