...
public class whilell2branchbbImpl extends AbstractRuleImpl implements whilell2branchbb {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While a, Assignment b, Assignment d, While c, While w) {
		...
		Object[] result2_bindingAndBlack = whilell2branchbbImpl
				.pattern_whilell2branchbb_0_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, a, b, d, c, w);
		...
		if (whilell2branchbbImpl.pattern_whilell2branchbb_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whilell2branchbbImpl
					.pattern_whilell2branchbb_0_4_collectelementstobetranslated_blackBBBBBB(match, a, b, d, c, w);
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[a] = " + a + ", "
								+ "[b] = " + b + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[w] = " + w + ".");
			}
			whilell2branchbbImpl.pattern_whilell2branchbb_0_4_collectelementstobetranslated_greenBBBBBBFFFF(match, a, b,
					d, c, w);
			...
			Object[] result5_black = whilell2branchbbImpl
					.pattern_whilell2branchbb_0_5_collectcontextelements_blackBBBBBB(match, a, b, d, c, w);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whilell2branchbbImpl
				.pattern_whilell2branchbb_1_1_performtransformation_greenFBBBFFFFBFBFF(a, i, b, d, c);
		...
		Object[] result2_black = whilell2branchbbImpl
				.pattern_whilell2branchbb_1_2_collecttranslatedelements_blackBBBBBBBBBBBB(c2z, a, b, a2x, d2v, z, y, d,
						x, c, v, b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[c2z] = " + c2z + ", " + "[a] = "
					+ a + ", " + "[b] = " + b + ", " + "[a2x] = " + a2x + ", " + "[d2v] = " + d2v + ", " + "[z] = " + z
					+ ", " + "[y] = " + y + ", " + "[d] = " + d + ", " + "[x] = " + x + ", " + "[c] = " + c + ", "
					+ "[v] = " + v + ", " + "[b2y] = " + b2y + ".");
		}
		Object[] result2_green = whilell2branchbbImpl
				.pattern_whilell2branchbb_1_2_collecttranslatedelements_greenFBBBBBBBBBBBB(c2z, a, b, a2x, d2v, z, y, d,
						x, c, v, b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whilell2branchbbImpl
				.pattern_whilell2branchbb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(ruleresult, c2z, a, i, b, a2x,
						d2v, z, y, d, x, c, v, w2i, w, b2y);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2z] = " + c2z + ", " + "[a] = " + a + ", " + "[i] = " + i + ", " + "[b] = " + b + ", "
					+ "[a2x] = " + a2x + ", " + "[d2v] = " + d2v + ", " + "[z] = " + z + ", " + "[y] = " + y + ", "
					+ "[d] = " + d + ", " + "[x] = " + x + ", " + "[c] = " + c + ", " + "[v] = " + v + ", " + "[w2i] = "
					+ w2i + ", " + "[w] = " + w + ", " + "[b2y] = " + b2y + ".");
		}
		whilell2branchbbImpl.pattern_whilell2branchbb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFF(
				ruleresult, c2z, a, i, b, a2x, d2v, z, y, d, x, c, v, w, b2y);
		...
		//nothing EMoflonEdge d2v__v____target = (EMoflonEdge) result3_green[23];
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whilell2branchbbImpl.pattern_whilell2branchbb_2_2_corematch_blackBFBBBFBB(a, b, d,
				c, w, match)) {
			...
			for (Object[] result3_black : whilell2branchbbImpl.pattern_whilell2branchbb_2_3_findcontext_blackBBBBBBB(a,
				...
				Object[] result3_green = whilell2branchbbImpl
						.pattern_whilell2branchbb_2_3_findcontext_greenBBBBBBBFFFFFFF(a, i, b, d, c, w2i, w);
				...
				Object[] result4_bindingAndBlack = whilell2branchbbImpl
						.pattern_whilell2branchbb_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, a, i,
								b, d, c, w2i, w);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While a, Assignment b, Assignment d, While c, While w) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While a, Assignment b, Assignment d, While c, While w) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While a, Branch i, Assignment b,
			Assignment d, While c, S2B w2i, While w) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2z, EObject a, EObject i, EObject b,
			EObject a2x, EObject d2v, EObject z, EObject y, EObject d, EObject x, EObject c, EObject v, EObject w2i,
	...
	public boolean isAppropriate_BWD(Match match, Branch i, Branch z, Command y, Branch x, Command v) {
		...
		Object[] result2_bindingAndBlack = whilell2branchbbImpl
				.pattern_whilell2branchbb_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, i, z, y, x, v);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[i] = " + i + ", " + "[z] = " + z + ", " + "[y] = " + y + ", "
					+ "[x] = " + x + ", " + "[v] = " + v + ".");
		...
		if (whilell2branchbbImpl.pattern_whilell2branchbb_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whilell2branchbbImpl
					.pattern_whilell2branchbb_10_4_collectelementstobetranslated_blackBBBBBB(match, i, z, y, x, v);
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[i] = " + i + ", "
								+ "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[v] = " + v + ".");
			}
			whilell2branchbbImpl.pattern_whilell2branchbb_10_4_collectelementstobetranslated_greenBBBBBBFFFF(match, i,
					z, y, x, v);
			...
			Object[] result5_black = whilell2branchbbImpl
					.pattern_whilell2branchbb_10_5_collectcontextelements_blackBBBBBB(match, i, z, y, x, v);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[i] = " + i + ", "
								+ "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[v] = " + v + ".");
			...
			// 
			whilell2branchbbImpl.pattern_whilell2branchbb_10_6_registerobjectstomatch_expressionBBBBBBB(this, match, i,
					z, y, x, v);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = whilell2branchbbImpl
				.pattern_whilell2branchbb_11_1_performtransformation_greenFFFFFBBFBFBBF(z, y, x, v, w);
		S2B c2z = (S2B) result1_green[0];
		...
		Object[] result2_black = whilell2branchbbImpl
				.pattern_whilell2branchbb_11_2_collecttranslatedelements_blackBBBBBBBBBBBB(c2z, a, b, a2x, d2v, z, y, d,
						x, c, v, b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[c2z] = " + c2z + ", " + "[a] = "
					+ a + ", " + "[b] = " + b + ", " + "[a2x] = " + a2x + ", " + "[d2v] = " + d2v + ", " + "[z] = " + z
		...
		Object[] result2_green = whilell2branchbbImpl
				.pattern_whilell2branchbb_11_2_collecttranslatedelements_greenFBBBBBBBBBBBB(c2z, a, b, a2x, d2v, z, y,
						d, x, c, v, b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whilell2branchbbImpl
				.pattern_whilell2branchbb_11_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(ruleresult, c2z, a, i, b, a2x,
						d2v, z, y, d, x, c, v, w2i, w, b2y);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2z] = " + c2z + ", " + "[a] = " + a + ", " + "[i] = " + i + ", " + "[b] = " + b + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whilell2branchbbImpl.pattern_whilell2branchbb_12_2_corematch_blackBBBBBFFB(i, z,
				y, x, v, match)) {
			S2B w2i = (S2B) result2_black[5];
			While w = (While) result2_black[6];
			// ForEach 
			for (Object[] result3_black : whilell2branchbbImpl.pattern_whilell2branchbb_12_3_findcontext_blackBBBBBBB(i,
					z, y, x, v, w2i, w)) {
				Object[] result3_green = whilell2branchbbImpl
						.pattern_whilell2branchbb_12_3_findcontext_greenBBBBBBBFFFFFFF(i, z, y, x, v, w2i, w);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = whilell2branchbbImpl
						.pattern_whilell2branchbb_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, i, z,
								y, x, v, w2i, w);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch i, Branch z, Command y, Branch x,
			Command v, S2B w2i, While w) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2z, EObject a, EObject i, EObject b,
			EObject a2x, EObject d2v, EObject z, EObject y, EObject d, EObject x, EObject c, EObject v, EObject w2i,
			EObject w, EObject b2y) {
		ruleresult.registerObject("c2z", c2z);
		ruleresult.registerObject("a", a);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_271(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_279(EMoflonEdge _edge_last) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whilell2branchbbImpl
				.pattern_whilell2branchbb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBB(this, a, i, b, z, y, d, x, c, v,
		...
		if (whilell2branchbbImpl.pattern_whilell2branchbb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whilell2branchbbImpl
					.pattern_whilell2branchbb_24_5_matchcorrcontext_blackBFBBB(i, w, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = whilell2branchbbImpl
						.pattern_whilell2branchbb_24_6_createcorrespondence_blackBBBBBBBBBBB(a, i, b, z, y, d, x, c, v,
								w, ccMatch);
				if (result6_black == null) {
				...
				whilell2branchbbImpl.pattern_whilell2branchbb_24_6_createcorrespondence_greenFBBFFBBBBBBFB(a, b, z, y,
						d, x, c, v, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(While a, Branch i, Assignment b, Branch z, Command y, Assignment d, Branch x,
			While c, Command v, While w, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While a, Assignment b, Assignment d, While c, While w) {// 
		Object[] result1_black = whilell2branchbbImpl.pattern_whilell2branchbb_27_1_matchtggpattern_blackBBBBB(a, b, d,
				c, w);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(Branch i, Branch z, Command y, Branch x, Command v) {// 
		Object[] result1_black = whilell2branchbbImpl.pattern_whilell2branchbb_28_1_matchtggpattern_blackBBBBB(i, z, y,
				x, v);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B w2iParameter) {
		...
		for (Object[] result2_black : whilell2branchbbImpl
			...
			Object[] result3_bindingAndBlack = whilell2branchbbImpl
					.pattern_whilell2branchbb_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, i, w2i, w,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (whilell2branchbbImpl.pattern_whilell2branchbb_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = whilell2branchbbImpl.pattern_whilell2branchbb_29_5_checknacs_blackBBB(i, w2i,
						w);
				if (result5_black != null) {

					Object[] result6_black = whilell2branchbbImpl.pattern_whilell2branchbb_29_6_perform_blackBBBB(i,
							w2i, w, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[i] = " + i + ", "
								+ "[w2i] = " + w2i + ", " + "[w] = " + w + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					whilell2branchbbImpl.pattern_whilell2branchbb_29_6_perform_greenFFBFFFFFFFFFBFB(i, w, ruleResult);
					//nothing S2B c2z = (S2B) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.WHILELL2BRANCHBB___IS_APPROPRIATE_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_WHILE_WHILE:
		...
		case RulesPackage.WHILELL2BRANCHBB___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_WHILE_WHILE:
			...
			return null;
		case RulesPackage.WHILELL2BRANCHBB___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_WHILE_WHILE:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (While) arguments.get(1),
					(Assignment) arguments.get(2), (Assignment) arguments.get(3), (While) arguments.get(4),
					(While) arguments.get(5));
		case RulesPackage.WHILELL2BRANCHBB___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.WHILELL2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_BRANCH_ASSIGNMENT_ASSIGNMENT_WHILE_S2B_WHILE:
		...
		case RulesPackage.WHILELL2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_BRANCH_COMMAND_BRANCH_COMMAND_S2B_WHILE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Branch) arguments.get(1),
					(Branch) arguments.get(2), (Command) arguments.get(3), (Branch) arguments.get(4),
					(Command) arguments.get(5), (S2B) arguments.get(6), (While) arguments.get(7));
		...
		case RulesPackage.WHILELL2BRANCHBB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_271__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_271((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILELL2BRANCHBB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_279__EMOFLONEDGE:
		...
		case RulesPackage.WHILELL2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_CC__WHILE_BRANCH_ASSIGNMENT_BRANCH_COMMAND_ASSIGNMENT_BRANCH_WHILE_COMMAND_WHILE_MATCH_MATCH:
		...
		case RulesPackage.WHILELL2BRANCHBB___CHECK_DEC_FWD__WHILE_ASSIGNMENT_ASSIGNMENT_WHILE_WHILE:
		...
		case RulesPackage.WHILELL2BRANCHBB___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_S2B_WHILE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_whilell2branchbb_0_1_initialbindings_blackBBBBBBB(whilell2branchbb _this,
			Match match, While a, Assignment b, Assignment d, While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!b.equals(d)) {
					if (!c.equals(w)) {
						return new Object[] { _this, match, a, b, d, c, w };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whilell2branchbb_0_2_SolveCSP_bindingFBBBBBBB(whilell2branchbb _this,
			Match match, While a, Assignment b, Assignment d, While c, While w) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, a, b, d, c, w);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, a, b, d, c, w };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilell2branchbb_0_4_collectelementstobetranslated_blackBBBBBB(Match match,
			While a, Assignment b, Assignment d, While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!b.equals(d)) {
					if (!c.equals(w)) {
						return new Object[] { match, a, b, d, c, w };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whilell2branchbb_0_4_collectelementstobetranslated_greenBBBBBBFFFF(Match match,
		...
		return new Object[] { match, a, b, d, c, w, a__b____last, c__d____last, w__c____next, w__a____first };
	}

	public static final Object[] pattern_whilell2branchbb_0_5_collectcontextelements_blackBBBBBB(Match match, While a,
			Assignment b, Assignment d, While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!b.equals(d)) {
					if (!c.equals(w)) {
	...
	public static final void pattern_whilell2branchbb_0_6_registerobjectstomatch_expressionBBBBBBB(
			whilell2branchbb _this, Match match, While a, Assignment b, Assignment d, While c, While w) {
		_this.registerObjectsToMatch_FWD(match, a, b, d, c, w);
						...
						if (tmpC instanceof While) {
							...
							if (tmpW2i instanceof S2B) {
								...
								if (tmpW instanceof While) {
									While w = (While) tmpW;
									return new Object[] { a, i, b, d, c, w2i, w, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_whilell2branchbb_1_1_performtransformation_blackBBBBBBBFBB(While a, Branch i,
			Assignment b, Assignment d, While c, S2B w2i, While w, whilell2branchbb _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!b.equals(d)) {
					if (!c.equals(w)) {
						for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
							if (tmpCsp instanceof CSP) {
								CSP csp = (CSP) tmpCsp;
								return new Object[] { a, i, b, d, c, w2i, w, csp, _this, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whilell2branchbb_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_whilell2branchbb_1_1_performtransformation_binding != null) {
			...
			Branch i = (Branch) result_pattern_whilell2branchbb_1_1_performtransformation_binding[1];
			Assignment b = (Assignment) result_pattern_whilell2branchbb_1_1_performtransformation_binding[2];
			Assignment d = (Assignment) result_pattern_whilell2branchbb_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_whilell2branchbb_1_1_performtransformation_black = pattern_whilell2branchbb_1_1_performtransformation_blackBBBBBBBFBB(
					a, i, b, d, c, w2i, w, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whilell2branchbb_1_1_performtransformation_greenFBBBFFFFBFBFF(While a,
		...
		b2y.setSource(b);
		b2y.setTarget(y);
		return new Object[] { c2z, a, i, b, a2x, d2v, z, y, d, x, c, v, b2y };
	}

	public static final Object[] pattern_whilell2branchbb_1_2_collecttranslatedelements_blackBBBBBBBBBBBB(S2B c2z,
			While a, Assignment b, S2B a2x, S2N d2v, Branch z, Command y, Assignment d, Branch x, While c, Command v,
			S2N b2y) {
		if (!a.equals(c)) {
			if (!b.equals(d)) {
				if (!a2x.equals(c2z)) {
					if (!x.equals(z)) {
						if (!v.equals(y)) {
							if (!b2y.equals(d2v)) {
								return new Object[] { c2z, a, b, a2x, d2v, z, y, d, x, c, v, b2y };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whilell2branchbb_1_2_collecttranslatedelements_greenFBBBBBBBBBBBB(S2B c2z,
			While a, Assignment b, S2B a2x, S2N d2v, Branch z, Command y, Assignment d, Branch x, While c, Command v,
			S2N b2y) {
		...
		return new Object[] { ruleresult, c2z, a, b, a2x, d2v, z, y, d, x, c, v, b2y };
	}

	public static final Object[] pattern_whilell2branchbb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject c2z, EObject a, EObject i, EObject b, EObject a2x, EObject d2v,
			EObject z, EObject y, EObject d, EObject x, EObject c, EObject v, EObject w2i, EObject w, EObject b2y) {
		if (!c2z.equals(i)) {
			if (!c2z.equals(d2v)) {
				if (!c2z.equals(z)) {
					if (!c2z.equals(y)) {
	...
	public static final Object[] pattern_whilell2branchbb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject c2z, EObject a, EObject i, EObject b, EObject a2x, EObject d2v,
			EObject z, EObject y, EObject d, EObject x, EObject c, EObject v, EObject w, EObject b2y) {
		...
		return new Object[] { ruleresult, c2z, a, i, b, a2x, d2v, z, y, d, x, c, v, w, b2y, a2x__a____source,
				a__b____last, i__x____positive, c2z__z____target, d2v__d____source, a2x__x____target, c__d____last,
				c2z__c____source, d2v__v____target, w__c____next, y__x____next, v__z____next, w__a____first,
				b2y__b____source, b2y__y____target, i__z____negative };
	}

	public static final void pattern_whilell2branchbb_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
			whilell2branchbb _this, PerformRuleResult ruleresult, EObject c2z, EObject a, EObject i, EObject b,
			EObject a2x, EObject d2v, EObject z, EObject y, EObject d, EObject x, EObject c, EObject v, EObject w2i,
			EObject w, EObject b2y) {
		_this.registerObjects_FWD(ruleresult, c2z, a, i, b, a2x, d2v, z, y, d, x, c, v, w2i, w, b2y);
			...
			if (tmpB instanceof Assignment) {
				...
				if (tmpD instanceof Assignment) {
					...
					if (tmpC instanceof While) {
						...
						if (tmpW instanceof While) {
							While w = (While) tmpW;
							return new Object[] { a, b, d, c, w, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_whilell2branchbb_2_2_corematch_blackBFBBBFBB(While a, Assignment b,
			Assignment d, While c, While w, Match match) {
				...
				if (!b.equals(d)) {
					if (!c.equals(w)) {
						for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class,
							...
							if (i != null) {
								_result.add(new Object[] { a, i, b, d, c, w2i, w, match });
							}
	...
	public static final Iterable<Object[]> pattern_whilell2branchbb_2_3_findcontext_blackBBBBBBB(While a, Branch i,
			Assignment b, Assignment d, While c, S2B w2i, While w) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!b.equals(d)) {
									...
									if (w.equals(w2i.getSource())) {
										if (a.equals(w.getFirst())) {
											if (i.equals(w2i.getTarget())) {
												_result.add(new Object[] { a, i, b, d, c, w2i, w });
											}
										}
									}
								}
	...
	public static final Object[] pattern_whilell2branchbb_2_3_findcontext_greenBBBBBBBFFFFFFF(While a, Branch i,
			Assignment b, Assignment d, While c, S2B w2i, While w) {
		...
		return new Object[] { a, i, b, d, c, w2i, w, isApplicableMatch, a__b____last, c__d____last, w__c____next,
				w2i__w____source, w__a____first, w2i__i____target };
	}

	public static final Object[] pattern_whilell2branchbb_2_4_solveCSP_bindingFBBBBBBBBB(whilell2branchbb _this,
			IsApplicableMatch isApplicableMatch, While a, Branch i, Assignment b, Assignment d, While c, S2B w2i,
			While w) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, a, i, b, d, c, w2i, w);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, a, i, b, d, c, w2i, w };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilell2branchbb_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(whilell2branchbb _this,
		...
		Object[] result_pattern_whilell2branchbb_2_4_solveCSP_binding = pattern_whilell2branchbb_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, a, i, b, d, c, w2i, w);
	...
	public static final Object[] pattern_whilell2branchbb_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		v__z____next.setName(v__z____next_name_prime);
		i__z____negative.setName(i__z____negative_name_prime);
		return new Object[] { match, i, z, y, x, v, i__x____positive, y__x____next, v__z____next, i__z____negative };
	}

	public static final Object[] pattern_whilell2branchbb_10_5_collectcontextelements_blackBBBBBB(Match match, Branch i,
			Branch z, Command y, Branch x, Command v) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					if (!v.equals(y)) {
	...
	public static final void pattern_whilell2branchbb_10_6_registerobjectstomatch_expressionBBBBBBB(
			whilell2branchbb _this, Match match, Branch i, Branch z, Command y, Branch x, Command v) {
					...
					if (tmpX instanceof Branch) {
						...
						if (tmpV instanceof Command) {
							...
							if (tmpW2i instanceof S2B) {
								...
								if (tmpW instanceof While) {
									While w = (While) tmpW;
									return new Object[] { i, z, y, x, v, w2i, w, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_whilell2branchbb_11_1_performtransformation_blackBBBBBBBFBB(Branch i, Branch z,
			Command y, Branch x, Command v, S2B w2i, While w, whilell2branchbb _this,
			IsApplicableMatch isApplicableMatch) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					if (!v.equals(y)) {
						for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
							if (tmpCsp instanceof CSP) {
								CSP csp = (CSP) tmpCsp;
								return new Object[] { i, z, y, x, v, w2i, w, csp, _this, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whilell2branchbb_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_whilell2branchbb_11_1_performtransformation_binding != null) {
			Branch i = (Branch) result_pattern_whilell2branchbb_11_1_performtransformation_binding[0];
			...
			Command v = (Command) result_pattern_whilell2branchbb_11_1_performtransformation_binding[4];
			S2B w2i = (S2B) result_pattern_whilell2branchbb_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_whilell2branchbb_11_1_performtransformation_black = pattern_whilell2branchbb_11_1_performtransformation_blackBBBBBBBFBB(
					i, z, y, x, v, w2i, w, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whilell2branchbb_11_1_performtransformation_greenFFFFFBBFBFBBF(Branch z,
			Command y, Branch x, Command v, While w) {
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		b2y.setSource(b);
		b2y.setTarget(y);
		return new Object[] { c2z, a, b, a2x, d2v, z, y, d, x, c, v, w, b2y };
	}

	public static final Object[] pattern_whilell2branchbb_11_2_collecttranslatedelements_blackBBBBBBBBBBBB(S2B c2z,
			While a, Assignment b, S2B a2x, S2N d2v, Branch z, Command y, Assignment d, Branch x, While c, Command v,
			S2N b2y) {
		if (!a.equals(c)) {
			if (!b.equals(d)) {
	...
	public static final Object[] pattern_whilell2branchbb_11_2_collecttranslatedelements_greenFBBBBBBBBBBBB(S2B c2z,
			While a, Assignment b, S2B a2x, S2N d2v, Branch z, Command y, Assignment d, Branch x, While c, Command v,
			S2N b2y) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(c2z);
	...
	public static final void pattern_whilell2branchbb_11_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
			...
			EObject a2x, EObject d2v, EObject z, EObject y, EObject d, EObject x, EObject c, EObject v, EObject w2i,
			EObject w, EObject b2y) {
		_this.registerObjects_BWD(ruleresult, c2z, a, i, b, a2x, d2v, z, y, d, x, c, v, w2i, w, b2y);
	...
	public static final Iterable<Object[]> pattern_whilell2branchbb_12_2_corematch_blackBBBBBFFB(Branch i, Branch z,
				...
				if (!x.equals(z)) {
					if (!v.equals(y)) {
						for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(i, S2B.class,
							...
							if (tmpW instanceof While) {
								While w = (While) tmpW;
								_result.add(new Object[] { i, z, y, x, v, w2i, w, match });
							}
	...
	public static final Iterable<Object[]> pattern_whilell2branchbb_12_3_findcontext_blackBBBBBBB(Branch i, Branch z,
			Command y, Branch x, Command v, S2B w2i, While w) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
								...
								if (x.equals(y.getNext())) {
									if (z.equals(v.getNext())) {
										if (z.equals(i.getNegative())) {
											if (i.equals(w2i.getTarget())) {
												_result.add(new Object[] { i, z, y, x, v, w2i, w });
											}
										}
									}
								}
	...
	public static final Object[] pattern_whilell2branchbb_12_3_findcontext_greenBBBBBBBFFFFFFF(Branch i, Branch z,
			Command y, Branch x, Command v, S2B w2i, While w) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge i__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge w2i__w____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		i__z____negative.setName(i__z____negative_name_prime);
		w2i__i____target.setName(w2i__i____target_name_prime);
		return new Object[] { i, z, y, x, v, w2i, w, isApplicableMatch, i__x____positive, w2i__w____source,
				y__x____next, v__z____next, i__z____negative, w2i__i____target };
	}

	public static final Object[] pattern_whilell2branchbb_12_4_solveCSP_bindingFBBBBBBBBB(whilell2branchbb _this,
			IsApplicableMatch isApplicableMatch, Branch i, Branch z, Command y, Branch x, Command v, S2B w2i, While w) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, i, z, y, x, v, w2i, w);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, i, z, y, x, v, w2i, w };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilell2branchbb_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			whilell2branchbb _this, IsApplicableMatch isApplicableMatch, Branch i, Branch z, Command y, Branch x,
		...
		Object[] result_pattern_whilell2branchbb_12_4_solveCSP_binding = pattern_whilell2branchbb_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, i, z, y, x, v, w2i, w);
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_0B(Branch z) {
		for (Graph __DEC_z_root_944146 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_1BBB(Branch z, Branch i,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_positive_154729 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!z.equals(__DEC_z_positive_154729)) {
							if (!i.equals(__DEC_z_positive_154729)) {
								if (!x.equals(__DEC_z_positive_154729)) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_2BBB(Branch z, Branch i,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_negative_422423 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!z.equals(__DEC_z_negative_422423)) {
							if (!i.equals(__DEC_z_negative_422423)) {
								if (!x.equals(__DEC_z_negative_422423)) {
									return new Object[] { z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_3B(Command y) {
		for (Graph __DEC_y_root_151318 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_4BBBB(Command y, Branch i,
			Branch z, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_positive_521472 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!i.equals(__DEC_y_positive_521472)) {
							if (!z.equals(__DEC_y_positive_521472)) {
								if (!x.equals(__DEC_y_positive_521472)) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_5BBBB(Command y, Branch i,
			Branch z, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_negative_927513 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!i.equals(__DEC_y_negative_927513)) {
							if (!z.equals(__DEC_y_negative_927513)) {
								if (!x.equals(__DEC_y_negative_927513)) {
									return new Object[] { y, i, z, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_538181 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_7BBB(Branch x, Branch i,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_positive_30466 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_30466)) {
							if (!i.equals(__DEC_x_positive_30466)) {
								if (!z.equals(__DEC_x_positive_30466)) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_8BBB(Branch x, Branch i,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_negative_509315 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_509315)) {
							if (!i.equals(__DEC_x_negative_509315)) {
								if (!z.equals(__DEC_x_negative_509315)) {
									return new Object[] { x, i, z };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_9B(Command v) {
		for (Graph __DEC_v_root_45958 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(v,
				Graph.class, "root")) {
			return new Object[] { v };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_10BBBB(Command v,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_v_positive_876505 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(v, Branch.class, "positive")) {
						if (!i.equals(__DEC_v_positive_876505)) {
							if (!z.equals(__DEC_v_positive_876505)) {
								if (!x.equals(__DEC_v_positive_876505)) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_11BBBB(Command v,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_v_negative_884907 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(v, Branch.class, "negative")) {
						if (!i.equals(__DEC_v_negative_884907)) {
							if (!z.equals(__DEC_v_negative_884907)) {
								if (!x.equals(__DEC_v_negative_884907)) {
									return new Object[] { v, i, z, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_12BB(Branch i, Branch z) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_21BB(Branch z, Branch x) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_24BB(Branch x,
			Command v) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_26BB(Branch z,
			Command v) {
	...
	public static final Object[] pattern_whilell2branchbb_20_2_testcorematchandDECs_black_nac_27BB(Branch x,
			Command v) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_0B(While a) {
		for (Decision __DEC_a_positive_719993 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_1B(While a) {
		for (Decision __DEC_a_negative_498466 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_2BBB(While a, While c,
		...
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_a_last_603022 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(a, While.class, "last")) {
						if (!a.equals(__DEC_a_last_603022)) {
							if (!c.equals(__DEC_a_last_603022)) {
								if (!w.equals(__DEC_a_last_603022)) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_3B(While a) {
		for (Program __DEC_a_first_85353 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_4B(Assignment b) {
		for (Decision __DEC_b_positive_579944 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_5B(Assignment b) {
		for (Decision __DEC_b_negative_699552 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_6BBBB(Assignment b,
			While a, While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_b_first_285535 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, While.class, "first")) {
						if (!a.equals(__DEC_b_first_285535)) {
							if (!c.equals(__DEC_b_first_285535)) {
								if (!w.equals(__DEC_b_first_285535)) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_7BBBB(Assignment b,
		...
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_b_last_467349 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, While.class, "last")) {
						if (!a.equals(__DEC_b_last_467349)) {
							if (!c.equals(__DEC_b_last_467349)) {
								if (!w.equals(__DEC_b_last_467349)) {
									return new Object[] { b, a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_8B(Assignment b) {
		for (Program __DEC_b_first_113169 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_9B(Assignment d) {
		for (Decision __DEC_d_positive_939979 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "positive")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_10B(Assignment d) {
		for (Decision __DEC_d_negative_723892 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "negative")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_11BBBB(Assignment d,
		...
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_d_first_18127 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(d, While.class, "first")) {
						if (!a.equals(__DEC_d_first_18127)) {
							if (!c.equals(__DEC_d_first_18127)) {
								if (!w.equals(__DEC_d_first_18127)) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_12BBBB(Assignment d,
		...
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_d_last_423420 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(d, While.class, "last")) {
						if (!a.equals(__DEC_d_last_423420)) {
							if (!c.equals(__DEC_d_last_423420)) {
								if (!w.equals(__DEC_d_last_423420)) {
									return new Object[] { d, a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_13B(Assignment d) {
		for (Program __DEC_d_first_955205 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Program.class, "first")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_14B(While c) {
		for (Decision __DEC_c_positive_327316 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_15B(While c) {
		for (Decision __DEC_c_negative_477300 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_16BBB(While c, While a,
			While w) {
		if (!c.equals(w)) {
			if (!a.equals(c)) {
				if (!a.equals(w)) {
					for (While __DEC_c_first_780300 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(c, While.class, "first")) {
						if (!c.equals(__DEC_c_first_780300)) {
							if (!a.equals(__DEC_c_first_780300)) {
								if (!w.equals(__DEC_c_first_780300)) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_17BBB(While c, While a,
			While w) {
		if (!c.equals(w)) {
			if (!a.equals(c)) {
				if (!a.equals(w)) {
					for (While __DEC_c_last_236526 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(c, While.class, "last")) {
						if (!c.equals(__DEC_c_last_236526)) {
							if (!a.equals(__DEC_c_last_236526)) {
								if (!w.equals(__DEC_c_last_236526)) {
									return new Object[] { c, a, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_18B(While c) {
		for (Program __DEC_c_first_177068 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_24BB(While a,
			Assignment d) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_26BB(While w,
			Assignment d) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_27BB(While a,
			Assignment d) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_29BB(While a, While c) {
	...
	public static final Object[] pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_30BB(While a, While c) {
					...
					if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_0B(a) == null) {
						if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_1B(a) == null) {
							if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_3B(a) == null) {
								if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_4B(b) == null) {
									if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_5B(b) == null) {
										if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_8B(
												b) == null) {
											if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_19BB(a,
													b) == null) {
																							...
																							if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_7BBBB(
																								...
																								if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_14B(
																									...
																									if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_15B(
																											c) == null) {
																										if (pattern_whilell2branchbb_21_2_testcorematchandDECs_black_nac_16BBB(
																												c, a,
																												w) == null) {
	...
	public static final boolean pattern_whilell2branchbb_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			whilell2branchbb _this, Match match, While a, Assignment b, Assignment d, While c, While w) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, a, b, d, c, w);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
								...
								if (tmpX instanceof Branch) {
									...
									if (tmpC instanceof While) {
										...
										if (tmpV instanceof Command) {
											...
											if (tmpW instanceof While) {
												While w = (While) tmpW;
												return new Object[] { a, i, b, z, y, d, x, c, v, w, sourceMatch,
														targetMatch };
											}
										}
									}
	...
	public static final Object[] pattern_whilell2branchbb_24_2_matchsrctrgcontext_blackBBBBBBBBBBBB(While a, Branch i,
			Assignment b, Branch z, Command y, Assignment d, Branch x, While c, Command v, While w, Match sourceMatch,
			Match targetMatch) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!i.equals(z)) {
	...
	public static final Object[] pattern_whilell2branchbb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding != null) {
			While a = (While) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[0];
			Branch i = (Branch) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[1];
			Assignment b = (Assignment) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[2];
			Branch z = (Branch) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[3];
			Command y = (Command) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[4];
			Assignment d = (Assignment) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[5];
			Branch x = (Branch) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[6];
			While c = (While) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[7];
			Command v = (Command) result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_binding[8];
			...
			Object[] result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_black = pattern_whilell2branchbb_24_2_matchsrctrgcontext_blackBBBBBBBBBBBB(
					a, i, b, z, y, d, x, c, v, w, sourceMatch, targetMatch);
			if (result_pattern_whilell2branchbb_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { a, i, b, z, y, d, x, c, v, w, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_whilell2branchbb_24_3_solvecsp_bindingFBBBBBBBBBBBBB(whilell2branchbb _this,
			While a, Branch i, Assignment b, Branch z, Command y, Assignment d, Branch x, While c, Command v, While w,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_10 = _this.isApplicable_solveCsp_CC(a, i, b, z, y, d, x, c, v, w, sourceMatch, targetMatch);
		CSP csp = _localVariable_10;
		if (csp != null) {
			return new Object[] { csp, _this, a, i, b, z, y, d, x, c, v, w, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilell2branchbb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBB(
			whilell2branchbb _this, While a, Branch i, Assignment b, Branch z, Command y, Assignment d, Branch x,
			While c, Command v, While w, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_whilell2branchbb_24_3_solvecsp_binding = pattern_whilell2branchbb_24_3_solvecsp_bindingFBBBBBBBBBBBBB(
				_this, a, i, b, z, y, d, x, c, v, w, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_whilell2branchbb_24_5_matchcorrcontext_blackBFBBB(Branch i, While w,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_whilell2branchbb_24_6_createcorrespondence_blackBBBBBBBBBBB(While a, Branch i,
			Assignment b, Branch z, Command y, Assignment d, Branch x, While c, Command v, While w, CCMatch ccMatch) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!i.equals(z)) {
					if (!i.equals(x)) {
						if (!b.equals(d)) {
							if (!x.equals(z)) {
								if (!c.equals(w)) {
									if (!v.equals(y)) {
										return new Object[] { a, i, b, z, y, d, x, c, v, w, ccMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_24_6_createcorrespondence_greenFBBFFBBBBBBFB(While a,
			Assignment b, Branch z, Command y, Assignment d, Branch x, While c, Command v, CCMatch ccMatch) {
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N d2v = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		return new Object[] { c2z, a, b, a2x, d2v, z, y, d, x, c, v, b2y, ccMatch };
	}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_0B(While a) {
		for (Decision __DEC_a_positive_540194 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_1B(While a) {
		for (Decision __DEC_a_negative_872209 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_2BBB(While a, While c,
		...
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_a_last_393084 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(a, While.class, "last")) {
						if (!a.equals(__DEC_a_last_393084)) {
							if (!c.equals(__DEC_a_last_393084)) {
								if (!w.equals(__DEC_a_last_393084)) {
									return new Object[] { a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_3B(While a) {
		for (Program __DEC_a_first_333968 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_4B(Assignment b) {
		for (Decision __DEC_b_positive_470703 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_5B(Assignment b) {
		for (Decision __DEC_b_negative_524250 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_6BBBB(Assignment b, While a,
			While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_b_first_727748 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, While.class, "first")) {
						if (!a.equals(__DEC_b_first_727748)) {
							if (!c.equals(__DEC_b_first_727748)) {
								if (!w.equals(__DEC_b_first_727748)) {
									return new Object[] { b, a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_7BBBB(Assignment b, While a,
			While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_b_last_558146 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, While.class, "last")) {
						if (!a.equals(__DEC_b_last_558146)) {
							if (!c.equals(__DEC_b_last_558146)) {
								if (!w.equals(__DEC_b_last_558146)) {
									return new Object[] { b, a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_8B(Assignment b) {
		for (Program __DEC_b_first_463305 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_9B(Assignment d) {
		for (Decision __DEC_d_positive_10609 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "positive")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_10B(Assignment d) {
		for (Decision __DEC_d_negative_598054 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "negative")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_11BBBB(Assignment d, While a,
			While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_d_first_438577 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(d, While.class, "first")) {
						if (!a.equals(__DEC_d_first_438577)) {
							if (!c.equals(__DEC_d_first_438577)) {
								if (!w.equals(__DEC_d_first_438577)) {
									return new Object[] { d, a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_12BBBB(Assignment d, While a,
			While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!c.equals(w)) {
					for (While __DEC_d_last_159234 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(d, While.class, "last")) {
						if (!a.equals(__DEC_d_last_159234)) {
							if (!c.equals(__DEC_d_last_159234)) {
								if (!w.equals(__DEC_d_last_159234)) {
									return new Object[] { d, a, c, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_13B(Assignment d) {
		for (Program __DEC_d_first_431049 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Program.class, "first")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_14B(While c) {
		for (Decision __DEC_c_positive_317052 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_15B(While c) {
		for (Decision __DEC_c_negative_593404 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_16BBB(While c, While a,
			While w) {
		if (!c.equals(w)) {
			if (!a.equals(c)) {
				if (!a.equals(w)) {
					for (While __DEC_c_first_292073 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(c, While.class, "first")) {
						if (!c.equals(__DEC_c_first_292073)) {
							if (!a.equals(__DEC_c_first_292073)) {
								if (!w.equals(__DEC_c_first_292073)) {
									return new Object[] { c, a, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_17BBB(While c, While a,
			While w) {
		if (!c.equals(w)) {
			if (!a.equals(c)) {
				if (!a.equals(w)) {
					for (While __DEC_c_last_550935 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(c, While.class, "last")) {
						if (!c.equals(__DEC_c_last_550935)) {
							if (!a.equals(__DEC_c_last_550935)) {
								if (!w.equals(__DEC_c_last_550935)) {
									return new Object[] { c, a, w };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_18B(While c) {
		for (Program __DEC_c_first_65300 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_19BB(While a, Assignment b) {
		if (b.equals(a.getFirst())) {
			return new Object[] { a, b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_21BB(While w, Assignment b) {
		if (b.equals(w.getFirst())) {
			return new Object[] { w, b };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_24BB(While a, Assignment d) {
		if (d.equals(a.getFirst())) {
			return new Object[] { a, d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_26BB(While w, Assignment d) {
		if (d.equals(w.getFirst())) {
			return new Object[] { w, d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_27BB(While a, Assignment d) {
		if (d.equals(a.getLast())) {
			return new Object[] { a, d };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_29BB(While a, While c) {
		if (c.equals(a.getFirst())) {
			return new Object[] { a, c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_30BB(While a, While c) {
		if (c.equals(a.getLast())) {
			return new Object[] { a, c };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_27_1_matchtggpattern_blackBBBBB(While a, Assignment b,
			Assignment d, While c, While w) {
		if (!a.equals(c)) {
			if (!a.equals(w)) {
				if (!b.equals(d)) {
					if (!c.equals(w)) {
																							...
																							if (pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_13B(
																								...
																								if (pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_14B(
																									...
																									if (pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_15B(
																											c) == null) {
																										if (pattern_whilell2branchbb_27_1_matchtggpattern_black_nac_16BBB(
																												c, a,
																												w) == null) {
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_0B(Branch z) {
		for (Graph __DEC_z_root_452081 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_1BBB(Branch z, Branch i,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_positive_861123 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!z.equals(__DEC_z_positive_861123)) {
							if (!i.equals(__DEC_z_positive_861123)) {
								if (!x.equals(__DEC_z_positive_861123)) {
									return new Object[] { z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_2BBB(Branch z, Branch i,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_negative_18287 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!z.equals(__DEC_z_negative_18287)) {
							if (!i.equals(__DEC_z_negative_18287)) {
								if (!x.equals(__DEC_z_negative_18287)) {
									return new Object[] { z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_3B(Command y) {
		for (Graph __DEC_y_root_18805 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_4BBBB(Command y, Branch i,
			Branch z, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_positive_394626 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!i.equals(__DEC_y_positive_394626)) {
							if (!z.equals(__DEC_y_positive_394626)) {
								if (!x.equals(__DEC_y_positive_394626)) {
									return new Object[] { y, i, z, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_5BBBB(Command y, Branch i,
			Branch z, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_negative_941946 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!i.equals(__DEC_y_negative_941946)) {
							if (!z.equals(__DEC_y_negative_941946)) {
								if (!x.equals(__DEC_y_negative_941946)) {
									return new Object[] { y, i, z, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_638446 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_7BBB(Branch x, Branch i,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_positive_29305 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_29305)) {
							if (!i.equals(__DEC_x_positive_29305)) {
								if (!z.equals(__DEC_x_positive_29305)) {
									return new Object[] { x, i, z };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_8BBB(Branch x, Branch i,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_negative_893584 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_893584)) {
							if (!i.equals(__DEC_x_negative_893584)) {
								if (!z.equals(__DEC_x_negative_893584)) {
									return new Object[] { x, i, z };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_9B(Command v) {
		for (Graph __DEC_v_root_697091 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(v,
				Graph.class, "root")) {
			return new Object[] { v };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_10BBBB(Command v, Branch i,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_v_positive_151460 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(v, Branch.class, "positive")) {
						if (!i.equals(__DEC_v_positive_151460)) {
							if (!z.equals(__DEC_v_positive_151460)) {
								if (!x.equals(__DEC_v_positive_151460)) {
									return new Object[] { v, i, z, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_11BBBB(Command v, Branch i,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_v_negative_45402 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(v, Branch.class, "negative")) {
						if (!i.equals(__DEC_v_negative_45402)) {
							if (!z.equals(__DEC_v_negative_45402)) {
								if (!x.equals(__DEC_v_negative_45402)) {
									return new Object[] { v, i, z, x };
								}
							}
						}
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_12BB(Branch i, Branch z) {
		if (z.equals(i.getPositive())) {
			return new Object[] { i, z };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_18BB(Branch x, Command y) {
		if (y.equals(x.getNegative())) {
			return new Object[] { x, y };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_21BB(Branch z, Branch x) {
		if (x.equals(z.getNegative())) {
			return new Object[] { z, x };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_24BB(Branch x, Command v) {
		if (v.equals(x.getPositive())) {
			return new Object[] { x, v };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_26BB(Branch z, Command v) {
		if (v.equals(z.getNegative())) {
			return new Object[] { z, v };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_black_nac_27BB(Branch x, Command v) {
		if (v.equals(x.getNegative())) {
			return new Object[] { x, v };
		}
		return null;
	...
	public static final Object[] pattern_whilell2branchbb_28_1_matchtggpattern_blackBBBBB(Branch i, Branch z, Command y,
			Branch x, Command v) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
	...
	public static final Object[] pattern_whilell2branchbb_29_5_checknacs_blackBBB(Branch i, S2B w2i, While w) {
		return new Object[] { i, w2i, w };
	}

	public static final Object[] pattern_whilell2branchbb_29_6_perform_blackBBBB(Branch i, S2B w2i, While w,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { i, w2i, w, ruleResult };
	}

	public static final Object[] pattern_whilell2branchbb_29_6_perform_greenFFBFFFFFFFFFBFB(Branch i, While w,
			ModelgeneratorRuleResult ruleResult) {
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		While a = SourcecodeFactory.eINSTANCE.createWhile();
		Assignment b = SourcecodeFactory.eINSTANCE.createAssignment();
		...
		return new Object[] { c2z, a, i, b, a2x, d2v, z, y, d, x, c, v, w, b2y, ruleResult };
	}
