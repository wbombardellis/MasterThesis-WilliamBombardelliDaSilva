...
public class deculul2branchububImpl extends AbstractRuleImpl implements deculul2branchubub {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While a, Assignment m, Decision d, While b, Assignment l) {

		Object[] result1_black = deculul2branchububImpl
				.pattern_deculul2branchubub_0_1_initialbindings_blackBBBBBBB(this, match, a, m, d, b, l);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[a] = " + a + ", " + "[m] = " + m + ", " + "[d] = " + d + ", "
					+ "[b] = " + b + ", " + "[l] = " + l + ".");
		}

		Object[] result2_bindingAndBlack = deculul2branchububImpl
				.pattern_deculul2branchubub_0_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, a, m, d, b, l);
		...
		if (deculul2branchububImpl.pattern_deculul2branchubub_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = deculul2branchububImpl
					.pattern_deculul2branchubub_0_4_collectelementstobetranslated_blackBBBBBB(match, a, m, d, b, l);
			...
			Object[] result5_black = deculul2branchububImpl
					.pattern_deculul2branchubub_0_5_collectcontextelements_blackBBBBBB(match, a, m, d, b, l);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = deculul2branchububImpl
				.pattern_deculul2branchubub_1_1_performtransformation_greenFFBBFFFFBFBFB(a, m, b, c, l);
		...
		Object[] result2_black = deculul2branchububImpl
				.pattern_deculul2branchubub_1_2_collecttranslatedelements_blackBBBBBBBBBBBB(a2x, w, a, m, x, m2w, b2y,
						z, b, y, l2z, l);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a2x] = " + a2x + ", " + "[w] = "
					+ w + ", " + "[a] = " + a + ", " + "[m] = " + m + ", " + "[x] = " + x + ", " + "[m2w] = " + m2w
					+ ", " + "[b2y] = " + b2y + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[y] = " + y + ", "
					+ "[l2z] = " + l2z + ", " + "[l] = " + l + ".");
		}
		Object[] result2_green = deculul2branchububImpl
				.pattern_deculul2branchubub_1_2_collecttranslatedelements_greenFBBBBBBBBBBBB(a2x, w, a, m, x, m2w, b2y,
						z, b, y, l2z, l);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = deculul2branchububImpl
				.pattern_deculul2branchubub_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(ruleresult, a2x, d2c, w, a, m,
						x, d, m2w, b2y, z, b, y, c, l2z, l);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2x] = " + a2x + ", " + "[d2c] = " + d2c + ", " + "[w] = " + w + ", " + "[a] = " + a
					+ ", " + "[m] = " + m + ", " + "[x] = " + x + ", " + "[d] = " + d + ", " + "[m2w] = " + m2w + ", "
					+ "[b2y] = " + b2y + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[y] = " + y + ", "
					+ "[c] = " + c + ", " + "[l2z] = " + l2z + ", " + "[l] = " + l + ".");
		}
		deculul2branchububImpl
				.pattern_deculul2branchubub_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFFF(ruleresult,
						a2x, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l);
		...
		//nothing EMoflonEdge x__z____positive = (EMoflonEdge) result3_green[29];
		...
		//nothing EMoflonEdge l2z__z____target = (EMoflonEdge) result3_green[32];
		//nothing EMoflonEdge l2z__l____source = (EMoflonEdge) result3_green[33];
		//nothing EMoflonEdge b__m____last = (EMoflonEdge) result3_green[34];

		// 
		// 
		deculul2branchububImpl.pattern_deculul2branchubub_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(this,
				ruleresult, a2x, d2c, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : deculul2branchububImpl.pattern_deculul2branchubub_2_2_corematch_blackFBBBBFBB(a,
				m, d, b, l, match)) {
			S2B d2c = (S2B) result2_black[0];
			Branch c = (Branch) result2_black[5];
			// ForEach 
			for (Object[] result3_black : deculul2branchububImpl
					.pattern_deculul2branchubub_2_3_findcontext_blackBBBBBBB(d2c, a, m, d, b, c, l)) {
				Object[] result3_green = deculul2branchububImpl
						.pattern_deculul2branchubub_2_3_findcontext_greenBBBBBBBFFFFFFFFF(d2c, a, m, d, b, c, l);
				...
				//nothing EMoflonEdge b__m____first = (EMoflonEdge) result3_green[11];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While a, Assignment m, Decision d, While b, Assignment l) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While a, Assignment m, Decision d, While b, Assignment l) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2B d2c, While a, Assignment m,
			Decision d, While b, Branch c, Assignment l) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject a2x, EObject d2c, EObject w, EObject a,
			EObject m, EObject x, EObject d, EObject m2w, EObject b2y, EObject z, EObject b, EObject y, EObject c,
			EObject l2z, EObject l) {
	...
	public boolean isAppropriate_BWD(Match match, Command w, Branch x, Command z, Branch y, Branch c) {
		...
		Object[] result1_black = deculul2branchububImpl
				.pattern_deculul2branchubub_10_1_initialbindings_blackBBBBBBB(this, match, w, x, z, y, c);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = deculul2branchububImpl
				.pattern_deculul2branchubub_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, w, x, z, y, c);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[w] = " + w + ", " + "[x] = " + x + ", " + "[z] = " + z + ", "
					+ "[y] = " + y + ", " + "[c] = " + c + ".");
		...
		if (deculul2branchububImpl.pattern_deculul2branchubub_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = deculul2branchububImpl
					.pattern_deculul2branchubub_10_4_collectelementstobetranslated_blackBBBBBB(match, w, x, z, y, c);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			Object[] result5_black = deculul2branchububImpl
					.pattern_deculul2branchubub_10_5_collectcontextelements_blackBBBBBB(match, w, x, z, y, c);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[w] = " + w + ", "
								+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[c] = " + c + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = deculul2branchububImpl
				.pattern_deculul2branchubub_11_1_performtransformation_greenFBFFBBFFBFBFF(w, x, d, z, y);
		S2B a2x = (S2B) result1_green[0];
		...
		S2N l2z = (S2N) result1_green[11];
		Assignment l = (Assignment) result1_green[12];

		Object[] result2_black = deculul2branchububImpl
				.pattern_deculul2branchubub_11_2_collecttranslatedelements_blackBBBBBBBBBBBB(a2x, w, a, m, x, m2w, b2y,
						z, b, y, l2z, l);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a2x] = " + a2x + ", " + "[w] = "
					+ w + ", " + "[a] = " + a + ", " + "[m] = " + m + ", " + "[x] = " + x + ", " + "[m2w] = " + m2w
		...
		Object[] result2_green = deculul2branchububImpl
				.pattern_deculul2branchubub_11_2_collecttranslatedelements_greenFBBBBBBBBBBBB(a2x, w, a, m, x, m2w, b2y,
						z, b, y, l2z, l);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = deculul2branchububImpl
				.pattern_deculul2branchubub_11_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(ruleresult, a2x, d2c, w, a,
						m, x, d, m2w, b2y, z, b, y, c, l2z, l);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2x] = " + a2x + ", " + "[d2c] = " + d2c + ", " + "[w] = " + w + ", " + "[a] = " + a
					+ ", " + "[m] = " + m + ", " + "[x] = " + x + ", " + "[d] = " + d + ", " + "[m2w] = " + m2w + ", "
		...
		deculul2branchububImpl
				.pattern_deculul2branchubub_11_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFFF(
						ruleresult, a2x, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l);
		//nothing EMoflonEdge w__y____next = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge a__l____last = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge a2x__a____source = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge d__a____positive = (EMoflonEdge) result3_green[18];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : deculul2branchububImpl.pattern_deculul2branchubub_12_2_corematch_blackFBBFBBBB(w,
				x, z, y, c, match)) {
			S2B d2c = (S2B) result2_black[0];
			Decision d = (Decision) result2_black[3];
			// ForEach 
			for (Object[] result3_black : deculul2branchububImpl
					.pattern_deculul2branchubub_12_3_findcontext_blackBBBBBBB(d2c, w, x, d, z, y, c)) {
				Object[] result3_green = deculul2branchububImpl
						.pattern_deculul2branchubub_12_3_findcontext_greenBBBBBBBFFFFFFFFF(d2c, w, x, d, z, y, c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, S2B d2c, Command w, Branch x, Decision d,
			Command z, Branch y, Branch c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject a2x, EObject d2c, EObject w, EObject a,
			EObject m, EObject x, EObject d, EObject m2w, EObject b2y, EObject z, EObject b, EObject y, EObject c,
			EObject l2z, EObject l) {
		ruleresult.registerObject("a2x", a2x);
		ruleresult.registerObject("d2c", d2c);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_58(EMoflonEdge _edge_last) {
		...
		// ForEach 
		for (Object[] result2_black : deculul2branchububImpl
				.pattern_deculul2branchubub_21_2_testcorematchandDECs_blackFFFFFB(_edge_last)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Assignment l = (Assignment) result2_bindingAndBlack[9];

		Object[] result3_bindingAndBlack = deculul2branchububImpl
				.pattern_deculul2branchubub_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBB(this, w, a, m, x, d, z, b, y, c,
						l, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[w] = " + w + ", " + "[a] = " + a + ", " + "[m] = " + m + ", " + "[x] = " + x + ", " + "[d] = "
					+ d + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[y] = " + y + ", " + "[c] = " + c + ", "
					+ "[l] = " + l + ", " + "[sourceMatch] = " + sourceMatch + ", " + "[targetMatch] = " + targetMatch
					+ ".");
		}
		...
		if (deculul2branchububImpl.pattern_deculul2branchubub_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : deculul2branchububImpl
				...
				Object[] result6_black = deculul2branchububImpl
						.pattern_deculul2branchubub_24_6_createcorrespondence_blackBBBBBBBBBBB(w, a, m, x, d, z, b, y,
								c, l, ccMatch);
				if (result6_black == null) {
				...
				deculul2branchububImpl.pattern_deculul2branchubub_24_6_createcorrespondence_greenFBBBBFFBBBFBB(w, a, m,
						x, z, b, y, l, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Command w, While a, Assignment m, Branch x, Decision d, Command z, While b,
			Branch y, Branch c, Assignment l, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While a, Assignment m, Decision d, While b, Assignment l) {// 
		Object[] result1_black = deculul2branchububImpl.pattern_deculul2branchubub_27_1_matchtggpattern_blackBBBBB(a, m,
				d, b, l);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(Command w, Branch x, Command z, Branch y, Branch c) {// 
		Object[] result1_black = deculul2branchububImpl.pattern_deculul2branchubub_28_1_matchtggpattern_blackBBBBB(w, x,
				z, y, c);
		if (result1_black != null) {
		...
		for (Object[] result2_black : deculul2branchububImpl
			...
			if (deculul2branchububImpl.pattern_deculul2branchubub_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					deculul2branchububImpl.pattern_deculul2branchubub_29_6_perform_greenFFFFFBFFFFFBFFB(d, c,
							ruleResult);
					//nothing S2B a2x = (S2B) result6_green[0];
					...
					//nothing Assignment l = (Assignment) result6_green[13];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_FWD__MATCH_WHILE_ASSIGNMENT_DECISION_WHILE_ASSIGNMENT:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_WHILE_ASSIGNMENT_DECISION_WHILE_ASSIGNMENT:
			...
			return null;
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_WHILE_ASSIGNMENT_DECISION_WHILE_ASSIGNMENT:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (While) arguments.get(1),
					(Assignment) arguments.get(2), (Decision) arguments.get(3), (While) arguments.get(4),
					(Assignment) arguments.get(5));
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2B_WHILE_ASSIGNMENT_DECISION_WHILE_BRANCH_ASSIGNMENT:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_BWD__MATCH_COMMAND_BRANCH_COMMAND_BRANCH_BRANCH:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_COMMAND_BRANCH_COMMAND_BRANCH_BRANCH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Command) arguments.get(1), (Branch) arguments.get(2),
					(Command) arguments.get(3), (Branch) arguments.get(4), (Branch) arguments.get(5));
			return null;
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_COMMAND_BRANCH_COMMAND_BRANCH_BRANCH:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_COMMAND_BRANCH_DECISION_COMMAND_BRANCH_BRANCH:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_58__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_58((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_58__EMOFLONEDGE:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPLICABLE_SOLVE_CSP_CC__COMMAND_WHILE_ASSIGNMENT_BRANCH_DECISION_COMMAND_WHILE_BRANCH_BRANCH_ASSIGNMENT_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Command) arguments.get(0), (While) arguments.get(1),
					...
					(Branch) arguments.get(8), (Assignment) arguments.get(9), (Match) arguments.get(10),
					(Match) arguments.get(11));
		case RulesPackage.DECULUL2BRANCHUBUB___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.DECULUL2BRANCHUBUB___CHECK_DEC_FWD__WHILE_ASSIGNMENT_DECISION_WHILE_ASSIGNMENT:
		...
		case RulesPackage.DECULUL2BRANCHUBUB___CHECK_DEC_BWD__COMMAND_BRANCH_COMMAND_BRANCH_BRANCH:
	...
	public static final Object[] pattern_deculul2branchubub_0_1_initialbindings_blackBBBBBBB(deculul2branchubub _this,
			Match match, While a, Assignment m, Decision d, While b, Assignment l) {
		if (!a.equals(b)) {
			if (!l.equals(m)) {
				return new Object[] { _this, match, a, m, d, b, l };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_deculul2branchubub_0_2_SolveCSP_bindingFBBBBBBB(deculul2branchubub _this,
			Match match, While a, Assignment m, Decision d, While b, Assignment l) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, a, m, d, b, l);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, a, m, d, b, l };
		}
		return null;
	}
	...
	public static final Object[] pattern_deculul2branchubub_0_4_collectelementstobetranslated_blackBBBBBB(Match match,
			While a, Assignment m, Decision d, While b, Assignment l) {
		if (!a.equals(b)) {
			if (!l.equals(m)) {
				return new Object[] { match, a, m, d, b, l };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_deculul2branchubub_0_4_collectelementstobetranslated_greenBBBBBBFFFFFF(
		...
		return new Object[] { match, a, m, d, b, l, a__l____last, d__a____positive, a__l____first, b__m____first,
				d__b____negative, b__m____last };
	}

	public static final Object[] pattern_deculul2branchubub_0_5_collectcontextelements_blackBBBBBB(Match match, While a,
			Assignment m, Decision d, While b, Assignment l) {
		if (!a.equals(b)) {
			if (!l.equals(m)) {
				return new Object[] { match, a, m, d, b, l };
			}
	...
	public static final void pattern_deculul2branchubub_0_6_registerobjectstomatch_expressionBBBBBBB(
			deculul2branchubub _this, Match match, While a, Assignment m, Decision d, While b, Assignment l) {
		_this.registerObjectsToMatch_FWD(match, a, m, d, b, l);
						...
						if (tmpB instanceof While) {
							...
							if (tmpC instanceof Branch) {
								...
								if (tmpL instanceof Assignment) {
									...
									return new Object[] { d2c, a, m, d, b, c, l, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_deculul2branchubub_1_1_performtransformation_blackBBBBBBBFBB(S2B d2c, While a,
			Assignment m, Decision d, While b, Branch c, Assignment l, deculul2branchubub _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(b)) {
			if (!l.equals(m)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { d2c, a, m, d, b, c, l, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_deculul2branchubub_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_deculul2branchubub_1_1_performtransformation_binding != null) {
			...
			While a = (While) result_pattern_deculul2branchubub_1_1_performtransformation_binding[1];
			Assignment m = (Assignment) result_pattern_deculul2branchubub_1_1_performtransformation_binding[2];
			Decision d = (Decision) result_pattern_deculul2branchubub_1_1_performtransformation_binding[3];
			...
			Assignment l = (Assignment) result_pattern_deculul2branchubub_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_deculul2branchubub_1_1_performtransformation_black = pattern_deculul2branchubub_1_1_performtransformation_blackBBBBBBBFBB(
					d2c, a, m, d, b, c, l, _this, isApplicableMatch);
	...
	public static final Object[] pattern_deculul2branchubub_1_1_performtransformation_greenFFBBFFFFBFBFB(While a,
			Assignment m, While b, Branch c, Assignment l) {
		...
		l2z.setTarget(z);
		l2z.setSource(l);
		return new Object[] { a2x, w, a, m, x, m2w, b2y, z, b, y, c, l2z, l };
	}

	public static final Object[] pattern_deculul2branchubub_1_2_collecttranslatedelements_blackBBBBBBBBBBBB(S2B a2x,
			Command w, While a, Assignment m, Branch x, S2N m2w, S2B b2y, Command z, While b, Branch y, S2N l2z,
			Assignment l) {
		if (!a2x.equals(b2y)) {
			if (!w.equals(z)) {
				if (!a.equals(b)) {
					if (!x.equals(y)) {
						if (!l2z.equals(m2w)) {
							if (!l.equals(m)) {
								return new Object[] { a2x, w, a, m, x, m2w, b2y, z, b, y, l2z, l };
							}
						}
					}
				}
	...
	public static final Object[] pattern_deculul2branchubub_1_2_collecttranslatedelements_greenFBBBBBBBBBBBB(S2B a2x,
			Command w, While a, Assignment m, Branch x, S2N m2w, S2B b2y, Command z, While b, Branch y, S2N l2z,
			Assignment l) {
		...
		return new Object[] { ruleresult, a2x, w, a, m, x, m2w, b2y, z, b, y, l2z, l };
	}

	public static final Object[] pattern_deculul2branchubub_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject a2x, EObject d2c, EObject w, EObject a, EObject m, EObject x,
			EObject d, EObject m2w, EObject b2y, EObject z, EObject b, EObject y, EObject c, EObject l2z, EObject l) {
		if (!a2x.equals(d2c)) {
			if (!a2x.equals(w)) {
				if (!a2x.equals(m)) {
					if (!a2x.equals(x)) {
	...
	public static final Object[] pattern_deculul2branchubub_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject a2x, EObject w, EObject a, EObject m, EObject x, EObject d,
			EObject m2w, EObject b2y, EObject z, EObject b, EObject y, EObject c, EObject l2z, EObject l) {
		...
		b__m____last.setName(b__m____last_name_prime);
		return new Object[] { ruleresult, a2x, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l, w__y____next, a__l____last,
				a2x__a____source, d__a____positive, m2w__w____target, m2w__m____source, z__x____next, a2x__x____target,
				a__l____first, b2y__b____source, b__m____first, d__b____negative, b2y__y____target, y__w____positive,
				x__z____positive, c__x____positive, c__y____negative, l2z__z____target, l2z__l____source,
				b__m____last };
	}

	public static final void pattern_deculul2branchubub_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
			deculul2branchubub _this, PerformRuleResult ruleresult, EObject a2x, EObject d2c, EObject w, EObject a,
			EObject m, EObject x, EObject d, EObject m2w, EObject b2y, EObject z, EObject b, EObject y, EObject c,
			EObject l2z, EObject l) {
		_this.registerObjects_FWD(ruleresult, a2x, d2c, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l);
			...
			if (tmpM instanceof Assignment) {
				...
				if (tmpD instanceof Decision) {
					...
					if (tmpB instanceof While) {
						...
						if (tmpL instanceof Assignment) {
							Assignment l = (Assignment) tmpL;
							return new Object[] { a, m, d, b, l, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_deculul2branchubub_2_2_corematch_blackFBBBBFBB(While a, Assignment m,
			Decision d, While b, Assignment l, Match match) {
		...
		if (!a.equals(b)) {
			if (!l.equals(m)) {
				for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class,
					...
					if (c != null) {
						_result.add(new Object[] { d2c, a, m, d, b, c, l, match });
					}
	...
	public static final Iterable<Object[]> pattern_deculul2branchubub_2_3_findcontext_blackBBBBBBB(S2B d2c, While a,
			Assignment m, Decision d, While b, Branch c, Assignment l) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(b)) {
			if (!l.equals(m)) {
									...
									if (b.equals(d.getNegative())) {
										if (c.equals(d2c.getTarget())) {
											if (m.equals(b.getLast())) {
												_result.add(new Object[] { d2c, a, m, d, b, c, l });
											}
										}
									}
								}
	...
	public static final Object[] pattern_deculul2branchubub_2_3_findcontext_greenBBBBBBBFFFFFFFFF(S2B d2c, While a,
			Assignment m, Decision d, While b, Branch c, Assignment l) {
		...
		b__m____last.setName(b__m____last_name_prime);
		return new Object[] { d2c, a, m, d, b, c, l, isApplicableMatch, a__l____last, d__a____positive, a__l____first,
				b__m____first, d2c__d____source, d__b____negative, d2c__c____target, b__m____last };
	}

	public static final Object[] pattern_deculul2branchubub_2_4_solveCSP_bindingFBBBBBBBBB(deculul2branchubub _this,
			IsApplicableMatch isApplicableMatch, S2B d2c, While a, Assignment m, Decision d, While b, Branch c,
			Assignment l) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, d2c, a, m, d, b, c, l);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, a, m, d, b, c, l };
		}
		return null;
	}
	...
	public static final Object[] pattern_deculul2branchubub_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			deculul2branchubub _this, IsApplicableMatch isApplicableMatch, S2B d2c, While a, Assignment m, Decision d,
			While b, Branch c, Assignment l) {
		Object[] result_pattern_deculul2branchubub_2_4_solveCSP_binding = pattern_deculul2branchubub_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, d2c, a, m, d, b, c, l);
	...
	public static final Object[] pattern_deculul2branchubub_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
			deculul2branchubub _this, Match match, Command w, Branch x, Command z, Branch y, Branch c) {
	...
	public static final Object[] pattern_deculul2branchubub_10_4_collectelementstobetranslated_greenBBBBBBFFFFFF(
		...
		c__x____positive.setName(c__x____positive_name_prime);
		c__y____negative.setName(c__y____negative_name_prime);
		return new Object[] { match, w, x, z, y, c, w__y____next, z__x____next, y__w____positive, x__z____positive,
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpZ instanceof Command) {
							...
							if (tmpY instanceof Branch) {
								...
								if (tmpC instanceof Branch) {
									Branch c = (Branch) tmpC;
									return new Object[] { d2c, w, x, d, z, y, c, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_deculul2branchubub_11_1_performtransformation_blackBBBBBBBFBB(S2B d2c,
			Command w, Branch x, Decision d, Command z, Branch y, Branch c, deculul2branchubub _this,
			IsApplicableMatch isApplicableMatch) {
		if (!w.equals(z)) {
			if (!x.equals(y)) {
				if (!c.equals(x)) {
					if (!c.equals(y)) {
						for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
							if (tmpCsp instanceof CSP) {
								CSP csp = (CSP) tmpCsp;
								return new Object[] { d2c, w, x, d, z, y, c, csp, _this, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_deculul2branchubub_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_deculul2branchubub_11_1_performtransformation_binding != null) {
			...
			Decision d = (Decision) result_pattern_deculul2branchubub_11_1_performtransformation_binding[3];
			Command z = (Command) result_pattern_deculul2branchubub_11_1_performtransformation_binding[4];
			Branch y = (Branch) result_pattern_deculul2branchubub_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_deculul2branchubub_11_1_performtransformation_black = pattern_deculul2branchubub_11_1_performtransformation_blackBBBBBBBFBB(
					d2c, w, x, d, z, y, c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_deculul2branchubub_11_1_performtransformation_greenFBFFBBFFBFBFF(Command w,
		...
		a.setFirst(l);
		l2z.setSource(l);
		return new Object[] { a2x, w, a, m, x, d, m2w, b2y, z, b, y, l2z, l };
	}

	public static final Object[] pattern_deculul2branchubub_11_2_collecttranslatedelements_blackBBBBBBBBBBBB(S2B a2x,
			Command w, While a, Assignment m, Branch x, S2N m2w, S2B b2y, Command z, While b, Branch y, S2N l2z,
			Assignment l) {
		if (!a2x.equals(b2y)) {
			if (!w.equals(z)) {
	...
	public static final Object[] pattern_deculul2branchubub_11_2_collecttranslatedelements_greenFBBBBBBBBBBBB(S2B a2x,
			Command w, While a, Assignment m, Branch x, S2N m2w, S2B b2y, Command z, While b, Branch y, S2N l2z,
			Assignment l) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(a2x);
	...
	public static final void pattern_deculul2branchubub_11_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
			...
			EObject m, EObject x, EObject d, EObject m2w, EObject b2y, EObject z, EObject b, EObject y, EObject c,
			EObject l2z, EObject l) {
		_this.registerObjects_BWD(ruleresult, a2x, d2c, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l);
	...
	public static final Iterable<Object[]> pattern_deculul2branchubub_12_2_corematch_blackFBBFBBBB(Command w, Branch x,
				...
				if (!c.equals(x)) {
					if (!c.equals(y)) {
						for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
							...
							if (tmpD instanceof Decision) {
								Decision d = (Decision) tmpD;
								_result.add(new Object[] { d2c, w, x, d, z, y, c, match });
							}
	...
	public static final Iterable<Object[]> pattern_deculul2branchubub_12_3_findcontext_blackBBBBBBB(S2B d2c, Command w,
			Branch x, Decision d, Command z, Branch y, Branch c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!w.equals(z)) {
			if (!x.equals(y)) {
				if (!c.equals(x)) {
										...
										if (z.equals(x.getPositive())) {
											if (x.equals(c.getPositive())) {
												if (y.equals(c.getNegative())) {
													if (c.equals(d2c.getTarget())) {
														_result.add(new Object[] { d2c, w, x, d, z, y, c });
													}
												}
											}
										}
	...
	public static final Object[] pattern_deculul2branchubub_12_3_findcontext_greenBBBBBBBFFFFFFFFF(S2B d2c, Command w,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		d2c__c____target.setName(d2c__c____target_name_prime);
		return new Object[] { d2c, w, x, d, z, y, c, isApplicableMatch, w__y____next, z__x____next, d2c__d____source,
				y__w____positive, x__z____positive, c__x____positive, c__y____negative, d2c__c____target };
	}

	public static final Object[] pattern_deculul2branchubub_12_4_solveCSP_bindingFBBBBBBBBB(deculul2branchubub _this,
			IsApplicableMatch isApplicableMatch, S2B d2c, Command w, Branch x, Decision d, Command z, Branch y,
			Branch c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d2c, w, x, d, z, y, c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, w, x, d, z, y, c };
		}
		return null;
	}
	...
	public static final Object[] pattern_deculul2branchubub_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			deculul2branchubub _this, IsApplicableMatch isApplicableMatch, S2B d2c, Command w, Branch x, Decision d,
		...
		Object[] result_pattern_deculul2branchubub_12_4_solveCSP_binding = pattern_deculul2branchubub_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, d2c, w, x, d, z, y, c);
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_0B(Command w) {
		for (Graph __DEC_w_root_345131 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Graph.class, "root")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_1BBBB(Command w,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_w_positive_677507 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(w, Branch.class, "positive")) {
						if (!x.equals(__DEC_w_positive_677507)) {
							if (!y.equals(__DEC_w_positive_677507)) {
								if (!c.equals(__DEC_w_positive_677507)) {
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_2BBBB(Command w,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_w_negative_126134 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(w, Branch.class, "negative")) {
						if (!x.equals(__DEC_w_negative_126134)) {
							if (!y.equals(__DEC_w_negative_126134)) {
								if (!c.equals(__DEC_w_negative_126134)) {
									return new Object[] { w, x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_296749 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_4BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_317251 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_317251)) {
							if (!y.equals(__DEC_x_positive_317251)) {
								if (!c.equals(__DEC_x_positive_317251)) {
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_5BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_598779 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_598779)) {
							if (!y.equals(__DEC_x_negative_598779)) {
								if (!c.equals(__DEC_x_negative_598779)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_6B(Command z) {
		for (Graph __DEC_z_root_279531 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_7BBBB(Command z,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_positive_776813 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!x.equals(__DEC_z_positive_776813)) {
							if (!y.equals(__DEC_z_positive_776813)) {
								if (!c.equals(__DEC_z_positive_776813)) {
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_8BBBB(Command z,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_negative_257376 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!x.equals(__DEC_z_negative_257376)) {
							if (!y.equals(__DEC_z_negative_257376)) {
								if (!c.equals(__DEC_z_negative_257376)) {
									return new Object[] { z, x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_9B(Branch y) {
		for (Graph __DEC_y_root_269210 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_10BBB(Branch y,
			Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_426321 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_426321)) {
							if (!x.equals(__DEC_y_positive_426321)) {
								if (!c.equals(__DEC_y_positive_426321)) {
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_11BBB(Branch y,
			Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_941975 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_941975)) {
							if (!x.equals(__DEC_y_negative_941975)) {
								if (!c.equals(__DEC_y_negative_941975)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_20BB(Branch y,
			Command z) {
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_21BB(Branch c,
			Command z) {
	...
	public static final Object[] pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_23BB(Branch x,
			Branch y) {
				...
				if (y.equals(w.getNext())) {
					if (w.equals(y.getPositive())) {
						if (pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_0B(w) == null) {
							if (pattern_deculul2branchubub_20_2_testcorematchandDECs_black_nac_9B(y) == null) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_0BB(While a,
			Decision d) {
		for (Decision __DEC_a_negative_801503 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_801503)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_1BB(While a, While b) {
		if (!a.equals(b)) {
			for (While __DEC_a_first_914078 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "first")) {
				if (!a.equals(__DEC_a_first_914078)) {
					if (!b.equals(__DEC_a_first_914078)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_2BB(While a, While b) {
		if (!a.equals(b)) {
			for (While __DEC_a_last_953647 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_953647)) {
					if (!b.equals(__DEC_a_last_953647)) {
						return new Object[] { a, b };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_3B(While a) {
		for (Program __DEC_a_first_400285 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_4BB(Assignment m,
			Decision d) {
		for (Decision __DEC_m_positive_366983 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_m_positive_366983)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_5BB(Assignment m,
			Decision d) {
		for (Decision __DEC_m_negative_365263 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_m_negative_365263)) {
				return new Object[] { m, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_6BBB(Assignment m,
			While a, While b) {
		if (!a.equals(b)) {
			for (While __DEC_m_last_430788 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
					While.class, "last")) {
				if (!a.equals(__DEC_m_last_430788)) {
					if (!b.equals(__DEC_m_last_430788)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_7B(Assignment m) {
		for (Program __DEC_m_first_804635 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
				Program.class, "first")) {
			return new Object[] { m };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_8BB(While b,
			Decision d) {
		for (Decision __DEC_b_positive_164473 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_164473)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_9BB(While b, While a) {
		if (!a.equals(b)) {
			for (While __DEC_b_first_741622 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "first")) {
				if (!b.equals(__DEC_b_first_741622)) {
					if (!a.equals(__DEC_b_first_741622)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_10BB(While b, While a) {
		if (!a.equals(b)) {
			for (While __DEC_b_last_163985 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!b.equals(__DEC_b_last_163985)) {
					if (!a.equals(__DEC_b_last_163985)) {
						return new Object[] { b, a };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_11B(While b) {
		for (Program __DEC_b_first_726541 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_12BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_positive_480035 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_480035)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_13BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_negative_767022 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_767022)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_14BBB(Assignment l,
			While a, While b) {
		if (!a.equals(b)) {
			for (While __DEC_l_last_202491 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
					While.class, "last")) {
				if (!a.equals(__DEC_l_last_202491)) {
					if (!b.equals(__DEC_l_last_202491)) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_15B(Assignment l) {
		for (Program __DEC_l_first_769236 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_18BB(Decision d,
			Assignment m) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_19BB(While a,
			Assignment m) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_21BB(While a, While b) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_22BB(While a, While b) {
	...
	public static final Object[] pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_25BB(While b,
			Assignment l) {
	...
	public static final Iterable<Object[]> pattern_deculul2branchubub_21_2_testcorematchandDECs_blackFFFFFB(
		...
		if (tmpA instanceof While) {
			...
			if (tmpL instanceof Assignment) {
				...
				if (l.equals(a.getLast())) {
					if (l.equals(a.getFirst())) {
						if (pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_3B(a) == null) {
							if (pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_15B(l) == null) {
																		...
																		if (pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_23BB(
																			...
																			if (pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_24BB(
																				...
																				if (pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_1BB(
																						a, b) == null) {
																					if (pattern_deculul2branchubub_21_2_testcorematchandDECs_black_nac_2BB(
																							a, b) == null) {
	...
	public static final boolean pattern_deculul2branchubub_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			deculul2branchubub _this, Match match, While a, Assignment m, Decision d, While b, Assignment l) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, a, m, d, b, l);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_deculul2branchubub_24_2_matchsrctrgcontext_bindingFFFFFFFFFFBB(
		...
		EObject _localVariable_9 = sourceMatch.getObject("l");
		EObject tmpW = _localVariable_0;
		EObject tmpA = _localVariable_1;
		EObject tmpM = _localVariable_2;
								...
								if (tmpB instanceof While) {
									...
									if (tmpY instanceof Branch) {
										...
										if (tmpC instanceof Branch) {
											...
											if (tmpL instanceof Assignment) {
												Assignment l = (Assignment) tmpL;
												return new Object[] { w, a, m, x, d, z, b, y, c, l, targetMatch,
														sourceMatch };
											}
										}
									}
	...
	public static final Object[] pattern_deculul2branchubub_24_2_matchsrctrgcontext_blackBBBBBBBBBBBB(Command w,
			While a, Assignment m, Branch x, Decision d, Command z, While b, Branch y, Branch c, Assignment l,
						...
						if (!c.equals(y)) {
							if (!l.equals(m)) {
								if (!sourceMatch.equals(targetMatch)) {
									return new Object[] { w, a, m, x, d, z, b, y, c, l, sourceMatch, targetMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_deculul2branchubub_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_deculul2branchubub_24_2_matchsrctrgcontext_binding != null) {
			...
			While a = (While) result_pattern_deculul2branchubub_24_2_matchsrctrgcontext_binding[1];
			Assignment m = (Assignment) result_pattern_deculul2branchubub_24_2_matchsrctrgcontext_binding[2];
			...
			Command z = (Command) result_pattern_deculul2branchubub_24_2_matchsrctrgcontext_binding[5];
			...
			Assignment l = (Assignment) result_pattern_deculul2branchubub_24_2_matchsrctrgcontext_binding[9];
			...
			Object[] result_pattern_deculul2branchubub_24_2_matchsrctrgcontext_black = pattern_deculul2branchubub_24_2_matchsrctrgcontext_blackBBBBBBBBBBBB(
					w, a, m, x, d, z, b, y, c, l, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_deculul2branchubub_24_3_solvecsp_bindingFBBBBBBBBBBBBB(
			deculul2branchubub _this, Command w, While a, Assignment m, Branch x, Decision d, Command z, While b,
			Branch y, Branch c, Assignment l, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_10 = _this.isApplicable_solveCsp_CC(w, a, m, x, d, z, b, y, c, l, sourceMatch, targetMatch);
		CSP csp = _localVariable_10;
		if (csp != null) {
			return new Object[] { csp, _this, w, a, m, x, d, z, b, y, c, l, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_deculul2branchubub_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBB(
		...
		Object[] result_pattern_deculul2branchubub_24_3_solvecsp_binding = pattern_deculul2branchubub_24_3_solvecsp_bindingFBBBBBBBBBBBBB(
				_this, w, a, m, x, d, z, b, y, c, l, sourceMatch, targetMatch);
			...
			if (!a.equals(b)) {
				if (!x.equals(y)) {
					if (!c.equals(x)) {
						if (!c.equals(y)) {
							if (!l.equals(m)) {
								return new Object[] { w, a, m, x, d, z, b, y, c, l, ccMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_deculul2branchubub_24_6_createcorrespondence_greenFBBBBFFBBBFBB(Command w,
			While a, Assignment m, Branch x, Command z, While b, Branch y, Assignment l, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N m2w = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		return new Object[] { a2x, w, a, m, x, m2w, b2y, z, b, y, l2z, l, ccMatch };
	}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_0BB(While a, Decision d) {
		for (Decision __DEC_a_negative_746240 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_746240)) {
				return new Object[] { a, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_1BB(While a, While b) {
		if (!a.equals(b)) {
			for (While __DEC_a_first_72861 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "first")) {
				if (!a.equals(__DEC_a_first_72861)) {
					if (!b.equals(__DEC_a_first_72861)) {
						return new Object[] { a, b };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_2BB(While a, While b) {
		if (!a.equals(b)) {
			for (While __DEC_a_last_461215 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_461215)) {
					if (!b.equals(__DEC_a_last_461215)) {
						return new Object[] { a, b };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_3B(While a) {
		for (Program __DEC_a_first_661055 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_4BB(Assignment m,
			Decision d) {
		for (Decision __DEC_m_positive_547562 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_m_positive_547562)) {
				return new Object[] { m, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_5BB(Assignment m,
			Decision d) {
		for (Decision __DEC_m_negative_850475 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_m_negative_850475)) {
				return new Object[] { m, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_6BBB(Assignment m, While a,
			While b) {
		if (!a.equals(b)) {
			for (While __DEC_m_last_536089 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
					While.class, "last")) {
				if (!a.equals(__DEC_m_last_536089)) {
					if (!b.equals(__DEC_m_last_536089)) {
						return new Object[] { m, a, b };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_7B(Assignment m) {
		for (Program __DEC_m_first_347390 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(m,
				Program.class, "first")) {
			return new Object[] { m };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_8BB(While b, Decision d) {
		for (Decision __DEC_b_positive_927533 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_927533)) {
				return new Object[] { b, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_9BB(While b, While a) {
		if (!a.equals(b)) {
			for (While __DEC_b_first_451313 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "first")) {
				if (!b.equals(__DEC_b_first_451313)) {
					if (!a.equals(__DEC_b_first_451313)) {
						return new Object[] { b, a };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_10BB(While b, While a) {
		if (!a.equals(b)) {
			for (While __DEC_b_last_298173 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!b.equals(__DEC_b_last_298173)) {
					if (!a.equals(__DEC_b_last_298173)) {
						return new Object[] { b, a };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_11B(While b) {
		for (Program __DEC_b_first_345932 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_12BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_positive_186246 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_186246)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_13BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_negative_73408 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_73408)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_14BBB(Assignment l, While a,
			While b) {
		if (!a.equals(b)) {
			for (While __DEC_l_last_764306 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
					While.class, "last")) {
				if (!a.equals(__DEC_l_last_764306)) {
					if (!b.equals(__DEC_l_last_764306)) {
						return new Object[] { l, a, b };
					}
				}
			}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_15B(Assignment l) {
		for (Program __DEC_l_first_391595 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_16BB(Decision d, While a) {
		if (a.equals(d.getNegative())) {
			return new Object[] { d, a };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_18BB(Decision d,
			Assignment m) {
		if (m.equals(d.getNegative())) {
			return new Object[] { d, m };
		}
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_19BB(While a, Assignment m) {
		if (m.equals(a.getLast())) {
			return new Object[] { a, m };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_20BB(Decision d, While b) {
		if (b.equals(d.getPositive())) {
			return new Object[] { d, b };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_21BB(While a, While b) {
		if (b.equals(a.getFirst())) {
			return new Object[] { a, b };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_22BB(While a, While b) {
		if (b.equals(a.getLast())) {
			return new Object[] { a, b };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_25BB(While b, Assignment l) {
		if (l.equals(b.getLast())) {
			return new Object[] { b, l };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_27_1_matchtggpattern_blackBBBBB(While a, Assignment m,
					...
					if (a.equals(d.getPositive())) {
						if (l.equals(a.getFirst())) {
							if (m.equals(b.getFirst())) {
								if (b.equals(d.getNegative())) {
									if (m.equals(b.getLast())) {
										if (pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_0BB(a,
												d) == null) {
											if (pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_1BB(a,
													b) == null) {
												if (pattern_deculul2branchubub_27_1_matchtggpattern_black_nac_2BB(a,
														b) == null) {
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_0B(Command w) {
		for (Graph __DEC_w_root_590417 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w,
				Graph.class, "root")) {
			return new Object[] { w };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_1BBBB(Command w, Branch x,
			Branch y, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_w_positive_578301 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(w, Branch.class, "positive")) {
						if (!x.equals(__DEC_w_positive_578301)) {
							if (!y.equals(__DEC_w_positive_578301)) {
								if (!c.equals(__DEC_w_positive_578301)) {
									return new Object[] { w, x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_2BBBB(Command w, Branch x,
			Branch y, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_w_negative_801619 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(w, Branch.class, "negative")) {
						if (!x.equals(__DEC_w_negative_801619)) {
							if (!y.equals(__DEC_w_negative_801619)) {
								if (!c.equals(__DEC_w_negative_801619)) {
									return new Object[] { w, x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_208973 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_4BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_600161 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_600161)) {
							if (!y.equals(__DEC_x_positive_600161)) {
								if (!c.equals(__DEC_x_positive_600161)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_5BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_42074 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_42074)) {
							if (!y.equals(__DEC_x_negative_42074)) {
								if (!c.equals(__DEC_x_negative_42074)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_6B(Command z) {
		for (Graph __DEC_z_root_311125 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_7BBBB(Command z, Branch x,
			Branch y, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_positive_963287 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!x.equals(__DEC_z_positive_963287)) {
							if (!y.equals(__DEC_z_positive_963287)) {
								if (!c.equals(__DEC_z_positive_963287)) {
									return new Object[] { z, x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_8BBBB(Command z, Branch x,
			Branch y, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_z_negative_324098 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!x.equals(__DEC_z_negative_324098)) {
							if (!y.equals(__DEC_z_negative_324098)) {
								if (!c.equals(__DEC_z_negative_324098)) {
									return new Object[] { z, x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_9B(Branch y) {
		for (Graph __DEC_y_root_794751 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_10BBB(Branch y, Branch x,
			Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_927370 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_927370)) {
							if (!x.equals(__DEC_y_positive_927370)) {
								if (!c.equals(__DEC_y_positive_927370)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_11BBB(Branch y, Branch x,
			Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_13436 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_13436)) {
							if (!x.equals(__DEC_y_negative_13436)) {
								if (!c.equals(__DEC_y_negative_13436)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_17BB(Branch y, Command z) {
		if (z.equals(y.getPositive())) {
			return new Object[] { y, z };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_19BB(Branch x, Command z) {
		if (z.equals(x.getNegative())) {
			return new Object[] { x, z };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_20BB(Branch y, Command z) {
		if (z.equals(y.getNegative())) {
			return new Object[] { y, z };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_21BB(Branch c, Command z) {
		if (z.equals(c.getNegative())) {
			return new Object[] { c, z };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_22BB(Branch x, Branch y) {
		if (y.equals(x.getPositive())) {
			return new Object[] { x, y };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_black_nac_23BB(Branch x, Branch y) {
		if (y.equals(x.getNegative())) {
			return new Object[] { x, y };
		}
		return null;
	...
	public static final Object[] pattern_deculul2branchubub_28_1_matchtggpattern_blackBBBBB(Command w, Branch x,
			Command z, Branch y, Branch c) {
		if (!w.equals(z)) {
			if (!x.equals(y)) {
				if (!c.equals(x)) {
	...
	public static final Object[] pattern_deculul2branchubub_29_6_perform_greenFFFFFBFFFFFBFFB(Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Command w = ControlflowFactory.eINSTANCE.createCommand();
		While a = SourcecodeFactory.eINSTANCE.createWhile();
		...
		return new Object[] { a2x, w, a, m, x, d, m2w, b2y, z, b, y, c, l2z, l, ruleResult };
	}
