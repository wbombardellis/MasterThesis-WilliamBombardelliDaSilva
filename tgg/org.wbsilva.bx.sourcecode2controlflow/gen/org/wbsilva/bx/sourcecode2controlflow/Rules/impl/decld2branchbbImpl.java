...
public class decld2branchbbImpl extends AbstractRuleImpl implements decld2branchbb {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While a, Decision b, Assignment l, Decision d) {
		...
		Object[] result2_bindingAndBlack = decld2branchbbImpl
				.pattern_decld2branchbb_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, a, b, l, d);
		...
		if (decld2branchbbImpl.pattern_decld2branchbb_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decld2branchbbImpl
					.pattern_decld2branchbb_0_4_collectelementstobetranslated_blackBBBBB(match, a, b, l, d);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[a] = " + a + ", " + "[b] = " + b + ", " + "[l] = " + l + ", " + "[d] = " + d + ".");
			}
			decld2branchbbImpl.pattern_decld2branchbb_0_4_collectelementstobetranslated_greenBBBBBFFF(match, a, b, l,
					d);
			...
			Object[] result5_black = decld2branchbbImpl
					.pattern_decld2branchbb_0_5_collectcontextelements_blackBBBBB(match, a, b, l, d);
			...
			// 
			decld2branchbbImpl.pattern_decld2branchbb_0_6_registerobjectstomatch_expressionBBBBBB(this, match, a, b, l,
					d);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decld2branchbbImpl.pattern_decld2branchbb_1_1_performtransformation_greenFBFFFBBFFB(a,
				b, l, c);
		...
		Object[] result2_black = decld2branchbbImpl
				.pattern_decld2branchbb_1_2_collecttranslatedelements_blackBBBBBBBBB(z, a, l2z, y, b2y, b, l, a2x, x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", " + "[a] = " + a
					+ ", " + "[l2z] = " + l2z + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[b] = " + b
					+ ", " + "[l] = " + l + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ".");
		}
		Object[] result2_green = decld2branchbbImpl
				.pattern_decld2branchbb_1_2_collecttranslatedelements_greenFBBBBBBBBB(z, a, l2z, y, b2y, b, l, a2x, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decld2branchbbImpl.pattern_decld2branchbb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
				ruleresult, z, a, l2z, y, b2y, b, l, a2x, x, d, c, d2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[z] = " + z + ", " + "[a] = " + a + ", " + "[l2z] = " + l2z + ", " + "[y] = " + y + ", "
					+ "[b2y] = " + b2y + ", " + "[b] = " + b + ", " + "[l] = " + l + ", " + "[a2x] = " + a2x + ", "
					+ "[x] = " + x + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[d2c] = " + d2c + ".");
		}
		decld2branchbbImpl.pattern_decld2branchbb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(ruleresult, z,
				a, l2z, y, b2y, b, l, a2x, x, d, c);
		...
		// 
		// 
		decld2branchbbImpl.pattern_decld2branchbb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, z, a,
				l2z, y, b2y, b, l, a2x, x, d, c, d2c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decld2branchbbImpl.pattern_decld2branchbb_2_2_corematch_blackBBBBFFB(a, b, l, d,
				match)) {
			Branch c = (Branch) result2_black[4];
			S2B d2c = (S2B) result2_black[5];
			// ForEach 
			for (Object[] result3_black : decld2branchbbImpl.pattern_decld2branchbb_2_3_findcontext_blackBBBBBB(a, b, l,
					d, c, d2c)) {
				...
				Object[] result4_bindingAndBlack = decld2branchbbImpl
						.pattern_decld2branchbb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, a, b, l,
								d, c, d2c);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While a, Decision b, Assignment l, Decision d) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While a, Decision b, Assignment l, Decision d) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While a, Decision b, Assignment l,
			Decision d, Branch c, S2B d2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject z, EObject a, EObject l2z, EObject y,
			EObject b2y, EObject b, EObject l, EObject a2x, EObject x, EObject d, EObject c, EObject d2c) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		S2B d2c = (S2B) result1_bindingAndBlack[5];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decld2branchbbImpl.pattern_decld2branchbb_11_1_performtransformation_greenBFFBFFFFBB(z,
				y, x, d);
		...
		Object[] result2_black = decld2branchbbImpl
				.pattern_decld2branchbb_11_2_collecttranslatedelements_blackBBBBBBBBB(z, a, l2z, y, b2y, b, l, a2x, x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", " + "[a] = " + a
					+ ", " + "[l2z] = " + l2z + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[b] = " + b
					+ ", " + "[l] = " + l + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ".");
		...
		Object[] result2_green = decld2branchbbImpl
				.pattern_decld2branchbb_11_2_collecttranslatedelements_greenFBBBBBBBBB(z, a, l2z, y, b2y, b, l, a2x, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		decld2branchbbImpl.pattern_decld2branchbb_11_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(ruleresult, z,
				a, l2z, y, b2y, b, l, a2x, x, d, c);
		//nothing EMoflonEdge a__l____last = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge z__x____next = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge l2z__z____target = (EMoflonEdge) result3_green[14];
		...
		// 
		// 
		decld2branchbbImpl.pattern_decld2branchbb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, z, a,
				l2z, y, b2y, b, l, a2x, x, d, c, d2c);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decld2branchbbImpl.pattern_decld2branchbb_12_2_corematch_blackBBBFBFB(z, y, x, c,
				match)) {
			...
			for (Object[] result3_black : decld2branchbbImpl.pattern_decld2branchbb_12_3_findcontext_blackBBBBBB(z, y,
				...
				Object[] result4_bindingAndBlack = decld2branchbbImpl
						.pattern_decld2branchbb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, z, y, x,
								d, c, d2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Command z, Branch y, Branch x, Decision d,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject z, EObject a, EObject l2z, EObject y,
			EObject b2y, EObject b, EObject l, EObject a2x, EObject x, EObject d, EObject c, EObject d2c) {
		ruleresult.registerObject("z", z);
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("l2z", l2z);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_284(EMoflonEdge _edge_last) {
		...
		// ForEach 
		for (Object[] result2_black : decld2branchbbImpl
				.pattern_decld2branchbb_21_2_testcorematchandDECs_blackFFFFB(_edge_last)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decld2branchbbImpl
				.pattern_decld2branchbb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, z, a, y, b, l, x, d, c,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[z] = " + z + ", " + "[a] = " + a + ", " + "[y] = " + y + ", " + "[b] = " + b + ", " + "[l] = "
					+ l + ", " + "[x] = " + x + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[sourceMatch] = "
		...
		if (decld2branchbbImpl.pattern_decld2branchbb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decld2branchbbImpl.pattern_decld2branchbb_24_5_matchcorrcontext_blackBBFBB(d,
				...
				Object[] result6_black = decld2branchbbImpl
						.pattern_decld2branchbb_24_6_createcorrespondence_blackBBBBBBBBB(z, a, y, b, l, x, d, c,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", "
							+ "[a] = " + a + ", " + "[y] = " + y + ", " + "[b] = " + b + ", " + "[l] = " + l + ", "
							+ "[x] = " + x + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				decld2branchbbImpl.pattern_decld2branchbb_24_6_createcorrespondence_greenBBFBFBBFBB(z, a, y, b, l, x,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Command z, While a, Branch y, Decision b, Assignment l, Branch x, Decision d,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While a, Decision b, Assignment l, Decision d) {// 
		Object[] result1_black = decld2branchbbImpl.pattern_decld2branchbb_27_1_matchtggpattern_blackBBBB(a, b, l, d);
		if (result1_black != null) {
		...
		for (Object[] result2_black : decld2branchbbImpl
			...
			if (decld2branchbbImpl.pattern_decld2branchbb_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					decld2branchbbImpl.pattern_decld2branchbb_29_6_perform_greenFFFFFFFFFBBB(d, c, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECLD2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_DECISION_ASSIGNMENT_DECISION_BRANCH_S2B:
		...
		case RulesPackage.DECLD2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMMAND_BRANCH_BRANCH_DECISION_BRANCH_S2B:
		...
		case RulesPackage.DECLD2BRANCHBB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_276__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_276((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECLD2BRANCHBB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_284__EMOFLONEDGE:
		...
		case RulesPackage.DECLD2BRANCHBB___IS_APPLICABLE_SOLVE_CSP_CC__COMMAND_WHILE_BRANCH_DECISION_ASSIGNMENT_BRANCH_DECISION_BRANCH_MATCH_MATCH:
	...
	public static final Object[] pattern_decld2branchbb_0_1_initialbindings_blackBBBBBB(decld2branchbb _this,
			Match match, While a, Decision b, Assignment l, Decision d) {
		if (!b.equals(d)) {
	...
	public static final Object[] pattern_decld2branchbb_0_2_SolveCSP_bindingFBBBBBB(decld2branchbb _this, Match match,
			While a, Decision b, Assignment l, Decision d) {
	...
	public static final Object[] pattern_decld2branchbb_0_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		return new Object[] { match, a, b, l, d, a__l____last, d__b____negative, d__a____positive };
	}

	public static final Object[] pattern_decld2branchbb_0_5_collectcontextelements_blackBBBBB(Match match, While a,
			Decision b, Assignment l, Decision d) {
		if (!b.equals(d)) {
			return new Object[] { match, a, b, l, d };
		}
		return null;
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpC instanceof Branch) {
							...
							if (tmpD2c instanceof S2B) {
								S2B d2c = (S2B) tmpD2c;
								return new Object[] { a, b, l, d, c, d2c, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decld2branchbb_1_1_performtransformation_blackBBBBBBFBB(While a, Decision b,
			Assignment l, Decision d, Branch c, S2B d2c, decld2branchbb _this, IsApplicableMatch isApplicableMatch) {
		if (!b.equals(d)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { a, b, l, d, c, d2c, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decld2branchbb_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_decld2branchbb_1_1_performtransformation_black = pattern_decld2branchbb_1_1_performtransformation_blackBBBBBBFBB(
					a, b, l, d, c, d2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decld2branchbb_1_1_performtransformation_greenFBFFFBBFFB(While a, Decision b,
		...
		a2x.setTarget(x);
		c.setPositive(x);
		return new Object[] { z, a, l2z, y, b2y, b, l, a2x, x, c };
	}

	public static final Object[] pattern_decld2branchbb_1_2_collecttranslatedelements_blackBBBBBBBBB(Command z, While a,
			S2N l2z, Branch y, S2B b2y, Decision b, Assignment l, S2B a2x, Branch x) {
		if (!a2x.equals(b2y)) {
			if (!x.equals(y)) {
				return new Object[] { z, a, l2z, y, b2y, b, l, a2x, x };
			}
		}
		return null;
	}

	public static final Object[] pattern_decld2branchbb_1_2_collecttranslatedelements_greenFBBBBBBBBB(Command z,
			While a, S2N l2z, Branch y, S2B b2y, Decision b, Assignment l, S2B a2x, Branch x) {
		...
		return new Object[] { ruleresult, z, a, l2z, y, b2y, b, l, a2x, x };
	}

	public static final Object[] pattern_decld2branchbb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject z, EObject a, EObject l2z, EObject y, EObject b2y, EObject b,
			EObject l, EObject a2x, EObject x, EObject d, EObject c, EObject d2c) {
		if (!a.equals(z)) {
			if (!a.equals(l2z)) {
				if (!a.equals(y)) {
					if (!a.equals(b2y)) {
	...
	public static final Object[] pattern_decld2branchbb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject z, EObject a, EObject l2z, EObject y, EObject b2y, EObject b,
			EObject l, EObject a2x, EObject x, EObject d, EObject c) {
		EMoflonEdge a__l____last = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, z, a, l2z, y, b2y, b, l, a2x, x, d, c, a__l____last, z__x____next,
				l2z__z____target, b2y__y____target, b2y__b____source, a2x__a____source, a2x__x____target,
				d__b____negative, l2z__l____source, d__a____positive, c__y____negative, c__x____positive };
	}

	public static final void pattern_decld2branchbb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(decld2branchbb _this,
			PerformRuleResult ruleresult, EObject z, EObject a, EObject l2z, EObject y, EObject b2y, EObject b,
			EObject l, EObject a2x, EObject x, EObject d, EObject c, EObject d2c) {
		_this.registerObjects_FWD(ruleresult, z, a, l2z, y, b2y, b, l, a2x, x, d, c, d2c);
	...
	public static final Iterable<Object[]> pattern_decld2branchbb_2_2_corematch_blackBBBBFFB(While a, Decision b,
		...
		if (!b.equals(d)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { a, b, l, d, c, d2c, match });
				}
	...
	public static final Iterable<Object[]> pattern_decld2branchbb_2_3_findcontext_blackBBBBBB(While a, Decision b,
			Assignment l, Decision d, Branch c, S2B d2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!b.equals(d)) {
					...
					if (a.equals(d.getPositive())) {
						if (d.equals(d2c.getSource())) {
							if (c.equals(d2c.getTarget())) {
								_result.add(new Object[] { a, b, l, d, c, d2c });
							}
						}
					}
				}
	...
	public static final Object[] pattern_decld2branchbb_2_3_findcontext_greenBBBBBBFFFFFF(While a, Decision b,
			Assignment l, Decision d, Branch c, S2B d2c) {
		...
		return new Object[] { a, b, l, d, c, d2c, isApplicableMatch, a__l____last, d__b____negative, d__a____positive,
	...
	public static final Object[] pattern_decld2branchbb_2_4_solveCSP_bindingFBBBBBBBB(decld2branchbb _this,
			IsApplicableMatch isApplicableMatch, While a, Decision b, Assignment l, Decision d, Branch c, S2B d2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, a, b, l, d, c, d2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, a, b, l, d, c, d2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decld2branchbb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(decld2branchbb _this,
		...
		Object[] result_pattern_decld2branchbb_2_4_solveCSP_binding = pattern_decld2branchbb_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, a, b, l, d, c, d2c);
	...
	public static final Object[] pattern_decld2branchbb_10_4_collectelementstobetranslated_greenBBBBBFFF(Match match,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		c__x____positive.setName(c__x____positive_name_prime);
		return new Object[] { match, z, y, x, c, z__x____next, c__y____negative, c__x____positive };
	}
				...
				if (tmpX instanceof Branch) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpC instanceof Branch) {
							...
							if (tmpD2c instanceof S2B) {
								S2B d2c = (S2B) tmpD2c;
								return new Object[] { z, y, x, d, c, d2c, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decld2branchbb_11_1_performtransformation_blackBBBBBBFBB(Command z, Branch y,
			Branch x, Decision d, Branch c, S2B d2c, decld2branchbb _this, IsApplicableMatch isApplicableMatch) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { z, y, x, d, c, d2c, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decld2branchbb_11_1_performtransformation_binding != null) {
			...
			Branch x = (Branch) result_pattern_decld2branchbb_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_decld2branchbb_11_1_performtransformation_black = pattern_decld2branchbb_11_1_performtransformation_blackBBBBBBFBB(
					z, y, x, d, c, d2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decld2branchbb_11_1_performtransformation_greenBFFBFFFFBB(Command z, Branch y,
			Branch x, Decision d) {
		...
		a2x.setSource(a);
		a2x.setTarget(x);
		return new Object[] { z, a, l2z, y, b2y, b, l, a2x, x, d };
	}

	public static final Object[] pattern_decld2branchbb_11_2_collecttranslatedelements_blackBBBBBBBBB(Command z,
			While a, S2N l2z, Branch y, S2B b2y, Decision b, Assignment l, S2B a2x, Branch x) {
		if (!a2x.equals(b2y)) {
			if (!x.equals(y)) {
				return new Object[] { z, a, l2z, y, b2y, b, l, a2x, x };
	...
	public static final Object[] pattern_decld2branchbb_11_2_collecttranslatedelements_greenFBBBBBBBBB(Command z,
			While a, S2N l2z, Branch y, S2B b2y, Decision b, Assignment l, S2B a2x, Branch x) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_decld2branchbb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(decld2branchbb _this,
			PerformRuleResult ruleresult, EObject z, EObject a, EObject l2z, EObject y, EObject b2y, EObject b,
			EObject l, EObject a2x, EObject x, EObject d, EObject c, EObject d2c) {
		_this.registerObjects_BWD(ruleresult, z, a, l2z, y, b2y, b, l, a2x, x, d, c, d2c);
	...
	public static final Iterable<Object[]> pattern_decld2branchbb_12_2_corematch_blackBBBFBFB(Command z, Branch y,
			...
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							_result.add(new Object[] { z, y, x, d, c, d2c, match });
						}
	...
	public static final Iterable<Object[]> pattern_decld2branchbb_12_3_findcontext_blackBBBBBB(Command z, Branch y,
			Branch x, Decision d, Branch c, S2B d2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					if (x.equals(z.getNext())) {
						if (y.equals(c.getNegative())) {
							if (x.equals(c.getPositive())) {
								if (d.equals(d2c.getSource())) {
									if (c.equals(d2c.getTarget())) {
										_result.add(new Object[] { z, y, x, d, c, d2c });
									}
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_12_3_findcontext_greenBBBBBBFFFFFF(Command z, Branch y,
		...
		d2c__d____source.setName(d2c__d____source_name_prime);
		d2c__c____target.setName(d2c__c____target_name_prime);
		return new Object[] { z, y, x, d, c, d2c, isApplicableMatch, z__x____next, c__y____negative, c__x____positive,
				d2c__d____source, d2c__c____target };
	}

	public static final Object[] pattern_decld2branchbb_12_4_solveCSP_bindingFBBBBBBBB(decld2branchbb _this,
			IsApplicableMatch isApplicableMatch, Command z, Branch y, Branch x, Decision d, Branch c, S2B d2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, z, y, x, d, c, d2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, z, y, x, d, c, d2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decld2branchbb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decld2branchbb _this,
		...
		Object[] result_pattern_decld2branchbb_12_4_solveCSP_binding = pattern_decld2branchbb_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, z, y, x, d, c, d2c);
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_109298 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_1BBBB(Command z, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_positive_993512 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!y.equals(__DEC_z_positive_993512)) {
							if (!x.equals(__DEC_z_positive_993512)) {
								if (!c.equals(__DEC_z_positive_993512)) {
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_2BBBB(Command z, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_negative_219791 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!y.equals(__DEC_z_negative_219791)) {
							if (!x.equals(__DEC_z_negative_219791)) {
								if (!c.equals(__DEC_z_negative_219791)) {
									return new Object[] { z, y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_3B(Branch y) {
		for (Graph __DEC_y_root_255133 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_4BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_960050 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_960050)) {
							if (!x.equals(__DEC_y_positive_960050)) {
								if (!c.equals(__DEC_y_positive_960050)) {
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_5BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_630335 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_630335)) {
							if (!x.equals(__DEC_y_negative_630335)) {
								if (!c.equals(__DEC_y_negative_630335)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_363461 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_7BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_961981 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_961981)) {
							if (!y.equals(__DEC_x_positive_961981)) {
								if (!c.equals(__DEC_x_positive_961981)) {
	...
	public static final Object[] pattern_decld2branchbb_20_2_testcorematchandDECs_black_nac_8BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_923959 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_923959)) {
							if (!y.equals(__DEC_x_negative_923959)) {
								if (!c.equals(__DEC_x_negative_923959)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_0BBB(While a, Decision b,
			Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_a_negative_343666 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!b.equals(__DEC_a_negative_343666)) {
					if (!d.equals(__DEC_a_negative_343666)) {
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_1B(While a) {
		for (While __DEC_a_first_97179 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!a.equals(__DEC_a_first_97179)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_2B(While a) {
		for (While __DEC_a_last_253551 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!a.equals(__DEC_a_last_253551)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_3B(While a) {
		for (Program __DEC_a_first_710749 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_4BB(Decision b,
			Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_b_positive_656448 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!b.equals(__DEC_b_positive_656448)) {
					if (!d.equals(__DEC_b_positive_656448)) {
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_5BB(Decision b, While a) {
		for (While __DEC_b_first_727089 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!a.equals(__DEC_b_first_727089)) {
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_6BB(Decision b, While a) {
		for (While __DEC_b_last_349596 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!a.equals(__DEC_b_last_349596)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_7B(Decision b) {
		for (Program __DEC_b_first_628500 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_8BBB(Assignment l,
		...
		if (!b.equals(d)) {
			for (Decision __DEC_l_positive_209316 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "positive")) {
				if (!b.equals(__DEC_l_positive_209316)) {
					if (!d.equals(__DEC_l_positive_209316)) {
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_9BBB(Assignment l,
			Decision b, Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_l_negative_404363 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "negative")) {
				if (!b.equals(__DEC_l_negative_404363)) {
					if (!d.equals(__DEC_l_negative_404363)) {
						return new Object[] { l, b, d };
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_10BB(Assignment l,
			While a) {
		for (While __DEC_l_first_395070 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!a.equals(__DEC_l_first_395070)) {
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_11BB(Assignment l,
			While a) {
		for (While __DEC_l_last_973476 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!a.equals(__DEC_l_last_973476)) {
				return new Object[] { l, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_12B(Assignment l) {
		for (Program __DEC_l_first_480620 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
					...
					if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_1B(a) == null) {
						if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_2B(a) == null) {
							if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_3B(a) == null) {
								if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_10BB(l, a) == null) {
									if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_11BB(l, a) == null) {
										if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_12B(l) == null) {
											if (pattern_decld2branchbb_21_2_testcorematchandDECs_black_nac_21BB(a,
													l) == null) {
	...
	public static final boolean pattern_decld2branchbb_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			decld2branchbb _this, Match match, While a, Decision b, Assignment l, Decision d) {
						...
						if (tmpL instanceof Assignment) {
							...
							if (tmpX instanceof Branch) {
								...
								if (tmpD instanceof Decision) {
									...
									if (tmpC instanceof Branch) {
										Branch c = (Branch) tmpC;
										return new Object[] { z, a, y, b, l, x, d, c, targetMatch, sourceMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Command z, While a,
			Branch y, Decision b, Assignment l, Branch x, Decision d, Branch c, Match sourceMatch, Match targetMatch) {
		if (!b.equals(d)) {
			if (!x.equals(y)) {
				if (!c.equals(y)) {
					if (!c.equals(x)) {
						if (!sourceMatch.equals(targetMatch)) {
							return new Object[] { z, a, y, b, l, x, d, c, sourceMatch, targetMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decld2branchbb_24_2_matchsrctrgcontext_binding != null) {
			...
			While a = (While) result_pattern_decld2branchbb_24_2_matchsrctrgcontext_binding[1];
			Branch y = (Branch) result_pattern_decld2branchbb_24_2_matchsrctrgcontext_binding[2];
			Decision b = (Decision) result_pattern_decld2branchbb_24_2_matchsrctrgcontext_binding[3];
			...
			Decision d = (Decision) result_pattern_decld2branchbb_24_2_matchsrctrgcontext_binding[6];
			Branch c = (Branch) result_pattern_decld2branchbb_24_2_matchsrctrgcontext_binding[7];
			...
			Object[] result_pattern_decld2branchbb_24_2_matchsrctrgcontext_black = pattern_decld2branchbb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					z, a, y, b, l, x, d, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decld2branchbb_24_3_solvecsp_bindingFBBBBBBBBBBB(decld2branchbb _this,
			Command z, While a, Branch y, Decision b, Assignment l, Branch x, Decision d, Branch c, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(z, a, y, b, l, x, d, c, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, z, a, y, b, l, x, d, c, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decld2branchbb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(decld2branchbb _this,
		...
		Object[] result_pattern_decld2branchbb_24_3_solvecsp_binding = pattern_decld2branchbb_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, z, a, y, b, l, x, d, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decld2branchbb_24_6_createcorrespondence_blackBBBBBBBBB(Command z, While a,
			Branch y, Decision b, Assignment l, Branch x, Decision d, Branch c, CCMatch ccMatch) {
		if (!b.equals(d)) {
			if (!x.equals(y)) {
				if (!c.equals(y)) {
					if (!c.equals(x)) {
						return new Object[] { z, a, y, b, l, x, d, c, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decld2branchbb_24_6_createcorrespondence_greenBBFBFBBFBB(Command z, While a,
			Branch y, Decision b, Assignment l, Branch x, CCMatch ccMatch) {
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		l2z.setTarget(z);
		...
		return new Object[] { z, a, l2z, y, b2y, b, l, a2x, x, ccMatch };
	}
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_0BBB(While a, Decision b,
			Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_a_negative_988825 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!b.equals(__DEC_a_negative_988825)) {
					if (!d.equals(__DEC_a_negative_988825)) {
						return new Object[] { a, b, d };
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_1B(While a) {
		for (While __DEC_a_first_887120 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!a.equals(__DEC_a_first_887120)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_2B(While a) {
		for (While __DEC_a_last_827876 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!a.equals(__DEC_a_last_827876)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_3B(While a) {
		for (Program __DEC_a_first_517496 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_4BB(Decision b, Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_b_positive_749472 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!b.equals(__DEC_b_positive_749472)) {
					if (!d.equals(__DEC_b_positive_749472)) {
						return new Object[] { b, d };
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_5BB(Decision b, While a) {
		for (While __DEC_b_first_439254 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!a.equals(__DEC_b_first_439254)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_6BB(Decision b, While a) {
		for (While __DEC_b_last_413623 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!a.equals(__DEC_b_last_413623)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_7B(Decision b) {
		for (Program __DEC_b_first_297325 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_8BBB(Assignment l, Decision b,
			Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_l_positive_369380 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "positive")) {
				if (!b.equals(__DEC_l_positive_369380)) {
					if (!d.equals(__DEC_l_positive_369380)) {
						return new Object[] { l, b, d };
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_9BBB(Assignment l, Decision b,
			Decision d) {
		if (!b.equals(d)) {
			for (Decision __DEC_l_negative_889596 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(l, Decision.class, "negative")) {
				if (!b.equals(__DEC_l_negative_889596)) {
					if (!d.equals(__DEC_l_negative_889596)) {
						return new Object[] { l, b, d };
					}
				}
			}
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_10BB(Assignment l, While a) {
		for (While __DEC_l_first_187202 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "first")) {
			if (!a.equals(__DEC_l_first_187202)) {
				return new Object[] { l, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_11BB(Assignment l, While a) {
		for (While __DEC_l_last_443258 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!a.equals(__DEC_l_last_443258)) {
				return new Object[] { l, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_black_nac_12B(Assignment l) {
		for (Program __DEC_l_first_310907 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_27_1_matchtggpattern_blackBBBB(While a, Decision b,
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_718199 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_1BBBB(Command z, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_positive_851447 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!y.equals(__DEC_z_positive_851447)) {
							if (!x.equals(__DEC_z_positive_851447)) {
								if (!c.equals(__DEC_z_positive_851447)) {
									return new Object[] { z, y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_2BBBB(Command z, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_z_negative_627555 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!y.equals(__DEC_z_negative_627555)) {
							if (!x.equals(__DEC_z_negative_627555)) {
								if (!c.equals(__DEC_z_negative_627555)) {
									return new Object[] { z, y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_3B(Branch y) {
		for (Graph __DEC_y_root_938867 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_4BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_525511 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_525511)) {
							if (!x.equals(__DEC_y_positive_525511)) {
								if (!c.equals(__DEC_y_positive_525511)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_5BBB(Branch y, Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_136222 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_136222)) {
							if (!x.equals(__DEC_y_negative_136222)) {
								if (!c.equals(__DEC_y_negative_136222)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_217326 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_7BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_925830 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_925830)) {
							if (!y.equals(__DEC_x_positive_925830)) {
								if (!c.equals(__DEC_x_positive_925830)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_28_1_matchtggpattern_black_nac_8BBB(Branch x, Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_823860 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_823860)) {
							if (!y.equals(__DEC_x_negative_823860)) {
								if (!c.equals(__DEC_x_negative_823860)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decld2branchbb_29_6_perform_greenFFFFFFFFFBBB(Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		Command z = ControlflowFactory.eINSTANCE.createCommand();
		While a = SourcecodeFactory.eINSTANCE.createWhile();
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		return new Object[] { z, a, l2z, y, b2y, b, l, a2x, x, d, c, ruleResult };
	}
