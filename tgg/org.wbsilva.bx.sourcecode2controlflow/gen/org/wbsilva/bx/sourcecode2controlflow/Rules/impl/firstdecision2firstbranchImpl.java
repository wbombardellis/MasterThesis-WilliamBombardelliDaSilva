...
public class firstdecision2firstbranchImpl extends AbstractRuleImpl implements firstdecision2firstbranch {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = firstdecision2firstbranchImpl
				.pattern_firstdecision2firstbranch_1_1_performtransformation_greenFFBB(d, g);
		...
		Object[] result3_black = firstdecision2firstbranchImpl
				.pattern_firstdecision2firstbranch_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, p, b, f2r, d, g,
						p2g);
		...
		firstdecision2firstbranchImpl
				.pattern_firstdecision2firstbranch_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, p, b, f2r, d, g);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject p, EObject b, EObject f2r, EObject d,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = firstdecision2firstbranchImpl
				.pattern_firstdecision2firstbranch_11_1_performtransformation_greenBBFF(p, b);
		...
		Object[] result3_black = firstdecision2firstbranchImpl
				.pattern_firstdecision2firstbranch_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, p, b, f2r, d, g,
						p2g);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[p] = " + p + ", " + "[b] = " + b + ", " + "[f2r] = " + f2r + ", " + "[d] = " + d + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : firstdecision2firstbranchImpl
			...
			// ForEach 
			for (Object[] result3_black : firstdecision2firstbranchImpl
					.pattern_firstdecision2firstbranch_12_3_findcontext_blackBBBB(p, b, g, p2g)) {
				Object[] result3_green = firstdecision2firstbranchImpl
						.pattern_firstdecision2firstbranch_12_3_findcontext_greenBBBBFFFF(p, b, g, p2g);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[p] = " + p + ", " + "[b] = " + b
							+ ", " + "[g] = " + g + ", " + "[p2g] = " + p2g + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Program p, Branch b, Graph g, P2G p2g) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject p, EObject b, EObject f2r, EObject d,
			EObject g, EObject p2g) {
		ruleresult.registerObject("p", p);
		ruleresult.registerObject("b", b);
		ruleresult.registerObject("f2r", f2r);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_35(EMoflonEdge _edge_root) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_36(EMoflonEdge _edge_first) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = firstdecision2firstbranchImpl
				.pattern_firstdecision2firstbranch_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, p, b, d, g, sourceMatch,
						targetMatch);
		...
		if (firstdecision2firstbranchImpl.pattern_firstdecision2firstbranch_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : firstdecision2firstbranchImpl
				...
				Object[] result6_black = firstdecision2firstbranchImpl
						.pattern_firstdecision2firstbranch_24_6_createcorrespondence_blackBBBBB(p, b, d, g, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[p] = " + p + ", " + "[b] = " + b + ", "
									+ "[d] = " + d + ", " + "[g] = " + g + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Program p, Branch b, Decision d, Graph g, Match sourceMatch,
		...
		for (Object[] result2_black : firstdecision2firstbranchImpl
			...
			if (firstdecision2firstbranchImpl.pattern_firstdecision2firstbranch_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					firstdecision2firstbranchImpl.pattern_firstdecision2firstbranch_29_6_perform_greenBFFFBB(p, g,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIRSTDECISION2FIRSTBRANCH___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PROGRAM_BRANCH_GRAPH_P2G:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Program) arguments.get(1),
					(Branch) arguments.get(2), (Graph) arguments.get(3), (P2G) arguments.get(4));
		...
		case RulesPackage.FIRSTDECISION2FIRSTBRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_35__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_35((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIRSTDECISION2FIRSTBRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_36__EMOFLONEDGE:
		...
		case RulesPackage.FIRSTDECISION2FIRSTBRANCH___IS_APPLICABLE_SOLVE_CSP_CC__PROGRAM_BRANCH_DECISION_GRAPH_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Program) arguments.get(0), (Branch) arguments.get(1),
					(Decision) arguments.get(2), (Graph) arguments.get(3), (Match) arguments.get(4),
	...
	public static final Object[] pattern_firstdecision2firstbranch_1_1_performtransformation_greenFFBB(Decision d,
			Graph g) {
	...
	public static final Object[] pattern_firstdecision2firstbranch_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject p, EObject b, EObject f2r, EObject d, EObject g, EObject p2g) {
		if (!p.equals(p2g)) {
			if (!b.equals(p)) {
				if (!b.equals(f2r)) {
					if (!b.equals(d)) {
												...
												if (!d.equals(f2r)) {
													if (!d.equals(g)) {
														if (!d.equals(p2g)) {
															if (!g.equals(p)) {
																if (!g.equals(p2g)) {
																	return new Object[] { ruleresult, p, b, f2r, d, g,
																			p2g };
																}
															}
														}
	...
	public static final Object[] pattern_firstdecision2firstbranch_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject p, EObject b, EObject f2r, EObject d, EObject g) {
		EMoflonEdge p__d____first = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, p, b, f2r, d, g, p__d____first, f2r__d____source, f2r__b____target,
				g__b____root };
	}

	public static final void pattern_firstdecision2firstbranch_1_5_registerobjects_expressionBBBBBBBB(
			firstdecision2firstbranch _this, PerformRuleResult ruleresult, EObject p, EObject b, EObject f2r, EObject d,
			EObject g, EObject p2g) {
		_this.registerObjects_FWD(ruleresult, p, b, f2r, d, g, p2g);
	...
	public static final Object[] pattern_firstdecision2firstbranch_2_3_findcontext_greenBBBBFFFF(Program p, Decision d,
		...
		return new Object[] { p, d, g, p2g, isApplicableMatch, p__d____first, p2g__g____target, p2g__p____source };
	}
		...
		if (tmpP instanceof Program) {
			...
			if (tmpB instanceof Branch) {
				...
				if (tmpG instanceof Graph) {
					...
					if (tmpP2g instanceof P2G) {
						P2G p2g = (P2G) tmpP2g;
						return new Object[] { p, b, g, p2g, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_firstdecision2firstbranch_11_1_performtransformation_blackBBBBFBB(Program p,
			Branch b, Graph g, P2G p2g, firstdecision2firstbranch _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { p, b, g, p2g, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_firstdecision2firstbranch_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_firstdecision2firstbranch_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_firstdecision2firstbranch_11_1_performtransformation_black = pattern_firstdecision2firstbranch_11_1_performtransformation_blackBBBBFBB(
					p, b, g, p2g, _this, isApplicableMatch);
	...
	public static final Object[] pattern_firstdecision2firstbranch_11_1_performtransformation_greenBBFF(Program p,
			Branch b) {
		S2B f2r = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
	...
	public static final void pattern_firstdecision2firstbranch_11_5_registerobjects_expressionBBBBBBBB(
			firstdecision2firstbranch _this, PerformRuleResult ruleresult, EObject p, EObject b, EObject f2r, EObject d,
			EObject g, EObject p2g) {
		_this.registerObjects_BWD(ruleresult, p, b, f2r, d, g, p2g);
	...
	public static final Iterable<Object[]> pattern_firstdecision2firstbranch_12_2_corematch_blackFBBFB(Branch b,
		...
		for (P2G p2g : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(g, P2G.class, "target")) {
			...
			if (p != null) {
				_result.add(new Object[] { p, b, g, p2g, match });
			}
	...
	public static final Iterable<Object[]> pattern_firstdecision2firstbranch_12_3_findcontext_blackBBBB(Program p,
			Branch b, Graph g, P2G p2g) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (b.equals(g.getRoot())) {
			if (g.equals(p2g.getTarget())) {
				if (p.equals(p2g.getSource())) {
					_result.add(new Object[] { p, b, g, p2g });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_firstdecision2firstbranch_12_3_findcontext_greenBBBBFFFF(Program p, Branch b,
			Graph g, P2G p2g) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge g__b____root = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge p2g__g____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		p2g__g____target.setName(p2g__g____target_name_prime);
		p2g__p____source.setName(p2g__p____source_name_prime);
		return new Object[] { p, b, g, p2g, isApplicableMatch, g__b____root, p2g__g____target, p2g__p____source };
	}

	public static final Object[] pattern_firstdecision2firstbranch_12_4_solveCSP_bindingFBBBBBB(
			firstdecision2firstbranch _this, IsApplicableMatch isApplicableMatch, Program p, Branch b, Graph g,
			P2G p2g) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, p, b, g, p2g);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p, b, g, p2g };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstdecision2firstbranch_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_firstdecision2firstbranch_12_4_solveCSP_binding = pattern_firstdecision2firstbranch_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, p, b, g, p2g);
	...
	public static final Object[] pattern_firstdecision2firstbranch_20_2_testcorematchandDECs_black_nac_0BB(Branch b,
			Graph g) {
		for (Graph __DEC_b_root_385866 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Graph.class, "root")) {
			if (!g.equals(__DEC_b_root_385866)) {
	...
	public static final Object[] pattern_firstdecision2firstbranch_20_2_testcorematchandDECs_black_nac_1B(Branch b) {
		for (Branch __DEC_b_positive_328265 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_b_positive_328265)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_20_2_testcorematchandDECs_black_nac_2B(Branch b) {
		for (Branch __DEC_b_negative_525555 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_b_negative_525555)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_21_2_testcorematchandDECs_black_nac_0B(Decision d) {
		for (Decision __DEC_d_positive_898221 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_d_positive_898221)) {
				return new Object[] { d };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_21_2_testcorematchandDECs_black_nac_1B(Decision d) {
		for (Decision __DEC_d_negative_270804 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_d_negative_270804)) {
				return new Object[] { d };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_21_2_testcorematchandDECs_black_nac_2B(Decision d) {
		for (While __DEC_d_first_777340 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				While.class, "first")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_21_2_testcorematchandDECs_black_nac_3B(Decision d) {
		for (While __DEC_d_last_542730 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				While.class, "last")) {
			return new Object[] { d };
		}
		return null;
		...
		if (tmpP instanceof Program) {
			...
			if (tmpB instanceof Branch) {
				...
				if (tmpD instanceof Decision) {
					...
					if (tmpG instanceof Graph) {
						Graph g = (Graph) tmpG;
						return new Object[] { p, b, d, g, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_firstdecision2firstbranch_24_2_matchsrctrgcontext_blackBBBBBB(Program p,
			Branch b, Decision d, Graph g, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_firstdecision2firstbranch_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_firstdecision2firstbranch_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_firstdecision2firstbranch_24_2_matchsrctrgcontext_black = pattern_firstdecision2firstbranch_24_2_matchsrctrgcontext_blackBBBBBB(
					p, b, d, g, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_firstdecision2firstbranch_24_3_solvecsp_bindingFBBBBBBB(
			firstdecision2firstbranch _this, Program p, Branch b, Decision d, Graph g, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(p, b, d, g, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, p, b, d, g, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_firstdecision2firstbranch_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_firstdecision2firstbranch_24_3_solvecsp_binding = pattern_firstdecision2firstbranch_24_3_solvecsp_bindingFBBBBBBB(
				_this, p, b, d, g, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_firstdecision2firstbranch_24_6_createcorrespondence_blackBBBBB(Program p,
			Branch b, Decision d, Graph g, CCMatch ccMatch) {
		return new Object[] { p, b, d, g, ccMatch };
	}
	...
	public static final Object[] pattern_firstdecision2firstbranch_27_1_matchtggpattern_black_nac_0B(Decision d) {
		for (Decision __DEC_d_positive_15847 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_d_positive_15847)) {
				return new Object[] { d };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_27_1_matchtggpattern_black_nac_1B(Decision d) {
		for (Decision __DEC_d_negative_292167 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_d_negative_292167)) {
				return new Object[] { d };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_27_1_matchtggpattern_black_nac_2B(Decision d) {
		for (While __DEC_d_first_173786 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				While.class, "first")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_27_1_matchtggpattern_black_nac_3B(Decision d) {
		for (While __DEC_d_last_732000 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d,
				While.class, "last")) {
			return new Object[] { d };
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_28_1_matchtggpattern_black_nac_0BB(Branch b,
			Graph g) {
		for (Graph __DEC_b_root_188590 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Graph.class, "root")) {
			if (!g.equals(__DEC_b_root_188590)) {
				return new Object[] { b, g };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_28_1_matchtggpattern_black_nac_1B(Branch b) {
		for (Branch __DEC_b_positive_339809 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "positive")) {
			if (!b.equals(__DEC_b_positive_339809)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_28_1_matchtggpattern_black_nac_2B(Branch b) {
		for (Branch __DEC_b_negative_908572 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Branch.class, "negative")) {
			if (!b.equals(__DEC_b_negative_908572)) {
				return new Object[] { b };
			}
		}
		return null;
	...
	public static final Object[] pattern_firstdecision2firstbranch_29_6_perform_greenBFFFBB(Program p, Graph g,
			ModelgeneratorRuleResult ruleResult) {
		Branch b = ControlflowFactory.eINSTANCE.createBranch();
		S2B f2r = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Decision d = SourcecodeFactory.eINSTANCE.createDecision();
		...
		return new Object[] { p, b, f2r, d, g, ruleResult };
	}
