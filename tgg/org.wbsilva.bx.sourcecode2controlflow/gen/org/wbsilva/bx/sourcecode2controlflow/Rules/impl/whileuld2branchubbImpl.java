...
public class whileuld2branchubbImpl extends AbstractRuleImpl implements whileuld2branchubb {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_1_1_performtransformation_greenFFFBBBFFBF(a, c, b, i);
		...
		Object[] result2_black = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_1_2_collecttranslatedelements_blackBBBBBBBBB(z, b2y, a2x, a, c, b, c2z, y,
						x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", " + "[b2y] = "
					+ b2y + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[b] = " + b
					+ ", " + "[c2z] = " + c2z + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
		}
		Object[] result2_green = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_1_2_collecttranslatedelements_greenFBBBBBBBBB(z, b2y, a2x, a, c, b, c2z, y,
						x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, z, b2y, a2x, a, c, b,
						w2i, c2z, y, i, w, x);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[z] = " + z + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a
					+ ", " + "[c] = " + c + ", " + "[b] = " + b + ", " + "[w2i] = " + w2i + ", " + "[c2z] = " + c2z
					+ ", " + "[y] = " + y + ", " + "[i] = " + i + ", " + "[w] = " + w + ", " + "[x] = " + x + ".");
		}
		whileuld2branchubbImpl.pattern_whileuld2branchubb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, z, b2y, a2x, a, c, b, c2z, y, i, w, x);
		...
		whileuld2branchubbImpl.pattern_whileuld2branchubb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult,
				z, b2y, a2x, a, c, b, w2i, c2z, y, i, w, x);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whileuld2branchubbImpl.pattern_whileuld2branchubb_2_2_corematch_blackBBBFFBB(a, c,
				b, w, match)) {
			S2B w2i = (S2B) result2_black[3];
			Branch i = (Branch) result2_black[4];
			// ForEach 
			for (Object[] result3_black : whileuld2branchubbImpl
					.pattern_whileuld2branchubb_2_3_findcontext_blackBBBBBB(a, c, b, w2i, i, w)) {
				Object[] result3_green = whileuld2branchubbImpl
						.pattern_whileuld2branchubb_2_3_findcontext_greenBBBBBBFFFFFFF(a, c, b, w2i, i, w);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject z, EObject b2y, EObject a2x, EObject a,
			EObject c, EObject b, EObject w2i, EObject c2z, EObject y, EObject i, EObject w, EObject x) {
	...
	public boolean isAppropriate_BWD(Match match, Branch z, Command y, Branch i, Branch x) {
		...
		Object[] result1_black = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_10_1_initialbindings_blackBBBBBB(this, match, z, y, i, x);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, z, y, i, x);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ", "
					+ "[x] = " + x + ".");
		...
		if (whileuld2branchubbImpl.pattern_whileuld2branchubb_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileuld2branchubbImpl
					.pattern_whileuld2branchubb_10_4_collectelementstobetranslated_blackBBBBB(match, z, y, i, x);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ", " + "[x] = " + x + ".");
			}
			...
			Object[] result5_black = whileuld2branchubbImpl
					.pattern_whileuld2branchubb_10_5_collectcontextelements_blackBBBBB(match, z, y, i, x);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ", " + "[x] = " + x + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_11_1_performtransformation_greenBFFFFFFBBB(z, y, w, x);
		S2N b2y = (S2N) result1_green[1];
		S2B a2x = (S2B) result1_green[2];
		...
		Object[] result2_black = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_11_2_collecttranslatedelements_blackBBBBBBBBB(z, b2y, a2x, a, c, b, c2z, y,
						x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", " + "[b2y] = "
					+ b2y + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[b] = " + b
		...
		Object[] result2_green = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_11_2_collecttranslatedelements_greenFBBBBBBBBB(z, b2y, a2x, a, c, b, c2z, y,
						x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, z, b2y, a2x, a, c,
						b, w2i, c2z, y, i, w, x);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[z] = " + z + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a
		...
		whileuld2branchubbImpl.pattern_whileuld2branchubb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this,
				ruleresult, z, b2y, a2x, a, c, b, w2i, c2z, y, i, w, x);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whileuld2branchubbImpl.pattern_whileuld2branchubb_12_2_corematch_blackBFBBFBB(z,
				y, i, x, match)) {
			S2B w2i = (S2B) result2_black[1];
			While w = (While) result2_black[4];
			// ForEach 
			for (Object[] result3_black : whileuld2branchubbImpl
					.pattern_whileuld2branchubb_12_3_findcontext_blackBBBBBB(z, w2i, y, i, w, x)) {
				Object[] result3_green = whileuld2branchubbImpl
						.pattern_whileuld2branchubb_12_3_findcontext_greenBBBBBBFFFFFFF(z, w2i, y, i, w, x);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = whileuld2branchubbImpl
						.pattern_whileuld2branchubb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, z,
								w2i, y, i, w, x);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject z, EObject b2y, EObject a2x, EObject a,
			EObject c, EObject b, EObject w2i, EObject c2z, EObject y, EObject i, EObject w, EObject x) {
		ruleresult.registerObject("z", z);
		ruleresult.registerObject("b2y", b2y);
		ruleresult.registerObject("a2x", a2x);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_75(EMoflonEdge _edge_next) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whileuld2branchubbImpl
				.pattern_whileuld2branchubb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, z, a, c, b, y, i, w, x,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[z] = " + z + ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[b] = " + b + ", " + "[y] = "
					+ y + ", " + "[i] = " + i + ", " + "[w] = " + w + ", " + "[x] = " + x + ", " + "[sourceMatch] = "
		...
		if (whileuld2branchubbImpl.pattern_whileuld2branchubb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whileuld2branchubbImpl
				...
				Object[] result6_black = whileuld2branchubbImpl
						.pattern_whileuld2branchubb_24_6_createcorrespondence_blackBBBBBBBBB(z, a, c, b, y, i, w, x,
								ccMatch);
				if (result6_black == null) {
				...
				whileuld2branchubbImpl.pattern_whileuld2branchubb_24_6_createcorrespondence_greenBFFBBBFBBB(z, a, c, b,
						y, x, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Branch z, While a, Decision c, Assignment b, Command y, Branch i, While w,
	...
	public boolean checkDEC_BWD(Branch z, Command y, Branch i, Branch x) {// 
		Object[] result1_black = whileuld2branchubbImpl.pattern_whileuld2branchubb_28_1_matchtggpattern_blackBBBB(z, y,
				i, x);
		if (result1_black != null) {
		...
		for (Object[] result2_black : whileuld2branchubbImpl
			...
			if (whileuld2branchubbImpl.pattern_whileuld2branchubb_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					whileuld2branchubbImpl.pattern_whileuld2branchubb_29_6_perform_greenFFFFFFFFBBFB(i, w, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_DECISION_ASSIGNMENT_S2B_BRANCH_WHILE:
		...
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPROPRIATE_BWD__MATCH_BRANCH_COMMAND_BRANCH_BRANCH:
		...
		case RulesPackage.WHILEULD2BRANCHUBB___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_BRANCH_COMMAND_BRANCH_BRANCH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Branch) arguments.get(1), (Command) arguments.get(2),
					(Branch) arguments.get(3), (Branch) arguments.get(4));
			return null;
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_BRANCH_COMMAND_BRANCH_BRANCH:
		...
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_S2B_COMMAND_BRANCH_WHILE_BRANCH:
		...
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_75__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_75((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_81__EMOFLONEDGE:
		...
		case RulesPackage.WHILEULD2BRANCHUBB___IS_APPLICABLE_SOLVE_CSP_CC__BRANCH_WHILE_DECISION_ASSIGNMENT_COMMAND_BRANCH_WHILE_BRANCH_MATCH_MATCH:
		...
		case RulesPackage.WHILEULD2BRANCHUBB___CHECK_DEC_BWD__BRANCH_COMMAND_BRANCH_BRANCH:
	...
	public static final Object[] pattern_whileuld2branchubb_0_4_collectelementstobetranslated_greenBBBBBFFFF(
		...
		return new Object[] { match, a, c, b, w, a__b____last, w__c____next, a__b____first, w__a____first };
	}
					...
					if (tmpW2i instanceof S2B) {
						...
						if (tmpI instanceof Branch) {
							...
							if (tmpW instanceof While) {
								While w = (While) tmpW;
								return new Object[] { a, c, b, w2i, i, w, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileuld2branchubb_1_1_performtransformation_blackBBBBBBFBB(While a,
			Decision c, Assignment b, S2B w2i, Branch i, While w, whileuld2branchubb _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(w)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { a, c, b, w2i, i, w, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileuld2branchubb_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_whileuld2branchubb_1_1_performtransformation_black = pattern_whileuld2branchubb_1_1_performtransformation_blackBBBBBBFBB(
					a, c, b, w2i, i, w, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileuld2branchubb_1_1_performtransformation_greenFFFBBBFFBF(While a,
		...
		x.setPositive(y);
		a2x.setTarget(x);
		return new Object[] { z, b2y, a2x, a, c, b, c2z, y, i, x };
	}

	public static final Object[] pattern_whileuld2branchubb_1_2_collecttranslatedelements_blackBBBBBBBBB(Branch z,
			S2N b2y, S2B a2x, While a, Decision c, Assignment b, S2B c2z, Command y, Branch x) {
		if (!a2x.equals(c2z)) {
			if (!x.equals(z)) {
				return new Object[] { z, b2y, a2x, a, c, b, c2z, y, x };
			}
		}
		return null;
	}

	public static final Object[] pattern_whileuld2branchubb_1_2_collecttranslatedelements_greenFBBBBBBBBB(Branch z,
			S2N b2y, S2B a2x, While a, Decision c, Assignment b, S2B c2z, Command y, Branch x) {
		...
		return new Object[] { ruleresult, z, b2y, a2x, a, c, b, c2z, y, x };
	}

	public static final Object[] pattern_whileuld2branchubb_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject z, EObject b2y, EObject a2x, EObject a, EObject c, EObject b,
			EObject w2i, EObject c2z, EObject y, EObject i, EObject w, EObject x) {
		if (!b2y.equals(z)) {
			if (!b2y.equals(c)) {
				if (!b2y.equals(w2i)) {
					if (!b2y.equals(c2z)) {
	...
	public static final Object[] pattern_whileuld2branchubb_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject z, EObject b2y, EObject a2x, EObject a, EObject c, EObject b,
			EObject c2z, EObject y, EObject i, EObject w, EObject x) {
		...
		w__a____first.setName(w__a____first_name_prime);
		return new Object[] { ruleresult, z, b2y, a2x, a, c, b, c2z, y, i, w, x, a2x__a____source, b2y__b____source,
				c2z__z____target, b2y__y____target, a__b____last, y__x____next, c2z__c____source, i__x____positive,
				i__z____negative, w__c____next, a__b____first, x__y____positive, a2x__x____target, w__a____first };
	}

	public static final void pattern_whileuld2branchubb_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileuld2branchubb _this, PerformRuleResult ruleresult, EObject z, EObject b2y, EObject a2x, EObject a,
			EObject c, EObject b, EObject w2i, EObject c2z, EObject y, EObject i, EObject w, EObject x) {
		_this.registerObjects_FWD(ruleresult, z, b2y, a2x, a, c, b, w2i, c2z, y, i, w, x);
	...
	public static final Iterable<Object[]> pattern_whileuld2branchubb_2_2_corematch_blackBBBFFBB(While a, Decision c,
		...
		if (!a.equals(w)) {
			for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class, "source")) {
				...
				if (i != null) {
					_result.add(new Object[] { a, c, b, w2i, i, w, match });
				}
	...
	public static final Iterable<Object[]> pattern_whileuld2branchubb_2_3_findcontext_blackBBBBBB(While a, Decision c,
			Assignment b, S2B w2i, Branch i, While w) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(w)) {
						...
						if (b.equals(a.getFirst())) {
							if (w.equals(w2i.getSource())) {
								if (a.equals(w.getFirst())) {
									_result.add(new Object[] { a, c, b, w2i, i, w });
								}
							}
						}
					}
	...
	public static final Object[] pattern_whileuld2branchubb_2_3_findcontext_greenBBBBBBFFFFFFF(While a, Decision c,
		...
		w__a____first.setName(w__a____first_name_prime);
		return new Object[] { a, c, b, w2i, i, w, isApplicableMatch, a__b____last, w2i__i____target, w__c____next,
				a__b____first, w2i__w____source, w__a____first };
	}

	public static final Object[] pattern_whileuld2branchubb_2_4_solveCSP_bindingFBBBBBBBB(whileuld2branchubb _this,
			IsApplicableMatch isApplicableMatch, While a, Decision c, Assignment b, S2B w2i, Branch i, While w) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, a, c, b, w2i, i, w);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, a, c, b, w2i, i, w };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileuld2branchubb_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			whileuld2branchubb _this, IsApplicableMatch isApplicableMatch, While a, Decision c, Assignment b, S2B w2i,
			Branch i, While w) {
		Object[] result_pattern_whileuld2branchubb_2_4_solveCSP_binding = pattern_whileuld2branchubb_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, a, c, b, w2i, i, w);
	...
	public static final Object[] pattern_whileuld2branchubb_10_2_SolveCSP_bindingAndBlackFBBBBBB(
			whileuld2branchubb _this, Match match, Branch z, Command y, Branch i, Branch x) {
	...
	public static final Object[] pattern_whileuld2branchubb_10_4_collectelementstobetranslated_greenBBBBBFFFF(
		...
		i__z____negative.setName(i__z____negative_name_prime);
		x__y____positive.setName(x__y____positive_name_prime);
		return new Object[] { match, z, y, i, x, y__x____next, i__x____positive, i__z____negative, x__y____positive };
	}
	...
	public static final Object[] pattern_whileuld2branchubb_11_1_performtransformation_blackBBBBBBFBB(Branch z, S2B w2i,
			Command y, Branch i, While w, Branch x, whileuld2branchubb _this, IsApplicableMatch isApplicableMatch) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
	...
	public static final Object[] pattern_whileuld2branchubb_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileuld2branchubb_11_1_performtransformation_binding != null) {
			Branch z = (Branch) result_pattern_whileuld2branchubb_11_1_performtransformation_binding[0];
			...
			Branch i = (Branch) result_pattern_whileuld2branchubb_11_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_whileuld2branchubb_11_1_performtransformation_greenBFFFFFFBBB(Branch z,
		...
		c2z.setTarget(z);
		c2z.setSource(c);
		return new Object[] { z, b2y, a2x, a, c, b, c2z, y, w, x };
	}

	public static final Object[] pattern_whileuld2branchubb_11_2_collecttranslatedelements_blackBBBBBBBBB(Branch z,
			S2N b2y, S2B a2x, While a, Decision c, Assignment b, S2B c2z, Command y, Branch x) {
		if (!a2x.equals(c2z)) {
			if (!x.equals(z)) {
				return new Object[] { z, b2y, a2x, a, c, b, c2z, y, x };
	...
	public static final Object[] pattern_whileuld2branchubb_11_2_collecttranslatedelements_greenFBBBBBBBBB(Branch z,
			S2N b2y, S2B a2x, While a, Decision c, Assignment b, S2B c2z, Command y, Branch x) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_whileuld2branchubb_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileuld2branchubb _this, PerformRuleResult ruleresult, EObject z, EObject b2y, EObject a2x, EObject a,
			EObject c, EObject b, EObject w2i, EObject c2z, EObject y, EObject i, EObject w, EObject x) {
		_this.registerObjects_BWD(ruleresult, z, b2y, a2x, a, c, b, w2i, c2z, y, i, w, x);
	...
	public static final Iterable<Object[]> pattern_whileuld2branchubb_12_2_corematch_blackBFBBFBB(Branch z, Command y,
	...
	public static final Iterable<Object[]> pattern_whileuld2branchubb_12_3_findcontext_blackBBBBBB(Branch z, S2B w2i,
	...
	public static final Object[] pattern_whileuld2branchubb_12_3_findcontext_greenBBBBBBFFFFFFF(Branch z, S2B w2i,
			Command y, Branch i, While w, Branch x) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge y__x____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge w2i__i____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		w2i__w____source.setName(w2i__w____source_name_prime);
		x__y____positive.setName(x__y____positive_name_prime);
		return new Object[] { z, w2i, y, i, w, x, isApplicableMatch, y__x____next, w2i__i____target, i__x____positive,
				i__z____negative, w2i__w____source, x__y____positive };
	}
	...
	public static final Object[] pattern_whileuld2branchubb_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
			whileuld2branchubb _this, IsApplicableMatch isApplicableMatch, Branch z, S2B w2i, Command y, Branch i,
			While w, Branch x) {
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_0B(Branch z) {
		for (Graph __DEC_z_root_426542 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_1BBB(Branch z, Branch i,
			Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_positive_815465 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!z.equals(__DEC_z_positive_815465)) {
							if (!i.equals(__DEC_z_positive_815465)) {
								if (!x.equals(__DEC_z_positive_815465)) {
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_2BBB(Branch z, Branch i,
			Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_negative_101264 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!z.equals(__DEC_z_negative_101264)) {
							if (!i.equals(__DEC_z_negative_101264)) {
								if (!x.equals(__DEC_z_negative_101264)) {
									return new Object[] { z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_3B(Command y) {
		for (Graph __DEC_y_root_958045 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_4BBBB(Command y,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_positive_257265 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!z.equals(__DEC_y_positive_257265)) {
							if (!i.equals(__DEC_y_positive_257265)) {
								if (!x.equals(__DEC_y_positive_257265)) {
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_5BBBB(Command y,
		...
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_negative_493518 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!z.equals(__DEC_y_negative_493518)) {
							if (!i.equals(__DEC_y_negative_493518)) {
								if (!x.equals(__DEC_y_negative_493518)) {
									return new Object[] { y, z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_450156 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_7BBB(Branch x, Branch z,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_positive_967151 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_967151)) {
							if (!z.equals(__DEC_x_positive_967151)) {
								if (!i.equals(__DEC_x_positive_967151)) {
	...
	public static final Object[] pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_8BBB(Branch x, Branch z,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_negative_345525 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_345525)) {
							if (!z.equals(__DEC_x_negative_345525)) {
								if (!i.equals(__DEC_x_negative_345525)) {
									return new Object[] { x, z, i };
								}
							}
						}
	...
	public static final Iterable<Object[]> pattern_whileuld2branchubb_20_2_testcorematchandDECs_blackFFFFB(
		...
		if (tmpY instanceof Command) {
			...
			if (tmpX instanceof Branch) {
				...
				if (x.equals(y.getNext())) {
					if (y.equals(x.getPositive())) {
						if (pattern_whileuld2branchubb_20_2_testcorematchandDECs_black_nac_3B(y) == null) {
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_0BB(While a,
			Decision c) {
		for (Decision __DEC_a_positive_201837 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_201837)) {
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_1BB(While a,
			Decision c) {
		for (Decision __DEC_a_negative_357339 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_357339)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_2BB(While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_a_last_305859 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_305859)) {
					if (!w.equals(__DEC_a_last_305859)) {
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_3B(While a) {
		for (Program __DEC_a_first_480910 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_4B(Decision c) {
		for (Decision __DEC_c_positive_804879 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_804879)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_5B(Decision c) {
		for (Decision __DEC_c_negative_629999 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_629999)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_6BBB(Decision c,
			While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_first_811805 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!a.equals(__DEC_c_first_811805)) {
					if (!w.equals(__DEC_c_first_811805)) {
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_7BBB(Decision c,
			While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_last_34006 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!a.equals(__DEC_c_last_34006)) {
					if (!w.equals(__DEC_c_last_34006)) {
						return new Object[] { c, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_8B(Decision c) {
		for (Program __DEC_c_first_57872 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_9BB(Assignment b,
			Decision c) {
		for (Decision __DEC_b_positive_166172 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_b_positive_166172)) {
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_10BB(Assignment b,
			Decision c) {
		for (Decision __DEC_b_negative_540560 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_b_negative_540560)) {
				return new Object[] { b, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_11BBB(Assignment b,
			While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_b_last_169618 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!a.equals(__DEC_b_last_169618)) {
					if (!w.equals(__DEC_b_last_169618)) {
	...
	public static final Object[] pattern_whileuld2branchubb_21_2_testcorematchandDECs_black_nac_12B(Assignment b) {
		for (Program __DEC_b_first_379110 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
						...
						if (tmpY instanceof Command) {
							...
							if (tmpI instanceof Branch) {
								...
								if (tmpW instanceof While) {
									...
									if (tmpX instanceof Branch) {
										Branch x = (Branch) tmpX;
										return new Object[] { z, a, c, b, y, i, w, x, targetMatch, sourceMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Branch z, While a,
			Decision c, Assignment b, Command y, Branch i, While w, Branch x, Match sourceMatch, Match targetMatch) {
		if (!a.equals(w)) {
			if (!i.equals(z)) {
				if (!i.equals(x)) {
					if (!x.equals(z)) {
						if (!sourceMatch.equals(targetMatch)) {
							return new Object[] { z, a, c, b, y, i, w, x, sourceMatch, targetMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whileuld2branchubb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_whileuld2branchubb_24_2_matchsrctrgcontext_binding != null) {
			Branch z = (Branch) result_pattern_whileuld2branchubb_24_2_matchsrctrgcontext_binding[0];
			While a = (While) result_pattern_whileuld2branchubb_24_2_matchsrctrgcontext_binding[1];
			...
			Command y = (Command) result_pattern_whileuld2branchubb_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_whileuld2branchubb_24_2_matchsrctrgcontext_black = pattern_whileuld2branchubb_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					z, a, c, b, y, i, w, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileuld2branchubb_24_3_solvecsp_bindingFBBBBBBBBBBB(whileuld2branchubb _this,
			Branch z, While a, Decision c, Assignment b, Command y, Branch i, While w, Branch x, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(z, a, c, b, y, i, w, x, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, z, a, c, b, y, i, w, x, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileuld2branchubb_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			whileuld2branchubb _this, Branch z, While a, Decision c, Assignment b, Command y, Branch i, While w,
		...
		Object[] result_pattern_whileuld2branchubb_24_3_solvecsp_binding = pattern_whileuld2branchubb_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, z, a, c, b, y, i, w, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileuld2branchubb_24_6_createcorrespondence_blackBBBBBBBBB(Branch z, While a,
			Decision c, Assignment b, Command y, Branch i, While w, Branch x, CCMatch ccMatch) {
		if (!a.equals(w)) {
			if (!i.equals(z)) {
				if (!i.equals(x)) {
					if (!x.equals(z)) {
						return new Object[] { z, a, c, b, y, i, w, x, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileuld2branchubb_24_6_createcorrespondence_greenBFFBBBFBBB(Branch z, While a,
			Decision c, Assignment b, Command y, Branch x, CCMatch ccMatch) {
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		b2y.setSource(b);
		...
		return new Object[] { z, b2y, a2x, a, c, b, c2z, y, x, ccMatch };
	}
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_0BB(While a, Decision c) {
		for (Decision __DEC_a_positive_583854 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_583854)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_1BB(While a, Decision c) {
		for (Decision __DEC_a_negative_802078 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_802078)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_2BB(While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_a_last_200659 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_200659)) {
					if (!w.equals(__DEC_a_last_200659)) {
						return new Object[] { a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_3B(While a) {
		for (Program __DEC_a_first_958390 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_4B(Decision c) {
		for (Decision __DEC_c_positive_977976 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_977976)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_5B(Decision c) {
		for (Decision __DEC_c_negative_880462 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_880462)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_6BBB(Decision c, While a,
			While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_first_68987 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!a.equals(__DEC_c_first_68987)) {
					if (!w.equals(__DEC_c_first_68987)) {
						return new Object[] { c, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_7BBB(Decision c, While a,
			While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_last_60008 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!a.equals(__DEC_c_last_60008)) {
					if (!w.equals(__DEC_c_last_60008)) {
						return new Object[] { c, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_8B(Decision c) {
		for (Program __DEC_c_first_6115 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_9BB(Assignment b,
			Decision c) {
		for (Decision __DEC_b_positive_965682 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_b_positive_965682)) {
				return new Object[] { b, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_10BB(Assignment b,
			Decision c) {
		for (Decision __DEC_b_negative_999314 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_b_negative_999314)) {
				return new Object[] { b, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_11BBB(Assignment b, While a,
			While w) {
		if (!a.equals(w)) {
			for (While __DEC_b_last_810638 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!a.equals(__DEC_b_last_810638)) {
					if (!w.equals(__DEC_b_last_810638)) {
						return new Object[] { b, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileuld2branchubb_27_1_matchtggpattern_black_nac_12B(Assignment b) {
		for (Program __DEC_b_first_58517 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_0B(Branch z) {
		for (Graph __DEC_z_root_552136 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_1BBB(Branch z, Branch i,
			Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_positive_101997 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "positive")) {
						if (!z.equals(__DEC_z_positive_101997)) {
							if (!i.equals(__DEC_z_positive_101997)) {
								if (!x.equals(__DEC_z_positive_101997)) {
									return new Object[] { z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_2BBB(Branch z, Branch i,
			Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_z_negative_704940 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(z, Branch.class, "negative")) {
						if (!z.equals(__DEC_z_negative_704940)) {
							if (!i.equals(__DEC_z_negative_704940)) {
								if (!x.equals(__DEC_z_negative_704940)) {
									return new Object[] { z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_3B(Command y) {
		for (Graph __DEC_y_root_912275 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_4BBBB(Command y, Branch z,
			Branch i, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_positive_686301 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!z.equals(__DEC_y_positive_686301)) {
							if (!i.equals(__DEC_y_positive_686301)) {
								if (!x.equals(__DEC_y_positive_686301)) {
									return new Object[] { y, z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_5BBBB(Command y, Branch z,
			Branch i, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
					for (Branch __DEC_y_negative_377561 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!z.equals(__DEC_y_negative_377561)) {
							if (!i.equals(__DEC_y_negative_377561)) {
								if (!x.equals(__DEC_y_negative_377561)) {
									return new Object[] { y, z, i, x };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_487860 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_7BBB(Branch x, Branch z,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_positive_43474 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_43474)) {
							if (!z.equals(__DEC_x_positive_43474)) {
								if (!i.equals(__DEC_x_positive_43474)) {
									return new Object[] { x, z, i };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_8BBB(Branch x, Branch z,
		...
		if (!x.equals(z)) {
			if (!i.equals(x)) {
				if (!i.equals(z)) {
					for (Branch __DEC_x_negative_36608 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_36608)) {
							if (!z.equals(__DEC_x_negative_36608)) {
								if (!i.equals(__DEC_x_negative_36608)) {
									return new Object[] { x, z, i };
								}
							}
						}
	...
	public static final Object[] pattern_whileuld2branchubb_28_1_matchtggpattern_blackBBBB(Branch z, Command y,
			Branch i, Branch x) {
		if (!i.equals(z)) {
			if (!i.equals(x)) {
				if (!x.equals(z)) {
							...
							if (z.equals(i.getNegative())) {
								if (y.equals(x.getPositive())) {
									if (pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_0B(z) == null) {
										if (pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_1BBB(z, i,
												x) == null) {
											if (pattern_whileuld2branchubb_28_1_matchtggpattern_black_nac_2BBB(z, i,
													x) == null) {
	...
	public static final Object[] pattern_whileuld2branchubb_29_6_perform_greenFFFFFFFFBBFB(Branch i, While w,
			ModelgeneratorRuleResult ruleResult) {
		Branch z = ControlflowFactory.eINSTANCE.createBranch();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		return new Object[] { z, b2y, a2x, a, c, b, c2z, y, i, w, x, ruleResult };
	}
