...
public class whilead2branchcbImpl extends AbstractRuleImpl implements whilead2branchcb {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whilead2branchcbImpl.pattern_whilead2branchcb_1_1_performtransformation_greenBFFBBFF(c,
				a, i);
		...
		Object[] result2_black = whilead2branchcbImpl
				.pattern_whilead2branchcb_1_2_collecttranslatedelements_blackBBBBBB(c, c2z, x, a, a2x, z);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[c] = " + c + ", " + "[c2z] = " + c2z + ", "
							+ "[x] = " + x + ", " + "[a] = " + a + ", " + "[a2x] = " + a2x + ", " + "[z] = " + z + ".");
		}
		Object[] result2_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_1_2_collecttranslatedelements_greenFBBBBBB(c, c2z, x, a, a2x, z);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whilead2branchcbImpl.pattern_whilead2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, c, c2z, x, a, i, a2x, w, z, w2i);
		...
		whilead2branchcbImpl.pattern_whilead2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, c, c2z,
				x, a, i, a2x, w, z);
		...
		// 
		// 
		whilead2branchcbImpl.pattern_whilead2branchcb_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, c,
				c2z, x, a, i, a2x, w, z, w2i);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whilead2branchcbImpl.pattern_whilead2branchcb_2_2_corematch_blackBBFBFB(c, a, w,
				match)) {
			...
			for (Object[] result3_black : whilead2branchcbImpl.pattern_whilead2branchcb_2_3_findcontext_blackBBBBB(c, a,
				...
				Object[] result3_green = whilead2branchcbImpl
						.pattern_whilead2branchcb_2_3_findcontext_greenBBBBBFFFFF(c, a, i, w, w2i);
				...
				Object[] result4_bindingAndBlack = whilead2branchcbImpl
						.pattern_whilead2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, c, a, i,
								w, w2i);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Decision c, Assignment a, Branch i,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c, EObject c2z, EObject x, EObject a,
			EObject i, EObject a2x, EObject w, EObject z, EObject w2i) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_1_performtransformation_greenFFBFFBB(x, w, z);
		...
		Object[] result2_black = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_2_collecttranslatedelements_blackBBBBBB(c, c2z, x, a, a2x, z);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[c] = " + c + ", " + "[c2z] = " + c2z + ", "
							+ "[x] = " + x + ", " + "[a] = " + a + ", " + "[a2x] = " + a2x + ", " + "[z] = " + z + ".");
		...
		Object[] result2_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_2_collecttranslatedelements_greenFBBBBBB(c, c2z, x, a, a2x, z);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		whilead2branchcbImpl.pattern_whilead2branchcb_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, c,
				c2z, x, a, i, a2x, w, z);
		//nothing EMoflonEdge c2z__c____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge i__x____positive = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge a2x__x____target = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		whilead2branchcbImpl.pattern_whilead2branchcb_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, c,
				c2z, x, a, i, a2x, w, z, w2i);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whilead2branchcbImpl.pattern_whilead2branchcb_12_2_corematch_blackBBFBFB(x, i, z,
				match)) {
			...
			for (Object[] result3_black : whilead2branchcbImpl.pattern_whilead2branchcb_12_3_findcontext_blackBBBBB(x,
					i, w, z, w2i)) {
				Object[] result3_green = whilead2branchcbImpl
						.pattern_whilead2branchcb_12_3_findcontext_greenBBBBBFFFFF(x, i, w, z, w2i);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				...
				Object[] result4_bindingAndBlack = whilead2branchcbImpl
						.pattern_whilead2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, x, i,
								w, z, w2i);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Command x, Branch i, While w, Branch z,
			S2B w2i) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c, EObject c2z, EObject x, EObject a,
			EObject i, EObject a2x, EObject w, EObject z, EObject w2i) {
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("c2z", c2z);
		ruleresult.registerObject("x", x);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_270(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_278(EMoflonEdge _edge_next) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whilead2branchcbImpl
				.pattern_whilead2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, c, x, a, i, w, z, sourceMatch,
						targetMatch);
		...
		if (whilead2branchcbImpl.pattern_whilead2branchcb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whilead2branchcbImpl
				...
				Object[] result6_black = whilead2branchcbImpl
						.pattern_whilead2branchcb_24_6_createcorrespondence_blackBBBBBBB(c, x, a, i, w, z, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[c] = " + c + ", "
							+ "[x] = " + x + ", " + "[a] = " + a + ", " + "[i] = " + i + ", " + "[w] = " + w + ", "
							+ "[z] = " + z + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				whilead2branchcbImpl.pattern_whilead2branchcb_24_6_createcorrespondence_greenBFBBFBB(c, x, a, z,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Decision c, Command x, Assignment a, Branch i, While w, Branch z,
		...
		for (Object[] result2_black : whilead2branchcbImpl
			...
			if (whilead2branchcbImpl.pattern_whilead2branchcb_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					whilead2branchcbImpl.pattern_whilead2branchcb_29_6_perform_greenFFFFBFBFB(i, w, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_DECISION_ASSIGNMENT_BRANCH_WHILE_S2B:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMMAND_BRANCH_WHILE_BRANCH_S2B:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_270__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_270((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_278__EMOFLONEDGE:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_CC__DECISION_COMMAND_ASSIGNMENT_BRANCH_WHILE_BRANCH_MATCH_MATCH:
				...
				if (tmpI instanceof Branch) {
					...
					if (tmpW instanceof While) {
						...
						if (tmpW2i instanceof S2B) {
							S2B w2i = (S2B) tmpW2i;
							return new Object[] { c, a, i, w, w2i, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_blackBBBBBFBB(Decision c,
			Assignment a, Branch i, While w, S2B w2i, whilead2branchcb _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { c, a, i, w, w2i, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_1_1_performtransformation_binding != null) {
			...
			Branch i = (Branch) result_pattern_whilead2branchcb_1_1_performtransformation_binding[2];
			While w = (While) result_pattern_whilead2branchcb_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_whilead2branchcb_1_1_performtransformation_black = pattern_whilead2branchcb_1_1_performtransformation_blackBBBBBFBB(
					c, a, i, w, w2i, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_greenBFFBBFF(Decision c,
		...
		i.setNegative(z);
		c2z.setTarget(z);
		return new Object[] { c, c2z, x, a, i, a2x, z };
	}

	public static final Object[] pattern_whilead2branchcb_1_2_collecttranslatedelements_blackBBBBBB(Decision c, S2B c2z,
			Command x, Assignment a, S2N a2x, Branch z) {
		return new Object[] { c, c2z, x, a, a2x, z };
	}

	public static final Object[] pattern_whilead2branchcb_1_2_collecttranslatedelements_greenFBBBBBB(Decision c,
			S2B c2z, Command x, Assignment a, S2N a2x, Branch z) {
		...
		return new Object[] { ruleresult, c, c2z, x, a, a2x, z };
	}

	public static final Object[] pattern_whilead2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject c, EObject c2z, EObject x, EObject a, EObject i, EObject a2x,
			EObject w, EObject z, EObject w2i) {
		if (!c.equals(c2z)) {
			if (!c.equals(x)) {
				if (!c.equals(i)) {
					if (!c.equals(w)) {
	...
	public static final Object[] pattern_whilead2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
		...
		return new Object[] { ruleresult, c, c2z, x, a, i, a2x, w, z, c2z__c____source, i__x____positive,
				a2x__x____target, a2x__a____source, i__z____negative, w__c____next, w__a____first, c2z__z____target };
	}

	public static final void pattern_whilead2branchcb_1_5_registerobjects_expressionBBBBBBBBBBB(whilead2branchcb _this,
			PerformRuleResult ruleresult, EObject c, EObject c2z, EObject x, EObject a, EObject i, EObject a2x,
			EObject w, EObject z, EObject w2i) {
		_this.registerObjects_FWD(ruleresult, c, c2z, x, a, i, a2x, w, z, w2i);
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_2_2_corematch_blackBBFBFB(Decision c, Assignment a,
			While w, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class, "source")) {
			Branch i = w2i.getTarget();
			if (i != null) {
				_result.add(new Object[] { c, a, i, w, w2i, match });
			}
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_2_3_findcontext_blackBBBBB(Decision c, Assignment a,
			Branch i, While w, S2B w2i) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (c.equals(w.getNext())) {
			if (a.equals(w.getFirst())) {
				if (i.equals(w2i.getTarget())) {
					if (w.equals(w2i.getSource())) {
						_result.add(new Object[] { c, a, i, w, w2i });
					}
				}
			}
		}
	...
	public static final Object[] pattern_whilead2branchcb_2_3_findcontext_greenBBBBBFFFFF(Decision c, Assignment a,
		...
		return new Object[] { c, a, i, w, w2i, isApplicableMatch, w__c____next, w__a____first, w2i__i____target,
				w2i__w____source };
	}

	public static final Object[] pattern_whilead2branchcb_2_4_solveCSP_bindingFBBBBBBB(whilead2branchcb _this,
			IsApplicableMatch isApplicableMatch, Decision c, Assignment a, Branch i, While w, S2B w2i) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, c, a, i, w, w2i);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c, a, i, w, w2i };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBB(whilead2branchcb _this,
		...
		Object[] result_pattern_whilead2branchcb_2_4_solveCSP_binding = pattern_whilead2branchcb_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, c, a, i, w, w2i);
	...
	public static final Object[] pattern_whilead2branchcb_11_1_performtransformation_blackBBBBBFBB(Command x, Branch i,
			While w, Branch z, S2B w2i, whilead2branchcb _this, IsApplicableMatch isApplicableMatch) {
		if (!i.equals(z)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_whilead2branchcb_11_1_performtransformation_greenFFBFFBB(Command x, While w,
			Branch z) {
		...
		a2x.setTarget(x);
		a2x.setSource(a);
		return new Object[] { c, c2z, x, a, a2x, w, z };
	}
	...
	public static final void pattern_whilead2branchcb_11_5_registerobjects_expressionBBBBBBBBBBB(whilead2branchcb _this,
			PerformRuleResult ruleresult, EObject c, EObject c2z, EObject x, EObject a, EObject i, EObject a2x,
			EObject w, EObject z, EObject w2i) {
		_this.registerObjects_BWD(ruleresult, c, c2z, x, a, i, a2x, w, z, w2i);
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_12_2_corematch_blackBBFBFB(Command x, Branch i,
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_12_3_findcontext_blackBBBBB(Command x, Branch i,
			While w, Branch z, S2B w2i) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!i.equals(z)) {
	...
	public static final Object[] pattern_whilead2branchcb_12_3_findcontext_greenBBBBBFFFFF(Command x, Branch i, While w,
			Branch z, S2B w2i) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge i__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge i__z____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		w2i__i____target.setName(w2i__i____target_name_prime);
		w2i__w____source.setName(w2i__w____source_name_prime);
		return new Object[] { x, i, w, z, w2i, isApplicableMatch, i__x____positive, i__z____negative, w2i__i____target,
				w2i__w____source };
	}

	public static final Object[] pattern_whilead2branchcb_12_4_solveCSP_bindingFBBBBBBB(whilead2branchcb _this,
			IsApplicableMatch isApplicableMatch, Command x, Branch i, While w, Branch z, S2B w2i) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_549125 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_1BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_821211 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_x_positive_821211)) {
					if (!z.equals(__DEC_x_positive_821211)) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_2BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_692116 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_x_negative_692116)) {
					if (!z.equals(__DEC_x_negative_692116)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_3B(Branch z) {
		for (Graph __DEC_z_root_977365 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_4BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_96592 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_96592)) {
					if (!i.equals(__DEC_z_positive_96592)) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_5BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_870668 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_870668)) {
					if (!i.equals(__DEC_z_negative_870668)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_0B(Decision c) {
		for (Decision __DEC_c_positive_592664 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_592664)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_1B(Decision c) {
		for (Decision __DEC_c_negative_631108 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_631108)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_2BB(Decision c, While w) {
		for (While __DEC_c_first_730477 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_730477)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_3BB(Decision c, While w) {
		for (While __DEC_c_last_139924 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_139924)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_4B(Decision c) {
		for (Program __DEC_c_first_493465 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_5BB(Assignment a,
			Decision c) {
		for (Decision __DEC_a_positive_743046 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_743046)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_6BB(Assignment a,
			Decision c) {
		for (Decision __DEC_a_negative_90697 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_90697)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_7BB(Assignment a,
			While w) {
		for (While __DEC_a_last_794686 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_794686)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_8B(Assignment a) {
		for (Program __DEC_a_first_735390 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
				...
				if (tmpA instanceof Assignment) {
					...
					if (tmpI instanceof Branch) {
						...
						if (tmpW instanceof While) {
							...
							if (tmpZ instanceof Branch) {
								Branch z = (Branch) tmpZ;
								return new Object[] { c, x, a, i, w, z, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whilead2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBB(Decision c, Command x,
			Assignment a, Branch i, While w, Branch z, Match sourceMatch, Match targetMatch) {
		if (!i.equals(z)) {
	...
	public static final Object[] pattern_whilead2branchcb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding != null) {
			...
			Assignment a = (Assignment) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[2];
			Branch i = (Branch) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[3];
			While w = (While) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_black = pattern_whilead2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBB(
					c, x, a, i, w, z, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whilead2branchcb_24_3_solvecsp_bindingFBBBBBBBBB(whilead2branchcb _this,
			Decision c, Command x, Assignment a, Branch i, While w, Branch z, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(c, x, a, i, w, z, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, c, x, a, i, w, z, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			whilead2branchcb _this, Decision c, Command x, Assignment a, Branch i, While w, Branch z, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_whilead2branchcb_24_3_solvecsp_binding = pattern_whilead2branchcb_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, c, x, a, i, w, z, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whilead2branchcb_24_6_createcorrespondence_blackBBBBBBB(Decision c, Command x,
			Assignment a, Branch i, While w, Branch z, CCMatch ccMatch) {
		if (!i.equals(z)) {
			return new Object[] { c, x, a, i, w, z, ccMatch };
		}
		return null;
	}

	public static final Object[] pattern_whilead2branchcb_24_6_createcorrespondence_greenBFBBFBB(Decision c, Command x,
			Assignment a, Branch z, CCMatch ccMatch) {
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		c2z.setSource(c);
		c2z.setTarget(z);
		...
		return new Object[] { c, c2z, x, a, a2x, z, ccMatch };
	}
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_0B(Decision c) {
		for (Decision __DEC_c_positive_701761 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_701761)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_1B(Decision c) {
		for (Decision __DEC_c_negative_277810 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_277810)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_2BB(Decision c, While w) {
		for (While __DEC_c_first_495550 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_495550)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_3BB(Decision c, While w) {
		for (While __DEC_c_last_327228 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_327228)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_4B(Decision c) {
		for (Program __DEC_c_first_124646 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_5BB(Assignment a, Decision c) {
		for (Decision __DEC_a_positive_357753 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_357753)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_6BB(Assignment a, Decision c) {
		for (Decision __DEC_a_negative_256767 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_256767)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_7BB(Assignment a, While w) {
		for (While __DEC_a_last_569698 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_569698)) {
				return new Object[] { a, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_8B(Assignment a) {
		for (Program __DEC_a_first_658433 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_914008 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_1BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_409529 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_x_positive_409529)) {
					if (!z.equals(__DEC_x_positive_409529)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_2BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_126216 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_x_negative_126216)) {
					if (!z.equals(__DEC_x_negative_126216)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_3B(Branch z) {
		for (Graph __DEC_z_root_282394 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_4BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_877589 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_877589)) {
					if (!i.equals(__DEC_z_positive_877589)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_5BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_733506 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_733506)) {
					if (!i.equals(__DEC_z_negative_733506)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_29_6_perform_greenFFFFBFBFB(Branch i, While w,
			ModelgeneratorRuleResult ruleResult) {
		Decision c = SourcecodeFactory.eINSTANCE.createDecision();
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Command x = ControlflowFactory.eINSTANCE.createCommand();
		...
		return new Object[] { c, c2z, x, a, i, a2x, w, z, ruleResult };
	}
