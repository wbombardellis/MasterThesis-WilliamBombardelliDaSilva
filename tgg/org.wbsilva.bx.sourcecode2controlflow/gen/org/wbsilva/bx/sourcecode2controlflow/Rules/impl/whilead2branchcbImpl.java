...
public class whilead2branchcbImpl extends AbstractRuleImpl implements whilead2branchcb {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whilead2branchcbImpl.pattern_whilead2branchcb_1_1_performtransformation_greenBBFFFFB(i,
				c, a);
		...
		Object[] result2_black = whilead2branchcbImpl
				.pattern_whilead2branchcb_1_2_collecttranslatedelements_blackBBBBBB(c, c2z, z, a2x, x, a);
		...
		Object[] result2_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_1_2_collecttranslatedelements_greenFBBBBBB(c, c2z, z, a2x, x, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whilead2branchcbImpl.pattern_whilead2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, i, c, c2z, w, z, a2x, w2i, x, a);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[i] = " + i + ", " + "[c] = " + c + ", " + "[c2z] = " + c2z + ", " + "[w] = " + w + ", "
					+ "[z] = " + z + ", " + "[a2x] = " + a2x + ", " + "[w2i] = " + w2i + ", " + "[x] = " + x + ", "
					+ "[a] = " + a + ".");
		}
		whilead2branchcbImpl.pattern_whilead2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, i, c,
				c2z, w, z, a2x, x, a);
		...
		// 
		// 
		whilead2branchcbImpl.pattern_whilead2branchcb_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, i, c,
				c2z, w, z, a2x, w2i, x, a);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whilead2branchcbImpl.pattern_whilead2branchcb_2_2_corematch_blackFBBFBB(c, w, a,
				match)) {
			Branch i = (Branch) result2_black[0];
			S2B w2i = (S2B) result2_black[3];
			// ForEach 
			for (Object[] result3_black : whilead2branchcbImpl.pattern_whilead2branchcb_2_3_findcontext_blackBBBBB(i, c,
					w, w2i, a)) {
				Object[] result3_green = whilead2branchcbImpl
						.pattern_whilead2branchcb_2_3_findcontext_greenBBBBBFFFFF(i, c, w, w2i, a);
				...
				Object[] result4_bindingAndBlack = whilead2branchcbImpl
						.pattern_whilead2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, i, c, w,
								w2i, a);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Branch i, Decision c, While w, S2B w2i,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject i, EObject c, EObject c2z, EObject w,
			EObject z, EObject a2x, EObject w2i, EObject x, EObject a) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_2_collecttranslatedelements_blackBBBBBB(c, c2z, z, a2x, x, a);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[c] = " + c + ", " + "[c2z] = " + c2z + ", "
							+ "[z] = " + z + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ", " + "[a] = " + a + ".");
		...
		Object[] result2_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_2_collecttranslatedelements_greenFBBBBBB(c, c2z, z, a2x, x, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		whilead2branchcbImpl.pattern_whilead2branchcb_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, i, c,
				c2z, w, z, a2x, x, a);
		//nothing EMoflonEdge i__z____negative = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge c2z__c____source = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge w__a____first = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		whilead2branchcbImpl.pattern_whilead2branchcb_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, i, c,
				c2z, w, z, a2x, w2i, x, a);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject i, EObject c, EObject c2z, EObject w,
			EObject z, EObject a2x, EObject w2i, EObject x, EObject a) {
		ruleresult.registerObject("i", i);
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("c2z", c2z);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_93(EMoflonEdge _edge_negative) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_93(EMoflonEdge _edge_first) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whilead2branchcbImpl
				.pattern_whilead2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, i, c, w, z, x, a, sourceMatch,
						targetMatch);
		...
		if (whilead2branchcbImpl.pattern_whilead2branchcb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whilead2branchcbImpl
				...
				Object[] result6_black = whilead2branchcbImpl
						.pattern_whilead2branchcb_24_6_createcorrespondence_blackBBBBBBB(i, c, w, z, x, a, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[i] = " + i + ", "
							+ "[c] = " + c + ", " + "[w] = " + w + ", " + "[z] = " + z + ", " + "[x] = " + x + ", "
							+ "[a] = " + a + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				whilead2branchcbImpl.pattern_whilead2branchcb_24_6_createcorrespondence_greenBFBFBBB(c, z, x, a,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Branch i, Decision c, While w, Branch z, Command x, Assignment a,
		...
		for (Object[] result2_black : whilead2branchcbImpl
			...
			if (whilead2branchcbImpl.pattern_whilead2branchcb_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					whilead2branchcbImpl.pattern_whilead2branchcb_29_6_perform_greenBFFBFFFFB(i, w, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_BRANCH_DECISION_WHILE_S2B_ASSIGNMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Branch) arguments.get(1),
					(Decision) arguments.get(2), (While) arguments.get(3), (S2B) arguments.get(4),
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_93__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_93((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_93__EMOFLONEDGE:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_CC__BRANCH_DECISION_WHILE_BRANCH_COMMAND_ASSIGNMENT_MATCH_MATCH:
				...
				if (tmpW instanceof While) {
					...
					if (tmpW2i instanceof S2B) {
						...
						if (tmpA instanceof Assignment) {
							...
							return new Object[] { i, c, w, w2i, a, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_blackBBBBBFBB(Branch i, Decision c,
			While w, S2B w2i, Assignment a, whilead2branchcb _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { i, c, w, w2i, a, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_1_1_performtransformation_binding != null) {
			...
			Decision c = (Decision) result_pattern_whilead2branchcb_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_whilead2branchcb_1_1_performtransformation_black = pattern_whilead2branchcb_1_1_performtransformation_blackBBBBBFBB(
					i, c, w, w2i, a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_greenBBFFFFB(Branch i, Decision c,
			Assignment a) {
	...
	public static final Object[] pattern_whilead2branchcb_1_2_collecttranslatedelements_greenFBBBBBB(Decision c,
		...
		return new Object[] { ruleresult, c, c2z, z, a2x, x, a };
	}

	public static final Object[] pattern_whilead2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject i, EObject c, EObject c2z, EObject w, EObject z, EObject a2x,
			EObject w2i, EObject x, EObject a) {
		if (!i.equals(w)) {
			if (!i.equals(z)) {
				if (!i.equals(w2i)) {
					if (!i.equals(x)) {
	...
	public static final Object[] pattern_whilead2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
		...
		return new Object[] { ruleresult, i, c, c2z, w, z, a2x, x, a, i__z____negative, c2z__c____source, w__a____first,
				c2z__z____target, i__x____positive, a2x__x____target, w__c____next, a2x__a____source };
	}

	public static final void pattern_whilead2branchcb_1_5_registerobjects_expressionBBBBBBBBBBB(whilead2branchcb _this,
			PerformRuleResult ruleresult, EObject i, EObject c, EObject c2z, EObject w, EObject z, EObject a2x,
			EObject w2i, EObject x, EObject a) {
		_this.registerObjects_FWD(ruleresult, i, c, c2z, w, z, a2x, w2i, x, a);
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_2_2_corematch_blackFBBFBB(Decision c, While w,
			Assignment a, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class, "source")) {
			Branch i = w2i.getTarget();
			if (i != null) {
				_result.add(new Object[] { i, c, w, w2i, a, match });
			}
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_2_3_findcontext_blackBBBBB(Branch i, Decision c,
			While w, S2B w2i, Assignment a) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (a.equals(w.getFirst())) {
			if (i.equals(w2i.getTarget())) {
				if (w.equals(w2i.getSource())) {
					if (c.equals(w.getNext())) {
						_result.add(new Object[] { i, c, w, w2i, a });
					}
				}
			}
		}
	...
	public static final Object[] pattern_whilead2branchcb_2_3_findcontext_greenBBBBBFFFFF(Branch i, Decision c, While w,
			S2B w2i, Assignment a) {
		...
		w__c____next.setName(w__c____next_name_prime);
		return new Object[] { i, c, w, w2i, a, isApplicableMatch, w__a____first, w2i__i____target, w2i__w____source,
				w__c____next };
	}

	public static final Object[] pattern_whilead2branchcb_2_4_solveCSP_bindingFBBBBBBB(whilead2branchcb _this,
			IsApplicableMatch isApplicableMatch, Branch i, Decision c, While w, S2B w2i, Assignment a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, i, c, w, w2i, a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, i, c, w, w2i, a };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBB(whilead2branchcb _this,
		...
		Object[] result_pattern_whilead2branchcb_2_4_solveCSP_binding = pattern_whilead2branchcb_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, i, c, w, w2i, a);
	...
	public static final Object[] pattern_whilead2branchcb_11_1_performtransformation_greenFFBBFBF(While w, Branch z,
		...
		w.setFirst(a);
		a2x.setSource(a);
		return new Object[] { c, c2z, w, z, a2x, x, a };
	}
	...
	public static final void pattern_whilead2branchcb_11_5_registerobjects_expressionBBBBBBBBBBB(whilead2branchcb _this,
			PerformRuleResult ruleresult, EObject i, EObject c, EObject c2z, EObject w, EObject z, EObject a2x,
			EObject w2i, EObject x, EObject a) {
		_this.registerObjects_BWD(ruleresult, i, c, c2z, w, z, a2x, w2i, x, a);
	...
	public static final Object[] pattern_whilead2branchcb_12_3_findcontext_greenBBBBBFFFFF(Branch i, While w, Branch z,
		...
		w2i__i____target.setName(w2i__i____target_name_prime);
		w2i__w____source.setName(w2i__w____source_name_prime);
		return new Object[] { i, w, z, w2i, x, isApplicableMatch, i__z____negative, i__x____positive, w2i__i____target,
				w2i__w____source };
	}
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_0B(Branch z) {
		for (Graph __DEC_z_root_860214 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_1BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_769853 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_769853)) {
					if (!i.equals(__DEC_z_positive_769853)) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_2BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_122930 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_122930)) {
					if (!i.equals(__DEC_z_negative_122930)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_3B(Command x) {
		for (Graph __DEC_x_root_286516 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_4BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_490947 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_x_positive_490947)) {
					if (!z.equals(__DEC_x_positive_490947)) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_5BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_500761 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_x_negative_500761)) {
					if (!z.equals(__DEC_x_negative_500761)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_0B(Decision c) {
		for (Decision __DEC_c_positive_57646 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_57646)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_1B(Decision c) {
		for (Decision __DEC_c_negative_495793 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_495793)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_2BB(Decision c, While w) {
		for (While __DEC_c_first_630539 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_630539)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_3BB(Decision c, While w) {
		for (While __DEC_c_last_487434 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_487434)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_4B(Decision c) {
		for (Program __DEC_c_first_26439 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_5BB(Assignment a,
			Decision c) {
		for (Decision __DEC_a_positive_192394 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_192394)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_6BB(Assignment a,
			Decision c) {
		for (Decision __DEC_a_negative_821459 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_821459)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_7BB(Assignment a,
			While w) {
		for (While __DEC_a_last_170767 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_170767)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_8B(Assignment a) {
		for (Program __DEC_a_first_280586 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
				...
				if (tmpW instanceof While) {
					...
					if (tmpZ instanceof Branch) {
						...
						if (tmpX instanceof Command) {
							...
							if (tmpA instanceof Assignment) {
								Assignment a = (Assignment) tmpA;
								return new Object[] { i, c, w, z, x, a, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whilead2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBB(Branch i, Decision c,
			While w, Branch z, Command x, Assignment a, Match sourceMatch, Match targetMatch) {
		if (!i.equals(z)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { i, c, w, z, x, a, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding != null) {
			...
			Decision c = (Decision) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[1];
			...
			Command x = (Command) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_black = pattern_whilead2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBB(
					i, c, w, z, x, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whilead2branchcb_24_3_solvecsp_bindingFBBBBBBBBB(whilead2branchcb _this,
			Branch i, Decision c, While w, Branch z, Command x, Assignment a, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(i, c, w, z, x, a, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, i, c, w, z, x, a, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			whilead2branchcb _this, Branch i, Decision c, While w, Branch z, Command x, Assignment a, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_whilead2branchcb_24_3_solvecsp_binding = pattern_whilead2branchcb_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, i, c, w, z, x, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whilead2branchcb_24_6_createcorrespondence_blackBBBBBBB(Branch i, Decision c,
			While w, Branch z, Command x, Assignment a, CCMatch ccMatch) {
		if (!i.equals(z)) {
			return new Object[] { i, c, w, z, x, a, ccMatch };
		}
		return null;
	}

	public static final Object[] pattern_whilead2branchcb_24_6_createcorrespondence_greenBFBFBBB(Decision c, Branch z,
		...
		return new Object[] { c, c2z, z, a2x, x, a, ccMatch };
	}
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_0B(Decision c) {
		for (Decision __DEC_c_positive_382520 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_382520)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_1B(Decision c) {
		for (Decision __DEC_c_negative_902372 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_902372)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_2BB(Decision c, While w) {
		for (While __DEC_c_first_97040 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_97040)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_3BB(Decision c, While w) {
		for (While __DEC_c_last_334594 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_334594)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_4B(Decision c) {
		for (Program __DEC_c_first_68301 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_5BB(Assignment a, Decision c) {
		for (Decision __DEC_a_positive_742934 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_742934)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_6BB(Assignment a, Decision c) {
		for (Decision __DEC_a_negative_788983 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_788983)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_7BB(Assignment a, While w) {
		for (While __DEC_a_last_82821 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_82821)) {
				return new Object[] { a, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_8B(Assignment a) {
		for (Program __DEC_a_first_643004 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_0B(Branch z) {
		for (Graph __DEC_z_root_921709 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_1BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_637177 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_637177)) {
					if (!i.equals(__DEC_z_positive_637177)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_2BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_124688 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_124688)) {
					if (!i.equals(__DEC_z_negative_124688)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_3B(Command x) {
		for (Graph __DEC_x_root_486995 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_4BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_878979 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_x_positive_878979)) {
					if (!z.equals(__DEC_x_positive_878979)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_5BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_166330 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_x_negative_166330)) {
					if (!z.equals(__DEC_x_negative_166330)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_29_6_perform_greenBFFBFFFFB(Branch i, While w,
			ModelgeneratorRuleResult ruleResult) {
		Decision c = SourcecodeFactory.eINSTANCE.createDecision();
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Branch z = ControlflowFactory.eINSTANCE.createBranch();
		...
		return new Object[] { i, c, c2z, w, z, a2x, x, a, ruleResult };
	}
