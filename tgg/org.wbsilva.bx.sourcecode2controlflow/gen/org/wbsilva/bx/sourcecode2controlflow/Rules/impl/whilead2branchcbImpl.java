...
public class whilead2branchcbImpl extends AbstractRuleImpl implements whilead2branchcb {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whilead2branchcbImpl.pattern_whilead2branchcb_1_1_performtransformation_greenFFBBFFB(c,
				i, a);
		...
		Object[] result2_black = whilead2branchcbImpl
				.pattern_whilead2branchcb_1_2_collecttranslatedelements_blackBBBBBB(x, c2z, c, a2x, z, a);
		...
		Object[] result2_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_1_2_collecttranslatedelements_greenFBBBBBB(x, c2z, c, a2x, z, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whilead2branchcbImpl.pattern_whilead2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, w2i, w, x, c2z, c, i, a2x, z, a);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[w2i] = " + w2i + ", " + "[w] = " + w + ", " + "[x] = " + x + ", " + "[c2z] = " + c2z
					+ ", " + "[c] = " + c + ", " + "[i] = " + i + ", " + "[a2x] = " + a2x + ", " + "[z] = " + z + ", "
					+ "[a] = " + a + ".");
		}
		whilead2branchcbImpl.pattern_whilead2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, w, x,
				c2z, c, i, a2x, z, a);
		...
		// 
		// 
		whilead2branchcbImpl.pattern_whilead2branchcb_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, w2i,
				w, x, c2z, c, i, a2x, z, a);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whilead2branchcbImpl.pattern_whilead2branchcb_2_2_corematch_blackFBBFBB(w, c, a,
				match)) {
			S2B w2i = (S2B) result2_black[0];
			Branch i = (Branch) result2_black[3];
			// ForEach 
			for (Object[] result3_black : whilead2branchcbImpl.pattern_whilead2branchcb_2_3_findcontext_blackBBBBB(w2i,
					w, c, i, a)) {
				Object[] result3_green = whilead2branchcbImpl
						.pattern_whilead2branchcb_2_3_findcontext_greenBBBBBFFFFF(w2i, w, c, i, a);
				...
				Object[] result4_bindingAndBlack = whilead2branchcbImpl
						.pattern_whilead2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, w2i, w,
								c, i, a);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2B w2i, While w, Decision c, Branch i,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject w2i, EObject w, EObject x, EObject c2z,
			EObject c, EObject i, EObject a2x, EObject z, EObject a) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_1_performtransformation_greenBBFFFBF(w, x, z);
		...
		Object[] result2_black = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_2_collecttranslatedelements_blackBBBBBB(x, c2z, c, a2x, z, a);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[x] = " + x + ", " + "[c2z] = " + c2z + ", "
							+ "[c] = " + c + ", " + "[a2x] = " + a2x + ", " + "[z] = " + z + ", " + "[a] = " + a + ".");
		...
		Object[] result2_green = whilead2branchcbImpl
				.pattern_whilead2branchcb_11_2_collecttranslatedelements_greenFBBBBBB(x, c2z, c, a2x, z, a);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		whilead2branchcbImpl.pattern_whilead2branchcb_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, w, x,
				c2z, c, i, a2x, z, a);
		//nothing EMoflonEdge w__a____first = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge w__c____next = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge i__z____negative = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		whilead2branchcbImpl.pattern_whilead2branchcb_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, w2i,
				w, x, c2z, c, i, a2x, z, a);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whilead2branchcbImpl.pattern_whilead2branchcb_12_2_corematch_blackFFBBBB(x, i, z,
				match)) {
			S2B w2i = (S2B) result2_black[0];
			While w = (While) result2_black[1];
			// ForEach 
			for (Object[] result3_black : whilead2branchcbImpl.pattern_whilead2branchcb_12_3_findcontext_blackBBBBB(w2i,
					w, x, i, z)) {
				Object[] result3_green = whilead2branchcbImpl
						.pattern_whilead2branchcb_12_3_findcontext_greenBBBBBFFFFF(w2i, w, x, i, z);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				...
				Object[] result4_bindingAndBlack = whilead2branchcbImpl
						.pattern_whilead2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, w2i, w,
								x, i, z);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[w2i] = " + w2i + ", " + "[w] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, S2B w2i, While w, Command x, Branch i,
			Branch z) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject w2i, EObject w, EObject x, EObject c2z,
			EObject c, EObject i, EObject a2x, EObject z, EObject a) {
		ruleresult.registerObject("w2i", w2i);
		ruleresult.registerObject("w", w);
		ruleresult.registerObject("x", x);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_116(EMoflonEdge _edge_negative) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_116(EMoflonEdge _edge_first) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whilead2branchcbImpl
				.pattern_whilead2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, w, x, c, i, z, a, sourceMatch,
						targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[w] = " + w + ", " + "[x] = " + x + ", " + "[c] = " + c + ", " + "[i] = " + i + ", " + "[z] = "
					+ z + ", " + "[a] = " + a + ", " + "[sourceMatch] = " + sourceMatch + ", " + "[targetMatch] = "
					+ targetMatch + ".");
		}
		...
		if (whilead2branchcbImpl.pattern_whilead2branchcb_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whilead2branchcbImpl
					.pattern_whilead2branchcb_24_5_matchcorrcontext_blackFBBBB(w, i, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = whilead2branchcbImpl
						.pattern_whilead2branchcb_24_6_createcorrespondence_blackBBBBBBB(w, x, c, i, z, a, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[w] = " + w + ", "
							+ "[x] = " + x + ", " + "[c] = " + c + ", " + "[i] = " + i + ", " + "[z] = " + z + ", "
							+ "[a] = " + a + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				whilead2branchcbImpl.pattern_whilead2branchcb_24_6_createcorrespondence_greenBFBFBBB(x, c, z, a,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(While w, Command x, Decision c, Branch i, Branch z, Assignment a,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B w2iParameter) {
		...
		for (Object[] result2_black : whilead2branchcbImpl
			...
			Object[] result3_bindingAndBlack = whilead2branchcbImpl
					.pattern_whilead2branchcb_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, w2i, w, i,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (whilead2branchcbImpl.pattern_whilead2branchcb_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = whilead2branchcbImpl.pattern_whilead2branchcb_29_5_checknacs_blackBBB(w2i, w,
						i);
				if (result5_black != null) {

					Object[] result6_black = whilead2branchcbImpl.pattern_whilead2branchcb_29_6_perform_blackBBBB(w2i,
							w, i, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[w2i] = " + w2i + ", "
								+ "[w] = " + w + ", " + "[i] = " + i + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					whilead2branchcbImpl.pattern_whilead2branchcb_29_6_perform_greenBFFFBFFFB(w, i, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2B_WHILE_DECISION_BRANCH_ASSIGNMENT:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_WHILE_COMMAND_BRANCH_BRANCH:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPROPRIATE_BWD_EMOFLON_EDGE_116__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_116((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPROPRIATE_FWD_EMOFLON_EDGE_116__EMOFLONEDGE:
		...
		case RulesPackage.WHILEAD2BRANCHCB___IS_APPLICABLE_SOLVE_CSP_CC__WHILE_COMMAND_DECISION_BRANCH_BRANCH_ASSIGNMENT_MATCH_MATCH:
		...
		case RulesPackage.WHILEAD2BRANCHCB___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_WHILE_BRANCH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_whilead2branchcb_0_4_collectelementstobetranslated_greenBBBBFF(Match match,
		...
		return new Object[] { match, w, c, a, w__a____first, w__c____next };
	}
				...
				if (tmpC instanceof Decision) {
					...
					if (tmpI instanceof Branch) {
						...
						if (tmpA instanceof Assignment) {
							...
							return new Object[] { w2i, w, c, i, a, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_blackBBBBBFBB(S2B w2i, While w,
			Decision c, Branch i, Assignment a, whilead2branchcb _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { w2i, w, c, i, a, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_1_1_performtransformation_binding != null) {
			S2B w2i = (S2B) result_pattern_whilead2branchcb_1_1_performtransformation_binding[0];
			...
			Object[] result_pattern_whilead2branchcb_1_1_performtransformation_black = pattern_whilead2branchcb_1_1_performtransformation_blackBBBBBFBB(
					w2i, w, c, i, a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whilead2branchcb_1_1_performtransformation_greenFFBBFFB(Decision c, Branch i,
			Assignment a) {
		...
		i.setNegative(z);
		c2z.setTarget(z);
		return new Object[] { x, c2z, c, i, a2x, z, a };
	}

	public static final Object[] pattern_whilead2branchcb_1_2_collecttranslatedelements_blackBBBBBB(Command x, S2B c2z,
			Decision c, S2N a2x, Branch z, Assignment a) {
		return new Object[] { x, c2z, c, a2x, z, a };
	}

	public static final Object[] pattern_whilead2branchcb_1_2_collecttranslatedelements_greenFBBBBBB(Command x, S2B c2z,
			Decision c, S2N a2x, Branch z, Assignment a) {
		...
		return new Object[] { ruleresult, x, c2z, c, a2x, z, a };
	}

	public static final Object[] pattern_whilead2branchcb_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject w2i, EObject w, EObject x, EObject c2z, EObject c, EObject i,
			EObject a2x, EObject z, EObject a) {
		if (!w2i.equals(x)) {
			if (!w2i.equals(z)) {
				if (!w.equals(w2i)) {
					if (!w.equals(x)) {
	...
	public static final Object[] pattern_whilead2branchcb_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject w, EObject x, EObject c2z, EObject c, EObject i, EObject a2x,
			EObject z, EObject a) {
		EMoflonEdge w__a____first = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge w__c____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, w, x, c2z, c, i, a2x, z, a, w__a____first, w__c____next, i__z____negative,
				c2z__z____target, c2z__c____source, i__x____positive, a2x__x____target, a2x__a____source };
	}

	public static final void pattern_whilead2branchcb_1_5_registerobjects_expressionBBBBBBBBBBB(whilead2branchcb _this,
			PerformRuleResult ruleresult, EObject w2i, EObject w, EObject x, EObject c2z, EObject c, EObject i,
			EObject a2x, EObject z, EObject a) {
		_this.registerObjects_FWD(ruleresult, w2i, w, x, c2z, c, i, a2x, z, a);
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_2_2_corematch_blackFBBFBB(While w, Decision c,
			Assignment a, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class, "source")) {
			Branch i = w2i.getTarget();
			if (i != null) {
				_result.add(new Object[] { w2i, w, c, i, a, match });
			}
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_2_3_findcontext_blackBBBBB(S2B w2i, While w,
			Decision c, Branch i, Assignment a) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (a.equals(w.getFirst())) {
			if (w.equals(w2i.getSource())) {
				if (c.equals(w.getNext())) {
					if (i.equals(w2i.getTarget())) {
						_result.add(new Object[] { w2i, w, c, i, a });
					}
				}
			}
		}
	...
	public static final Object[] pattern_whilead2branchcb_2_3_findcontext_greenBBBBBFFFFF(S2B w2i, While w, Decision c,
		...
		return new Object[] { w2i, w, c, i, a, isApplicableMatch, w__a____first, w2i__w____source, w__c____next,
				w2i__i____target };
	}

	public static final Object[] pattern_whilead2branchcb_2_4_solveCSP_bindingFBBBBBBB(whilead2branchcb _this,
			IsApplicableMatch isApplicableMatch, S2B w2i, While w, Decision c, Branch i, Assignment a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, w2i, w, c, i, a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, w2i, w, c, i, a };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_2_4_solveCSP_bindingAndBlackFBBBBBBB(whilead2branchcb _this,
		...
		Object[] result_pattern_whilead2branchcb_2_4_solveCSP_binding = pattern_whilead2branchcb_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, w2i, w, c, i, a);
				...
				if (tmpX instanceof Command) {
					...
					if (tmpI instanceof Branch) {
						...
						if (tmpZ instanceof Branch) {
							...
							return new Object[] { w2i, w, x, i, z, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_11_1_performtransformation_blackBBBBBFBB(S2B w2i, While w,
			Command x, Branch i, Branch z, whilead2branchcb _this, IsApplicableMatch isApplicableMatch) {
		if (!i.equals(z)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { w2i, w, x, i, z, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_11_1_performtransformation_binding != null) {
			S2B w2i = (S2B) result_pattern_whilead2branchcb_11_1_performtransformation_binding[0];
			While w = (While) result_pattern_whilead2branchcb_11_1_performtransformation_binding[1];
			Command x = (Command) result_pattern_whilead2branchcb_11_1_performtransformation_binding[2];
			Branch i = (Branch) result_pattern_whilead2branchcb_11_1_performtransformation_binding[3];
			Branch z = (Branch) result_pattern_whilead2branchcb_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_whilead2branchcb_11_1_performtransformation_black = pattern_whilead2branchcb_11_1_performtransformation_blackBBBBBFBB(
					w2i, w, x, i, z, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whilead2branchcb_11_1_performtransformation_greenBBFFFBF(While w, Command x,
			Branch z) {
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		w.setFirst(a);
		a2x.setSource(a);
		return new Object[] { w, x, c2z, c, a2x, z, a };
	}

	public static final Object[] pattern_whilead2branchcb_11_2_collecttranslatedelements_blackBBBBBB(Command x, S2B c2z,
			Decision c, S2N a2x, Branch z, Assignment a) {
		return new Object[] { x, c2z, c, a2x, z, a };
	}

	public static final Object[] pattern_whilead2branchcb_11_2_collecttranslatedelements_greenFBBBBBB(Command x,
			S2B c2z, Decision c, S2N a2x, Branch z, Assignment a) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_whilead2branchcb_11_5_registerobjects_expressionBBBBBBBBBBB(whilead2branchcb _this,
			PerformRuleResult ruleresult, EObject w2i, EObject w, EObject x, EObject c2z, EObject c, EObject i,
			EObject a2x, EObject z, EObject a) {
		_this.registerObjects_BWD(ruleresult, w2i, w, x, c2z, c, i, a2x, z, a);
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_12_2_corematch_blackFFBBBB(Command x, Branch i,
		...
		if (!i.equals(z)) {
			for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(i, S2B.class, "target")) {
				...
				if (tmpW instanceof While) {
					While w = (While) tmpW;
					_result.add(new Object[] { w2i, w, x, i, z, match });
				}
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_12_3_findcontext_blackBBBBB(S2B w2i, While w,
			Command x, Branch i, Branch z) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!i.equals(z)) {
			if (w.equals(w2i.getSource())) {
				if (z.equals(i.getNegative())) {
					if (i.equals(w2i.getTarget())) {
						if (x.equals(i.getPositive())) {
							_result.add(new Object[] { w2i, w, x, i, z });
						}
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_12_3_findcontext_greenBBBBBFFFFF(S2B w2i, While w, Command x,
			Branch i, Branch z) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge w2i__w____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge i__z____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		w2i__i____target.setName(w2i__i____target_name_prime);
		i__x____positive.setName(i__x____positive_name_prime);
		return new Object[] { w2i, w, x, i, z, isApplicableMatch, w2i__w____source, i__z____negative, w2i__i____target,
				i__x____positive };
	}

	public static final Object[] pattern_whilead2branchcb_12_4_solveCSP_bindingFBBBBBBB(whilead2branchcb _this,
			IsApplicableMatch isApplicableMatch, S2B w2i, While w, Command x, Branch i, Branch z) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, w2i, w, x, i, z);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, w2i, w, x, i, z };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_12_4_solveCSP_bindingAndBlackFBBBBBBB(whilead2branchcb _this,
		...
		Object[] result_pattern_whilead2branchcb_12_4_solveCSP_binding = pattern_whilead2branchcb_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, w2i, w, x, i, z);
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_108695 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_1BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_69065 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_x_positive_69065)) {
					if (!z.equals(__DEC_x_positive_69065)) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_2BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_732518 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_x_negative_732518)) {
					if (!z.equals(__DEC_x_negative_732518)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_3B(Branch z) {
		for (Graph __DEC_z_root_767490 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_4BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_506495 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_506495)) {
					if (!i.equals(__DEC_z_positive_506495)) {
	...
	public static final Object[] pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_5BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_418915 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_418915)) {
					if (!i.equals(__DEC_z_negative_418915)) {
						return new Object[] { z, i };
					}
				}
			}
			...
			if (tmpZ instanceof Branch) {
				...
				if (!i.equals(z)) {
					if (z.equals(i.getNegative())) {
						...
						if (tmpX instanceof Command) {
							Command x = (Command) tmpX;
							if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_3B(z) == null) {
								if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_4BB(z, i) == null) {
									if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_5BB(z,
											i) == null) {
										if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_9BB(i,
												z) == null) {
											if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_0B(
													x) == null) {
												if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_1BBB(x,
														i, z) == null) {
													if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_2BBB(
															x, i, z) == null) {
														if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_6BB(
															...
															if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_7BB(
																...
																if (pattern_whilead2branchcb_20_2_testcorematchandDECs_black_nac_8BB(
																		z, x) == null) {
																	_result.add(
																			new Object[] { x, i, z, _edge_negative });
																}
															}
														}
													}
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_0B(Decision c) {
		for (Decision __DEC_c_positive_990144 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_990144)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_1B(Decision c) {
		for (Decision __DEC_c_negative_521393 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_521393)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_2BB(Decision c, While w) {
		for (While __DEC_c_first_608489 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_608489)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_3BB(Decision c, While w) {
		for (While __DEC_c_last_737978 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_737978)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_4B(Decision c) {
		for (Program __DEC_c_first_254459 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_5BB(Assignment a,
			Decision c) {
		for (Decision __DEC_a_positive_612548 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_612548)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_6BB(Assignment a,
			Decision c) {
		for (Decision __DEC_a_negative_989801 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_989801)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_7BB(Assignment a,
			While w) {
		for (While __DEC_a_last_375798 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_375798)) {
	...
	public static final Object[] pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_8B(Assignment a) {
		for (Program __DEC_a_first_753861 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
		...
		if (tmpW instanceof While) {
			...
			if (tmpA instanceof Assignment) {
				...
				if (a.equals(w.getFirst())) {
					...
					if (tmpC instanceof Decision) {
						Decision c = (Decision) tmpC;
						if (pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_7BB(a, w) == null) {
							if (pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_8B(a) == null) {
								if (pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_13BB(w, a) == null) {
									if (pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_0B(c) == null) {
										if (pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_1B(
												c) == null) {
											if (pattern_whilead2branchcb_21_2_testcorematchandDECs_black_nac_2BB(c,
													w) == null) {
				...
				if (tmpC instanceof Decision) {
					...
					if (tmpI instanceof Branch) {
						...
						if (tmpZ instanceof Branch) {
							...
							if (tmpA instanceof Assignment) {
								Assignment a = (Assignment) tmpA;
								return new Object[] { w, x, c, i, z, a, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whilead2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBB(While w, Command x,
			Decision c, Branch i, Branch z, Assignment a, Match sourceMatch, Match targetMatch) {
		if (!i.equals(z)) {
	...
	public static final Object[] pattern_whilead2branchcb_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding != null) {
			While w = (While) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[0];
			Command x = (Command) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[1];
			Decision c = (Decision) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[2];
			Branch i = (Branch) result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_whilead2branchcb_24_2_matchsrctrgcontext_black = pattern_whilead2branchcb_24_2_matchsrctrgcontext_blackBBBBBBBB(
					w, x, c, i, z, a, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whilead2branchcb_24_3_solvecsp_bindingFBBBBBBBBB(whilead2branchcb _this,
			While w, Command x, Decision c, Branch i, Branch z, Assignment a, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(w, x, c, i, z, a, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, w, x, c, i, z, a, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whilead2branchcb_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			whilead2branchcb _this, While w, Command x, Decision c, Branch i, Branch z, Assignment a, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_whilead2branchcb_24_3_solvecsp_binding = pattern_whilead2branchcb_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, w, x, c, i, z, a, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_whilead2branchcb_24_5_matchcorrcontext_blackFBBBB(While w, Branch i,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class, "source")) {
	...
	public static final Object[] pattern_whilead2branchcb_24_6_createcorrespondence_blackBBBBBBB(While w, Command x,
			Decision c, Branch i, Branch z, Assignment a, CCMatch ccMatch) {
		if (!i.equals(z)) {
			return new Object[] { w, x, c, i, z, a, ccMatch };
		}
		return null;
	}

	public static final Object[] pattern_whilead2branchcb_24_6_createcorrespondence_greenBFBFBBB(Command x, Decision c,
			Branch z, Assignment a, CCMatch ccMatch) {
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		c2z.setTarget(z);
		c2z.setSource(c);
		...
		return new Object[] { x, c2z, c, a2x, z, a, ccMatch };
	}
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_0B(Decision c) {
		for (Decision __DEC_c_positive_930201 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_c_positive_930201)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_1B(Decision c) {
		for (Decision __DEC_c_negative_351396 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_c_negative_351396)) {
				return new Object[] { c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_2BB(Decision c, While w) {
		for (While __DEC_c_first_745917 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "first")) {
			if (!w.equals(__DEC_c_first_745917)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_3BB(Decision c, While w) {
		for (While __DEC_c_last_184481 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				While.class, "last")) {
			if (!w.equals(__DEC_c_last_184481)) {
				return new Object[] { c, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_4B(Decision c) {
		for (Program __DEC_c_first_812597 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_5BB(Assignment a, Decision c) {
		for (Decision __DEC_a_positive_591065 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			if (!c.equals(__DEC_a_positive_591065)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_6BB(Assignment a, Decision c) {
		for (Decision __DEC_a_negative_161118 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!c.equals(__DEC_a_negative_161118)) {
				return new Object[] { a, c };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_7BB(Assignment a, While w) {
		for (While __DEC_a_last_145534 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!w.equals(__DEC_a_last_145534)) {
				return new Object[] { a, w };
			}
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_27_1_matchtggpattern_black_nac_8B(Assignment a) {
		for (Program __DEC_a_first_43377 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_0B(Command x) {
		for (Graph __DEC_x_root_978464 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_1BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_positive_908693 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!i.equals(__DEC_x_positive_908693)) {
					if (!z.equals(__DEC_x_positive_908693)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_2BBB(Command x, Branch i,
			Branch z) {
		if (!i.equals(z)) {
			for (Branch __DEC_x_negative_816013 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!i.equals(__DEC_x_negative_816013)) {
					if (!z.equals(__DEC_x_negative_816013)) {
						return new Object[] { x, i, z };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_3B(Branch z) {
		for (Graph __DEC_z_root_462350 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_4BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_positive_558712 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!z.equals(__DEC_z_positive_558712)) {
					if (!i.equals(__DEC_z_positive_558712)) {
						return new Object[] { z, i };
					}
				}
			}
	...
	public static final Object[] pattern_whilead2branchcb_28_1_matchtggpattern_black_nac_5BB(Branch z, Branch i) {
		if (!i.equals(z)) {
			for (Branch __DEC_z_negative_509172 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!z.equals(__DEC_z_negative_509172)) {
					if (!i.equals(__DEC_z_negative_509172)) {
						return new Object[] { z, i };
					}
				}
			}
			...
			for (EObject tmpW2i : w2iList.getEntryObjects()) {
				if (tmpW2i instanceof S2B) {
					...
					if (tmpW instanceof While) {
						...
						Branch i = w2i.getTarget();
						if (i != null) {
							if (pattern_whilead2branchcb_29_2_isapplicablecore_black_nac_0BB(ruleResult, w2i) == null) {
								if (pattern_whilead2branchcb_29_2_isapplicablecore_black_nac_1BB(ruleResult,
										w) == null) {
	...
	public static final Object[] pattern_whilead2branchcb_29_5_checknacs_blackBBB(S2B w2i, While w, Branch i) {
		return new Object[] { w2i, w, i };
	}

	public static final Object[] pattern_whilead2branchcb_29_6_perform_blackBBBB(S2B w2i, While w, Branch i,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { w2i, w, i, ruleResult };
	}

	public static final Object[] pattern_whilead2branchcb_29_6_perform_greenBFFFBFFFB(While w, Branch i,
			ModelgeneratorRuleResult ruleResult) {
		Command x = ControlflowFactory.eINSTANCE.createCommand();
		S2B c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Decision c = SourcecodeFactory.eINSTANCE.createDecision();
		...
		return new Object[] { w, x, c2z, c, i, a2x, z, a, ruleResult };
	}
