...
public class decdecdec2branchbranchbranchImpl extends AbstractRuleImpl implements decdecdec2branchbranchbranch {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_1_performtransformation_greenBFFBFFB(a, b, c);
		...
		Object[] result2_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_blackBBBBBB(a, b2y, a2x, b, y, x);
		...
		Object[] result2_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_greenFBBBBBB(a, b2y, a2x, b, y, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, d2c, a, b2y,
						a2x, b, y, x, d, c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[d2c] = " + d2c + ", " + "[a] = " + a + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x
					+ ", " + "[b] = " + b + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[d] = " + d + ", "
					+ "[c] = " + c + ".");
		}
		decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, a, b2y,
						a2x, b, y, x, d, c);
		...
		decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, d2c, a, b2y, a2x, b, y, x, d, c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_2_2_corematch_blackFBBBFB(a, b, d, match)) {
			S2B d2c = (S2B) result2_black[0];
			Branch c = (Branch) result2_black[4];
			// ForEach 
			for (Object[] result3_black : decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_2_3_findcontext_blackBBBBB(d2c, a, b, d, c)) {
				Object[] result3_green = decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_2_3_findcontext_greenBBBBBFFFFF(d2c, a, b, d, c);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2B d2c, Decision a, Decision b,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b2y, EObject a2x,
			EObject b, EObject y, EObject x, EObject d, EObject c) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Branch y, Branch x, Branch c) {

		Object[] result1_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_10_1_initialbindings_blackBBBBB(this, match, y, x, c);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, y, x, c);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[c] = " + c + ".");
		}
		...
		if (decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_10_3_CheckCSP_expressionFBB(this,
			...
			Object[] result4_black = decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_10_4_collectelementstobetranslated_blackBBBB(match, y, x, c);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[y] = " + y + ", " + "[x] = " + x + ", " + "[c] = " + c + ".");
			}
			decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_10_4_collectelementstobetranslated_greenBBBBFF(match, y, x,
							c);
			...
			Object[] result5_black = decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_10_5_collectcontextelements_blackBBBB(match, y, x, c);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[y] = " + y + ", " + "[x] = " + x + ", " + "[c] = " + c + ".");
			}
			...
			// 
			decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_10_6_registerobjectstomatch_expressionBBBBB(this, match, y, x,
							c);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_1_performtransformation_greenFFFFBBB(y, x, d);
		...
		Object[] result2_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_2_collecttranslatedelements_blackBBBBBB(a, b2y, a2x, b, y, x);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[b2y] = " + b2y + ", "
							+ "[a2x] = " + a2x + ", " + "[b] = " + b + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
		...
		Object[] result2_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_2_collecttranslatedelements_greenFBBBBBB(a, b2y, a2x, b, y, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, d2c, a, b2y,
						a2x, b, y, x, d, c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[d2c] = " + d2c + ", " + "[a] = " + a + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x
		...
		decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, a,
						b2y, a2x, b, y, x, d, c);
		//nothing EMoflonEdge b2y__b____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge b2y__y____target = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge a2x__x____target = (EMoflonEdge) result3_green[11];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_12_2_corematch_blackFBBFBB(y, x, c, match)) {
			S2B d2c = (S2B) result2_black[0];
			Decision d = (Decision) result2_black[3];
			// ForEach 
			for (Object[] result3_black : decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_12_3_findcontext_blackBBBBB(d2c, y, x, d, c)) {
				Object[] result3_green = decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_12_3_findcontext_greenBBBBBFFFFF(d2c, y, x, d, c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Branch y, Branch x, Branch c) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Branch y, Branch x, Branch c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, S2B d2c, Branch y, Branch x, Decision d,
			Branch c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b2y, EObject a2x,
			EObject b, EObject y, EObject x, EObject d, EObject c) {
		ruleresult.registerObject("d2c", d2c);
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("b2y", b2y);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_253(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_261(EMoflonEdge _edge_negative) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, a, b, y, x, d, c,
		...
		if (decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decdecdec2branchbranchbranchImpl
				...
				Object[] result6_black = decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_blackBBBBBBB(a, b, y, x, d, c,
								ccMatch);
				if (result6_black == null) {
				...
				decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_greenBFFBBBB(a, b, y, x,
								ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Decision a, Decision b, Branch y, Branch x, Decision d, Branch c,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Branch y, Branch x, Branch c) {// 
		Object[] result1_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_blackBBB(y, x, c);
		if (result1_black != null) {
		...
		for (Object[] result2_black : decdecdec2branchbranchbranchImpl
			...
			if (decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_29_6_perform_greenFFFFFFBBB(d,
							c, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_253__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_253((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_261__EMOFLONEDGE:
		...
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPLICABLE_SOLVE_CSP_CC__DECISION_DECISION_BRANCH_BRANCH_DECISION_BRANCH_MATCH_MATCH:
				...
				if (tmpB instanceof Decision) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpC instanceof Branch) {
							...
							return new Object[] { d2c, a, b, d, c, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_1_performtransformation_blackBBBBBFBB(S2B d2c,
			Decision a, Decision b, Decision d, Branch c, decdecdec2branchbranchbranch _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(b)) {
			if (!a.equals(d)) {
				if (!b.equals(d)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { d2c, a, b, d, c, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecdec2branchbranchbranch_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_decdecdec2branchbranchbranch_1_1_performtransformation_black = pattern_decdecdec2branchbranchbranch_1_1_performtransformation_blackBBBBBFBB(
					d2c, a, b, d, c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_1_performtransformation_greenBFFBFFB(Decision a,
			Decision b, Branch c) {
		...
		a2x.setTarget(x);
		c.setPositive(x);
		return new Object[] { a, b2y, a2x, b, y, x, c };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_blackBBBBBB(
			Decision a, S2B b2y, S2B a2x, Decision b, Branch y, Branch x) {
		if (!a.equals(b)) {
			if (!a2x.equals(b2y)) {
				if (!x.equals(y)) {
					return new Object[] { a, b2y, a2x, b, y, x };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, a, b2y, a2x, b, y, x };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b2y, EObject a2x, EObject b, EObject y,
			EObject x, EObject d, EObject c) {
		if (!d2c.equals(y)) {
			if (!d2c.equals(x)) {
				if (!a.equals(d2c)) {
					if (!a.equals(b2y)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject a, EObject b2y, EObject a2x, EObject b, EObject y, EObject x,
			EObject d, EObject c) {
		...
		d__a____positive.setName(d__a____positive_name_prime);
		return new Object[] { ruleresult, a, b2y, a2x, b, y, x, d, c, b2y__b____source, b2y__y____target,
				a2x__x____target, a2x__a____source, d__b____negative, c__x____positive, c__y____negative,
				d__a____positive };
	}

	public static final void pattern_decdecdec2branchbranchbranch_1_5_registerobjects_expressionBBBBBBBBBBB(
			decdecdec2branchbranchbranch _this, PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b2y,
			EObject a2x, EObject b, EObject y, EObject x, EObject d, EObject c) {
		_this.registerObjects_FWD(ruleresult, d2c, a, b2y, a2x, b, y, x, d, c);
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_2_2_corematch_blackFBBBFB(Decision a,
			...
			if (!a.equals(d)) {
				if (!b.equals(d)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class,
						...
						if (c != null) {
							_result.add(new Object[] { d2c, a, b, d, c, match });
						}
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_2_3_findcontext_blackBBBBB(S2B d2c,
			Decision a, Decision b, Decision d, Branch c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(b)) {
			if (!a.equals(d)) {
				if (!b.equals(d)) {
						...
						if (d.equals(d2c.getSource())) {
							if (c.equals(d2c.getTarget())) {
								if (a.equals(d.getPositive())) {
									_result.add(new Object[] { d2c, a, b, d, c });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_2_3_findcontext_greenBBBBBFFFFF(S2B d2c,
		...
		d__a____positive.setName(d__a____positive_name_prime);
		return new Object[] { d2c, a, b, d, c, isApplicableMatch, d__b____negative, d2c__d____source, d2c__c____target,
				d__a____positive };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_2_4_solveCSP_bindingFBBBBBBB(
			decdecdec2branchbranchbranch _this, IsApplicableMatch isApplicableMatch, S2B d2c, Decision a, Decision b,
			Decision d, Branch c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, d2c, a, b, d, c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, a, b, d, c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecdec2branchbranchbranch_2_4_solveCSP_binding = pattern_decdecdec2branchbranchbranch_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, d2c, a, b, d, c);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_10_1_initialbindings_blackBBBBB(
			decdecdec2branchbranchbranch _this, Match match, Branch y, Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_10_4_collectelementstobetranslated_blackBBBB(
			Match match, Branch y, Branch x, Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
			...
			if (tmpY instanceof Branch) {
				...
				if (tmpX instanceof Branch) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpC instanceof Branch) {
							Branch c = (Branch) tmpC;
							return new Object[] { d2c, y, x, d, c, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_11_1_performtransformation_blackBBBBBFBB(S2B d2c,
			Branch y, Branch x, Decision d, Branch c, decdecdec2branchbranchbranch _this,
			IsApplicableMatch isApplicableMatch) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { d2c, y, x, d, c, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecdec2branchbranchbranch_11_1_performtransformation_binding != null) {
			...
			Branch y = (Branch) result_pattern_decdecdec2branchbranchbranch_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_decdecdec2branchbranchbranch_11_1_performtransformation_black = pattern_decdecdec2branchbranchbranch_11_1_performtransformation_blackBBBBBFBB(
					d2c, y, x, d, c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_11_1_performtransformation_greenFFFFBBB(Branch y,
			Branch x, Decision d) {
		...
		b2y.setSource(b);
		d.setNegative(b);
		return new Object[] { a, b2y, a2x, b, y, x, d };
	}
	...
	public static final void pattern_decdecdec2branchbranchbranch_11_5_registerobjects_expressionBBBBBBBBBBB(
			decdecdec2branchbranchbranch _this, PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b2y,
			EObject a2x, EObject b, EObject y, EObject x, EObject d, EObject c) {
		_this.registerObjects_BWD(ruleresult, d2c, a, b2y, a2x, b, y, x, d, c);
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_12_2_corematch_blackFBBFBB(Branch y,
			...
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							_result.add(new Object[] { d2c, y, x, d, c, match });
						}
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_12_3_findcontext_blackBBBBB(S2B d2c,
			Branch y, Branch x, Decision d, Branch c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					if (d.equals(d2c.getSource())) {
						if (x.equals(c.getPositive())) {
							if (y.equals(c.getNegative())) {
								if (c.equals(d2c.getTarget())) {
									_result.add(new Object[] { d2c, y, x, d, c });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_12_3_findcontext_greenBBBBBFFFFF(S2B d2c,
		...
		c__y____negative.setName(c__y____negative_name_prime);
		d2c__c____target.setName(d2c__c____target_name_prime);
		return new Object[] { d2c, y, x, d, c, isApplicableMatch, d2c__d____source, c__x____positive, c__y____negative,
				d2c__c____target };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_12_4_solveCSP_bindingFBBBBBBB(
			decdecdec2branchbranchbranch _this, IsApplicableMatch isApplicableMatch, S2B d2c, Branch y, Branch x,
			Decision d, Branch c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d2c, y, x, d, c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, y, x, d, c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecdec2branchbranchbranch_12_4_solveCSP_binding = pattern_decdecdec2branchbranchbranch_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, d2c, y, x, d, c);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_0B(Branch y) {
		for (Graph __DEC_y_root_811750 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_1BBB(Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_262425 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_262425)) {
							if (!x.equals(__DEC_y_positive_262425)) {
								if (!c.equals(__DEC_y_positive_262425)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_2BBB(Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_652599 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_652599)) {
							if (!x.equals(__DEC_y_negative_652599)) {
								if (!c.equals(__DEC_y_negative_652599)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_604207 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_4BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_145626 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_145626)) {
							if (!y.equals(__DEC_x_positive_145626)) {
								if (!c.equals(__DEC_x_positive_145626)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_5BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_203870 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_203870)) {
							if (!y.equals(__DEC_x_negative_203870)) {
								if (!c.equals(__DEC_x_negative_203870)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_6BB(Branch y,
			Branch x) {
														...
														if (pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_5BBB(
															...
															if (pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_6BB(
																...
																if (pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_7BB(
																		y, x) == null) {
																	_result.add(
																			new Object[] { y, x, c, _edge_positive });
																}
															}
														}
													}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!a.equals(b)) {
			if (!a.equals(d)) {
				if (!b.equals(d)) {
					for (Decision __DEC_a_negative_478589 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(a, Decision.class, "negative")) {
						if (!a.equals(__DEC_a_negative_478589)) {
							if (!b.equals(__DEC_a_negative_478589)) {
								if (!d.equals(__DEC_a_negative_478589)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_1B(
			Decision a) {
		for (While __DEC_a_first_91287 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_2B(
			Decision a) {
		for (While __DEC_a_last_14677 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_3B(
			Decision a) {
		for (Program __DEC_a_first_426113 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_4BBB(
		...
		if (!b.equals(d)) {
			if (!a.equals(b)) {
				if (!a.equals(d)) {
					for (Decision __DEC_b_positive_45030 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, Decision.class, "positive")) {
						if (!b.equals(__DEC_b_positive_45030)) {
							if (!a.equals(__DEC_b_positive_45030)) {
								if (!d.equals(__DEC_b_positive_45030)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_5B(
			Decision b) {
		for (While __DEC_b_first_344995 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_6B(
			Decision b) {
		for (While __DEC_b_last_715741 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_7B(
			Decision b) {
		for (Program __DEC_b_first_706981 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
				...
				if (tmpY instanceof Branch) {
					...
					if (tmpX instanceof Branch) {
						...
						if (tmpD instanceof Decision) {
							...
							if (tmpC instanceof Branch) {
								Branch c = (Branch) tmpC;
								return new Object[] { a, b, y, x, d, c, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_blackBBBBBBBB(Decision a,
			Decision b, Branch y, Branch x, Decision d, Branch c, Match sourceMatch, Match targetMatch) {
		if (!a.equals(b)) {
			if (!a.equals(d)) {
				if (!b.equals(d)) {
					if (!x.equals(y)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_black = pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_blackBBBBBBBB(
					a, b, y, x, d, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingFBBBBBBBBB(
			decdecdec2branchbranchbranch _this, Decision a, Decision b, Branch y, Branch x, Decision d, Branch c,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(a, b, y, x, d, c, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, a, b, y, x, d, c, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_decdecdec2branchbranchbranch_24_3_solvecsp_binding = pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, a, b, y, x, d, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_blackBBBBBBB(Decision a,
			Decision b, Branch y, Branch x, Decision d, Branch c, CCMatch ccMatch) {
		if (!a.equals(b)) {
			if (!a.equals(d)) {
				if (!b.equals(d)) {
					if (!x.equals(y)) {
						if (!c.equals(y)) {
							if (!c.equals(x)) {
								return new Object[] { a, b, y, x, d, c, ccMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_greenBFFBBBB(Decision a,
		...
		return new Object[] { a, b2y, a2x, b, y, x, ccMatch };
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_0BBB(Decision a,
		...
		if (!a.equals(b)) {
			if (!a.equals(d)) {
				if (!b.equals(d)) {
					for (Decision __DEC_a_negative_603851 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(a, Decision.class, "negative")) {
						if (!a.equals(__DEC_a_negative_603851)) {
							if (!b.equals(__DEC_a_negative_603851)) {
								if (!d.equals(__DEC_a_negative_603851)) {
									return new Object[] { a, b, d };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_1B(Decision a) {
		for (While __DEC_a_first_478303 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_2B(Decision a) {
		for (While __DEC_a_last_938958 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_783617 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_4BBB(Decision b,
		...
		if (!b.equals(d)) {
			if (!a.equals(b)) {
				if (!a.equals(d)) {
					for (Decision __DEC_b_positive_168315 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, Decision.class, "positive")) {
						if (!b.equals(__DEC_b_positive_168315)) {
							if (!a.equals(__DEC_b_positive_168315)) {
								if (!d.equals(__DEC_b_positive_168315)) {
									return new Object[] { b, a, d };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_5B(Decision b) {
		for (While __DEC_b_first_447270 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_6B(Decision b) {
		for (While __DEC_b_last_798035 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_7B(Decision b) {
		for (Program __DEC_b_first_563395 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_0B(Branch y) {
		for (Graph __DEC_y_root_107504 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_1BBB(Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_positive_741791 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_741791)) {
							if (!x.equals(__DEC_y_positive_741791)) {
								if (!c.equals(__DEC_y_positive_741791)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_2BBB(Branch y,
		...
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					for (Branch __DEC_y_negative_350125 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_350125)) {
							if (!x.equals(__DEC_y_negative_350125)) {
								if (!c.equals(__DEC_y_negative_350125)) {
									return new Object[] { y, x, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_13406 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_4BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_637001 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_637001)) {
							if (!y.equals(__DEC_x_positive_637001)) {
								if (!c.equals(__DEC_x_positive_637001)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_5BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_848203 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_848203)) {
							if (!y.equals(__DEC_x_negative_848203)) {
								if (!c.equals(__DEC_x_negative_848203)) {
									return new Object[] { x, y, c };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_6BB(Branch y,
			Branch x) {
		if (x.equals(y.getPositive())) {
			return new Object[] { y, x };
		}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_blackBBB(Branch y, Branch x,
			Branch c) {
		if (!x.equals(y)) {
			if (!c.equals(y)) {
				if (!c.equals(x)) {
					if (x.equals(c.getPositive())) {
						if (y.equals(c.getNegative())) {
							if (pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_0B(y) == null) {
								if (pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_1BBB(y, x,
										c) == null) {
									if (pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_2BBB(y, x,
											c) == null) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_29_6_perform_greenFFFFFFBBB(Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		Decision a = SourcecodeFactory.eINSTANCE.createDecision();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		return new Object[] { a, b2y, a2x, b, y, x, d, c, ruleResult };
	}
