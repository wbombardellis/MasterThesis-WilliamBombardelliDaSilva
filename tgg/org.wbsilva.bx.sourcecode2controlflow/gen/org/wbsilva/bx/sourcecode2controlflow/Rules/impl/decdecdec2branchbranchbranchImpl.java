...
public class decdecdec2branchbranchbranchImpl extends AbstractRuleImpl implements decdecdec2branchbranchbranch {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_1_performtransformation_greenBBFFFFB(a, c, b);
		...
		Object[] result2_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_blackBBBBBB(a, y, a2x, b2y, x, b);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[y] = " + y + ", " + "[a2x] = "
							+ a2x + ", " + "[b2y] = " + b2y + ", " + "[x] = " + x + ", " + "[b] = " + b + ".");
		}
		Object[] result2_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_greenFBBBBBB(a, y, a2x, b2y, x, b);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, a, c, y, d2c,
						a2x, b2y, d, x, b);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[y] = " + y + ", " + "[d2c] = " + d2c + ", "
					+ "[a2x] = " + a2x + ", " + "[b2y] = " + b2y + ", " + "[d] = " + d + ", " + "[x] = " + x + ", "
					+ "[b] = " + b + ".");
		}
		decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, a, c,
						y, a2x, b2y, d, x, b);
		...
		decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, a, c, y, d2c, a2x, b2y, d, x, b);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_2_2_corematch_blackBFFBBB(a, d, b, match)) {
			Branch c = (Branch) result2_black[1];
			S2B d2c = (S2B) result2_black[2];
			// ForEach 
			for (Object[] result3_black : decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_2_3_findcontext_blackBBBBB(a, c, d2c, d, b)) {
				Object[] result3_green = decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_2_3_findcontext_greenBBBBBFFFFF(a, c, d2c, d, b);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Decision a, Branch c, S2B d2c, Decision d,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject a, EObject c, EObject y, EObject d2c,
			EObject a2x, EObject b2y, EObject d, EObject x, EObject b) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_1_performtransformation_greenFBFFBBF(y, d, x);
		...
		Object[] result2_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_2_collecttranslatedelements_blackBBBBBB(a, y, a2x, b2y, x, b);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[y] = " + y + ", " + "[a2x] = "
							+ a2x + ", " + "[b2y] = " + b2y + ", " + "[x] = " + x + ", " + "[b] = " + b + ".");
		...
		Object[] result2_green = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_2_collecttranslatedelements_greenFBBBBBB(a, y, a2x, b2y, x, b);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, a, c, y, d2c,
						a2x, b2y, d, x, b);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[y] = " + y + ", " + "[d2c] = " + d2c + ", "
		...
		decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult, a, c,
						y, a2x, b2y, d, x, b);
		//nothing EMoflonEdge c__y____negative = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge d__b____negative = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge d__a____positive = (EMoflonEdge) result3_green[11];
		...
		// 
		decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, a, c,
						y, d2c, a2x, b2y, d, x, b);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_12_2_corematch_blackBBFFBB(c, y, x, match)) {
			S2B d2c = (S2B) result2_black[2];
			Decision d = (Decision) result2_black[3];
			// ForEach 
			for (Object[] result3_black : decdecdec2branchbranchbranchImpl
					.pattern_decdecdec2branchbranchbranch_12_3_findcontext_blackBBBBB(c, y, d2c, d, x)) {
				Object[] result3_green = decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_12_3_findcontext_greenBBBBBFFFFF(c, y, d2c, d, x);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject a, EObject c, EObject y, EObject d2c,
			EObject a2x, EObject b2y, EObject d, EObject x, EObject b) {
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("y", y);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_42(EMoflonEdge _edge_negative) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdecdec2branchbranchbranchImpl
				.pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, a, c, y, d, x, b,
		...
		if (decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decdecdec2branchbranchbranchImpl
				...
				Object[] result6_black = decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_blackBBBBBBB(a, c, y, d, x, b,
								ccMatch);
				if (result6_black == null) {
				...
				decdecdec2branchbranchbranchImpl
						.pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_greenBBFFBBB(a, y, x, b,
								ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Decision a, Branch c, Branch y, Decision d, Branch x, Decision b,
		...
		for (Object[] result2_black : decdecdec2branchbranchbranchImpl
			...
			if (decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					decdecdec2branchbranchbranchImpl.pattern_decdecdec2branchbranchbranch_29_6_perform_greenFBFFFBFFB(c,
							d, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_DECISION_BRANCH_S2B_DECISION_DECISION:
		...
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_BRANCH_S2B_DECISION_BRANCH:
		...
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPROPRIATE_BWD_EMOFLON_EDGE_42__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_42((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPROPRIATE_FWD_EMOFLON_EDGE_43__EMOFLONEDGE:
		...
		case RulesPackage.DECDECDEC2BRANCHBRANCHBRANCH___IS_APPLICABLE_SOLVE_CSP_CC__DECISION_BRANCH_BRANCH_DECISION_BRANCH_DECISION_MATCH_MATCH:
				...
				if (tmpD2c instanceof S2B) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpB instanceof Decision) {
							...
							return new Object[] { a, c, d2c, d, b, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_1_performtransformation_blackBBBBBFBB(
			Decision a, Branch c, S2B d2c, Decision d, Decision b, decdecdec2branchbranchbranch _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(d)) {
			if (!a.equals(b)) {
				if (!b.equals(d)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { a, c, d2c, d, b, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecdec2branchbranchbranch_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_decdecdec2branchbranchbranch_1_1_performtransformation_black = pattern_decdecdec2branchbranchbranch_1_1_performtransformation_blackBBBBBFBB(
					a, c, d2c, d, b, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_1_performtransformation_greenBBFFFFB(Decision a,
			Branch c, Decision b) {
		...
		a2x.setTarget(x);
		c.setPositive(x);
		return new Object[] { a, c, y, a2x, b2y, x, b };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_blackBBBBBB(
			Decision a, Branch y, S2B a2x, S2B b2y, Branch x, Decision b) {
		if (!a.equals(b)) {
			if (!a2x.equals(b2y)) {
				if (!x.equals(y)) {
					return new Object[] { a, y, a2x, b2y, x, b };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, a, y, a2x, b2y, x, b };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject a, EObject c, EObject y, EObject d2c, EObject a2x, EObject b2y,
			EObject d, EObject x, EObject b) {
		if (!a.equals(c)) {
			if (!a.equals(y)) {
				if (!a.equals(d2c)) {
					if (!a.equals(a2x)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject a, EObject c, EObject y, EObject a2x, EObject b2y, EObject d,
			EObject x, EObject b) {
		...
		return new Object[] { ruleresult, a, c, y, a2x, b2y, d, x, b, c__y____negative, d__b____negative,
				d__a____positive, b2y__y____target, a2x__x____target, b2y__b____source, c__x____positive,
				a2x__a____source };
	}

	public static final void pattern_decdecdec2branchbranchbranch_1_5_registerobjects_expressionBBBBBBBBBBB(
			decdecdec2branchbranchbranch _this, PerformRuleResult ruleresult, EObject a, EObject c, EObject y,
			EObject d2c, EObject a2x, EObject b2y, EObject d, EObject x, EObject b) {
		_this.registerObjects_FWD(ruleresult, a, c, y, d2c, a2x, b2y, d, x, b);
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_2_2_corematch_blackBFFBBB(Decision a,
			...
			if (!a.equals(b)) {
				if (!b.equals(d)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class,
						...
						if (c != null) {
							_result.add(new Object[] { a, c, d2c, d, b, match });
						}
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_2_3_findcontext_blackBBBBB(Decision a,
			Branch c, S2B d2c, Decision d, Decision b) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(d)) {
			if (!a.equals(b)) {
				if (!b.equals(d)) {
						...
						if (b.equals(d.getNegative())) {
							if (d.equals(d2c.getSource())) {
								if (a.equals(d.getPositive())) {
									_result.add(new Object[] { a, c, d2c, d, b });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_2_3_findcontext_greenBBBBBFFFFF(Decision a,
		...
		d__a____positive.setName(d__a____positive_name_prime);
		return new Object[] { a, c, d2c, d, b, isApplicableMatch, d2c__c____target, d__b____negative, d2c__d____source,
				d__a____positive };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_2_4_solveCSP_bindingFBBBBBBB(
			decdecdec2branchbranchbranch _this, IsApplicableMatch isApplicableMatch, Decision a, Branch c, S2B d2c,
			Decision d, Decision b) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, a, c, d2c, d, b);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, a, c, d2c, d, b };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecdec2branchbranchbranch_2_4_solveCSP_binding = pattern_decdecdec2branchbranchbranch_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, a, c, d2c, d, b);
				...
				if (tmpD2c instanceof S2B) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpX instanceof Branch) {
							...
							return new Object[] { c, y, d2c, d, x, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_11_1_performtransformation_blackBBBBBFBB(Branch c,
			Branch y, S2B d2c, Decision d, Branch x, decdecdec2branchbranchbranch _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(y)) {
			if (!c.equals(x)) {
				if (!x.equals(y)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { c, y, d2c, d, x, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecdec2branchbranchbranch_11_1_performtransformation_binding != null) {
			...
			S2B d2c = (S2B) result_pattern_decdecdec2branchbranchbranch_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_decdecdec2branchbranchbranch_11_1_performtransformation_black = pattern_decdecdec2branchbranchbranch_11_1_performtransformation_blackBBBBBFBB(
					c, y, d2c, d, x, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_11_1_performtransformation_greenFBFFBBF(Branch y,
			Decision d, Branch x) {
		...
		d.setNegative(b);
		b2y.setSource(b);
		return new Object[] { a, y, a2x, b2y, d, x, b };
	}
	...
	public static final void pattern_decdecdec2branchbranchbranch_11_5_registerobjects_expressionBBBBBBBBBBB(
			decdecdec2branchbranchbranch _this, PerformRuleResult ruleresult, EObject a, EObject c, EObject y,
			EObject d2c, EObject a2x, EObject b2y, EObject d, EObject x, EObject b) {
		_this.registerObjects_BWD(ruleresult, a, c, y, d2c, a2x, b2y, d, x, b);
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_12_2_corematch_blackBBFFBB(Branch c,
			...
			if (!c.equals(x)) {
				if (!x.equals(y)) {
					for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							_result.add(new Object[] { c, y, d2c, d, x, match });
						}
	...
	public static final Iterable<Object[]> pattern_decdecdec2branchbranchbranch_12_3_findcontext_blackBBBBB(Branch c,
			Branch y, S2B d2c, Decision d, Branch x) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(y)) {
			if (!c.equals(x)) {
				if (!x.equals(y)) {
						...
						if (c.equals(d2c.getTarget())) {
							if (d.equals(d2c.getSource())) {
								if (x.equals(c.getPositive())) {
									_result.add(new Object[] { c, y, d2c, d, x });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_12_3_findcontext_greenBBBBBFFFFF(Branch c,
		...
		d2c__d____source.setName(d2c__d____source_name_prime);
		c__x____positive.setName(c__x____positive_name_prime);
		return new Object[] { c, y, d2c, d, x, isApplicableMatch, c__y____negative, d2c__c____target, d2c__d____source,
				c__x____positive };
	}

	public static final Object[] pattern_decdecdec2branchbranchbranch_12_4_solveCSP_bindingFBBBBBBB(
			decdecdec2branchbranchbranch _this, IsApplicableMatch isApplicableMatch, Branch c, Branch y, S2B d2c,
			Decision d, Branch x) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, c, y, d2c, d, x);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c, y, d2c, d, x };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecdec2branchbranchbranch_12_4_solveCSP_binding = pattern_decdecdec2branchbranchbranch_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, c, y, d2c, d, x);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_0B(Branch y) {
		for (Graph __DEC_y_root_762685 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_1BBB(Branch y,
		...
		if (!c.equals(y)) {
			if (!c.equals(x)) {
				if (!x.equals(y)) {
					for (Branch __DEC_y_positive_442440 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_442440)) {
							if (!c.equals(__DEC_y_positive_442440)) {
								if (!x.equals(__DEC_y_positive_442440)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_2BBB(Branch y,
		...
		if (!c.equals(y)) {
			if (!c.equals(x)) {
				if (!x.equals(y)) {
					for (Branch __DEC_y_negative_316732 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_316732)) {
							if (!c.equals(__DEC_y_negative_316732)) {
								if (!x.equals(__DEC_y_negative_316732)) {
									return new Object[] { y, c, x };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_452106 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_4BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_49915 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_49915)) {
							if (!c.equals(__DEC_x_positive_49915)) {
								if (!y.equals(__DEC_x_positive_49915)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_20_2_testcorematchandDECs_black_nac_5BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_458622 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_458622)) {
							if (!c.equals(__DEC_x_negative_458622)) {
								if (!y.equals(__DEC_x_negative_458622)) {
									return new Object[] { x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!a.equals(d)) {
			if (!a.equals(b)) {
				if (!b.equals(d)) {
					for (Decision __DEC_a_negative_399141 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(a, Decision.class, "negative")) {
						if (!a.equals(__DEC_a_negative_399141)) {
							if (!d.equals(__DEC_a_negative_399141)) {
								if (!b.equals(__DEC_a_negative_399141)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_1B(
			Decision a) {
		for (While __DEC_a_first_258025 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_2B(
			Decision a) {
		for (While __DEC_a_last_97113 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_3B(
			Decision a) {
		for (Program __DEC_a_first_36815 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_4BBB(
		...
		if (!b.equals(d)) {
			if (!a.equals(b)) {
				if (!a.equals(d)) {
					for (Decision __DEC_b_positive_775652 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, Decision.class, "positive")) {
						if (!b.equals(__DEC_b_positive_775652)) {
							if (!a.equals(__DEC_b_positive_775652)) {
								if (!d.equals(__DEC_b_positive_775652)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_5B(
			Decision b) {
		for (While __DEC_b_first_598414 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_6B(
			Decision b) {
		for (While __DEC_b_last_896122 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_21_2_testcorematchandDECs_black_nac_7B(
			Decision b) {
		for (Program __DEC_b_first_169248 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
				...
				if (tmpY instanceof Branch) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpX instanceof Branch) {
							...
							if (tmpB instanceof Decision) {
								Decision b = (Decision) tmpB;
								return new Object[] { a, c, y, d, x, b, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_blackBBBBBBBB(Decision a,
			Branch c, Branch y, Decision d, Branch x, Decision b, Match sourceMatch, Match targetMatch) {
		if (!a.equals(d)) {
			if (!a.equals(b)) {
				if (!c.equals(y)) {
					if (!c.equals(x)) {
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding != null) {
			...
			Branch c = (Branch) result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding[1];
			Branch y = (Branch) result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding[2];
			Decision d = (Decision) result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding[3];
			Branch x = (Branch) result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding[4];
			Decision b = (Decision) result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_black = pattern_decdecdec2branchbranchbranch_24_2_matchsrctrgcontext_blackBBBBBBBB(
					a, c, y, d, x, b, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingFBBBBBBBBB(
			decdecdec2branchbranchbranch _this, Decision a, Branch c, Branch y, Decision d, Branch x, Decision b,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(a, c, y, d, x, b, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, a, c, y, d, x, b, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_decdecdec2branchbranchbranch_24_3_solvecsp_binding = pattern_decdecdec2branchbranchbranch_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, a, c, y, d, x, b, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_blackBBBBBBB(Decision a,
			Branch c, Branch y, Decision d, Branch x, Decision b, CCMatch ccMatch) {
		if (!a.equals(d)) {
			if (!a.equals(b)) {
				if (!c.equals(y)) {
					if (!c.equals(x)) {
						if (!x.equals(y)) {
							if (!b.equals(d)) {
								return new Object[] { a, c, y, d, x, b, ccMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_24_6_createcorrespondence_greenBBFFBBB(Decision a,
			Branch y, Branch x, Decision b, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2B b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		a2x.setTarget(x);
		a2x.setSource(a);
		...
		return new Object[] { a, y, a2x, b2y, x, b, ccMatch };
	}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_0BBB(Decision a,
		...
		if (!a.equals(d)) {
			if (!a.equals(b)) {
				if (!b.equals(d)) {
					for (Decision __DEC_a_negative_290661 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(a, Decision.class, "negative")) {
						if (!a.equals(__DEC_a_negative_290661)) {
							if (!d.equals(__DEC_a_negative_290661)) {
								if (!b.equals(__DEC_a_negative_290661)) {
									return new Object[] { a, d, b };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_1B(Decision a) {
		for (While __DEC_a_first_165714 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_2B(Decision a) {
		for (While __DEC_a_last_67947 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_731097 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_4BBB(Decision b,
		...
		if (!b.equals(d)) {
			if (!a.equals(b)) {
				if (!a.equals(d)) {
					for (Decision __DEC_b_positive_391530 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(b, Decision.class, "positive")) {
						if (!b.equals(__DEC_b_positive_391530)) {
							if (!a.equals(__DEC_b_positive_391530)) {
								if (!d.equals(__DEC_b_positive_391530)) {
									return new Object[] { b, a, d };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_5B(Decision b) {
		for (While __DEC_b_first_93486 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_6B(Decision b) {
		for (While __DEC_b_last_37483 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_27_1_matchtggpattern_black_nac_7B(Decision b) {
		for (Program __DEC_b_first_949870 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_0B(Branch y) {
		for (Graph __DEC_y_root_371067 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_1BBB(Branch y,
		...
		if (!c.equals(y)) {
			if (!c.equals(x)) {
				if (!x.equals(y)) {
					for (Branch __DEC_y_positive_144983 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "positive")) {
						if (!y.equals(__DEC_y_positive_144983)) {
							if (!c.equals(__DEC_y_positive_144983)) {
								if (!x.equals(__DEC_y_positive_144983)) {
									return new Object[] { y, c, x };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_2BBB(Branch y,
		...
		if (!c.equals(y)) {
			if (!c.equals(x)) {
				if (!x.equals(y)) {
					for (Branch __DEC_y_negative_948628 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(y, Branch.class, "negative")) {
						if (!y.equals(__DEC_y_negative_948628)) {
							if (!c.equals(__DEC_y_negative_948628)) {
								if (!x.equals(__DEC_y_negative_948628)) {
									return new Object[] { y, c, x };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_107872 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_4BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_positive_600249 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "positive")) {
						if (!x.equals(__DEC_x_positive_600249)) {
							if (!c.equals(__DEC_x_positive_600249)) {
								if (!y.equals(__DEC_x_positive_600249)) {
									return new Object[] { x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_28_1_matchtggpattern_black_nac_5BBB(Branch x,
		...
		if (!x.equals(y)) {
			if (!c.equals(x)) {
				if (!c.equals(y)) {
					for (Branch __DEC_x_negative_365853 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(x, Branch.class, "negative")) {
						if (!x.equals(__DEC_x_negative_365853)) {
							if (!c.equals(__DEC_x_negative_365853)) {
								if (!y.equals(__DEC_x_negative_365853)) {
									return new Object[] { x, c, y };
								}
							}
						}
	...
	public static final Object[] pattern_decdecdec2branchbranchbranch_29_6_perform_greenFBFFFBFFB(Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		Decision a = SourcecodeFactory.eINSTANCE.createDecision();
		Branch y = ControlflowFactory.eINSTANCE.createBranch();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		return new Object[] { a, c, y, a2x, b2y, d, x, b, ruleResult };
	}
