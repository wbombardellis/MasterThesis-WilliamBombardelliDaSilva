...
public class whileula2branchubcImpl extends AbstractRuleImpl implements whileula2branchubc {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, While a, Assignment c, Assignment b, While w) {
		...
		Object[] result2_bindingAndBlack = whileula2branchubcImpl
				.pattern_whileula2branchubc_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, a, c, b, w);
		...
		if (whileula2branchubcImpl.pattern_whileula2branchubc_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileula2branchubcImpl
					.pattern_whileula2branchubc_0_4_collectelementstobetranslated_blackBBBBB(match, a, c, b, w);
			...
			Object[] result5_black = whileula2branchubcImpl
					.pattern_whileula2branchubc_0_5_collectcontextelements_blackBBBBB(match, a, c, b, w);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_1_performtransformation_greenFBFFFBFBBF(a, i, c, b);
		...
		Object[] result2_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(a2x, a, x, z, y, c2z, c, b,
						b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a2x] = " + a2x + ", " + "[a] = "
					+ a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[c2z] = " + c2z
					+ ", " + "[c] = " + c + ", " + "[b] = " + b + ", " + "[b2y] = " + b2y + ".");
		}
		Object[] result2_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(a2x, a, x, z, y, c2z, c, b,
						b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, a2x, a, x, z, y, i,
						c2z, w2i, c, b, w, b2y);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", "
					+ "[y] = " + y + ", " + "[i] = " + i + ", " + "[c2z] = " + c2z + ", " + "[w2i] = " + w2i + ", "
					+ "[c] = " + c + ", " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[b2y] = " + b2y + ".");
		}
		whileula2branchubcImpl.pattern_whileula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, a2x, a, x, z, y, i, c2z, c, b, w, b2y);
		...
		whileula2branchubcImpl.pattern_whileula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult,
				a2x, a, x, z, y, i, c2z, w2i, c, b, w, b2y);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whileula2branchubcImpl.pattern_whileula2branchubc_2_2_corematch_blackBFFBBBB(a, c,
				b, w, match)) {
			Branch i = (Branch) result2_black[1];
			S2B w2i = (S2B) result2_black[2];
			// ForEach 
			for (Object[] result3_black : whileula2branchubcImpl
					.pattern_whileula2branchubc_2_3_findcontext_blackBBBBBB(a, i, w2i, c, b, w)) {
				Object[] result3_green = whileula2branchubcImpl
						.pattern_whileula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(a, i, w2i, c, b, w);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, While a, Assignment c, Assignment b, While w) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, While a, Assignment c, Assignment b, While w) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While a, Branch i, S2B w2i, Assignment c,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject a2x, EObject a, EObject x, EObject z,
			EObject y, EObject i, EObject c2z, EObject w2i, EObject c, EObject b, EObject w, EObject b2y) {
	...
	public boolean isAppropriate_BWD(Match match, Branch x, Command z, Command y, Branch i) {
		...
		Object[] result1_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_10_1_initialbindings_blackBBBBBB(this, match, x, z, y, i);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = whileula2branchubcImpl
				.pattern_whileula2branchubc_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, x, z, y, i);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", "
					+ "[i] = " + i + ".");
		...
		if (whileula2branchubcImpl.pattern_whileula2branchubc_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileula2branchubcImpl
					.pattern_whileula2branchubc_10_4_collectelementstobetranslated_blackBBBBB(match, x, z, y, i);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ".");
			}
			...
			Object[] result5_black = whileula2branchubcImpl
					.pattern_whileula2branchubc_10_5_collectcontextelements_blackBBBBB(match, x, z, y, i);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_1_performtransformation_greenFFBBBFFFBF(x, z, y, w);
		S2B a2x = (S2B) result1_green[0];
		...
		Object[] result2_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(a2x, a, x, z, y, c2z, c, b,
						b2y);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a2x] = " + a2x + ", " + "[a] = "
					+ a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[c2z] = " + c2z
		...
		Object[] result2_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(a2x, a, x, z, y, c2z, c, b,
						b2y);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, a2x, a, x, z, y, i,
						c2z, w2i, c, b, w, b2y);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", "
		...
		whileula2branchubcImpl.pattern_whileula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this,
				ruleresult, a2x, a, x, z, y, i, c2z, w2i, c, b, w, b2y);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whileula2branchubcImpl.pattern_whileula2branchubc_12_2_corematch_blackBBBBFFB(x,
				z, y, i, match)) {
			S2B w2i = (S2B) result2_black[4];
			While w = (While) result2_black[5];
			// ForEach 
			for (Object[] result3_black : whileula2branchubcImpl
					.pattern_whileula2branchubc_12_3_findcontext_blackBBBBBB(x, z, y, i, w2i, w)) {
				Object[] result3_green = whileula2branchubcImpl
						.pattern_whileula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(x, z, y, i, w2i, w);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = whileula2branchubcImpl
						.pattern_whileula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, x,
								z, y, i, w2i, w);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch x, Command z, Command y, Branch i,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject a2x, EObject a, EObject x, EObject z,
			EObject y, EObject i, EObject c2z, EObject w2i, EObject c, EObject b, EObject w, EObject b2y) {
		ruleresult.registerObject("a2x", a2x);
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("x", x);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_57(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_57(EMoflonEdge _edge_first) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whileula2branchubcImpl
				.pattern_whileula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, a, x, z, y, i, c, b, w,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[a] = " + a + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = "
					+ i + ", " + "[c] = " + c + ", " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[sourceMatch] = "
		...
		if (whileula2branchubcImpl.pattern_whileula2branchubc_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whileula2branchubcImpl
				...
				Object[] result6_black = whileula2branchubcImpl
						.pattern_whileula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(a, x, z, y, i, c, b, w,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a] = " + a + ", "
							+ "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[i] = " + i + ", "
							+ "[c] = " + c + ", " + "[b] = " + b + ", " + "[w] = " + w + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				whileula2branchubcImpl.pattern_whileula2branchubc_24_6_createcorrespondence_greenFBBBBFBBFB(a, x, z, y,
						c, b, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(While a, Branch x, Command z, Command y, Branch i, Assignment c, Assignment b,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(While a, Assignment c, Assignment b, While w) {// 
	...
	public boolean checkDEC_BWD(Branch x, Command z, Command y, Branch i) {// 
		Object[] result1_black = whileula2branchubcImpl.pattern_whileula2branchubc_28_1_matchtggpattern_blackBBBB(x, z,
				y, i);
		if (result1_black != null) {
		...
		for (Object[] result2_black : whileula2branchubcImpl
			...
			if (whileula2branchubcImpl.pattern_whileula2branchubc_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					whileula2branchubcImpl.pattern_whileula2branchubc_29_6_perform_greenFFFFFBFFFBFB(i, w, ruleResult);
					//nothing S2B a2x = (S2B) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPROPRIATE_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_WHILE:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_WHILE:
			...
			return null;
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_WHILE_ASSIGNMENT_ASSIGNMENT_WHILE:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (While) arguments.get(1),
					(Assignment) arguments.get(2), (Assignment) arguments.get(3), (While) arguments.get(4));
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_BRANCH_S2B_ASSIGNMENT_ASSIGNMENT_WHILE:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_COMMAND_COMMAND_BRANCH_S2B_WHILE:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPROPRIATE_BWD_EMOFLON_EDGE_57__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_57((EMoflonEdge) arguments.get(0));
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPROPRIATE_FWD_EMOFLON_EDGE_57__EMOFLONEDGE:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_CC__WHILE_BRANCH_COMMAND_COMMAND_BRANCH_ASSIGNMENT_ASSIGNMENT_WHILE_MATCH_MATCH:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___CHECK_DEC_FWD__WHILE_ASSIGNMENT_ASSIGNMENT_WHILE:
	...
	public static final Object[] pattern_whileula2branchubc_0_1_initialbindings_blackBBBBBB(whileula2branchubc _this,
			Match match, While a, Assignment c, Assignment b, While w) {
		if (!a.equals(w)) {
			if (!b.equals(c)) {
	...
	public static final Object[] pattern_whileula2branchubc_0_2_SolveCSP_bindingAndBlackFBBBBBB(
			whileula2branchubc _this, Match match, While a, Assignment c, Assignment b, While w) {
	...
	public static final Object[] pattern_whileula2branchubc_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			While a, Assignment c, Assignment b, While w) {
		if (!a.equals(w)) {
			if (!b.equals(c)) {
	...
	public static final Object[] pattern_whileula2branchubc_0_5_collectcontextelements_blackBBBBB(Match match, While a,
			Assignment c, Assignment b, While w) {
		if (!a.equals(w)) {
			if (!b.equals(c)) {
				return new Object[] { match, a, c, b, w };
			}
					...
					if (tmpC instanceof Assignment) {
						...
						if (tmpB instanceof Assignment) {
							...
							if (tmpW instanceof While) {
								While w = (While) tmpW;
								return new Object[] { a, i, w2i, c, b, w, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileula2branchubc_1_1_performtransformation_blackBBBBBBFBB(While a, Branch i,
			S2B w2i, Assignment c, Assignment b, While w, whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(w)) {
			if (!b.equals(c)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { a, i, w2i, c, b, w, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileula2branchubc_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileula2branchubc_1_1_performtransformation_binding != null) {
			...
			S2B w2i = (S2B) result_pattern_whileula2branchubc_1_1_performtransformation_binding[2];
			Assignment c = (Assignment) result_pattern_whileula2branchubc_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_whileula2branchubc_1_1_performtransformation_black = pattern_whileula2branchubc_1_1_performtransformation_blackBBBBBBFBB(
					a, i, w2i, c, b, w, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileula2branchubc_1_1_performtransformation_greenFBFFFBFBBF(While a, Branch i,
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { a2x, a, x, z, y, i, c2z, c, b, b2y };
	}

	public static final Object[] pattern_whileula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(S2B a2x,
			While a, Branch x, Command z, Command y, S2N c2z, Assignment c, Assignment b, S2N b2y) {
		if (!y.equals(z)) {
			if (!b.equals(c)) {
				if (!b2y.equals(c2z)) {
					return new Object[] { a2x, a, x, z, y, c2z, c, b, b2y };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(S2B a2x,
			While a, Branch x, Command z, Command y, S2N c2z, Assignment c, Assignment b, S2N b2y) {
		...
		return new Object[] { ruleresult, a2x, a, x, z, y, c2z, c, b, b2y };
	}

	public static final Object[] pattern_whileula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject a2x, EObject a, EObject x, EObject z, EObject y, EObject i,
			EObject c2z, EObject w2i, EObject c, EObject b, EObject w, EObject b2y) {
		if (!a2x.equals(x)) {
			if (!a2x.equals(z)) {
				if (!a2x.equals(y)) {
					if (!a2x.equals(i)) {
	...
	public static final Object[] pattern_whileula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject a2x, EObject a, EObject x, EObject z, EObject y, EObject i,
			EObject c2z, EObject c, EObject b, EObject w, EObject b2y) {
		EMoflonEdge a__b____first = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, a2x, a, x, z, y, i, c2z, c, b, w, b2y, a__b____first, a2x__a____source,
				x__y____positive, a2x__x____target, y__x____next, i__x____positive, c2z__c____source, c2z__z____target,
				i__z____negative, a__b____last, w__c____next, w__a____first, b2y__y____target, b2y__b____source };
	}

	public static final void pattern_whileula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileula2branchubc _this, PerformRuleResult ruleresult, EObject a2x, EObject a, EObject x, EObject z,
			EObject y, EObject i, EObject c2z, EObject w2i, EObject c, EObject b, EObject w, EObject b2y) {
		_this.registerObjects_FWD(ruleresult, a2x, a, x, z, y, i, c2z, w2i, c, b, w, b2y);
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_2_2_corematch_blackBFFBBBB(While a, Assignment c,
		...
		if (!a.equals(w)) {
			if (!b.equals(c)) {
				for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class,
					...
					if (i != null) {
						_result.add(new Object[] { a, i, w2i, c, b, w, match });
					}
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_2_3_findcontext_blackBBBBBB(While a, Branch i,
			S2B w2i, Assignment c, Assignment b, While w) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(w)) {
			if (!b.equals(c)) {
							...
							if (c.equals(w.getNext())) {
								if (w.equals(w2i.getSource())) {
									if (a.equals(w.getFirst())) {
										_result.add(new Object[] { a, i, w2i, c, b, w });
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(While a, Branch i,
		...
		w__a____first.setName(w__a____first_name_prime);
		return new Object[] { a, i, w2i, c, b, w, isApplicableMatch, a__b____first, a__b____last, w2i__i____target,
	...
	public static final Object[] pattern_whileula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch, While a, Branch i, S2B w2i, Assignment c, Assignment b, While w) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, a, i, w2i, c, b, w);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, a, i, w2i, c, b, w };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileula2branchubc_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			whileula2branchubc _this, IsApplicableMatch isApplicableMatch, While a, Branch i, S2B w2i, Assignment c,
		...
		Object[] result_pattern_whileula2branchubc_2_4_solveCSP_binding = pattern_whileula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, a, i, w2i, c, b, w);
	...
	public static final Object[] pattern_whileula2branchubc_10_2_SolveCSP_bindingAndBlackFBBBBBB(
			whileula2branchubc _this, Match match, Branch x, Command z, Command y, Branch i) {
	...
	public static final Object[] pattern_whileula2branchubc_10_4_collectelementstobetranslated_greenBBBBBFFFF(
		...
		i__x____positive.setName(i__x____positive_name_prime);
		i__z____negative.setName(i__z____negative_name_prime);
		return new Object[] { match, x, z, y, i, x__y____positive, y__x____next, i__x____positive, i__z____negative };
	}
				...
				if (tmpY instanceof Command) {
					...
					if (tmpI instanceof Branch) {
						...
						if (tmpW2i instanceof S2B) {
							...
							if (tmpW instanceof While) {
								While w = (While) tmpW;
								return new Object[] { x, z, y, i, w2i, w, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileula2branchubc_11_1_performtransformation_blackBBBBBBFBB(Branch x,
			Command z, Command y, Branch i, S2B w2i, While w, whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { x, z, y, i, w2i, w, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileula2branchubc_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileula2branchubc_11_1_performtransformation_binding != null) {
			Branch x = (Branch) result_pattern_whileula2branchubc_11_1_performtransformation_binding[0];
			...
			Branch i = (Branch) result_pattern_whileula2branchubc_11_1_performtransformation_binding[3];
			...
			Object[] result_pattern_whileula2branchubc_11_1_performtransformation_black = pattern_whileula2branchubc_11_1_performtransformation_blackBBBBBBFBB(
					x, z, y, i, w2i, w, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileula2branchubc_11_1_performtransformation_greenFFBBBFFFBF(Branch x,
			Command z, Command y, While w) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { a2x, a, x, z, y, c2z, c, b, w, b2y };
	}

	public static final Object[] pattern_whileula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(S2B a2x,
			While a, Branch x, Command z, Command y, S2N c2z, Assignment c, Assignment b, S2N b2y) {
		if (!y.equals(z)) {
			if (!b.equals(c)) {
				if (!b2y.equals(c2z)) {
	...
	public static final Object[] pattern_whileula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(S2B a2x,
			While a, Branch x, Command z, Command y, S2N c2z, Assignment c, Assignment b, S2N b2y) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(a2x);
	...
	public static final void pattern_whileula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileula2branchubc _this, PerformRuleResult ruleresult, EObject a2x, EObject a, EObject x, EObject z,
			EObject y, EObject i, EObject c2z, EObject w2i, EObject c, EObject b, EObject w, EObject b2y) {
		_this.registerObjects_BWD(ruleresult, a2x, a, x, z, y, i, c2z, w2i, c, b, w, b2y);
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_12_2_corematch_blackBBBBFFB(Branch x, Command z,
		...
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(i, S2B.class,
					...
					if (tmpW instanceof While) {
						While w = (While) tmpW;
						_result.add(new Object[] { x, z, y, i, w2i, w, match });
					}
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_12_3_findcontext_blackBBBBBB(Branch x, Command z,
			Command y, Branch i, S2B w2i, While w) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!y.equals(z)) {
			if (!i.equals(x)) {
					...
					if (x.equals(y.getNext())) {
						if (x.equals(i.getPositive())) {
							if (z.equals(i.getNegative())) {
								if (i.equals(w2i.getTarget())) {
									if (w.equals(w2i.getSource())) {
										_result.add(new Object[] { x, z, y, i, w2i, w });
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(Branch x, Command z,
			Command y, Branch i, S2B w2i, While w) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge x__y____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge y__x____next = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		w2i__i____target.setName(w2i__i____target_name_prime);
		w2i__w____source.setName(w2i__w____source_name_prime);
		return new Object[] { x, z, y, i, w2i, w, isApplicableMatch, x__y____positive, y__x____next, i__x____positive,
	...
	public static final Object[] pattern_whileula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch, Branch x, Command z, Command y, Branch i, S2B w2i, While w) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, x, z, y, i, w2i, w);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, x, z, y, i, w2i, w };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
			whileula2branchubc _this, IsApplicableMatch isApplicableMatch, Branch x, Command z, Command y, Branch i,
			S2B w2i, While w) {
		Object[] result_pattern_whileula2branchubc_12_4_solveCSP_binding = pattern_whileula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, x, z, y, i, w2i, w);
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_993007 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_1BB(Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_positive_506638 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_506638)) {
					if (!i.equals(__DEC_x_positive_506638)) {
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_2BB(Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_negative_7805 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_7805)) {
					if (!i.equals(__DEC_x_negative_7805)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_541027 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_4BBB(Command z,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_positive_797876 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_z_positive_797876)) {
					if (!i.equals(__DEC_z_positive_797876)) {
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_5BBB(Command z,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_negative_308799 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_z_negative_308799)) {
					if (!i.equals(__DEC_z_negative_308799)) {
						return new Object[] { z, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_840697 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_7BBB(Command y,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_positive_863395 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_y_positive_863395)) {
					if (!i.equals(__DEC_y_positive_863395)) {
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_8BBB(Command y,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_negative_626980 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_y_negative_626980)) {
					if (!i.equals(__DEC_y_negative_626980)) {
						return new Object[] { y, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_9BB(Branch x,
			Command z) {
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_20_2_testcorematchandDECs_blackFFFFB(
		...
		if (tmpX instanceof Branch) {
			...
			if (tmpY instanceof Command) {
				...
				if (y.equals(x.getPositive())) {
					if (x.equals(y.getNext())) {
						if (pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_0B(x) == null) {
							if (pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_6B(y) == null) {
								if (pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_13BB(x, y) == null) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_0B(While a) {
		for (Decision __DEC_a_positive_733377 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_1B(While a) {
		for (Decision __DEC_a_negative_365577 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_2BB(While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_a_last_626103 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_626103)) {
					if (!w.equals(__DEC_a_last_626103)) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_3B(While a) {
		for (Program __DEC_a_first_243154 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_4B(Assignment c) {
		for (Decision __DEC_c_positive_417038 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_5B(Assignment c) {
		for (Decision __DEC_c_negative_421281 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_6BBB(Assignment c,
			While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_first_385117 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!a.equals(__DEC_c_first_385117)) {
					if (!w.equals(__DEC_c_first_385117)) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_7BBB(Assignment c,
			While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_last_675277 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!a.equals(__DEC_c_last_675277)) {
					if (!w.equals(__DEC_c_last_675277)) {
						return new Object[] { c, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_8B(Assignment c) {
		for (Program __DEC_c_first_128024 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_9B(Assignment b) {
		for (Decision __DEC_b_positive_942086 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_10B(Assignment b) {
		for (Decision __DEC_b_negative_562046 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_11BBB(Assignment b,
			While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_b_last_742835 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!a.equals(__DEC_b_last_742835)) {
					if (!w.equals(__DEC_b_last_742835)) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_12B(Assignment b) {
		for (Program __DEC_b_first_326010 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
						...
						if (tmpI instanceof Branch) {
							...
							if (tmpC instanceof Assignment) {
								...
								if (tmpB instanceof Assignment) {
									...
									if (tmpW instanceof While) {
										While w = (While) tmpW;
										return new Object[] { a, x, z, y, i, c, b, w, sourceMatch, targetMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(While a, Branch x,
			Command z, Command y, Branch i, Assignment c, Assignment b, While w, Match sourceMatch, Match targetMatch) {
		if (!a.equals(w)) {
			if (!y.equals(z)) {
				if (!i.equals(x)) {
					if (!b.equals(c)) {
	...
	public static final Object[] pattern_whileula2branchubc_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding != null) {
			...
			Branch x = (Branch) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[1];
			Command z = (Command) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[2];
			...
			Assignment c = (Assignment) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[5];
			Assignment b = (Assignment) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[6];
			While w = (While) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[7];
			...
			Object[] result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_black = pattern_whileula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					a, x, z, y, i, c, b, w, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(whileula2branchubc _this,
			While a, Branch x, Command z, Command y, Branch i, Assignment c, Assignment b, While w, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(a, x, z, y, i, c, b, w, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, a, x, z, y, i, c, b, w, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			whileula2branchubc _this, While a, Branch x, Command z, Command y, Branch i, Assignment c, Assignment b,
		...
		Object[] result_pattern_whileula2branchubc_24_3_solvecsp_binding = pattern_whileula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, a, x, z, y, i, c, b, w, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(While a, Branch x,
			Command z, Command y, Branch i, Assignment c, Assignment b, While w, CCMatch ccMatch) {
		if (!a.equals(w)) {
			if (!y.equals(z)) {
				if (!i.equals(x)) {
					if (!b.equals(c)) {
						return new Object[] { a, x, z, y, i, c, b, w, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileula2branchubc_24_6_createcorrespondence_greenFBBBBFBBFB(While a, Branch x,
			Command z, Command y, Assignment c, Assignment b, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		a2x.setSource(a);
		...
		return new Object[] { a2x, a, x, z, y, c2z, c, b, b2y, ccMatch };
	}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_0B(While a) {
		for (Decision __DEC_a_positive_439837 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_1B(While a) {
		for (Decision __DEC_a_negative_112177 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_2BB(While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_a_last_447908 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_447908)) {
					if (!w.equals(__DEC_a_last_447908)) {
						return new Object[] { a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_3B(While a) {
		for (Program __DEC_a_first_247720 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_4B(Assignment c) {
		for (Decision __DEC_c_positive_40087 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_5B(Assignment c) {
		for (Decision __DEC_c_negative_510352 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_6BBB(Assignment c, While a,
			While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_first_767297 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!a.equals(__DEC_c_first_767297)) {
					if (!w.equals(__DEC_c_first_767297)) {
						return new Object[] { c, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_7BBB(Assignment c, While a,
			While w) {
		if (!a.equals(w)) {
			for (While __DEC_c_last_410803 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!a.equals(__DEC_c_last_410803)) {
					if (!w.equals(__DEC_c_last_410803)) {
						return new Object[] { c, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_8B(Assignment c) {
		for (Program __DEC_c_first_425104 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_9B(Assignment b) {
		for (Decision __DEC_b_positive_691779 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_10B(Assignment b) {
		for (Decision __DEC_b_negative_27224 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_11BBB(Assignment b, While a,
			While w) {
		if (!a.equals(w)) {
			for (While __DEC_b_last_247527 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!a.equals(__DEC_b_last_247527)) {
					if (!w.equals(__DEC_b_last_247527)) {
						return new Object[] { b, a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_12B(Assignment b) {
		for (Program __DEC_b_first_497111 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_123571 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_1BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_positive_82662 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_82662)) {
					if (!i.equals(__DEC_x_positive_82662)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_2BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_negative_440333 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_440333)) {
					if (!i.equals(__DEC_x_negative_440333)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_537583 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_4BBB(Command z, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_positive_813511 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_z_positive_813511)) {
					if (!i.equals(__DEC_z_positive_813511)) {
						return new Object[] { z, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_5BBB(Command z, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_negative_243861 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_z_negative_243861)) {
					if (!i.equals(__DEC_z_negative_243861)) {
						return new Object[] { z, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_675799 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_7BBB(Command y, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_positive_9954 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_y_positive_9954)) {
					if (!i.equals(__DEC_y_positive_9954)) {
						return new Object[] { y, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_8BBB(Command y, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_negative_714850 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_y_negative_714850)) {
					if (!i.equals(__DEC_y_negative_714850)) {
						return new Object[] { y, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_9BB(Branch x, Command z) {
		if (z.equals(x.getPositive())) {
			return new Object[] { x, z };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_10BB(Branch i, Command z) {
		if (z.equals(i.getPositive())) {
			return new Object[] { i, z };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_13BB(Branch x, Command y) {
		if (y.equals(x.getNegative())) {
			return new Object[] { x, y };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_blackBBBB(Branch x, Command z,
			Command y, Branch i) {
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				if (y.equals(x.getPositive())) {
									...
									if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_1BB(x, i) == null) {
										if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_2BB(x,
											...
											if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_3B(
													z) == null) {
												if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_4BBB(z, x,
														i) == null) {
	...
	public static final Object[] pattern_whileula2branchubc_29_6_perform_greenFFFFFBFFFBFB(Branch i, While w,
			ModelgeneratorRuleResult ruleResult) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		While a = SourcecodeFactory.eINSTANCE.createWhile();
		Branch x = ControlflowFactory.eINSTANCE.createBranch();
		...
		return new Object[] { a2x, a, x, z, y, i, c2z, c, b, w, b2y, ruleResult };
	}
