...
public class whileula2branchubcImpl extends AbstractRuleImpl implements whileula2branchubc {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_1_performtransformation_greenFFFFBFBBFB(c, a, b, i);
		...
		Object[] result2_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(z, x, y, b2y, c, c2z, a, b,
						a2x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", " + "[x] = " + x
					+ ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[c] = " + c + ", " + "[c2z] = " + c2z
					+ ", " + "[a] = " + a + ", " + "[b] = " + b + ", " + "[a2x] = " + a2x + ".");
		}
		Object[] result2_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(z, x, y, b2y, c, c2z, a, b,
						a2x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, z, x, y, b2y, c, c2z,
						w, w2i, a, b, a2x, i);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[z] = " + z + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", "
					+ "[c] = " + c + ", " + "[c2z] = " + c2z + ", " + "[w] = " + w + ", " + "[w2i] = " + w2i + ", "
					+ "[a] = " + a + ", " + "[b] = " + b + ", " + "[a2x] = " + a2x + ", " + "[i] = " + i + ".");
		}
		whileula2branchubcImpl.pattern_whileula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, z, x, y, b2y, c, c2z, w, a, b, a2x, i);
		...
		whileula2branchubcImpl.pattern_whileula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult,
				z, x, y, b2y, c, c2z, w, w2i, a, b, a2x, i);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : whileula2branchubcImpl.pattern_whileula2branchubc_2_2_corematch_blackBBFBBFB(c, w,
				a, b, match)) {
			S2B w2i = (S2B) result2_black[2];
			Branch i = (Branch) result2_black[5];
			// ForEach 
			for (Object[] result3_black : whileula2branchubcImpl
					.pattern_whileula2branchubc_2_3_findcontext_blackBBBBBB(c, w, w2i, a, b, i)) {
				Object[] result3_green = whileula2branchubcImpl
						.pattern_whileula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(c, w, w2i, a, b, i);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Assignment c, While w, S2B w2i, While a,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject z, EObject x, EObject y, EObject b2y,
			EObject c, EObject c2z, EObject w, EObject w2i, EObject a, EObject b, EObject a2x, EObject i) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Command z, Branch x, Command y, Branch i) {

		Object[] result1_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_10_1_initialbindings_blackBBBBBB(this, match, z, x, y, i);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = whileula2branchubcImpl
				.pattern_whileula2branchubc_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, z, x, y, i);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[z] = " + z + ", " + "[x] = " + x + ", " + "[y] = " + y + ", "
					+ "[i] = " + i + ".");
		...
		if (whileula2branchubcImpl.pattern_whileula2branchubc_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = whileula2branchubcImpl
					.pattern_whileula2branchubc_10_4_collectelementstobetranslated_blackBBBBB(match, z, x, y, i);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[z] = " + z + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[i] = " + i + ".");
			}
			...
			Object[] result5_black = whileula2branchubcImpl
					.pattern_whileula2branchubc_10_5_collectcontextelements_blackBBBBB(match, z, x, y, i);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[z] = " + z + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[i] = " + i + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_1_performtransformation_greenBBBFFFBFFF(z, x, y, w);
		S2N b2y = (S2N) result1_green[3];
		...
		Object[] result2_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(z, x, y, b2y, c, c2z, a, b,
						a2x);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", " + "[x] = " + x
					+ ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[c] = " + c + ", " + "[c2z] = " + c2z
		...
		Object[] result2_green = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(z, x, y, b2y, c, c2z, a, b,
						a2x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = whileula2branchubcImpl
				.pattern_whileula2branchubc_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, z, x, y, b2y, c,
						c2z, w, w2i, a, b, a2x, i);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[z] = " + z + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", "
		...
		whileula2branchubcImpl.pattern_whileula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this,
				ruleresult, z, x, y, b2y, c, c2z, w, w2i, a, b, a2x, i);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : whileula2branchubcImpl.pattern_whileula2branchubc_12_2_corematch_blackBBBFFBB(z,
				x, y, i, match)) {
			While w = (While) result2_black[3];
			S2B w2i = (S2B) result2_black[4];
			// ForEach 
			for (Object[] result3_black : whileula2branchubcImpl
					.pattern_whileula2branchubc_12_3_findcontext_blackBBBBBB(z, x, y, w, w2i, i)) {
				Object[] result3_green = whileula2branchubcImpl
						.pattern_whileula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(z, x, y, w, w2i, i);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = whileula2branchubcImpl
						.pattern_whileula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, z,
								x, y, w, w2i, i);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Command z, Branch x, Command y, Branch i) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Command z, Branch x, Command y, Branch i) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Command z, Branch x, Command y, While w,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject z, EObject x, EObject y, EObject b2y,
			EObject c, EObject c2z, EObject w, EObject w2i, EObject a, EObject b, EObject a2x, EObject i) {
		ruleresult.registerObject("z", z);
		ruleresult.registerObject("x", x);
		ruleresult.registerObject("y", y);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_76(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_82(EMoflonEdge _edge_first) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = whileula2branchubcImpl
				.pattern_whileula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, z, x, y, c, w, a, b, i,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[z] = " + z + ", " + "[x] = " + x + ", " + "[y] = " + y + ", " + "[c] = " + c + ", " + "[w] = "
					+ w + ", " + "[a] = " + a + ", " + "[b] = " + b + ", " + "[i] = " + i + ", " + "[sourceMatch] = "
		...
		if (whileula2branchubcImpl.pattern_whileula2branchubc_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : whileula2branchubcImpl
					.pattern_whileula2branchubc_24_5_matchcorrcontext_blackBFBBB(w, i, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = whileula2branchubcImpl
						.pattern_whileula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(z, x, y, c, w, a, b, i,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[z] = " + z + ", "
							+ "[x] = " + x + ", " + "[y] = " + y + ", " + "[c] = " + c + ", " + "[w] = " + w + ", "
							+ "[a] = " + a + ", " + "[b] = " + b + ", " + "[i] = " + i + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				whileula2branchubcImpl.pattern_whileula2branchubc_24_6_createcorrespondence_greenBBBFBFBBFB(z, x, y, c,
						a, b, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Command z, Branch x, Command y, Assignment c, While w, While a, Assignment b,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Command z, Branch x, Command y, Branch i) {// 
		Object[] result1_black = whileula2branchubcImpl.pattern_whileula2branchubc_28_1_matchtggpattern_blackBBBB(z, x,
				y, i);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B w2iParameter) {
		...
		for (Object[] result2_black : whileula2branchubcImpl
			...
			Object[] result3_bindingAndBlack = whileula2branchubcImpl
					.pattern_whileula2branchubc_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, w, w2i, i,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (whileula2branchubcImpl.pattern_whileula2branchubc_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = whileula2branchubcImpl.pattern_whileula2branchubc_29_5_checknacs_blackBBB(w,
						w2i, i);
				if (result5_black != null) {
					...
					whileula2branchubcImpl.pattern_whileula2branchubc_29_6_perform_greenFFFFFFBFFFBB(w, i, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASSIGNMENT_WHILE_S2B_WHILE_ASSIGNMENT_BRANCH:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMMAND_BRANCH_COMMAND_WHILE_S2B_BRANCH:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_CC__COMMAND_BRANCH_COMMAND_ASSIGNMENT_WHILE_WHILE_ASSIGNMENT_BRANCH_MATCH_MATCH:
		...
		case RulesPackage.WHILEULA2BRANCHUBC___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_WHILE_S2B_BRANCH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_whileula2branchubc_0_4_collectelementstobetranslated_greenBBBBBFFFF(
		...
		return new Object[] { match, c, w, a, b, w__a____first, w__c____next, a__b____first, a__b____last };
	}
					...
					if (tmpA instanceof While) {
						...
						if (tmpB instanceof Assignment) {
							...
							if (tmpI instanceof Branch) {
								...
								return new Object[] { c, w, w2i, a, b, i, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileula2branchubc_1_1_performtransformation_blackBBBBBBFBB(Assignment c,
			While w, S2B w2i, While a, Assignment b, Branch i, whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(w)) {
			if (!b.equals(c)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { c, w, w2i, a, b, i, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileula2branchubc_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileula2branchubc_1_1_performtransformation_binding != null) {
			...
			Branch i = (Branch) result_pattern_whileula2branchubc_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_whileula2branchubc_1_1_performtransformation_black = pattern_whileula2branchubc_1_1_performtransformation_blackBBBBBBFBB(
					c, w, w2i, a, b, i, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileula2branchubc_1_1_performtransformation_greenFFFFBFBBFB(Assignment c,
		...
		a2x.setSource(a);
		a2x.setTarget(x);
		return new Object[] { z, x, y, b2y, c, c2z, a, b, a2x, i };
	}

	public static final Object[] pattern_whileula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(Command z,
			Branch x, Command y, S2N b2y, Assignment c, S2N c2z, While a, Assignment b, S2B a2x) {
		if (!y.equals(z)) {
			if (!b2y.equals(c2z)) {
				if (!b.equals(c)) {
					return new Object[] { z, x, y, b2y, c, c2z, a, b, a2x };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(Command z,
		...
		return new Object[] { ruleresult, z, x, y, b2y, c, c2z, a, b, a2x };
	}

	public static final Object[] pattern_whileula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject z, EObject x, EObject y, EObject b2y, EObject c, EObject c2z,
			EObject w, EObject w2i, EObject a, EObject b, EObject a2x, EObject i) {
		if (!x.equals(z)) {
			if (!x.equals(y)) {
				if (!y.equals(z)) {
					if (!b2y.equals(z)) {
	...
	public static final Object[] pattern_whileula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject z, EObject x, EObject y, EObject b2y, EObject c, EObject c2z,
			EObject w, EObject a, EObject b, EObject a2x, EObject i) {
		...
		return new Object[] { ruleresult, z, x, y, b2y, c, c2z, w, a, b, a2x, i, b2y__y____target, x__y____positive,
				c2z__c____source, c2z__z____target, w__a____first, w__c____next, a__b____first, y__x____next,
				i__z____negative, a2x__a____source, a__b____last, a2x__x____target, b2y__b____source,
				i__x____positive };
	}

	public static final void pattern_whileula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileula2branchubc _this, PerformRuleResult ruleresult, EObject z, EObject x, EObject y, EObject b2y,
			EObject c, EObject c2z, EObject w, EObject w2i, EObject a, EObject b, EObject a2x, EObject i) {
		_this.registerObjects_FWD(ruleresult, z, x, y, b2y, c, c2z, w, w2i, a, b, a2x, i);
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_2_2_corematch_blackBBFBBFB(Assignment c, While w,
		...
		if (!a.equals(w)) {
			if (!b.equals(c)) {
				for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(w, S2B.class,
					...
					if (i != null) {
						_result.add(new Object[] { c, w, w2i, a, b, i, match });
					}
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_2_3_findcontext_blackBBBBBB(Assignment c, While w,
			S2B w2i, While a, Assignment b, Branch i) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(w)) {
			if (!b.equals(c)) {
							...
							if (b.equals(a.getFirst())) {
								if (i.equals(w2i.getTarget())) {
									if (b.equals(a.getLast())) {
										_result.add(new Object[] { c, w, w2i, a, b, i });
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(Assignment c, While w,
		...
		a__b____last.setName(a__b____last_name_prime);
		return new Object[] { c, w, w2i, a, b, i, isApplicableMatch, w__a____first, w__c____next, w2i__w____source,
				a__b____first, w2i__i____target, a__b____last };
	}

	public static final Object[] pattern_whileula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch, Assignment c, While w, S2B w2i, While a, Assignment b, Branch i) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, c, w, w2i, a, b, i);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c, w, w2i, a, b, i };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileula2branchubc_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			whileula2branchubc _this, IsApplicableMatch isApplicableMatch, Assignment c, While w, S2B w2i, While a,
		...
		Object[] result_pattern_whileula2branchubc_2_4_solveCSP_binding = pattern_whileula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, c, w, w2i, a, b, i);
	...
	public static final Object[] pattern_whileula2branchubc_10_1_initialbindings_blackBBBBBB(whileula2branchubc _this,
			Match match, Command z, Branch x, Command y, Branch i) {
		if (!y.equals(z)) {
			if (!i.equals(x)) {
	...
	public static final Object[] pattern_whileula2branchubc_10_2_SolveCSP_bindingAndBlackFBBBBBB(
			whileula2branchubc _this, Match match, Command z, Branch x, Command y, Branch i) {
	...
	public static final Object[] pattern_whileula2branchubc_10_4_collectelementstobetranslated_blackBBBBB(Match match,
			Command z, Branch x, Command y, Branch i) {
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				...
				if (tmpY instanceof Command) {
					...
					if (tmpW instanceof While) {
						...
						if (tmpW2i instanceof S2B) {
							...
							if (tmpI instanceof Branch) {
								Branch i = (Branch) tmpI;
								return new Object[] { z, x, y, w, w2i, i, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_whileula2branchubc_11_1_performtransformation_blackBBBBBBFBB(Command z,
			Branch x, Command y, While w, S2B w2i, Branch i, whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { z, x, y, w, w2i, i, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileula2branchubc_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_whileula2branchubc_11_1_performtransformation_binding != null) {
			Command z = (Command) result_pattern_whileula2branchubc_11_1_performtransformation_binding[0];
			...
			Branch i = (Branch) result_pattern_whileula2branchubc_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_whileula2branchubc_11_1_performtransformation_black = pattern_whileula2branchubc_11_1_performtransformation_blackBBBBBBFBB(
					z, x, y, w, w2i, i, _this, isApplicableMatch);
	...
	public static final Object[] pattern_whileula2branchubc_11_1_performtransformation_greenBBBFFFBFFF(Command z,
		...
		a2x.setSource(a);
		a2x.setTarget(x);
		return new Object[] { z, x, y, b2y, c, c2z, w, a, b, a2x };
	}
	...
	public static final void pattern_whileula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			whileula2branchubc _this, PerformRuleResult ruleresult, EObject z, EObject x, EObject y, EObject b2y,
			EObject c, EObject c2z, EObject w, EObject w2i, EObject a, EObject b, EObject a2x, EObject i) {
		_this.registerObjects_BWD(ruleresult, z, x, y, b2y, c, c2z, w, w2i, a, b, a2x, i);
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_12_2_corematch_blackBBBFFBB(Command z, Branch x,
		...
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				for (S2B w2i : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(i, S2B.class,
					...
					if (tmpW instanceof While) {
						While w = (While) tmpW;
						_result.add(new Object[] { z, x, y, w, w2i, i, match });
					}
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_12_3_findcontext_blackBBBBBB(Command z, Branch x,
			Command y, While w, S2B w2i, Branch i) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!y.equals(z)) {
			if (!i.equals(x)) {
							...
							if (i.equals(w2i.getTarget())) {
								if (z.equals(i.getNegative())) {
									if (x.equals(i.getPositive())) {
										_result.add(new Object[] { z, x, y, w, w2i, i });
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(Command z, Branch x,
			Command y, While w, S2B w2i, Branch i) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge x__y____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge w2i__w____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		i__z____negative.setName(i__z____negative_name_prime);
		i__x____positive.setName(i__x____positive_name_prime);
		return new Object[] { z, x, y, w, w2i, i, isApplicableMatch, x__y____positive, w2i__w____source, y__x____next,
	...
	public static final Object[] pattern_whileula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(whileula2branchubc _this,
			IsApplicableMatch isApplicableMatch, Command z, Branch x, Command y, While w, S2B w2i, Branch i) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, z, x, y, w, w2i, i);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, z, x, y, w, w2i, i };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
			whileula2branchubc _this, IsApplicableMatch isApplicableMatch, Command z, Branch x, Command y, While w,
			S2B w2i, Branch i) {
		Object[] result_pattern_whileula2branchubc_12_4_solveCSP_binding = pattern_whileula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, z, x, y, w, w2i, i);
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_924846 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_1BBB(Command z,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_positive_260074 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_z_positive_260074)) {
					if (!i.equals(__DEC_z_positive_260074)) {
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_2BBB(Command z,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_negative_421786 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_z_negative_421786)) {
					if (!i.equals(__DEC_z_negative_421786)) {
						return new Object[] { z, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_67906 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_4BB(Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_positive_975102 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_975102)) {
					if (!i.equals(__DEC_x_positive_975102)) {
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_5BB(Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_negative_487930 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_487930)) {
					if (!i.equals(__DEC_x_negative_487930)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_62507 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_7BBB(Command y,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_positive_984547 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_y_positive_984547)) {
					if (!i.equals(__DEC_y_positive_984547)) {
	...
	public static final Object[] pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_8BBB(Command y,
			Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_negative_334788 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_y_negative_334788)) {
					if (!i.equals(__DEC_y_negative_334788)) {
						return new Object[] { y, x, i };
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_20_2_testcorematchandDECs_blackFFFFB(
		...
		if (tmpX instanceof Branch) {
			...
			if (tmpY instanceof Command) {
				...
				if (y.equals(x.getPositive())) {
					if (x.equals(y.getNext())) {
						if (pattern_whileula2branchubc_20_2_testcorematchandDECs_black_nac_3B(x) == null) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_0B(Assignment c) {
		for (Decision __DEC_c_positive_350044 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_1B(Assignment c) {
		for (Decision __DEC_c_negative_883941 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_2BBB(Assignment c,
			While w, While a) {
		if (!a.equals(w)) {
			for (While __DEC_c_first_65801 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!w.equals(__DEC_c_first_65801)) {
					if (!a.equals(__DEC_c_first_65801)) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_3BBB(Assignment c,
			While w, While a) {
		if (!a.equals(w)) {
			for (While __DEC_c_last_727054 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!w.equals(__DEC_c_last_727054)) {
					if (!a.equals(__DEC_c_last_727054)) {
						return new Object[] { c, w, a };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_4B(Assignment c) {
		for (Program __DEC_c_first_602474 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_5B(While a) {
		for (Decision __DEC_a_positive_439846 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_6B(While a) {
		for (Decision __DEC_a_negative_930287 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_7BB(While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_a_last_708923 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_708923)) {
					if (!w.equals(__DEC_a_last_708923)) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_8B(While a) {
		for (Program __DEC_a_first_968882 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_9B(Assignment b) {
		for (Decision __DEC_b_positive_426436 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_10B(Assignment b) {
		for (Decision __DEC_b_negative_1376 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_11BBB(Assignment b,
			While w, While a) {
		if (!a.equals(w)) {
			for (While __DEC_b_last_656694 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!w.equals(__DEC_b_last_656694)) {
					if (!a.equals(__DEC_b_last_656694)) {
	...
	public static final Object[] pattern_whileula2branchubc_21_2_testcorematchandDECs_black_nac_12B(Assignment b) {
		for (Program __DEC_b_first_829609 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
						...
						if (tmpW instanceof While) {
							...
							if (tmpA instanceof While) {
								...
								if (tmpB instanceof Assignment) {
									...
									if (tmpI instanceof Branch) {
										Branch i = (Branch) tmpI;
										return new Object[] { z, x, y, c, w, a, b, i, targetMatch, sourceMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_whileula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Command z, Branch x,
			Command y, Assignment c, While w, While a, Assignment b, Branch i, Match sourceMatch, Match targetMatch) {
		if (!y.equals(z)) {
			if (!a.equals(w)) {
				if (!b.equals(c)) {
					if (!i.equals(x)) {
						if (!sourceMatch.equals(targetMatch)) {
							return new Object[] { z, x, y, c, w, a, b, i, sourceMatch, targetMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding != null) {
			Command z = (Command) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[0];
			Branch x = (Branch) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[1];
			Command y = (Command) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[2];
			Assignment c = (Assignment) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[3];
			While w = (While) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[4];
			...
			Branch i = (Branch) result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_binding[7];
			...
			Object[] result_pattern_whileula2branchubc_24_2_matchsrctrgcontext_black = pattern_whileula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					z, x, y, c, w, a, b, i, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_whileula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(whileula2branchubc _this,
			Command z, Branch x, Command y, Assignment c, While w, While a, Assignment b, Branch i, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(z, x, y, c, w, a, b, i, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, z, x, y, c, w, a, b, i, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_whileula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			whileula2branchubc _this, Command z, Branch x, Command y, Assignment c, While w, While a, Assignment b,
		...
		Object[] result_pattern_whileula2branchubc_24_3_solvecsp_binding = pattern_whileula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, z, x, y, c, w, a, b, i, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_whileula2branchubc_24_5_matchcorrcontext_blackBFBBB(While w,
			Branch i, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_whileula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(Command z,
			Branch x, Command y, Assignment c, While w, While a, Assignment b, Branch i, CCMatch ccMatch) {
		if (!y.equals(z)) {
			if (!a.equals(w)) {
				if (!b.equals(c)) {
					if (!i.equals(x)) {
						return new Object[] { z, x, y, c, w, a, b, i, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_whileula2branchubc_24_6_createcorrespondence_greenBBBFBFBBFB(Command z,
			Branch x, Command y, Assignment c, While a, Assignment b, CCMatch ccMatch) {
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N c2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		b2y.setTarget(y);
		...
		return new Object[] { z, x, y, b2y, c, c2z, a, b, a2x, ccMatch };
	}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_0B(Assignment c) {
		for (Decision __DEC_c_positive_621154 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "positive")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_1B(Assignment c) {
		for (Decision __DEC_c_negative_726711 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Decision.class, "negative")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_2BBB(Assignment c, While w,
			While a) {
		if (!a.equals(w)) {
			for (While __DEC_c_first_919137 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "first")) {
				if (!w.equals(__DEC_c_first_919137)) {
					if (!a.equals(__DEC_c_first_919137)) {
						return new Object[] { c, w, a };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_3BBB(Assignment c, While w,
			While a) {
		if (!a.equals(w)) {
			for (While __DEC_c_last_105500 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					While.class, "last")) {
				if (!w.equals(__DEC_c_last_105500)) {
					if (!a.equals(__DEC_c_last_105500)) {
						return new Object[] { c, w, a };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_4B(Assignment c) {
		for (Program __DEC_c_first_242972 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
				Program.class, "first")) {
			return new Object[] { c };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_5B(While a) {
		for (Decision __DEC_a_positive_425114 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "positive")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_6B(While a) {
		for (Decision __DEC_a_negative_834901 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_7BB(While a, While w) {
		if (!a.equals(w)) {
			for (While __DEC_a_last_836385 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					While.class, "last")) {
				if (!a.equals(__DEC_a_last_836385)) {
					if (!w.equals(__DEC_a_last_836385)) {
						return new Object[] { a, w };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_8B(While a) {
		for (Program __DEC_a_first_492956 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_9B(Assignment b) {
		for (Decision __DEC_b_positive_29653 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_10B(Assignment b) {
		for (Decision __DEC_b_negative_341930 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "negative")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_11BBB(Assignment b, While w,
			While a) {
		if (!a.equals(w)) {
			for (While __DEC_b_last_509814 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					While.class, "last")) {
				if (!w.equals(__DEC_b_last_509814)) {
					if (!a.equals(__DEC_b_last_509814)) {
						return new Object[] { b, w, a };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_27_1_matchtggpattern_black_nac_12B(Assignment b) {
		for (Program __DEC_b_first_446244 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_837339 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_1BBB(Command z, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_positive_815319 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_z_positive_815319)) {
					if (!i.equals(__DEC_z_positive_815319)) {
						return new Object[] { z, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_2BBB(Command z, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_z_negative_746030 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_z_negative_746030)) {
					if (!i.equals(__DEC_z_negative_746030)) {
						return new Object[] { z, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_505252 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_4BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_positive_250431 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_250431)) {
					if (!i.equals(__DEC_x_positive_250431)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_5BB(Branch x, Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_x_negative_256333 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_256333)) {
					if (!i.equals(__DEC_x_negative_256333)) {
						return new Object[] { x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_635188 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_7BBB(Command y, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_positive_104966 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_y_positive_104966)) {
					if (!i.equals(__DEC_y_positive_104966)) {
						return new Object[] { y, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_8BBB(Command y, Branch x,
			Branch i) {
		if (!i.equals(x)) {
			for (Branch __DEC_y_negative_544928 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_y_negative_544928)) {
					if (!i.equals(__DEC_y_negative_544928)) {
						return new Object[] { y, x, i };
					}
				}
			}
	...
	public static final Object[] pattern_whileula2branchubc_28_1_matchtggpattern_blackBBBB(Command z, Branch x,
			Command y, Branch i) {
		if (!y.equals(z)) {
			if (!i.equals(x)) {
				if (y.equals(x.getPositive())) {
						...
						if (z.equals(i.getNegative())) {
							if (x.equals(i.getPositive())) {
								if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_0B(z) == null) {
									if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_1BBB(z, x,
											i) == null) {
										if (pattern_whileula2branchubc_28_1_matchtggpattern_black_nac_2BBB(z, x,
												i) == null) {
	...
	public static final Object[] pattern_whileula2branchubc_29_3_solveCSP_bindingAndBlackFBBBBBB(
			whileula2branchubc _this, IsApplicableMatch isApplicableMatch, While w, S2B w2i, Branch i,
	...
	public static final Object[] pattern_whileula2branchubc_29_5_checknacs_blackBBB(While w, S2B w2i, Branch i) {
		return new Object[] { w, w2i, i };
	}

	public static final Object[] pattern_whileula2branchubc_29_6_perform_blackBBBB(While w, S2B w2i, Branch i,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { w, w2i, i, ruleResult };
	}

	public static final Object[] pattern_whileula2branchubc_29_6_perform_greenFFFFFFBFFFBB(While w, Branch i,
			ModelgeneratorRuleResult ruleResult) {
		Command z = ControlflowFactory.eINSTANCE.createCommand();
		Branch x = ControlflowFactory.eINSTANCE.createBranch();
		Command y = ControlflowFactory.eINSTANCE.createCommand();
		...
		return new Object[] { z, x, y, b2y, c, c2z, w, a, b, a2x, i, ruleResult };
	}
