...
public class decula2branchubcImpl extends AbstractRuleImpl implements decula2branchubc {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decula2branchubcImpl
				.pattern_decula2branchubc_1_1_performtransformation_greenBBBFFFFFFB(l, c, a, b);
		...
		Object[] result2_black = decula2branchubcImpl
				.pattern_decula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(l, a, l2z, a2x, x, z, y, b2y, b);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[l] = " + l + ", " + "[a] = " + a
					+ ", " + "[l2z] = " + l2z + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ", " + "[z] = " + z
					+ ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[b] = " + b + ".");
		}
		Object[] result2_green = decula2branchubcImpl
				.pattern_decula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(l, a, l2z, a2x, x, z, y, b2y,
						b);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decula2branchubcImpl
				.pattern_decula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, l, d, c, a, l2z, a2x,
						x, d2c, z, y, b2y, b);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[l] = " + l + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[a] = " + a + ", "
					+ "[l2z] = " + l2z + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ", " + "[d2c] = " + d2c + ", "
					+ "[z] = " + z + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[b] = " + b + ".");
		}
		decula2branchubcImpl.pattern_decula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, l, d, c, a, l2z, a2x, x, z, y, b2y, b);
		...
		//nothing EMoflonEdge a__l____first = (EMoflonEdge) result3_green[18];
		...
		// 
		// 
		decula2branchubcImpl.pattern_decula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, l,
				d, c, a, l2z, a2x, x, d2c, z, y, b2y, b);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decula2branchubcImpl.pattern_decula2branchubc_2_2_corematch_blackBBFBFBB(l, d, a,
				b, match)) {
			...
			for (Object[] result3_black : decula2branchubcImpl.pattern_decula2branchubc_2_3_findcontext_blackBBBBBB(l,
				...
				Object[] result3_green = decula2branchubcImpl
						.pattern_decula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(l, d, c, a, d2c, b);
				...
				Object[] result4_bindingAndBlack = decula2branchubcImpl
						.pattern_decula2branchubc_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, l, d,
								c, a, d2c, b);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Assignment l, Decision d, Branch c,
			While a, S2B d2c, Assignment b) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject l, EObject d, EObject c, EObject a,
			EObject l2z, EObject a2x, EObject x, EObject d2c, EObject z, EObject y, EObject b2y, EObject b) {
	...
	public boolean isAppropriate_BWD(Match match, Branch c, Branch x, Command z, Command y) {
		...
		Object[] result2_bindingAndBlack = decula2branchubcImpl
				.pattern_decula2branchubc_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, c, x, z, y);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[c] = " + c + ", " + "[x] = " + x + ", " + "[z] = " + z + ", "
					+ "[y] = " + y + ".");
		...
		if (decula2branchubcImpl.pattern_decula2branchubc_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decula2branchubcImpl
					.pattern_decula2branchubc_10_4_collectelementstobetranslated_blackBBBBB(match, c, x, z, y);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ".");
			}
			decula2branchubcImpl.pattern_decula2branchubc_10_4_collectelementstobetranslated_greenBBBBBFFFF(match, c, x,
					z, y);
			...
			Object[] result5_black = decula2branchubcImpl
					.pattern_decula2branchubc_10_5_collectcontextelements_blackBBBBB(match, c, x, z, y);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[x] = " + x + ", " + "[z] = " + z + ", " + "[y] = " + y + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decula2branchubcImpl
				.pattern_decula2branchubc_11_1_performtransformation_greenFBFFFBBBFF(d, x, z, y);
		...
		Object[] result2_black = decula2branchubcImpl
				.pattern_decula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(l, a, l2z, a2x, x, z, y, b2y,
						b);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[l] = " + l + ", " + "[a] = " + a
					+ ", " + "[l2z] = " + l2z + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ", " + "[z] = " + z
		...
		Object[] result2_green = decula2branchubcImpl
				.pattern_decula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(l, a, l2z, a2x, x, z, y, b2y,
						b);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decula2branchubcImpl
				.pattern_decula2branchubc_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, l, d, c, a, l2z, a2x,
						x, d2c, z, y, b2y, b);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[l] = " + l + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[a] = " + a + ", "
		...
		// 
		// 
		decula2branchubcImpl.pattern_decula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, l,
				d, c, a, l2z, a2x, x, d2c, z, y, b2y, b);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decula2branchubcImpl.pattern_decula2branchubc_12_2_corematch_blackFBBFBBB(c, x, z,
				y, match)) {
			...
			for (Object[] result3_black : decula2branchubcImpl.pattern_decula2branchubc_12_3_findcontext_blackBBBBBB(d,
					c, x, d2c, z, y)) {
				Object[] result3_green = decula2branchubcImpl
						.pattern_decula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(d, c, x, d2c, z, y);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = decula2branchubcImpl
						.pattern_decula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, d, c,
								x, d2c, z, y);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Decision d, Branch c, Branch x, S2B d2c,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject l, EObject d, EObject c, EObject a,
			EObject l2z, EObject a2x, EObject x, EObject d2c, EObject z, EObject y, EObject b2y, EObject b) {
		ruleresult.registerObject("l", l);
		ruleresult.registerObject("d", d);
		ruleresult.registerObject("c", c);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_120(EMoflonEdge _edge_negative) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_120(EMoflonEdge _edge_positive) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decula2branchubcImpl
				.pattern_decula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, l, d, c, a, x, z, y, b,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[l] = " + l + ", " + "[d] = " + d + ", " + "[c] = " + c + ", " + "[a] = " + a + ", " + "[x] = "
					+ x + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[b] = " + b + ", " + "[sourceMatch] = "
		...
		if (decula2branchubcImpl.pattern_decula2branchubc_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decula2branchubcImpl
				...
				Object[] result6_black = decula2branchubcImpl
						.pattern_decula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(l, d, c, a, x, z, y, b,
								ccMatch);
				if (result6_black == null) {
				...
				decula2branchubcImpl.pattern_decula2branchubc_24_6_createcorrespondence_greenBBFFBBBFBB(l, a, x, z, y,
						b, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Assignment l, Decision d, Branch c, While a, Branch x, Command z, Command y,
	...
	public boolean checkDEC_BWD(Branch c, Branch x, Command z, Command y) {// 
		Object[] result1_black = decula2branchubcImpl.pattern_decula2branchubc_28_1_matchtggpattern_blackBBBB(c, x, z,
				y);
		if (result1_black != null) {
		...
		for (Object[] result2_black : decula2branchubcImpl
			...
			if (decula2branchubcImpl.pattern_decula2branchubc_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					decula2branchubcImpl.pattern_decula2branchubc_29_6_perform_greenFBBFFFFFFFFB(d, c, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASSIGNMENT_DECISION_BRANCH_WHILE_S2B_ASSIGNMENT:
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_DECISION_BRANCH_BRANCH_S2B_COMMAND_COMMAND:
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPROPRIATE_BWD_EMOFLON_EDGE_120__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_120((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECULA2BRANCHUBC___IS_APPROPRIATE_FWD_EMOFLON_EDGE_120__EMOFLONEDGE:
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_CC__ASSIGNMENT_DECISION_BRANCH_WHILE_BRANCH_COMMAND_COMMAND_ASSIGNMENT_MATCH_MATCH:
					...
					if (tmpA instanceof While) {
						...
						if (tmpD2c instanceof S2B) {
							...
							if (tmpB instanceof Assignment) {
								...
								return new Object[] { l, d, c, a, d2c, b, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decula2branchubc_1_1_performtransformation_blackBBBBBBFBB(Assignment l,
			Decision d, Branch c, While a, S2B d2c, Assignment b, decula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!b.equals(l)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { l, d, c, a, d2c, b, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decula2branchubc_1_1_performtransformation_binding != null) {
			...
			Decision d = (Decision) result_pattern_decula2branchubc_1_1_performtransformation_binding[1];
			Branch c = (Branch) result_pattern_decula2branchubc_1_1_performtransformation_binding[2];
			While a = (While) result_pattern_decula2branchubc_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_decula2branchubc_1_1_performtransformation_black = pattern_decula2branchubc_1_1_performtransformation_blackBBBBBBFBB(
					l, d, c, a, d2c, b, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decula2branchubc_1_1_performtransformation_greenBBBFFFFFFB(Assignment l,
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { l, c, a, l2z, a2x, x, z, y, b2y, b };
	}

	public static final Object[] pattern_decula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(Assignment l,
			While a, S2N l2z, S2B a2x, Branch x, Command z, Command y, S2N b2y, Assignment b) {
		if (!y.equals(z)) {
			if (!b2y.equals(l2z)) {
				if (!b.equals(l)) {
					return new Object[] { l, a, l2z, a2x, x, z, y, b2y, b };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(Assignment l,
			While a, S2N l2z, S2B a2x, Branch x, Command z, Command y, S2N b2y, Assignment b) {
		...
		return new Object[] { ruleresult, l, a, l2z, a2x, x, z, y, b2y, b };
	}

	public static final Object[] pattern_decula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject l, EObject d, EObject c, EObject a, EObject l2z, EObject a2x,
			EObject x, EObject d2c, EObject z, EObject y, EObject b2y, EObject b) {
		if (!l.equals(l2z)) {
			if (!l.equals(x)) {
				if (!l.equals(z)) {
					if (!l.equals(y)) {
	...
	public static final Object[] pattern_decula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject l, EObject d, EObject c, EObject a, EObject l2z, EObject a2x,
			EObject x, EObject z, EObject y, EObject b2y, EObject b) {
		EMoflonEdge d__a____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d__b____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, l, d, c, a, l2z, a2x, x, z, y, b2y, b, d__a____positive, d__b____negative,
				c__y____negative, c__x____positive, l2z__l____source, a__l____last, a__l____first, a2x__x____target,
				x__z____positive, z__x____next, l2z__z____target, a2x__a____source, b2y__y____target,
				b2y__b____source };
	}

	public static final void pattern_decula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			decula2branchubc _this, PerformRuleResult ruleresult, EObject l, EObject d, EObject c, EObject a,
			EObject l2z, EObject a2x, EObject x, EObject d2c, EObject z, EObject y, EObject b2y, EObject b) {
		_this.registerObjects_FWD(ruleresult, l, d, c, a, l2z, a2x, x, d2c, z, y, b2y, b);
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_2_2_corematch_blackBBFBFBB(Assignment l, Decision d,
		...
		if (!b.equals(l)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { l, d, c, a, d2c, b, match });
				}
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_2_3_findcontext_blackBBBBBB(Assignment l,
			Decision d, Branch c, While a, S2B d2c, Assignment b) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!b.equals(l)) {
						...
						if (l.equals(a.getFirst())) {
							if (d.equals(d2c.getSource())) {
								if (c.equals(d2c.getTarget())) {
									_result.add(new Object[] { l, d, c, a, d2c, b });
								}
							}
						}
					}
	...
	public static final Object[] pattern_decula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(Assignment l, Decision d,
			Branch c, While a, S2B d2c, Assignment b) {
		...
		return new Object[] { l, d, c, a, d2c, b, isApplicableMatch, d__a____positive, d__b____negative, a__l____last,
	...
	public static final Object[] pattern_decula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(decula2branchubc _this,
			IsApplicableMatch isApplicableMatch, Assignment l, Decision d, Branch c, While a, S2B d2c, Assignment b) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, l, d, c, a, d2c, b);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, l, d, c, a, d2c, b };
		}
		return null;
	}
	...
	public static final Object[] pattern_decula2branchubc_2_4_solveCSP_bindingAndBlackFBBBBBBBB(decula2branchubc _this,
		...
		Object[] result_pattern_decula2branchubc_2_4_solveCSP_binding = pattern_decula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, l, d, c, a, d2c, b);
	...
	public static final Object[] pattern_decula2branchubc_10_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		x__z____positive.setName(x__z____positive_name_prime);
		z__x____next.setName(z__x____next_name_prime);
		return new Object[] { match, c, x, z, y, c__y____negative, c__x____positive, x__z____positive, z__x____next };
	}
	...
	public static final void pattern_decula2branchubc_10_6_registerobjectstomatch_expressionBBBBBB(
			decula2branchubc _this, Match match, Branch c, Branch x, Command z, Command y) {
					...
					if (tmpD2c instanceof S2B) {
						...
						if (tmpZ instanceof Command) {
							...
							if (tmpY instanceof Command) {
								...
								return new Object[] { d, c, x, d2c, z, y, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decula2branchubc_11_1_performtransformation_blackBBBBBBFBB(Decision d,
			Branch c, Branch x, S2B d2c, Command z, Command y, decula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { d, c, x, d2c, z, y, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decula2branchubc_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decula2branchubc_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_decula2branchubc_11_1_performtransformation_black = pattern_decula2branchubc_11_1_performtransformation_blackBBBBBBFBB(
					d, c, x, d2c, z, y, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decula2branchubc_11_1_performtransformation_greenFBFFFBBBFF(Decision d,
			Branch x, Command z, Command y) {
		...
		d.setNegative(b);
		b2y.setSource(b);
		return new Object[] { l, d, a, l2z, a2x, x, z, y, b2y, b };
	}

	public static final Object[] pattern_decula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(Assignment l,
			While a, S2N l2z, S2B a2x, Branch x, Command z, Command y, S2N b2y, Assignment b) {
		if (!y.equals(z)) {
			if (!b2y.equals(l2z)) {
				if (!b.equals(l)) {
	...
	public static final Object[] pattern_decula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(Assignment l,
			While a, S2N l2z, S2B a2x, Branch x, Command z, Command y, S2N b2y, Assignment b) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_decula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			decula2branchubc _this, PerformRuleResult ruleresult, EObject l, EObject d, EObject c, EObject a,
			EObject l2z, EObject a2x, EObject x, EObject d2c, EObject z, EObject y, EObject b2y, EObject b) {
		_this.registerObjects_BWD(ruleresult, l, d, c, a, l2z, a2x, x, d2c, z, y, b2y, b);
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_12_2_corematch_blackFBBFBBB(Branch c, Branch x,
		...
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
					...
					if (tmpD instanceof Decision) {
						Decision d = (Decision) tmpD;
						_result.add(new Object[] { d, c, x, d2c, z, y, match });
					}
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_12_3_findcontext_blackBBBBBB(Decision d, Branch c,
			Branch x, S2B d2c, Command z, Command y) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(x)) {
			if (!y.equals(z)) {
							...
							if (d.equals(d2c.getSource())) {
								if (c.equals(d2c.getTarget())) {
									if (x.equals(z.getNext())) {
										_result.add(new Object[] { d, c, x, d2c, z, y });
									}
								}
							}
						}
	...
	public static final Object[] pattern_decula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(Decision d, Branch c,
			Branch x, S2B d2c, Command z, Command y) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge c__y____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		d2c__c____target.setName(d2c__c____target_name_prime);
		z__x____next.setName(z__x____next_name_prime);
		return new Object[] { d, c, x, d2c, z, y, isApplicableMatch, c__y____negative, c__x____positive,
	...
	public static final Object[] pattern_decula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(decula2branchubc _this,
			IsApplicableMatch isApplicableMatch, Decision d, Branch c, Branch x, S2B d2c, Command z, Command y) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d, c, x, d2c, z, y);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d, c, x, d2c, z, y };
		}
		return null;
	}
	...
	public static final Object[] pattern_decula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decula2branchubc _this,
		...
		Object[] result_pattern_decula2branchubc_12_4_solveCSP_binding = pattern_decula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, d, c, x, d2c, z, y);
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_858356 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_1BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_31767 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_31767)) {
					if (!c.equals(__DEC_x_positive_31767)) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_2BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_707273 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_707273)) {
					if (!c.equals(__DEC_x_negative_707273)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_422359 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_4BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_positive_298302 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_298302)) {
					if (!x.equals(__DEC_z_positive_298302)) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_5BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_negative_93863 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_93863)) {
					if (!x.equals(__DEC_z_negative_93863)) {
						return new Object[] { z, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_415671 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_7BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_285787 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_285787)) {
					if (!x.equals(__DEC_y_positive_285787)) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_8BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_341144 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_341144)) {
					if (!x.equals(__DEC_y_negative_341144)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_9BB(Branch c, Branch x) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_15BB(Branch x,
			Command y) {
								...
								if (!y.equals(z)) {
									if (x.equals(z.getNext())) {
										if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_6B(
												y) == null) {
											if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_13BB(c,
													y) == null) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_0BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_positive_152289 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_152289)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_1BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_negative_807252 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_807252)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_2BB(Assignment l,
			While a) {
		for (While __DEC_l_last_521179 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!a.equals(__DEC_l_last_521179)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_3B(Assignment l) {
		for (Program __DEC_l_first_808806 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_4BB(While a, Decision d) {
		for (Decision __DEC_a_negative_628558 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_628558)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_5B(While a) {
		for (While __DEC_a_first_356193 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!a.equals(__DEC_a_first_356193)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_6B(While a) {
		for (While __DEC_a_last_195048 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!a.equals(__DEC_a_last_195048)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_7B(While a) {
		for (Program __DEC_a_first_144336 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_8BB(Assignment b,
			Decision d) {
		for (Decision __DEC_b_positive_356210 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_356210)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_9BB(Assignment b,
			While a) {
		for (While __DEC_b_first_43324 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!a.equals(__DEC_b_first_43324)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_10BB(Assignment b,
			While a) {
		for (While __DEC_b_last_318810 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!a.equals(__DEC_b_last_318810)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_11B(Assignment b) {
		for (Program __DEC_b_first_795618 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
						...
						if (tmpX instanceof Branch) {
							...
							if (tmpZ instanceof Command) {
								...
								if (tmpY instanceof Command) {
									...
									if (tmpB instanceof Assignment) {
										Assignment b = (Assignment) tmpB;
										return new Object[] { l, d, c, a, x, z, y, b, sourceMatch, targetMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(Assignment l,
			Decision d, Branch c, While a, Branch x, Command z, Command y, Assignment b, Match sourceMatch,
			Match targetMatch) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				if (!b.equals(l)) {
	...
	public static final Object[] pattern_decula2branchubc_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding != null) {
			...
			While a = (While) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[3];
			Branch x = (Branch) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[4];
			Command z = (Command) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_decula2branchubc_24_2_matchsrctrgcontext_black = pattern_decula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					l, d, c, a, x, z, y, b, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(decula2branchubc _this,
			Assignment l, Decision d, Branch c, While a, Branch x, Command z, Command y, Assignment b,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(l, d, c, a, x, z, y, b, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, l, d, c, a, x, z, y, b, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			decula2branchubc _this, Assignment l, Decision d, Branch c, While a, Branch x, Command z, Command y,
		...
		Object[] result_pattern_decula2branchubc_24_3_solvecsp_binding = pattern_decula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, l, d, c, a, x, z, y, b, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(Assignment l,
			Decision d, Branch c, While a, Branch x, Command z, Command y, Assignment b, CCMatch ccMatch) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				if (!b.equals(l)) {
					return new Object[] { l, d, c, a, x, z, y, b, ccMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_24_6_createcorrespondence_greenBBFFBBBFBB(Assignment l,
			While a, Branch x, Command z, Command y, Assignment b, CCMatch ccMatch) {
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		l2z.setSource(l);
		...
		return new Object[] { l, a, l2z, a2x, x, z, y, b2y, b, ccMatch };
	}
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_0BB(Assignment l, Decision d) {
		for (Decision __DEC_l_positive_389212 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_389212)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_1BB(Assignment l, Decision d) {
		for (Decision __DEC_l_negative_435273 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_435273)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_2BB(Assignment l, While a) {
		for (While __DEC_l_last_502650 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!a.equals(__DEC_l_last_502650)) {
				return new Object[] { l, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_3B(Assignment l) {
		for (Program __DEC_l_first_178942 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_4BB(While a, Decision d) {
		for (Decision __DEC_a_negative_704906 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_704906)) {
				return new Object[] { a, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_5B(While a) {
		for (While __DEC_a_first_934032 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!a.equals(__DEC_a_first_934032)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_6B(While a) {
		for (While __DEC_a_last_538542 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!a.equals(__DEC_a_last_538542)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_7B(While a) {
		for (Program __DEC_a_first_805430 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_8BB(Assignment b, Decision d) {
		for (Decision __DEC_b_positive_304780 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_304780)) {
				return new Object[] { b, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_9BB(Assignment b, While a) {
		for (While __DEC_b_first_280668 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!a.equals(__DEC_b_first_280668)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_10BB(Assignment b, While a) {
		for (While __DEC_b_last_577366 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!a.equals(__DEC_b_last_577366)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_11B(Assignment b) {
		for (Program __DEC_b_first_355608 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_0B(Branch x) {
		for (Graph __DEC_x_root_490080 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_1BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_627865 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_627865)) {
					if (!c.equals(__DEC_x_positive_627865)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_2BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_19813 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_19813)) {
					if (!c.equals(__DEC_x_negative_19813)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_3B(Command z) {
		for (Graph __DEC_z_root_303398 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_4BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_positive_331185 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_331185)) {
					if (!x.equals(__DEC_z_positive_331185)) {
						return new Object[] { z, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_5BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_negative_438242 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_438242)) {
					if (!x.equals(__DEC_z_negative_438242)) {
						return new Object[] { z, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_6B(Command y) {
		for (Graph __DEC_y_root_740986 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_7BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_711862 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_711862)) {
					if (!x.equals(__DEC_y_positive_711862)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_8BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_920199 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_920199)) {
					if (!x.equals(__DEC_y_negative_920199)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_9BB(Branch c, Branch x) {
		if (x.equals(c.getNegative())) {
			return new Object[] { c, x };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_12BB(Branch x, Command z) {
		if (z.equals(x.getNegative())) {
			return new Object[] { x, z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_15BB(Branch x, Command y) {
		if (y.equals(x.getNegative())) {
			return new Object[] { x, y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_blackBBBB(Branch c, Branch x, Command z,
			Command y) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				if (y.equals(c.getNegative())) {
	...
	public static final Object[] pattern_decula2branchubc_29_6_perform_greenFBBFFFFFFFFB(Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		Assignment l = SourcecodeFactory.eINSTANCE.createAssignment();
		While a = SourcecodeFactory.eINSTANCE.createWhile();
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		return new Object[] { l, d, c, a, l2z, a2x, x, z, y, b2y, b, ruleResult };
	}
