...
public class decula2branchubcImpl extends AbstractRuleImpl implements decula2branchubc {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decula2branchubcImpl
				.pattern_decula2branchubc_1_1_performtransformation_greenBBFBFBFFFF(a, c, l, b);
		...
		Object[] result2_black = decula2branchubcImpl
				.pattern_decula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(a, a2x, l, z, b, y, x, b2y, l2z);
		...
		Object[] result2_green = decula2branchubcImpl
				.pattern_decula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(a, a2x, l, z, b, y, x, b2y,
						l2z);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decula2branchubcImpl
				.pattern_decula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, a, c, d, a2x, l, z, b,
						y, x, b2y, d2c, l2z);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[a2x] = " + a2x + ", "
					+ "[l] = " + l + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[y] = " + y + ", " + "[x] = "
					+ x + ", " + "[b2y] = " + b2y + ", " + "[d2c] = " + d2c + ", " + "[l2z] = " + l2z + ".");
		}
		decula2branchubcImpl.pattern_decula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, a, c, d, a2x, l, z, b, y, x, b2y, l2z);
		...
		// 
		// 
		decula2branchubcImpl.pattern_decula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, a,
				c, d, a2x, l, z, b, y, x, b2y, d2c, l2z);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decula2branchubcImpl.pattern_decula2branchubc_2_2_corematch_blackBFBBBFB(a, d, l,
				b, match)) {
			...
			for (Object[] result3_black : decula2branchubcImpl.pattern_decula2branchubc_2_3_findcontext_blackBBBBBB(a,
				...
				Object[] result3_green = decula2branchubcImpl
						.pattern_decula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(a, c, d, l, b, d2c);
				...
				Object[] result4_bindingAndBlack = decula2branchubcImpl
						.pattern_decula2branchubc_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, a, c,
								d, l, b, d2c);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, While a, Branch c, Decision d,
			Assignment l, Assignment b, S2B d2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject a, EObject c, EObject d, EObject a2x,
			EObject l, EObject z, EObject b, EObject y, EObject x, EObject b2y, EObject d2c, EObject l2z) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Branch c, Command z, Command y, Branch x) {
		...
		Object[] result2_bindingAndBlack = decula2branchubcImpl
				.pattern_decula2branchubc_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, c, z, y, x);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[c] = " + c + ", " + "[z] = " + z + ", " + "[y] = " + y + ", "
					+ "[x] = " + x + ".");
		...
		if (decula2branchubcImpl.pattern_decula2branchubc_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decula2branchubcImpl
					.pattern_decula2branchubc_10_4_collectelementstobetranslated_blackBBBBB(match, c, z, y, x);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
			}
			decula2branchubcImpl.pattern_decula2branchubc_10_4_collectelementstobetranslated_greenBBBBBFFFF(match, c, z,
					y, x);
			...
			Object[] result5_black = decula2branchubcImpl
					.pattern_decula2branchubc_10_5_collectcontextelements_blackBBBBB(match, c, z, y, x);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[z] = " + z + ", " + "[y] = " + y + ", " + "[x] = " + x + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = decula2branchubcImpl
				.pattern_decula2branchubc_11_1_performtransformation_greenFBFFBFBBFF(d, z, y, x);
		...
		Object[] result2_black = decula2branchubcImpl
				.pattern_decula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(a, a2x, l, z, b, y, x, b2y,
						l2z);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[a2x] = "
					+ a2x + ", " + "[l] = " + l + ", " + "[z] = " + z + ", " + "[b] = " + b + ", " + "[y] = " + y + ", "
		...
		Object[] result2_green = decula2branchubcImpl
				.pattern_decula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(a, a2x, l, z, b, y, x, b2y,
						l2z);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decula2branchubcImpl
				.pattern_decula2branchubc_11_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, a, c, d, a2x, l, z, b,
						y, x, b2y, d2c, l2z);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a] = " + a + ", " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[a2x] = " + a2x + ", "
		...
		// 
		// 
		decula2branchubcImpl.pattern_decula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(this, ruleresult, a,
				c, d, a2x, l, z, b, y, x, b2y, d2c, l2z);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decula2branchubcImpl.pattern_decula2branchubc_12_2_corematch_blackBFBBBFB(c, z, y,
				x, match)) {
			...
			for (Object[] result3_black : decula2branchubcImpl.pattern_decula2branchubc_12_3_findcontext_blackBBBBBB(c,
					d, z, y, x, d2c)) {
				Object[] result3_green = decula2branchubcImpl
						.pattern_decula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(c, d, z, y, x, d2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				Object[] result4_bindingAndBlack = decula2branchubcImpl
						.pattern_decula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, c, d,
								z, y, x, d2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Branch c, Command z, Command y, Branch x) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Branch c, Command z, Command y, Branch x) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Branch c, Decision d, Command z,
			Command y, Branch x, S2B d2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject a, EObject c, EObject d, EObject a2x,
			EObject l, EObject z, EObject b, EObject y, EObject x, EObject b2y, EObject d2c, EObject l2z) {
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("d", d);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_81(EMoflonEdge _edge_negative) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_81(EMoflonEdge _edge_first) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decula2branchubcImpl
				.pattern_decula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, a, c, d, l, z, b, y, x,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[a] = " + a + ", " + "[c] = " + c + ", " + "[d] = " + d + ", " + "[l] = " + l + ", " + "[z] = "
					+ z + ", " + "[b] = " + b + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[sourceMatch] = "
		...
		if (decula2branchubcImpl.pattern_decula2branchubc_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decula2branchubcImpl
				...
				Object[] result6_black = decula2branchubcImpl
						.pattern_decula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(a, c, d, l, z, b, y, x,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a] = " + a + ", "
							+ "[c] = " + c + ", " + "[d] = " + d + ", " + "[l] = " + l + ", " + "[z] = " + z + ", "
							+ "[b] = " + b + ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				decula2branchubcImpl.pattern_decula2branchubc_24_6_createcorrespondence_greenBFBBBBBFFB(a, l, z, b, y,
						x, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(While a, Branch c, Decision d, Assignment l, Command z, Assignment b, Command y,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Branch c, Command z, Command y, Branch x) {// 
		Object[] result1_black = decula2branchubcImpl.pattern_decula2branchubc_28_1_matchtggpattern_blackBBBB(c, z, y,
				x);
		if (result1_black != null) {
		...
		for (Object[] result2_black : decula2branchubcImpl
			...
			if (decula2branchubcImpl.pattern_decula2branchubc_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					decula2branchubcImpl.pattern_decula2branchubc_29_6_perform_greenFBBFFFFFFFFB(c, d, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_WHILE_BRANCH_DECISION_ASSIGNMENT_ASSIGNMENT_S2B:
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BRANCH_DECISION_COMMAND_COMMAND_BRANCH_S2B:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Branch) arguments.get(1),
					(Decision) arguments.get(2), (Command) arguments.get(3), (Command) arguments.get(4),
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPROPRIATE_BWD_EMOFLON_EDGE_81__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_81((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECULA2BRANCHUBC___IS_APPROPRIATE_FWD_EMOFLON_EDGE_81__EMOFLONEDGE:
		...
		case RulesPackage.DECULA2BRANCHUBC___IS_APPLICABLE_SOLVE_CSP_CC__WHILE_BRANCH_DECISION_ASSIGNMENT_COMMAND_ASSIGNMENT_COMMAND_BRANCH_MATCH_MATCH:
			return isApplicable_solveCsp_CC((While) arguments.get(0), (Branch) arguments.get(1),
					(Decision) arguments.get(2), (Assignment) arguments.get(3), (Command) arguments.get(4),
	...
	public static final Object[] pattern_decula2branchubc_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, a, d, l, b, a__l____first, d__b____negative, d__a____positive, a__l____last };
	}
	...
	public static final Object[] pattern_decula2branchubc_1_1_performtransformation_blackBBBBBBFBB(While a, Branch c,
			Decision d, Assignment l, Assignment b, S2B d2c, decula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!b.equals(l)) {
	...
	public static final Object[] pattern_decula2branchubc_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decula2branchubc_1_1_performtransformation_binding != null) {
			...
			Assignment b = (Assignment) result_pattern_decula2branchubc_1_1_performtransformation_binding[4];
			S2B d2c = (S2B) result_pattern_decula2branchubc_1_1_performtransformation_binding[5];
	...
	public static final Object[] pattern_decula2branchubc_1_1_performtransformation_greenBBFBFBFFFF(While a, Branch c,
		...
		l2z.setSource(l);
		l2z.setTarget(z);
		return new Object[] { a, c, a2x, l, z, b, y, x, b2y, l2z };
	}

	public static final Object[] pattern_decula2branchubc_1_2_collecttranslatedelements_blackBBBBBBBBB(While a, S2B a2x,
			Assignment l, Command z, Assignment b, Command y, Branch x, S2N b2y, S2N l2z) {
		if (!b.equals(l)) {
			if (!y.equals(z)) {
				if (!b2y.equals(l2z)) {
					return new Object[] { a, a2x, l, z, b, y, x, b2y, l2z };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_1_2_collecttranslatedelements_greenFBBBBBBBBB(While a,
			S2B a2x, Assignment l, Command z, Assignment b, Command y, Branch x, S2N b2y, S2N l2z) {
		...
		return new Object[] { ruleresult, a, a2x, l, z, b, y, x, b2y, l2z };
	}

	public static final Object[] pattern_decula2branchubc_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject a, EObject c, EObject d, EObject a2x, EObject l, EObject z, EObject b,
			EObject y, EObject x, EObject b2y, EObject d2c, EObject l2z) {
		if (!a.equals(c)) {
			if (!a.equals(d)) {
				if (!a.equals(a2x)) {
					if (!a.equals(l)) {
	...
	public static final Object[] pattern_decula2branchubc_1_3_bookkeepingforedges_greenBBBBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject a, EObject c, EObject d, EObject a2x, EObject l, EObject z, EObject b,
			EObject y, EObject x, EObject b2y, EObject l2z) {
		EMoflonEdge a__l____first = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, a, c, d, a2x, l, z, b, y, x, b2y, l2z, a__l____first, c__y____negative,
				d__b____negative, d__a____positive, a2x__a____source, a__l____last, c__x____positive, a2x__x____target,
				x__z____positive, b2y__y____target, b2y__b____source, z__x____next, l2z__l____source,
				l2z__z____target };
	}

	public static final void pattern_decula2branchubc_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
			decula2branchubc _this, PerformRuleResult ruleresult, EObject a, EObject c, EObject d, EObject a2x,
			EObject l, EObject z, EObject b, EObject y, EObject x, EObject b2y, EObject d2c, EObject l2z) {
		_this.registerObjects_FWD(ruleresult, a, c, d, a2x, l, z, b, y, x, b2y, d2c, l2z);
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_2_2_corematch_blackBFBBBFB(While a, Decision d,
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_2_3_findcontext_blackBBBBBB(While a, Branch c,
			Decision d, Assignment l, Assignment b, S2B d2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!b.equals(l)) {
	...
	public static final Object[] pattern_decula2branchubc_2_3_findcontext_greenBBBBBBFFFFFFF(While a, Branch c,
			Decision d, Assignment l, Assignment b, S2B d2c) {
		...
		return new Object[] { a, c, d, l, b, d2c, isApplicableMatch, a__l____first, d__b____negative, d__a____positive,
				a__l____last, d2c__c____target, d2c__d____source };
	}

	public static final Object[] pattern_decula2branchubc_2_4_solveCSP_bindingFBBBBBBBB(decula2branchubc _this,
			IsApplicableMatch isApplicableMatch, While a, Branch c, Decision d, Assignment l, Assignment b, S2B d2c) {
	...
	public static final Object[] pattern_decula2branchubc_10_1_initialbindings_blackBBBBBB(decula2branchubc _this,
			Match match, Branch c, Command z, Command y, Branch x) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
	...
	public static final Object[] pattern_decula2branchubc_10_4_collectelementstobetranslated_blackBBBBB(Match match,
			Branch c, Command z, Command y, Branch x) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
	...
	public static final Object[] pattern_decula2branchubc_10_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		x__z____positive.setName(x__z____positive_name_prime);
		z__x____next.setName(z__x____next_name_prime);
		return new Object[] { match, c, z, y, x, c__y____negative, c__x____positive, x__z____positive, z__x____next };
	}
	...
	public static final void pattern_decula2branchubc_10_6_registerobjectstomatch_expressionBBBBBB(
			decula2branchubc _this, Match match, Branch c, Command z, Command y, Branch x) {
				...
				if (tmpZ instanceof Command) {
					...
					if (tmpY instanceof Command) {
						...
						if (tmpX instanceof Branch) {
							...
							if (tmpD2c instanceof S2B) {
								S2B d2c = (S2B) tmpD2c;
								return new Object[] { c, d, z, y, x, d2c, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decula2branchubc_11_1_performtransformation_blackBBBBBBFBB(Branch c,
			Decision d, Command z, Command y, Branch x, S2B d2c, decula2branchubc _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { c, d, z, y, x, d2c, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_decula2branchubc_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_decula2branchubc_11_1_performtransformation_binding != null) {
			...
			Branch x = (Branch) result_pattern_decula2branchubc_11_1_performtransformation_binding[4];
			S2B d2c = (S2B) result_pattern_decula2branchubc_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_decula2branchubc_11_1_performtransformation_black = pattern_decula2branchubc_11_1_performtransformation_blackBBBBBBFBB(
					c, d, z, y, x, d2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decula2branchubc_11_1_performtransformation_greenFBFFBFBBFF(Decision d,
			Command z, Command y, Branch x) {
		...
		l2z.setSource(l);
		l2z.setTarget(z);
		return new Object[] { a, d, a2x, l, z, b, y, x, b2y, l2z };
	}

	public static final Object[] pattern_decula2branchubc_11_2_collecttranslatedelements_blackBBBBBBBBB(While a,
			S2B a2x, Assignment l, Command z, Assignment b, Command y, Branch x, S2N b2y, S2N l2z) {
		if (!b.equals(l)) {
			if (!y.equals(z)) {
				if (!b2y.equals(l2z)) {
	...
	public static final Object[] pattern_decula2branchubc_11_2_collecttranslatedelements_greenFBBBBBBBBB(While a,
			S2B a2x, Assignment l, Command z, Assignment b, Command y, Branch x, S2N b2y, S2N l2z) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_decula2branchubc_11_5_registerobjects_expressionBBBBBBBBBBBBBB(
			decula2branchubc _this, PerformRuleResult ruleresult, EObject a, EObject c, EObject d, EObject a2x,
			EObject l, EObject z, EObject b, EObject y, EObject x, EObject b2y, EObject d2c, EObject l2z) {
		_this.registerObjects_BWD(ruleresult, a, c, d, a2x, l, z, b, y, x, b2y, d2c, l2z);
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_12_2_corematch_blackBFBBBFB(Branch c, Command z,
		...
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class,
					...
					if (tmpD instanceof Decision) {
						Decision d = (Decision) tmpD;
						_result.add(new Object[] { c, d, z, y, x, d2c, match });
					}
	...
	public static final Iterable<Object[]> pattern_decula2branchubc_12_3_findcontext_blackBBBBBB(Branch c, Decision d,
			Command z, Command y, Branch x, S2B d2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(x)) {
			if (!y.equals(z)) {
							...
							if (c.equals(d2c.getTarget())) {
								if (d.equals(d2c.getSource())) {
									if (x.equals(z.getNext())) {
										_result.add(new Object[] { c, d, z, y, x, d2c });
									}
								}
							}
						}
	...
	public static final Object[] pattern_decula2branchubc_12_3_findcontext_greenBBBBBBFFFFFFF(Branch c, Decision d,
			Command z, Command y, Branch x, S2B d2c) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge c__y____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		d2c__d____source.setName(d2c__d____source_name_prime);
		z__x____next.setName(z__x____next_name_prime);
		return new Object[] { c, d, z, y, x, d2c, isApplicableMatch, c__y____negative, c__x____positive,
				x__z____positive, d2c__c____target, d2c__d____source, z__x____next };
	}

	public static final Object[] pattern_decula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(decula2branchubc _this,
			IsApplicableMatch isApplicableMatch, Branch c, Decision d, Command z, Command y, Branch x, S2B d2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, c, d, z, y, x, d2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c, d, z, y, x, d2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_decula2branchubc_12_4_solveCSP_bindingAndBlackFBBBBBBBB(decula2branchubc _this,
		...
		Object[] result_pattern_decula2branchubc_12_4_solveCSP_binding = pattern_decula2branchubc_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, c, d, z, y, x, d2c);
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_310708 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_1BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_positive_124867 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_124867)) {
					if (!x.equals(__DEC_z_positive_124867)) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_2BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_negative_160068 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_160068)) {
					if (!x.equals(__DEC_z_negative_160068)) {
						return new Object[] { z, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_3B(Command y) {
		for (Graph __DEC_y_root_597948 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_4BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_556479 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_556479)) {
					if (!x.equals(__DEC_y_positive_556479)) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_5BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_890125 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_890125)) {
					if (!x.equals(__DEC_y_negative_890125)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_880317 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_7BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_95205 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_95205)) {
					if (!c.equals(__DEC_x_positive_95205)) {
	...
	public static final Object[] pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_8BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_478641 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_478641)) {
					if (!c.equals(__DEC_x_negative_478641)) {
						return new Object[] { x, c };
					}
				}
			}
								...
								if (!y.equals(z)) {
									if (x.equals(z.getNext())) {
										if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_3B(
												y) == null) {
											if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_12BB(c,
													y) == null) {
												if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_4BBB(y,
														c, x) == null) {
													if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_5BBB(
														...
														if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_6B(
																x) == null) {
															if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_7BB(
																	x, c) == null) {
																if (pattern_decula2branchubc_20_2_testcorematchandDECs_black_nac_8BB(
																		x, c) == null) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_0BB(While a, Decision d) {
		for (Decision __DEC_a_negative_161676 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_161676)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_1B(While a) {
		for (While __DEC_a_first_514439 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!a.equals(__DEC_a_first_514439)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_2B(While a) {
		for (While __DEC_a_last_232081 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!a.equals(__DEC_a_last_232081)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_3B(While a) {
		for (Program __DEC_a_first_480253 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_4BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_positive_874349 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_874349)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_5BB(Assignment l,
			Decision d) {
		for (Decision __DEC_l_negative_903842 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_903842)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_6BB(Assignment l,
			While a) {
		for (While __DEC_l_last_455166 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!a.equals(__DEC_l_last_455166)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_7B(Assignment l) {
		for (Program __DEC_l_first_661811 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_8BB(Assignment b,
			Decision d) {
		for (Decision __DEC_b_positive_511415 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_511415)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_9BB(Assignment b,
			While a) {
		for (While __DEC_b_first_455575 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!a.equals(__DEC_b_first_455575)) {
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_10BB(Assignment b,
			While a) {
		for (While __DEC_b_last_322017 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!a.equals(__DEC_b_last_322017)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_21_2_testcorematchandDECs_black_nac_11B(Assignment b) {
		for (Program __DEC_b_first_909172 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
						...
						if (tmpZ instanceof Command) {
							...
							if (tmpB instanceof Assignment) {
								...
								if (tmpY instanceof Command) {
									...
									if (tmpX instanceof Branch) {
										Branch x = (Branch) tmpX;
										return new Object[] { a, c, d, l, z, b, y, x, sourceMatch, targetMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_decula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(While a, Branch c,
			Decision d, Assignment l, Command z, Assignment b, Command y, Branch x, Match sourceMatch,
			Match targetMatch) {
		if (!c.equals(x)) {
			if (!b.equals(l)) {
				if (!y.equals(z)) {
	...
	public static final Object[] pattern_decula2branchubc_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding != null) {
			...
			Decision d = (Decision) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[2];
			Assignment l = (Assignment) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[3];
			Command z = (Command) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[4];
			Assignment b = (Assignment) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[5];
			Command y = (Command) result_pattern_decula2branchubc_24_2_matchsrctrgcontext_binding[6];
			...
			Object[] result_pattern_decula2branchubc_24_2_matchsrctrgcontext_black = pattern_decula2branchubc_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					a, c, d, l, z, b, y, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(decula2branchubc _this,
			While a, Branch c, Decision d, Assignment l, Command z, Assignment b, Command y, Branch x,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_8 = _this.isApplicable_solveCsp_CC(a, c, d, l, z, b, y, x, sourceMatch, targetMatch);
		CSP csp = _localVariable_8;
		if (csp != null) {
			return new Object[] { csp, _this, a, c, d, l, z, b, y, x, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decula2branchubc_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
			decula2branchubc _this, While a, Branch c, Decision d, Assignment l, Command z, Assignment b, Command y,
		...
		Object[] result_pattern_decula2branchubc_24_3_solvecsp_binding = pattern_decula2branchubc_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, a, c, d, l, z, b, y, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decula2branchubc_24_6_createcorrespondence_blackBBBBBBBBB(While a, Branch c,
			Decision d, Assignment l, Command z, Assignment b, Command y, Branch x, CCMatch ccMatch) {
		if (!c.equals(x)) {
			if (!b.equals(l)) {
				if (!y.equals(z)) {
					return new Object[] { a, c, d, l, z, b, y, x, ccMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_24_6_createcorrespondence_greenBFBBBBBFFB(While a,
			Assignment l, Command z, Assignment b, Command y, Branch x, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2N l2z = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		a2x.setSource(a);
		...
		return new Object[] { a, a2x, l, z, b, y, x, b2y, l2z, ccMatch };
	}
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_0BB(While a, Decision d) {
		for (Decision __DEC_a_negative_100766 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_a_negative_100766)) {
				return new Object[] { a, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_1B(While a) {
		for (While __DEC_a_first_280631 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			if (!a.equals(__DEC_a_first_280631)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_2B(While a) {
		for (While __DEC_a_last_788954 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			if (!a.equals(__DEC_a_last_788954)) {
				return new Object[] { a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_3B(While a) {
		for (Program __DEC_a_first_847171 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_4BB(Assignment l, Decision d) {
		for (Decision __DEC_l_positive_57385 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_l_positive_57385)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_5BB(Assignment l, Decision d) {
		for (Decision __DEC_l_negative_531715 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Decision.class, "negative")) {
			if (!d.equals(__DEC_l_negative_531715)) {
				return new Object[] { l, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_6BB(Assignment l, While a) {
		for (While __DEC_l_last_796412 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				While.class, "last")) {
			if (!a.equals(__DEC_l_last_796412)) {
				return new Object[] { l, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_7B(Assignment l) {
		for (Program __DEC_l_first_556760 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(l,
				Program.class, "first")) {
			return new Object[] { l };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_8BB(Assignment b, Decision d) {
		for (Decision __DEC_b_positive_507707 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Decision.class, "positive")) {
			if (!d.equals(__DEC_b_positive_507707)) {
				return new Object[] { b, d };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_9BB(Assignment b, While a) {
		for (While __DEC_b_first_759353 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			if (!a.equals(__DEC_b_first_759353)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_10BB(Assignment b, While a) {
		for (While __DEC_b_last_6588 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			if (!a.equals(__DEC_b_last_6588)) {
				return new Object[] { b, a };
			}
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_27_1_matchtggpattern_black_nac_11B(Assignment b) {
		for (Program __DEC_b_first_622971 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_0B(Command z) {
		for (Graph __DEC_z_root_457624 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
				Graph.class, "root")) {
			return new Object[] { z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_1BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_positive_348755 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_z_positive_348755)) {
					if (!x.equals(__DEC_z_positive_348755)) {
						return new Object[] { z, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_2BBB(Command z, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_z_negative_872507 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(z,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_z_negative_872507)) {
					if (!x.equals(__DEC_z_negative_872507)) {
						return new Object[] { z, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_3B(Command y) {
		for (Graph __DEC_y_root_200127 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_4BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_265238 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_265238)) {
					if (!x.equals(__DEC_y_positive_265238)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_5BBB(Command y, Branch c,
			Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_443017 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_443017)) {
					if (!x.equals(__DEC_y_negative_443017)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_6B(Branch x) {
		for (Graph __DEC_x_root_711664 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_7BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_717978 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_717978)) {
					if (!c.equals(__DEC_x_positive_717978)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_8BB(Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_482059 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_482059)) {
					if (!c.equals(__DEC_x_negative_482059)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_10BB(Branch c, Command z) {
		if (z.equals(c.getNegative())) {
			return new Object[] { c, z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_11BB(Branch x, Command z) {
		if (z.equals(x.getNegative())) {
			return new Object[] { x, z };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_12BB(Branch c, Command y) {
		if (y.equals(c.getPositive())) {
			return new Object[] { c, y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_black_nac_13BB(Branch x, Command y) {
		if (y.equals(x.getPositive())) {
			return new Object[] { x, y };
		}
		return null;
	...
	public static final Object[] pattern_decula2branchubc_28_1_matchtggpattern_blackBBBB(Branch c, Command z, Command y,
			Branch x) {
		if (!c.equals(x)) {
			if (!y.equals(z)) {
				if (y.equals(c.getNegative())) {
					if (x.equals(c.getPositive())) {
						if (z.equals(x.getPositive())) {
							if (x.equals(z.getNext())) {
								if (pattern_decula2branchubc_28_1_matchtggpattern_black_nac_0B(z) == null) {
									if (pattern_decula2branchubc_28_1_matchtggpattern_black_nac_1BBB(z, c, x) == null) {
										if (pattern_decula2branchubc_28_1_matchtggpattern_black_nac_2BBB(z, c,
												x) == null) {
											if (pattern_decula2branchubc_28_1_matchtggpattern_black_nac_3B(y) == null) {
												if (pattern_decula2branchubc_28_1_matchtggpattern_black_nac_4BBB(y, c,
														x) == null) {
	...
	public static final Object[] pattern_decula2branchubc_29_6_perform_greenFBBFFFFFFFFB(Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		While a = SourcecodeFactory.eINSTANCE.createWhile();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Assignment l = SourcecodeFactory.eINSTANCE.createAssignment();
		...
		return new Object[] { a, c, d, a2x, l, z, b, y, x, b2y, l2z, ruleResult };
	}
