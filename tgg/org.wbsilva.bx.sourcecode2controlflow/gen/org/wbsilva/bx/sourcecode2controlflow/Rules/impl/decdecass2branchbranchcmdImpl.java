...
public class decdecass2branchbranchcmdImpl extends AbstractRuleImpl implements decdecass2branchbranchcmd {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_1_performtransformation_greenFFFFBBB(c, a, b);
		...
		Object[] result2_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_blackBBBBBB(y, x, b2y, a2x, a, b);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[b2y] = "
							+ b2y + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[b] = " + b + ".");
		}
		Object[] result2_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_greenFBBBBBB(y, x, b2y, a2x, a, b);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, y, x, b2y, d2c,
						a2x, c, a, b, d);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[b2y] = " + b2y + ", " + "[d2c] = " + d2c
					+ ", " + "[a2x] = " + a2x + ", " + "[c] = " + c + ", " + "[a] = " + a + ", " + "[b] = " + b + ", "
					+ "[d] = " + d + ".");
		}
		decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
				ruleresult, y, x, b2y, a2x, c, a, b, d);
		...
		decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, y, x, b2y, d2c, a2x, c, a, b, d);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_2_2_corematch_blackFFBBBB(a, b, d, match)) {
			S2B d2c = (S2B) result2_black[0];
			Branch c = (Branch) result2_black[1];
			// ForEach 
			for (Object[] result3_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_2_3_findcontext_blackBBBBB(d2c, c, a, b, d)) {
				Object[] result3_green = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_2_3_findcontext_greenBBBBBFFFFF(d2c, c, a, b, d);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2B d2c, Branch c, Decision a,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject y, EObject x, EObject b2y, EObject d2c,
			EObject a2x, EObject c, EObject a, EObject b, EObject d) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_1_performtransformation_greenBBFFFFB(y, x, d);
		S2N b2y = (S2N) result1_green[2];
		S2B a2x = (S2B) result1_green[3];
		...
		Object[] result2_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_blackBBBBBB(y, x, b2y, a2x, a, b);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[b2y] = "
							+ b2y + ", " + "[a2x] = " + a2x + ", " + "[a] = " + a + ", " + "[b] = " + b + ".");
		...
		Object[] result2_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_greenFBBBBBB(y, x, b2y, a2x, a, b);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, y, x, b2y, d2c,
						a2x, c, a, b, d);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[y] = " + y + ", " + "[x] = " + x + ", " + "[b2y] = " + b2y + ", " + "[d2c] = " + d2c
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_12_2_corematch_blackBBFBFB(y, x, c, match)) {
			S2B d2c = (S2B) result2_black[2];
			Decision d = (Decision) result2_black[4];
			// ForEach 
			for (Object[] result3_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_12_3_findcontext_blackBBBBB(y, x, d2c, c, d)) {
				Object[] result3_green = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_12_3_findcontext_greenBBBBBFFFFF(y, x, d2c, c, d);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge d2c__c____target = (EMoflonEdge) result3_green[6];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Command y, Branch x, S2B d2c, Branch c,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject y, EObject x, EObject b2y, EObject d2c,
			EObject a2x, EObject c, EObject a, EObject b, EObject d) {
		ruleresult.registerObject("y", y);
		ruleresult.registerObject("x", x);
		ruleresult.registerObject("b2y", b2y);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_38(EMoflonEdge _edge_negative) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_38(EMoflonEdge _edge_negative) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, y, x, c, a, b, d,
		...
		if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decdecass2branchbranchcmdImpl
				...
				Object[] result6_black = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_blackBBBBBBB(y, x, c, a, b, d,
								ccMatch);
				if (result6_black == null) {
				...
				decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_greenBBFFBBB(y, x, a, b, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Command y, Branch x, Branch c, Decision a, Assignment b, Decision d,
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
			...
			if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_29_6_perform_greenFFFFBFFBB(c, d,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2B_BRANCH_DECISION_ASSIGNMENT_DECISION:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMMAND_BRANCH_S2B_BRANCH_DECISION:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPROPRIATE_BWD_EMOFLON_EDGE_38__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_38((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPROPRIATE_FWD_EMOFLON_EDGE_38__EMOFLONEDGE:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_CC__COMMAND_BRANCH_BRANCH_DECISION_ASSIGNMENT_DECISION_MATCH_MATCH:
				...
				if (tmpA instanceof Decision) {
					...
					if (tmpB instanceof Assignment) {
						...
						if (tmpD instanceof Decision) {
							...
							return new Object[] { d2c, c, a, b, d, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_blackBBBBBFBB(S2B d2c,
			Branch c, Decision a, Assignment b, Decision d, decdecass2branchbranchcmd _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(d)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { d2c, c, a, b, d, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_black = pattern_decdecass2branchbranchcmd_1_1_performtransformation_blackBBBBBFBB(
					d2c, c, a, b, d, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_greenFFFFBBB(Branch c,
		...
		a2x.setTarget(x);
		a2x.setSource(a);
		return new Object[] { y, x, b2y, a2x, c, a, b };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_blackBBBBBB(Command y,
			Branch x, S2N b2y, S2B a2x, Decision a, Assignment b) {
		return new Object[] { y, x, b2y, a2x, a, b };
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_greenFBBBBBB(Command y,
		...
		return new Object[] { ruleresult, y, x, b2y, a2x, a, b };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject y, EObject x, EObject b2y, EObject d2c, EObject a2x, EObject c,
			EObject a, EObject b, EObject d) {
		if (!x.equals(y)) {
			if (!b2y.equals(y)) {
				if (!b2y.equals(x)) {
					if (!b2y.equals(d2c)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject y, EObject x, EObject b2y, EObject a2x, EObject c, EObject a,
			EObject b, EObject d) {
		...
		d__a____positive.setName(d__a____positive_name_prime);
		return new Object[] { ruleresult, y, x, b2y, a2x, c, a, b, d, b2y__y____target, a2x__x____target,
				c__y____negative, a2x__a____source, d__b____negative, b2y__b____source, c__x____positive,
				d__a____positive };
	}

	public static final void pattern_decdecass2branchbranchcmd_1_5_registerobjects_expressionBBBBBBBBBBB(
			decdecass2branchbranchcmd _this, PerformRuleResult ruleresult, EObject y, EObject x, EObject b2y,
			EObject d2c, EObject a2x, EObject c, EObject a, EObject b, EObject d) {
		_this.registerObjects_FWD(ruleresult, y, x, b2y, d2c, a2x, c, a, b, d);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_2_2_corematch_blackFFBBBB(Decision a,
		...
		if (!a.equals(d)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(d, S2B.class, "source")) {
				...
				if (c != null) {
					_result.add(new Object[] { d2c, c, a, b, d, match });
				}
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_2_3_findcontext_blackBBBBB(S2B d2c,
			Branch c, Decision a, Assignment b, Decision d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(d)) {
				...
				if (d.equals(d2c.getSource())) {
					if (b.equals(d.getNegative())) {
						if (a.equals(d.getPositive())) {
							_result.add(new Object[] { d2c, c, a, b, d });
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_2_3_findcontext_greenBBBBBFFFFF(S2B d2c, Branch c,
			Decision a, Assignment b, Decision d) {
		...
		d__b____negative.setName(d__b____negative_name_prime);
		d__a____positive.setName(d__a____positive_name_prime);
		return new Object[] { d2c, c, a, b, d, isApplicableMatch, d2c__c____target, d2c__d____source, d__b____negative,
				d__a____positive };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_2_4_solveCSP_bindingFBBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, S2B d2c, Branch c, Decision a,
			Assignment b, Decision d) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, d2c, c, a, b, d);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, c, a, b, d };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecass2branchbranchcmd_2_4_solveCSP_binding = pattern_decdecass2branchbranchcmd_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, d2c, c, a, b, d);
			...
			if (tmpX instanceof Branch) {
				...
				if (tmpD2c instanceof S2B) {
					...
					if (tmpC instanceof Branch) {
						...
						if (tmpD instanceof Decision) {
							Decision d = (Decision) tmpD;
							return new Object[] { y, x, d2c, c, d, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_blackBBBBBFBB(Command y,
			Branch x, S2B d2c, Branch c, Decision d, decdecass2branchbranchcmd _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(x)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { y, x, d2c, c, d, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_binding != null) {
			...
			Decision d = (Decision) result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_black = pattern_decdecass2branchbranchcmd_11_1_performtransformation_blackBBBBBFBB(
					y, x, d2c, c, d, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_greenBBFFFFB(Command y,
			Branch x, Decision d) {
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		...
		d.setNegative(b);
		b2y.setSource(b);
		return new Object[] { y, x, b2y, a2x, a, b, d };
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_greenFBBBBBB(
			Command y, Branch x, S2N b2y, S2B a2x, Decision a, Assignment b) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_decdecass2branchbranchcmd_11_5_registerobjects_expressionBBBBBBBBBBB(
			decdecass2branchbranchcmd _this, PerformRuleResult ruleresult, EObject y, EObject x, EObject b2y,
			EObject d2c, EObject a2x, EObject c, EObject a, EObject b, EObject d) {
		_this.registerObjects_BWD(ruleresult, y, x, b2y, d2c, a2x, c, a, b, d);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_12_2_corematch_blackBBFBFB(Command y,
		...
		if (!c.equals(x)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class, "target")) {
				...
				if (tmpD instanceof Decision) {
					Decision d = (Decision) tmpD;
					_result.add(new Object[] { y, x, d2c, c, d, match });
				}
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_12_3_findcontext_blackBBBBB(Command y,
			Branch x, S2B d2c, Branch c, Decision d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(x)) {
			if (c.equals(d2c.getTarget())) {
				if (y.equals(c.getNegative())) {
					if (d.equals(d2c.getSource())) {
						if (x.equals(c.getPositive())) {
							_result.add(new Object[] { y, x, d2c, c, d });
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_12_3_findcontext_greenBBBBBFFFFF(Command y, Branch x,
			S2B d2c, Branch c, Decision d) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge d2c__c____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__y____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d2c__d____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		d2c__d____source.setName(d2c__d____source_name_prime);
		c__x____positive.setName(c__x____positive_name_prime);
		return new Object[] { y, x, d2c, c, d, isApplicableMatch, d2c__c____target, c__y____negative, d2c__d____source,
				c__x____positive };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingFBBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, Command y, Branch x, S2B d2c,
			Branch c, Decision d) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, y, x, d2c, c, d);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, y, x, d2c, c, d };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecass2branchbranchcmd_12_4_solveCSP_binding = pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, y, x, d2c, c, d);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_0B(Command y) {
		for (Graph __DEC_y_root_164528 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_1BBB(Command y,
			Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_312596 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_y_positive_312596)) {
					if (!c.equals(__DEC_y_positive_312596)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_2BBB(Command y,
			Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_338287 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_y_negative_338287)) {
					if (!c.equals(__DEC_y_negative_338287)) {
						return new Object[] { y, x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_911538 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_4BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_298836 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_298836)) {
					if (!c.equals(__DEC_x_positive_298836)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_5BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_283192 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_283192)) {
					if (!c.equals(__DEC_x_negative_283192)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_0BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_102586 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_102586)) {
					if (!d.equals(__DEC_a_negative_102586)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_1B(Decision a) {
		for (While __DEC_a_first_521869 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_2B(Decision a) {
		for (While __DEC_a_last_822818 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_362553 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_4BBB(
		...
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_34037 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_34037)) {
					if (!d.equals(__DEC_b_positive_34037)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_5B(
			Assignment b) {
		for (While __DEC_b_first_397134 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_6B(
			Assignment b) {
		for (While __DEC_b_last_571033 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_7B(
			Assignment b) {
		for (Program __DEC_b_first_155172 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
				...
				if (tmpC instanceof Branch) {
					...
					if (tmpA instanceof Decision) {
						...
						if (tmpB instanceof Assignment) {
							...
							if (tmpD instanceof Decision) {
								Decision d = (Decision) tmpD;
								return new Object[] { y, x, c, a, b, d, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_blackBBBBBBBB(Command y,
			Branch x, Branch c, Decision a, Assignment b, Decision d, Match sourceMatch, Match targetMatch) {
		if (!c.equals(x)) {
			if (!a.equals(d)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { y, x, c, a, b, d, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding != null) {
			...
			Decision a = (Decision) result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_black = pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_blackBBBBBBBB(
					y, x, c, a, b, d, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingFBBBBBBBBB(
			decdecass2branchbranchcmd _this, Command y, Branch x, Branch c, Decision a, Assignment b, Decision d,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(y, x, c, a, b, d, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, y, x, c, a, b, d, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_decdecass2branchbranchcmd_24_3_solvecsp_binding = pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, y, x, c, a, b, d, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_blackBBBBBBB(Command y,
			Branch x, Branch c, Decision a, Assignment b, Decision d, CCMatch ccMatch) {
		if (!c.equals(x)) {
			if (!a.equals(d)) {
				return new Object[] { y, x, c, a, b, d, ccMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_greenBBFFBBB(Command y,
			Branch x, Decision a, Assignment b, CCMatch ccMatch) {
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		b2y.setTarget(y);
		b2y.setSource(b);
		...
		return new Object[] { y, x, b2y, a2x, a, b, ccMatch };
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_0BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_57081 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_57081)) {
					if (!d.equals(__DEC_a_negative_57081)) {
						return new Object[] { a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_1B(Decision a) {
		for (While __DEC_a_first_153060 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_2B(Decision a) {
		for (While __DEC_a_last_890435 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_917902 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_4BBB(Assignment b,
		...
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_2707 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_2707)) {
					if (!d.equals(__DEC_b_positive_2707)) {
						return new Object[] { b, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_5B(Assignment b) {
		for (While __DEC_b_first_791164 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_6B(Assignment b) {
		for (While __DEC_b_last_704340 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_7B(Assignment b) {
		for (Program __DEC_b_first_93966 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_0B(Command y) {
		for (Graph __DEC_y_root_79094 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_1BBB(Command y,
			Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_769040 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_y_positive_769040)) {
					if (!c.equals(__DEC_y_positive_769040)) {
						return new Object[] { y, x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_2BBB(Command y,
			Branch x, Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_693341 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_y_negative_693341)) {
					if (!c.equals(__DEC_y_negative_693341)) {
						return new Object[] { y, x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_627560 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_4BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_99769 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_99769)) {
					if (!c.equals(__DEC_x_positive_99769)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_5BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_498867 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_498867)) {
					if (!c.equals(__DEC_x_negative_498867)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_29_6_perform_greenFFFFBFFBB(Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		Command y = ControlflowFactory.eINSTANCE.createCommand();
		Branch x = ControlflowFactory.eINSTANCE.createBranch();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		...
		return new Object[] { y, x, b2y, a2x, c, a, b, d, ruleResult };
	}
