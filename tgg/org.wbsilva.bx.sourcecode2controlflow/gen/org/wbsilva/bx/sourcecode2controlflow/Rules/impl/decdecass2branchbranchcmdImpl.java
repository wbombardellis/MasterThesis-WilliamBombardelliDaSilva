...
public class decdecass2branchbranchcmdImpl extends AbstractRuleImpl implements decdecass2branchbranchcmd {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Decision a, Assignment b, Decision d) {

		Object[] result1_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_0_1_initialbindings_blackBBBBB(this, match, a, b, d);
		...
		Object[] result2_bindingAndBlack = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_0_2_SolveCSP_bindingAndBlackFBBBBB(this, match, a, b, d);
		...
		if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_0_4_collectelementstobetranslated_blackBBBB(match, a, b, d);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[a] = " + a + ", " + "[b] = " + b + ", " + "[d] = " + d + ".");
			}
			decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_0_4_collectelementstobetranslated_greenBBBBFF(match, a, b, d);
			...
			Object[] result5_black = decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_0_5_collectcontextelements_blackBBBB(match, a, b, d);
			...
			// 
			decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_0_6_registerobjectstomatch_expressionBBBBB(this, match, a, b, d);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_1_performtransformation_greenBFBFFBF(a, b, c);
		...
		Object[] result2_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_blackBBBBBB(a, a2x, b, y, b2y, x);
		...
		Object[] result2_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_greenFBBBBBB(a, a2x, b, y, b2y, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, a, d2c, a2x, b,
						y, d, b2y, c, x);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a] = " + a + ", " + "[d2c] = " + d2c + ", " + "[a2x] = " + a2x + ", " + "[b] = " + b
					+ ", " + "[y] = " + y + ", " + "[d] = " + d + ", " + "[b2y] = " + b2y + ", " + "[c] = " + c + ", "
					+ "[x] = " + x + ".");
		}
		decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
				ruleresult, a, a2x, b, y, d, b2y, c, x);
		...
		decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, a, d2c, a2x, b, y, d, b2y, c, x);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_2_2_corematch_blackBFBBFB(a, b, d, match)) {
			S2B d2c = (S2B) result2_black[1];
			Branch c = (Branch) result2_black[4];
			// ForEach 
			for (Object[] result3_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_2_3_findcontext_blackBBBBB(a, d2c, b, d, c)) {
				Object[] result3_green = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_2_3_findcontext_greenBBBBBFFFFF(a, d2c, b, d, c);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Decision a, Assignment b, Decision d) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Decision a, Assignment b, Decision d) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Decision a, S2B d2c, Assignment b,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject a, EObject d2c, EObject a2x, EObject b,
			EObject y, EObject d, EObject b2y, EObject c, EObject x) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_1_performtransformation_greenFFFBBFB(y, d, x);
		...
		Object[] result2_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_blackBBBBBB(a, a2x, b, y, b2y, x);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[a2x] = " + a2x + ", "
							+ "[b] = " + b + ", " + "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[x] = " + x + ".");
		...
		Object[] result2_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_greenFBBBBBB(a, a2x, b, y, b2y, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, a, d2c, a2x, b,
						y, d, b2y, c, x);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a] = " + a + ", " + "[d2c] = " + d2c + ", " + "[a2x] = " + a2x + ", " + "[b] = " + b
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_12_2_corematch_blackFBFBBB(y, c, x, match)) {
			S2B d2c = (S2B) result2_black[0];
			Decision d = (Decision) result2_black[2];
			// ForEach 
			for (Object[] result3_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_12_3_findcontext_blackBBBBB(d2c, y, d, c, x)) {
				Object[] result3_green = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_12_3_findcontext_greenBBBBBFFFFF(d2c, y, d, c, x);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject a, EObject d2c, EObject a2x, EObject b,
			EObject y, EObject d, EObject b2y, EObject c, EObject x) {
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("d2c", d2c);
		ruleresult.registerObject("a2x", a2x);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_266(EMoflonEdge _edge_positive) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_274(EMoflonEdge _edge_positive) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, a, b, y, d, c, x,
		...
		if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_24_5_matchcorrcontext_blackFBBBB(d, c, sourceMatch,
							targetMatch)) {
				...
				Object[] result6_black = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_blackBBBBBBB(a, b, y, d, c, x,
								ccMatch);
				if (result6_black == null) {
				...
				decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_greenBFBBFBB(a, b, y, x, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Decision a, Assignment b, Command y, Decision d, Branch c, Branch x,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Decision a, Assignment b, Decision d) {// 
		Object[] result1_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_blackBBB(a, b, d);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, S2B d2cParameter) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
			...
			if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_29_5_checknacs_blackBBB(d2c, d, c);
				if (result5_black != null) {

					Object[] result6_black = decdecass2branchbranchcmdImpl
							.pattern_decdecass2branchbranchcmd_29_6_perform_blackBBBB(d2c, d, c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[d2c] = " + d2c + ", "
								+ "[d] = " + d + ", " + "[c] = " + c + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_29_6_perform_greenFFFFBFBFB(d, c,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_DECISION_S2B_ASSIGNMENT_DECISION_BRANCH:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_COMMAND_DECISION_BRANCH_BRANCH:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPROPRIATE_BWD_EMOFLON_EDGE_266__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_266((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPROPRIATE_FWD_EMOFLON_EDGE_274__EMOFLONEDGE:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_CC__DECISION_ASSIGNMENT_COMMAND_DECISION_BRANCH_BRANCH_MATCH_MATCH:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_DECISION_BRANCH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_0_1_initialbindings_blackBBBBB(
			decdecass2branchbranchcmd _this, Match match, Decision a, Assignment b, Decision d) {
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_0_4_collectelementstobetranslated_blackBBBB(
			Match match, Decision a, Assignment b, Decision d) {
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_0_5_collectcontextelements_blackBBBB(Match match,
			Decision a, Assignment b, Decision d) {
		if (!a.equals(d)) {
			return new Object[] { match, a, b, d };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_blackBBBBBFBB(Decision a,
			S2B d2c, Assignment b, Decision d, Branch c, decdecass2branchbranchcmd _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding != null) {
			...
			S2B d2c = (S2B) result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding[1];
			Assignment b = (Assignment) result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding[2];
			Decision d = (Decision) result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding[3];
			Branch c = (Branch) result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_greenBFBFFBF(Decision a,
		...
		c.setPositive(x);
		a2x.setTarget(x);
		return new Object[] { a, a2x, b, y, b2y, c, x };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_blackBBBBBB(Decision a,
			S2B a2x, Assignment b, Command y, S2N b2y, Branch x) {
		return new Object[] { a, a2x, b, y, b2y, x };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_greenFBBBBBB(
			Decision a, S2B a2x, Assignment b, Command y, S2N b2y, Branch x) {
		...
		return new Object[] { ruleresult, a, a2x, b, y, b2y, x };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject a, EObject d2c, EObject a2x, EObject b, EObject y, EObject d,
			EObject b2y, EObject c, EObject x) {
		if (!a.equals(d2c)) {
			if (!a.equals(a2x)) {
				if (!a.equals(b)) {
					if (!a.equals(y)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject a, EObject a2x, EObject b, EObject y, EObject d, EObject b2y,
			EObject c, EObject x) {
		...
		return new Object[] { ruleresult, a, a2x, b, y, d, b2y, c, x, a2x__a____source, d__a____positive,
				d__b____negative, b2y__y____target, b2y__b____source, c__x____positive, a2x__x____target,
				c__y____negative };
	}

	public static final void pattern_decdecass2branchbranchcmd_1_5_registerobjects_expressionBBBBBBBBBBB(
			decdecass2branchbranchcmd _this, PerformRuleResult ruleresult, EObject a, EObject d2c, EObject a2x,
			EObject b, EObject y, EObject d, EObject b2y, EObject c, EObject x) {
		_this.registerObjects_FWD(ruleresult, a, d2c, a2x, b, y, d, b2y, c, x);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_2_2_corematch_blackBFBBFB(Decision a,
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_2_3_findcontext_blackBBBBB(Decision a,
			S2B d2c, Assignment b, Decision d, Branch c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_2_3_findcontext_greenBBBBBFFFFF(Decision a, S2B d2c,
			Assignment b, Decision d, Branch c) {
		...
		return new Object[] { a, d2c, b, d, c, isApplicableMatch, d__a____positive, d2c__d____source, d__b____negative,
				d2c__c____target };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_2_4_solveCSP_bindingFBBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, Decision a, S2B d2c, Assignment b,
			Decision d, Branch c) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_blackBBBBBFBB(S2B d2c,
			Command y, Decision d, Branch c, Branch x, decdecass2branchbranchcmd _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(x)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_binding != null) {
			...
			Command y = (Command) result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_binding[1];
			Decision d = (Decision) result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_binding[2];
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_greenFFFBBFB(Command y,
			Decision d, Branch x) {
		...
		b2y.setTarget(y);
		b2y.setSource(b);
		return new Object[] { a, a2x, b, y, d, b2y, x };
	}
	...
	public static final void pattern_decdecass2branchbranchcmd_11_5_registerobjects_expressionBBBBBBBBBBB(
			decdecass2branchbranchcmd _this, PerformRuleResult ruleresult, EObject a, EObject d2c, EObject a2x,
			EObject b, EObject y, EObject d, EObject b2y, EObject c, EObject x) {
		_this.registerObjects_BWD(ruleresult, a, d2c, a2x, b, y, d, b2y, c, x);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_12_2_corematch_blackFBFBBB(Command y,
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_12_3_findcontext_blackBBBBB(S2B d2c,
			Command y, Decision d, Branch c, Branch x) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(x)) {
			if (d.equals(d2c.getSource())) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_12_3_findcontext_greenBBBBBFFFFF(S2B d2c, Command y,
			Decision d, Branch c, Branch x) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge d2c__d____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__y____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		c__y____negative.setName(c__y____negative_name_prime);
		d2c__c____target.setName(d2c__c____target_name_prime);
		return new Object[] { d2c, y, d, c, x, isApplicableMatch, d2c__d____source, c__x____positive, c__y____negative,
				d2c__c____target };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingFBBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, S2B d2c, Command y, Decision d,
			Branch c, Branch x) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_0B(Command y) {
		for (Graph __DEC_y_root_307460 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_1BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_507875 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_507875)) {
					if (!x.equals(__DEC_y_positive_507875)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_2BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_810419 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_810419)) {
					if (!x.equals(__DEC_y_negative_810419)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_682418 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_4BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_985475 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_985475)) {
					if (!c.equals(__DEC_x_positive_985475)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_5BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_130614 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_130614)) {
					if (!c.equals(__DEC_x_negative_130614)) {
						return new Object[] { x, c };
					}
				}
			}
			...
			if (tmpX instanceof Branch) {
				...
				if (!c.equals(x)) {
					if (x.equals(c.getPositive())) {
						...
						if (tmpY instanceof Command) {
							Command y = (Command) tmpY;
							if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_3B(x) == null) {
								if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_4BB(x,
										c) == null) {
									if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_5BB(x,
											c) == null) {
										if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_9BB(c,
												x) == null) {
											if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_0B(
													y) == null) {
												if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_1BBB(
														y, c, x) == null) {
														...
														if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_6BB(
															...
															if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_7BB(
																...
																if (pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_8BB(
																		x, y) == null) {
																	_result.add(
																			new Object[] { y, c, x, _edge_positive });
																}
															}
														}
													}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_0BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_563821 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_563821)) {
					if (!d.equals(__DEC_a_negative_563821)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_1B(Decision a) {
		for (While __DEC_a_first_685969 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_2B(Decision a) {
		for (While __DEC_a_last_51942 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_132654 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_4BBB(
		...
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_138310 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_138310)) {
					if (!d.equals(__DEC_b_positive_138310)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_5B(
			Assignment b) {
		for (While __DEC_b_first_343913 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_6B(
			Assignment b) {
		for (While __DEC_b_last_433700 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_7B(
			Assignment b) {
		for (Program __DEC_b_first_448335 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
			...
			if (tmpA instanceof Decision) {
				...
				if (!a.equals(d)) {
					if (a.equals(d.getPositive())) {
						...
						if (tmpB instanceof Assignment) {
							Assignment b = (Assignment) tmpB;
							if (pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_0BB(a,
									d) == null) {
				...
				if (tmpY instanceof Command) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpC instanceof Branch) {
							...
							if (tmpX instanceof Branch) {
								Branch x = (Branch) tmpX;
								return new Object[] { a, b, y, d, c, x, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_blackBBBBBBBB(Decision a,
			Assignment b, Command y, Decision d, Branch c, Branch x, Match sourceMatch, Match targetMatch) {
		if (!a.equals(d)) {
			if (!c.equals(x)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding != null) {
			Decision a = (Decision) result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding[0];
			...
			Branch c = (Branch) result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding[4];
			Branch x = (Branch) result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_black = pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_blackBBBBBBBB(
					a, b, y, d, c, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingFBBBBBBBBB(
			decdecass2branchbranchcmd _this, Decision a, Assignment b, Command y, Decision d, Branch c, Branch x,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(a, b, y, d, c, x, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, a, b, y, d, c, x, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_decdecass2branchbranchcmd_24_3_solvecsp_binding = pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, a, b, y, d, c, x, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_24_5_matchcorrcontext_blackFBBBB(
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_blackBBBBBBB(Decision a,
			Assignment b, Command y, Decision d, Branch c, Branch x, CCMatch ccMatch) {
		if (!a.equals(d)) {
			if (!c.equals(x)) {
				return new Object[] { a, b, y, d, c, x, ccMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_greenBFBBFBB(Decision a,
			Assignment b, Command y, Branch x, CCMatch ccMatch) {
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		S2N b2y = Sourcecode2controlflowFactory.eINSTANCE.createS2N();
		a2x.setSource(a);
		a2x.setTarget(x);
		...
		return new Object[] { a, a2x, b, y, b2y, x, ccMatch };
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_0BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_663371 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(a, Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_663371)) {
					if (!d.equals(__DEC_a_negative_663371)) {
						return new Object[] { a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_1B(Decision a) {
		for (While __DEC_a_first_493274 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_2B(Decision a) {
		for (While __DEC_a_last_494739 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_912678 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_4BBB(Assignment b,
		...
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_537065 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_537065)) {
					if (!d.equals(__DEC_b_positive_537065)) {
						return new Object[] { b, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_5B(Assignment b) {
		for (While __DEC_b_first_847882 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_6B(Assignment b) {
		for (While __DEC_b_last_580710 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_7B(Assignment b) {
		for (Program __DEC_b_first_125659 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_blackBBB(Decision a,
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_0B(Command y) {
		for (Graph __DEC_y_root_748554 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_1BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_393045 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_393045)) {
					if (!x.equals(__DEC_y_positive_393045)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_2BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_35237 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_35237)) {
					if (!x.equals(__DEC_y_negative_35237)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_596783 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_4BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_317282 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_317282)) {
					if (!c.equals(__DEC_x_positive_317282)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_5BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_488705 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_488705)) {
					if (!c.equals(__DEC_x_negative_488705)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_29_3_solveCSP_bindingFBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, S2B d2c, Decision d, Branch c,
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_29_5_checknacs_blackBBB(S2B d2c, Decision d,
			Branch c) {
		return new Object[] { d2c, d, c };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_29_6_perform_blackBBBB(S2B d2c, Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { d2c, d, c, ruleResult };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_29_6_perform_greenFFFFBFBFB(Decision d, Branch c,
			ModelgeneratorRuleResult ruleResult) {
		Decision a = SourcecodeFactory.eINSTANCE.createDecision();
		S2B a2x = Sourcecode2controlflowFactory.eINSTANCE.createS2B();
		Assignment b = SourcecodeFactory.eINSTANCE.createAssignment();
		...
		return new Object[] { a, a2x, b, y, d, b2y, c, x, ruleResult };
	}
