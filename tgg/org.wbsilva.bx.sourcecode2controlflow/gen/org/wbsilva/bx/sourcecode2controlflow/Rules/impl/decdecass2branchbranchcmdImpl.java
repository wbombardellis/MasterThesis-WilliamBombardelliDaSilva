...
public class decdecass2branchbranchcmdImpl extends AbstractRuleImpl implements decdecass2branchbranchcmd {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_1_performtransformation_greenBBBFFFF(a, b, c);
		...
		Object[] result2_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_blackBBBBBB(a, b, y, b2y, a2x, x);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[b] = " + b + ", " + "[y] = "
							+ y + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ".");
		}
		Object[] result2_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_greenFBBBBBB(a, b, y, b2y, a2x, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, d2c, a, b, c, y,
						b2y, a2x, d, x);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[d2c] = " + d2c + ", " + "[a] = " + a + ", " + "[b] = " + b + ", " + "[c] = " + c + ", "
					+ "[y] = " + y + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x + ", " + "[d] = " + d + ", "
					+ "[x] = " + x + ".");
		}
		decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
				ruleresult, a, b, c, y, b2y, a2x, d, x);
		...
		decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, d2c, a, b, c, y, b2y, a2x, d, x);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_2_2_corematch_blackFBBFBB(a, b, d, match)) {
			S2B d2c = (S2B) result2_black[0];
			Branch c = (Branch) result2_black[3];
			// ForEach 
			for (Object[] result3_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_2_3_findcontext_blackBBBBB(d2c, a, b, c, d)) {
				Object[] result3_green = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_2_3_findcontext_greenBBBBBFFFFF(d2c, a, b, c, d);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, S2B d2c, Decision a, Assignment b,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b, EObject c,
			EObject y, EObject b2y, EObject a2x, EObject d, EObject x) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_1_performtransformation_greenFFBFFBB(y, d, x);
		...
		Object[] result2_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_blackBBBBBB(a, b, y, b2y, a2x, x);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[a] = " + a + ", " + "[b] = " + b + ", " + "[y] = "
							+ y + ", " + "[b2y] = " + b2y + ", " + "[a2x] = " + a2x + ", " + "[x] = " + x + ".");
		...
		Object[] result2_green = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_2_collecttranslatedelements_greenFBBBBBB(a, b, y, b2y, a2x, x);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, d2c, a, b, c, y,
						b2y, a2x, d, x);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[d2c] = " + d2c + ", " + "[a] = " + a + ", " + "[b] = " + b + ", " + "[c] = " + c + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
			...
			// ForEach 
			for (Object[] result3_black : decdecass2branchbranchcmdImpl
					.pattern_decdecass2branchbranchcmd_12_3_findcontext_blackBBBBB(d2c, c, y, d, x)) {
				Object[] result3_green = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_12_3_findcontext_greenBBBBBFFFFF(d2c, c, y, d, x);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, S2B d2c, Branch c, Command y, Decision d,
			Branch x) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b, EObject c,
			EObject y, EObject b2y, EObject a2x, EObject d, EObject x) {
		ruleresult.registerObject("d2c", d2c);
		ruleresult.registerObject("a", a);
		ruleresult.registerObject("b", b);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_66(EMoflonEdge _edge_negative) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_66(EMoflonEdge _edge_negative) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = decdecass2branchbranchcmdImpl
				.pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, a, b, c, y, d, x,
		...
		if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : decdecass2branchbranchcmdImpl
				...
				Object[] result6_black = decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_blackBBBBBBB(a, b, c, y, d, x,
								ccMatch);
				if (result6_black == null) {
				...
				decdecass2branchbranchcmdImpl
						.pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_greenBBBFFBB(a, b, y, x, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Decision a, Assignment b, Branch c, Command y, Decision d, Branch x,
		...
		for (Object[] result2_black : decdecass2branchbranchcmdImpl
			...
			if (decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					decdecass2branchbranchcmdImpl.pattern_decdecass2branchbranchcmd_29_6_perform_greenFFBFFFBFB(c, d,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_S2B_DECISION_ASSIGNMENT_BRANCH_DECISION:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_S2B_BRANCH_COMMAND_DECISION_BRANCH:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPROPRIATE_BWD_EMOFLON_EDGE_66__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_66((EMoflonEdge) arguments.get(0));
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPROPRIATE_FWD_EMOFLON_EDGE_66__EMOFLONEDGE:
		...
		case RulesPackage.DECDECASS2BRANCHBRANCHCMD___IS_APPLICABLE_SOLVE_CSP_CC__DECISION_ASSIGNMENT_BRANCH_COMMAND_DECISION_BRANCH_MATCH_MATCH:
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_blackBBBBBFBB(S2B d2c,
			Decision a, Assignment b, Branch c, Decision d, decdecass2branchbranchcmd _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding != null) {
			...
			Decision a = (Decision) result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding[1];
			...
			Decision d = (Decision) result_pattern_decdecass2branchbranchcmd_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_1_performtransformation_greenBBBFFFF(Decision a,
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, a, b, y, b2y, a2x, x };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b, EObject c, EObject y, EObject b2y,
			EObject a2x, EObject d, EObject x) {
		if (!d2c.equals(y)) {
			if (!d2c.equals(x)) {
				if (!a.equals(d2c)) {
					if (!a.equals(b)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject a, EObject b, EObject c, EObject y, EObject b2y, EObject a2x,
			EObject d, EObject x) {
		...
		d__a____positive.setName(d__a____positive_name_prime);
		return new Object[] { ruleresult, a, b, c, y, b2y, a2x, d, x, c__y____negative, c__x____positive,
				b2y__y____target, b2y__b____source, a2x__a____source, d__b____negative, a2x__x____target,
				d__a____positive };
	}

	public static final void pattern_decdecass2branchbranchcmd_1_5_registerobjects_expressionBBBBBBBBBBB(
			decdecass2branchbranchcmd _this, PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b, EObject c,
			EObject y, EObject b2y, EObject a2x, EObject d, EObject x) {
		_this.registerObjects_FWD(ruleresult, d2c, a, b, c, y, b2y, a2x, d, x);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_2_2_corematch_blackFBBFBB(Decision a,
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_2_3_findcontext_blackBBBBB(S2B d2c,
			Decision a, Assignment b, Branch c, Decision d) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!a.equals(d)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_2_3_findcontext_greenBBBBBFFFFF(S2B d2c, Decision a,
			Assignment b, Branch c, Decision d) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_2_4_solveCSP_bindingFBBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, S2B d2c, Decision a, Assignment b,
			Branch c, Decision d) {
				...
				if (tmpY instanceof Command) {
					...
					if (tmpD instanceof Decision) {
						...
						if (tmpX instanceof Branch) {
							...
							return new Object[] { d2c, c, y, d, x, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_blackBBBBBFBB(S2B d2c,
			Branch c, Command y, Decision d, Branch x, decdecass2branchbranchcmd _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(x)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { d2c, c, y, d, x, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_decdecass2branchbranchcmd_11_1_performtransformation_black = pattern_decdecass2branchbranchcmd_11_1_performtransformation_blackBBBBBFBB(
					d2c, c, y, d, x, _this, isApplicableMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_11_1_performtransformation_greenFFBFFBB(Command y,
			Decision d, Branch x) {
		...
		a2x.setSource(a);
		a2x.setTarget(x);
		return new Object[] { a, b, y, b2y, a2x, d, x };
	}
	...
	public static final void pattern_decdecass2branchbranchcmd_11_5_registerobjects_expressionBBBBBBBBBBB(
			decdecass2branchbranchcmd _this, PerformRuleResult ruleresult, EObject d2c, EObject a, EObject b, EObject c,
			EObject y, EObject b2y, EObject a2x, EObject d, EObject x) {
		_this.registerObjects_BWD(ruleresult, d2c, a, b, c, y, b2y, a2x, d, x);
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_12_2_corematch_blackFBBFBB(Branch c,
		...
		if (!c.equals(x)) {
			for (S2B d2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c, S2B.class, "target")) {
				...
				if (tmpD instanceof Decision) {
					Decision d = (Decision) tmpD;
					_result.add(new Object[] { d2c, c, y, d, x, match });
				}
	...
	public static final Iterable<Object[]> pattern_decdecass2branchbranchcmd_12_3_findcontext_blackBBBBB(S2B d2c,
			Branch c, Command y, Decision d, Branch x) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(x)) {
			if (y.equals(c.getNegative())) {
				if (c.equals(d2c.getTarget())) {
					if (x.equals(c.getPositive())) {
						if (d.equals(d2c.getSource())) {
							_result.add(new Object[] { d2c, c, y, d, x });
						}
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_12_3_findcontext_greenBBBBBFFFFF(S2B d2c, Branch c,
			Command y, Decision d, Branch x) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge c__y____negative = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge d2c__c____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge c__x____positive = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		c__x____positive.setName(c__x____positive_name_prime);
		d2c__d____source.setName(d2c__d____source_name_prime);
		return new Object[] { d2c, c, y, d, x, isApplicableMatch, c__y____negative, d2c__c____target, c__x____positive,
				d2c__d____source };
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingFBBBBBBB(
			decdecass2branchbranchcmd _this, IsApplicableMatch isApplicableMatch, S2B d2c, Branch c, Command y,
			Decision d, Branch x) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, d2c, c, y, d, x);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, d2c, c, y, d, x };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_decdecass2branchbranchcmd_12_4_solveCSP_binding = pattern_decdecass2branchbranchcmd_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, d2c, c, y, d, x);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_0B(Command y) {
		for (Graph __DEC_y_root_111316 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_1BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_830668 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_830668)) {
					if (!x.equals(__DEC_y_positive_830668)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_2BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_338840 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_338840)) {
					if (!x.equals(__DEC_y_negative_338840)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_764867 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_4BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_782222 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_782222)) {
					if (!c.equals(__DEC_x_positive_782222)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_20_2_testcorematchandDECs_black_nac_5BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_128594 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_128594)) {
					if (!c.equals(__DEC_x_negative_128594)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_0BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_49750 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_49750)) {
					if (!d.equals(__DEC_a_negative_49750)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_1B(Decision a) {
		for (While __DEC_a_first_378912 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_2B(Decision a) {
		for (While __DEC_a_last_456395 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_893841 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_4BBB(
		...
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_22484 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
					Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_22484)) {
					if (!d.equals(__DEC_b_positive_22484)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_5B(
			Assignment b) {
		for (While __DEC_b_first_453356 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_6B(
			Assignment b) {
		for (While __DEC_b_last_686189 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_21_2_testcorematchandDECs_black_nac_7B(
			Assignment b) {
		for (Program __DEC_b_first_647885 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
				...
				if (tmpC instanceof Branch) {
					...
					if (tmpY instanceof Command) {
						...
						if (tmpD instanceof Decision) {
							...
							if (tmpX instanceof Branch) {
								Branch x = (Branch) tmpX;
								return new Object[] { a, b, c, y, d, x, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_blackBBBBBBBB(Decision a,
			Assignment b, Branch c, Command y, Decision d, Branch x, Match sourceMatch, Match targetMatch) {
		if (!a.equals(d)) {
			if (!c.equals(x)) {
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding != null) {
			...
			Command y = (Command) result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding[3];
			Decision d = (Decision) result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_black = pattern_decdecass2branchbranchcmd_24_2_matchsrctrgcontext_blackBBBBBBBB(
					a, b, c, y, d, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingFBBBBBBBBB(
			decdecass2branchbranchcmd _this, Decision a, Assignment b, Branch c, Command y, Decision d, Branch x,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(a, b, c, y, d, x, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, a, b, c, y, d, x, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_decdecass2branchbranchcmd_24_3_solvecsp_binding = pattern_decdecass2branchbranchcmd_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, a, b, c, y, d, x, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_blackBBBBBBB(Decision a,
			Assignment b, Branch c, Command y, Decision d, Branch x, CCMatch ccMatch) {
		if (!a.equals(d)) {
			if (!c.equals(x)) {
				return new Object[] { a, b, c, y, d, x, ccMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_decdecass2branchbranchcmd_24_6_createcorrespondence_greenBBBFFBB(Decision a,
		...
		return new Object[] { a, b, y, b2y, a2x, x, ccMatch };
	}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_0BB(Decision a,
			Decision d) {
		if (!a.equals(d)) {
			for (Decision __DEC_a_negative_24765 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
					Decision.class, "negative")) {
				if (!a.equals(__DEC_a_negative_24765)) {
					if (!d.equals(__DEC_a_negative_24765)) {
						return new Object[] { a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_1B(Decision a) {
		for (While __DEC_a_first_870870 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_2B(Decision a) {
		for (While __DEC_a_last_662547 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				While.class, "last")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_3B(Decision a) {
		for (Program __DEC_a_first_179710 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(a,
				Program.class, "first")) {
			return new Object[] { a };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_4BBB(Assignment b,
		...
		if (!a.equals(d)) {
			for (Decision __DEC_b_positive_840834 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(b, Decision.class, "positive")) {
				if (!a.equals(__DEC_b_positive_840834)) {
					if (!d.equals(__DEC_b_positive_840834)) {
						return new Object[] { b, a, d };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_5B(Assignment b) {
		for (While __DEC_b_first_49038 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_6B(Assignment b) {
		for (While __DEC_b_last_547738 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				While.class, "last")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_27_1_matchtggpattern_black_nac_7B(Assignment b) {
		for (Program __DEC_b_first_860522 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(b,
				Program.class, "first")) {
			return new Object[] { b };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_0B(Command y) {
		for (Graph __DEC_y_root_864708 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
				Graph.class, "root")) {
			return new Object[] { y };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_1BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_positive_429473 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "positive")) {
				if (!c.equals(__DEC_y_positive_429473)) {
					if (!x.equals(__DEC_y_positive_429473)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_2BBB(Command y,
			Branch c, Branch x) {
		if (!c.equals(x)) {
			for (Branch __DEC_y_negative_929024 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(y,
					Branch.class, "negative")) {
				if (!c.equals(__DEC_y_negative_929024)) {
					if (!x.equals(__DEC_y_negative_929024)) {
						return new Object[] { y, c, x };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_3B(Branch x) {
		for (Graph __DEC_x_root_167333 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
				Graph.class, "root")) {
			return new Object[] { x };
		}
		return null;
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_4BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_positive_415701 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "positive")) {
				if (!x.equals(__DEC_x_positive_415701)) {
					if (!c.equals(__DEC_x_positive_415701)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_28_1_matchtggpattern_black_nac_5BB(Branch x,
			Branch c) {
		if (!c.equals(x)) {
			for (Branch __DEC_x_negative_534185 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(x,
					Branch.class, "negative")) {
				if (!x.equals(__DEC_x_negative_534185)) {
					if (!c.equals(__DEC_x_negative_534185)) {
						return new Object[] { x, c };
					}
				}
			}
	...
	public static final Object[] pattern_decdecass2branchbranchcmd_29_6_perform_greenFFBFFFBFB(Branch c, Decision d,
			ModelgeneratorRuleResult ruleResult) {
		Decision a = SourcecodeFactory.eINSTANCE.createDecision();
		Assignment b = SourcecodeFactory.eINSTANCE.createAssignment();
		Command y = ControlflowFactory.eINSTANCE.createCommand();
		...
		return new Object[] { a, b, c, y, b2y, a2x, d, x, ruleResult };
	}
