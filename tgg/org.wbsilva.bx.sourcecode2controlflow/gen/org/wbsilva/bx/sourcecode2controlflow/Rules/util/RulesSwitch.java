...
public class RulesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RulesPackage.NEXTD2NEXTB: {
			nextd2nextb nextd2nextb = (nextd2nextb) theEObject;
			T result = casenextd2nextb(nextd2nextb);
			if (result == null)
				result = caseAbstractRule(nextd2nextb);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>nextd2nextb</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>nextd2nextb</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casenextd2nextb(nextd2nextb object) {
		return null;
	}
