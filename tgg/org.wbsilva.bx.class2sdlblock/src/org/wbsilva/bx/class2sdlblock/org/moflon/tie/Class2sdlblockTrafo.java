...
public class Class2sdlblockTrafo extends SynchronizationHelper{

   public Class2sdlblockTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        Class2sdlblockTrafo helper = new Class2sdlblockTrafo();
		helper.performForward("instances/fwd.src.xmi");

		// Backward Transformation
		helper = new Class2sdlblockTrafo();
