...
public class Class2sdlblockModelGen extends SynchronizationHelper{

   public Class2sdlblockModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(Class2sdlblockPackage.eINSTANCE, controller);
		gen.generate();
	}
}