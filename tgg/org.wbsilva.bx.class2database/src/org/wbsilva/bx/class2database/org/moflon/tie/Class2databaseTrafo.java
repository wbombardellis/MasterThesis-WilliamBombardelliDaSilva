...
public class Class2databaseTrafo extends SynchronizationHelper{

   public Class2databaseTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        Class2databaseTrafo helper = new Class2databaseTrafo();
		helper.performForward("instances/fwd.src.xmi");

		// Backward Transformation
		helper = new Class2databaseTrafo();
