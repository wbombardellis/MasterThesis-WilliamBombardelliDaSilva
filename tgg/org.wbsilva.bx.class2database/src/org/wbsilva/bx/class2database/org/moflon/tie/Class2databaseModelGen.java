...
public class Class2databaseModelGen extends SynchronizationHelper{

   public Class2databaseModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(Class2databasePackage.eINSTANCE, controller);
		gen.generate();
	}
}