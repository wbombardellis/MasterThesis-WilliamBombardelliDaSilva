...
public class super2tableImpl extends AbstractRuleImpl implements super2table {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Clazz c, Clazz p, ClassDiagram cd) {

		Object[] result1_black = super2tableImpl.pattern_super2table_0_1_initialbindings_blackBBBBB(this, match, c, p,
				cd);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[c] = " + c + ", " + "[p] = " + p + ", " + "[cd] = " + cd + ".");
		}
		...
		if (super2tableImpl.pattern_super2table_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = super2tableImpl
					.pattern_super2table_0_4_collectelementstobetranslated_blackBBBB(match, c, p, cd);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[c] = " + c + ", " + "[p] = " + p + ", " + "[cd] = " + cd + ".");
			}
			super2tableImpl.pattern_super2table_0_4_collectelementstobetranslated_greenBBBBFF(match, c, p, cd);
			...
			Object[] result5_black = super2tableImpl.pattern_super2table_0_5_collectcontextelements_blackBBBB(match, c,
					p, cd);
			...
			// 
			super2tableImpl.pattern_super2table_0_6_registerobjectstomatch_expressionBBBBB(this, match, c, p, cd);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = super2tableImpl.pattern_super2table_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
				t, p2t, c, p, cd, c2t, cd2db, db);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[t] = " + t
							+ ", " + "[p2t] = " + p2t + ", " + "[c] = " + c + ", " + "[p] = " + p + ", " + "[cd] = "
							+ cd + ", " + "[c2t] = " + c2t + ", " + "[cd2db] = " + cd2db + ", " + "[db] = " + db + ".");
		}
		super2tableImpl.pattern_super2table_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, t, c, p, cd, c2t);
		...
		// 
		// 
		super2tableImpl.pattern_super2table_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult, t, p2t, c, p, cd,
				c2t, cd2db, db);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Clazz p = (Clazz) result2_binding[1];
		ClassDiagram cd = (ClassDiagram) result2_binding[2];
		for (Object[] result2_black : super2tableImpl.pattern_super2table_2_2_corematch_blackFFBBBFFB(c, p, cd,
				match)) {
			...
			// ForEach 
			for (Object[] result3_black : super2tableImpl.pattern_super2table_2_3_findcontext_blackBBBBBBB(t, p2t, c, p,
					cd, cd2db, db)) {
				...
				//nothing EMoflonEdge cd__p____classes = (EMoflonEdge) result3_green[11];
				...
				//nothing EMoflonEdge cd2db__db____target = (EMoflonEdge) result3_green[15];

				Object[] result4_bindingAndBlack = super2tableImpl
						.pattern_super2table_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, t, p2t, c,
								p, cd, cd2db, db);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Clazz c, Clazz p, ClassDiagram cd) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Clazz c, Clazz p, ClassDiagram cd) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Table t, C2T p2t, Clazz c, Clazz p,
			ClassDiagram cd, CD2D cd2db, DB db) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject t, EObject p2t, EObject c, EObject p,
			EObject cd, EObject c2t, EObject cd2db, EObject db) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_Table_0(Table t) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1(EMoflonEdge _edge_super) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = super2tableImpl.pattern_super2table_21_3_solvecsp_bindingAndBlackFBBBBBBBB(
				this, t, c, p, cd, db, sourceMatch, targetMatch);
		...
		if (super2tableImpl.pattern_super2table_21_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : super2tableImpl.pattern_super2table_21_5_matchcorrcontext_blackBFBBFBBB(t, p,
				...
				Object[] result6_black = super2tableImpl.pattern_super2table_21_6_createcorrespondence_blackBBBBBB(t, c,
						p, cd, db, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Table t, Clazz c, Clazz p, ClassDiagram cd, DB db, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Clazz c, Clazz p, ClassDiagram cd) {// 
		Object[] result1_black = super2tableImpl.pattern_super2table_24_1_matchtggpattern_blackBBB(c, p, cd);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, C2T p2tParameter) {
		...
		for (Object[] result2_black : super2tableImpl
			...
			Object[] result3_bindingAndBlack = super2tableImpl
					.pattern_super2table_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, t, p2t, p, cd,
							cd2db, db, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[t] = " + t + ", " + "[p2t] = " + p2t
						+ ", " + "[p] = " + p + ", " + "[cd] = " + cd + ", " + "[cd2db] = " + cd2db + ", " + "[db] = "
						+ db + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (super2tableImpl.pattern_super2table_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = super2tableImpl.pattern_super2table_26_5_checknacs_blackBBBBBB(t, p2t, p, cd,
						cd2db, db);
				if (result5_black != null) {

					Object[] result6_black = super2tableImpl.pattern_super2table_26_6_perform_blackBBBBBBB(t, p2t, p,
							cd, cd2db, db, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[t] = " + t + ", "
								+ "[p2t] = " + p2t + ", " + "[p] = " + p + ", " + "[cd] = " + cd + ", " + "[cd2db] = "
								+ cd2db + ", " + "[db] = " + db + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					super2tableImpl.pattern_super2table_26_6_perform_greenBFBBFB(t, p, cd, ruleResult);
					//nothing Clazz c = (Clazz) result6_green[1];
					//nothing C2T c2t = (C2T) result6_green[4];
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Table t, C2T p2t, Clazz p,
			ClassDiagram cd, CD2D cd2db, DB db, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SUPER2TABLE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABLE_C2T_CLAZZ_CLAZZ_CLASSDIAGRAM_CD2D_DB:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Table) arguments.get(1),
					(C2T) arguments.get(2), (Clazz) arguments.get(3), (Clazz) arguments.get(4),
					(ClassDiagram) arguments.get(5), (CD2D) arguments.get(6), (DB) arguments.get(7));
		...
		case RulesPackage.SUPER2TABLE___IS_APPROPRIATE_BWD_TABLE_0__TABLE:
			return isAppropriate_BWD_Table_0((Table) arguments.get(0));
		case RulesPackage.SUPER2TABLE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1__EMOFLONEDGE:
		...
		case RulesPackage.SUPER2TABLE___IS_APPLICABLE_SOLVE_CSP_CC__TABLE_CLAZZ_CLAZZ_CLASSDIAGRAM_DB_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Table) arguments.get(0), (Clazz) arguments.get(1),
					(Clazz) arguments.get(2), (ClassDiagram) arguments.get(3), (DB) arguments.get(4),
		...
		case RulesPackage.SUPER2TABLE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABLE_C2T_CLAZZ_CLASSDIAGRAM_CD2D_DB_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Table) arguments.get(1),
					(C2T) arguments.get(2), (Clazz) arguments.get(3), (ClassDiagram) arguments.get(4),
					(CD2D) arguments.get(5), (DB) arguments.get(6), (ModelgeneratorRuleResult) arguments.get(7));
	...
	public static final Object[] pattern_super2table_0_1_initialbindings_blackBBBBB(super2table _this, Match match,
			Clazz c, Clazz p, ClassDiagram cd) {
		if (!c.equals(p)) {
			return new Object[] { _this, match, c, p, cd };
		}
		return null;
	}

	public static final Object[] pattern_super2table_0_2_SolveCSP_bindingFBBBBB(super2table _this, Match match, Clazz c,
			Clazz p, ClassDiagram cd) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, c, p, cd);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, c, p, cd };
		}
		return null;
	}
	...
	public static final Object[] pattern_super2table_0_4_collectelementstobetranslated_blackBBBB(Match match, Clazz c,
			Clazz p, ClassDiagram cd) {
		if (!c.equals(p)) {
			return new Object[] { match, c, p, cd };
		}
		return null;
	}

	public static final Object[] pattern_super2table_0_4_collectelementstobetranslated_greenBBBBFF(Match match, Clazz c,
			Clazz p, ClassDiagram cd) {
		...
		return new Object[] { match, c, p, cd, c__p____super, cd__c____classes };
	}

	public static final Object[] pattern_super2table_0_5_collectcontextelements_blackBBBB(Match match, Clazz c, Clazz p,
			ClassDiagram cd) {
		if (!c.equals(p)) {
			return new Object[] { match, c, p, cd };
		}
	...
	public static final void pattern_super2table_0_6_registerobjectstomatch_expressionBBBBB(super2table _this,
			Match match, Clazz c, Clazz p, ClassDiagram cd) {
		_this.registerObjectsToMatch_FWD(match, c, p, cd);
						...
						if (tmpCd instanceof ClassDiagram) {
							...
							if (tmpCd2db instanceof CD2D) {
								...
								if (tmpDb instanceof DB) {
									DB db = (DB) tmpDb;
									return new Object[] { t, p2t, c, p, cd, cd2db, db, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_super2table_1_1_performtransformation_blackBBBBBBBFBB(Table t, C2T p2t,
			Clazz c, Clazz p, ClassDiagram cd, CD2D cd2db, DB db, super2table _this,
			IsApplicableMatch isApplicableMatch) {
		if (!c.equals(p)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { t, p2t, c, p, cd, cd2db, db, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_super2table_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_super2table_1_1_performtransformation_binding != null) {
			...
			Clazz c = (Clazz) result_pattern_super2table_1_1_performtransformation_binding[2];
			Clazz p = (Clazz) result_pattern_super2table_1_1_performtransformation_binding[3];
			ClassDiagram cd = (ClassDiagram) result_pattern_super2table_1_1_performtransformation_binding[4];
			CD2D cd2db = (CD2D) result_pattern_super2table_1_1_performtransformation_binding[5];
			DB db = (DB) result_pattern_super2table_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_super2table_1_1_performtransformation_black = pattern_super2table_1_1_performtransformation_blackBBBBBBBFBB(
					t, p2t, c, p, cd, cd2db, db, _this, isApplicableMatch);
	...
	public static final Object[] pattern_super2table_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject t, EObject p2t, EObject c, EObject p, EObject cd, EObject c2t,
			EObject cd2db, EObject db) {
		if (!p2t.equals(t)) {
			if (!c.equals(t)) {
				if (!c.equals(p2t)) {
					if (!c.equals(p)) {
	...
	public static final Object[] pattern_super2table_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject t, EObject c, EObject p, EObject cd, EObject c2t) {
		EMoflonEdge c__p____super = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		cd__c____classes.setName(cd__c____classes_name_prime);
		return new Object[] { ruleresult, t, c, p, cd, c2t, c__p____super, c2t__t____target, c2t__c____source,
				cd__c____classes };
	}
	...
	public static final void pattern_super2table_1_5_registerobjects_expressionBBBBBBBBBB(super2table _this,
			PerformRuleResult ruleresult, EObject t, EObject p2t, EObject c, EObject p, EObject cd, EObject c2t,
			EObject cd2db, EObject db) {
		_this.registerObjects_FWD(ruleresult, t, p2t, c, p, cd, c2t, cd2db, db);
	...
	public static final Object[] pattern_super2table_2_2_corematch_bindingFFFB(Match match) {
		...
		if (tmpC instanceof Clazz) {
			...
			if (tmpP instanceof Clazz) {
				...
				if (tmpCd instanceof ClassDiagram) {
					ClassDiagram cd = (ClassDiagram) tmpCd;
					return new Object[] { c, p, cd, match };
				}
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_super2table_2_2_corematch_blackFFBBBFFB(Clazz c, Clazz p,
			...
			for (C2T p2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(p, C2T.class, "source")) {
				...
				if (t != null) {
					for (CD2D cd2db : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(cd, CD2D.class,
						...
						if (db != null) {
							_result.add(new Object[] { t, p2t, c, p, cd, cd2db, db, match });
						}
	...
	public static final Iterable<Object[]> pattern_super2table_2_3_findcontext_blackBBBBBBB(Table t, C2T p2t, Clazz c,
			Clazz p, ClassDiagram cd, CD2D cd2db, DB db) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(p)) {
								...
								if (cd.getClasses().contains(c)) {
									if (db.getTable().contains(t)) {
										if (db.equals(cd2db.getTarget())) {
											_result.add(new Object[] { t, p2t, c, p, cd, cd2db, db });
										}
									}
								}
							}
	...
	public static final Object[] pattern_super2table_2_3_findcontext_greenBBBBBBBFFFFFFFFF(Table t, C2T p2t, Clazz c,
			Clazz p, ClassDiagram cd, CD2D cd2db, DB db) {
		...
		return new Object[] { t, p2t, c, p, cd, cd2db, db, isApplicableMatch, p2t__t____target, c__p____super,
				p2t__p____source, cd__p____classes, cd2db__cd____source, cd__c____classes, db__t____table,
				cd2db__db____target };
	}

	public static final Object[] pattern_super2table_2_4_solveCSP_bindingFBBBBBBBBB(super2table _this,
			IsApplicableMatch isApplicableMatch, Table t, C2T p2t, Clazz c, Clazz p, ClassDiagram cd, CD2D cd2db,
			DB db) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, t, p2t, c, p, cd, cd2db, db);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t, p2t, c, p, cd, cd2db, db };
		}
		return null;
	}
	...
	public static final Object[] pattern_super2table_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(super2table _this,
		...
		Object[] result_pattern_super2table_2_4_solveCSP_binding = pattern_super2table_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, t, p2t, c, p, cd, cd2db, db);
				...
				if (!c.equals(p)) {
					if (p.equals(c.getSuper())) {
						for (ClassDiagram cd : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
							...
							if (cd.getClasses().contains(p)) {
								_result.add(new Object[] { c, p, cd, _edge_super });
							}
						}
					}
				}
	...
	public static final boolean pattern_super2table_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			super2table _this, Match match, Clazz c, Clazz p, ClassDiagram cd) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, c, p, cd);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
			...
			if (tmpC instanceof Clazz) {
				...
				if (tmpP instanceof Clazz) {
					...
					if (tmpCd instanceof ClassDiagram) {
						...
						if (tmpDb instanceof DB) {
							DB db = (DB) tmpDb;
							return new Object[] { t, c, p, cd, db, targetMatch, sourceMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_super2table_21_2_matchsrctrgcontext_blackBBBBBBB(Table t, Clazz c, Clazz p,
			ClassDiagram cd, DB db, Match sourceMatch, Match targetMatch) {
		if (!c.equals(p)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { t, c, p, cd, db, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_super2table_21_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(Match sourceMatch,
		...
		if (result_pattern_super2table_21_2_matchsrctrgcontext_binding != null) {
			...
			Clazz c = (Clazz) result_pattern_super2table_21_2_matchsrctrgcontext_binding[1];
			Clazz p = (Clazz) result_pattern_super2table_21_2_matchsrctrgcontext_binding[2];
			ClassDiagram cd = (ClassDiagram) result_pattern_super2table_21_2_matchsrctrgcontext_binding[3];
			DB db = (DB) result_pattern_super2table_21_2_matchsrctrgcontext_binding[4];

			Object[] result_pattern_super2table_21_2_matchsrctrgcontext_black = pattern_super2table_21_2_matchsrctrgcontext_blackBBBBBBB(
					t, c, p, cd, db, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_super2table_21_3_solvecsp_bindingFBBBBBBBB(super2table _this, Table t, Clazz c,
			Clazz p, ClassDiagram cd, DB db, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(t, c, p, cd, db, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, t, c, p, cd, db, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_super2table_21_3_solvecsp_bindingAndBlackFBBBBBBBB(super2table _this, Table t,
			Clazz c, Clazz p, ClassDiagram cd, DB db, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_super2table_21_3_solvecsp_binding = pattern_super2table_21_3_solvecsp_bindingFBBBBBBBB(
				_this, t, c, p, cd, db, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_super2table_21_5_matchcorrcontext_blackBFBBFBBB(Table t, Clazz p,
			ClassDiagram cd, DB db, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (C2T p2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(t, C2T.class, "target")) {
				if (p.equals(p2t.getSource())) {
					for (CD2D cd2db : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(cd, CD2D.class,
							"source")) {
						if (db.equals(cd2db.getTarget())) {
							_result.add(new Object[] { t, p2t, p, cd, cd2db, db, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_super2table_21_6_createcorrespondence_blackBBBBBB(Table t, Clazz c, Clazz p,
			ClassDiagram cd, DB db, CCMatch ccMatch) {
		if (!c.equals(p)) {
			return new Object[] { t, c, p, cd, db, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_super2table_24_1_matchtggpattern_blackBBB(Clazz c, Clazz p, ClassDiagram cd) {
		if (!c.equals(p)) {
			if (p.equals(c.getSuper())) {
				if (cd.getClasses().contains(p)) {
					if (cd.getClasses().contains(c)) {
						return new Object[] { c, p, cd };
					}
				}
			}
		}
	...
	public static final Object[] pattern_super2table_26_3_solveCSP_bindingFBBBBBBBBB(super2table _this,
			IsApplicableMatch isApplicableMatch, Table t, C2T p2t, Clazz p, ClassDiagram cd, CD2D cd2db, DB db,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, t, p2t, p, cd, cd2db, db,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t, p2t, p, cd, cd2db, db, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_super2table_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(super2table _this,
		...
		Object[] result_pattern_super2table_26_3_solveCSP_binding = pattern_super2table_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, t, p2t, p, cd, cd2db, db, ruleResult);
	...
	public static final Object[] pattern_super2table_26_5_checknacs_blackBBBBBB(Table t, C2T p2t, Clazz p,
			ClassDiagram cd, CD2D cd2db, DB db) {
		return new Object[] { t, p2t, p, cd, cd2db, db };
	}

	public static final Object[] pattern_super2table_26_6_perform_blackBBBBBBB(Table t, C2T p2t, Clazz p,
			ClassDiagram cd, CD2D cd2db, DB db, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { t, p2t, p, cd, cd2db, db, ruleResult };
	}

	public static final Object[] pattern_super2table_26_6_perform_greenBFBBFB(Table t, Clazz p, ClassDiagram cd,
			ModelgeneratorRuleResult ruleResult) {
		...
		return new Object[] { t, c, p, cd, c2t, ruleResult };
	}
