...
public class left2southwestImpl extends AbstractRuleImpl implements left2southwest {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = left2southwestImpl.pattern_left2southwest_1_1_performtransformation_greenBFBF(xn, c);
		...
		Object[] result3_black = left2southwestImpl
				.pattern_left2southwest_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, n2xn, xn, xc, c, l2sw, n);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[n2xn] = " + n2xn + ", " + "[xn] = " + xn + ", " + "[xc] = " + xc + ", " + "[c] = " + c
					+ ", " + "[l2sw] = " + l2sw + ", " + "[n] = " + n + ".");
		}
		left2southwestImpl.pattern_left2southwest_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, xn, xc, c, l2sw,
				n);
		...
		// 
		// 
		left2southwestImpl.pattern_left2southwest_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, n2xn, xn, xc,
				c, l2sw, n);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : left2southwestImpl.pattern_left2southwest_2_2_corematch_blackFFBBB(c, n, match)) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, BTNode2XBTnode n2xn, XBTNode xn, BTNode c,
			BTNode n) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject n2xn, EObject xn, EObject xc, EObject c,
			EObject l2sw, EObject n) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = left2southwestImpl
				.pattern_left2southwest_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, n2xn, xn, xc, c, l2sw, n);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[n2xn] = " + n2xn + ", " + "[xn] = " + xn + ", " + "[xc] = " + xc + ", " + "[c] = " + c
					+ ", " + "[l2sw] = " + l2sw + ", " + "[n] = " + n + ".");
		}
		left2southwestImpl.pattern_left2southwest_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, xn, xc, c, l2sw,
				n);
		//nothing EMoflonEdge xn__xc____sw = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge l2sw__xc____target = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge l2sw__c____source = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		left2southwestImpl.pattern_left2southwest_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, n2xn, xn,
				xc, c, l2sw, n);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : left2southwestImpl.pattern_left2southwest_12_2_corematch_blackFBBFB(xn, xc,
				match)) {
			BTNode2XBTnode n2xn = (BTNode2XBTnode) result2_black[0];
			BTNode n = (BTNode) result2_black[3];
			// ForEach 
			for (Object[] result3_black : left2southwestImpl.pattern_left2southwest_12_3_findcontext_blackBBBB(n2xn, xn,
					xc, n)) {
				...
				Object[] result4_bindingAndBlack = left2southwestImpl
						.pattern_left2southwest_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, n2xn, xn,
								xc, n);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[n2xn] = " + n2xn + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, BTNode2XBTnode n2xn, XBTNode xn,
			XBTNode xc, BTNode n) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject n2xn, EObject xn, EObject xc, EObject c,
			EObject l2sw, EObject n) {
		ruleresult.registerObject("n2xn", n2xn);
		ruleresult.registerObject("xn", xn);
		ruleresult.registerObject("xc", xc);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_111(EMoflonEdge _edge_sw) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_119(EMoflonEdge _edge_l) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = left2southwestImpl
				.pattern_left2southwest_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, xn, xc, c, n, sourceMatch,
						targetMatch);
		...
		if (left2southwestImpl.pattern_left2southwest_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : left2southwestImpl.pattern_left2southwest_24_5_matchcorrcontext_blackFBBBB(xn,
				...
				Object[] result6_black = left2southwestImpl
						.pattern_left2southwest_24_6_createcorrespondence_blackBBBBB(xn, xc, c, n, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[xn] = " + xn + ", " + "[xc] = " + xc + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(XBTNode xn, XBTNode xc, BTNode c, BTNode n, Match sourceMatch,
		...
		for (Object[] result2_black : left2southwestImpl
			...
			if (left2southwestImpl.pattern_left2southwest_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					left2southwestImpl.pattern_left2southwest_29_6_perform_greenBFFFBB(xn, n, ruleResult);
					//nothing XBTNode xc = (XBTNode) result6_green[1];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LEFT2SOUTHWEST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_111__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_111((EMoflonEdge) arguments.get(0));
		case RulesPackage.LEFT2SOUTHWEST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_119__EMOFLONEDGE:
			...
			if (tmpXn instanceof XBTNode) {
				...
				if (tmpC instanceof BTNode) {
					...
					if (tmpN instanceof BTNode) {
						...
						return new Object[] { n2xn, xn, c, n, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_left2southwest_1_1_performtransformation_blackBBBBFBB(BTNode2XBTnode n2xn,
			XBTNode xn, BTNode c, BTNode n, left2southwest _this, IsApplicableMatch isApplicableMatch) {
		if (!c.equals(n)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { n2xn, xn, c, n, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_left2southwest_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_left2southwest_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_left2southwest_1_1_performtransformation_black = pattern_left2southwest_1_1_performtransformation_blackBBBBFBB(
					n2xn, xn, c, n, _this, isApplicableMatch);
	...
	public static final Object[] pattern_left2southwest_1_1_performtransformation_greenBFBF(XBTNode xn, BTNode c) {
		XBTNode xc = XbtreeFactory.eINSTANCE.createXBTNode();
		BTNode2XBTnode l2sw = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		xn.setSw(xc);
		l2sw.setTarget(xc);
		l2sw.setSource(c);
		return new Object[] { xn, xc, c, l2sw };
	}
	...
	public static final Object[] pattern_left2southwest_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject n2xn, EObject xn, EObject xc, EObject c, EObject l2sw, EObject n) {
		if (!n2xn.equals(xn)) {
			if (!n2xn.equals(xc)) {
				if (!xc.equals(xn)) {
					if (!c.equals(n2xn)) {
												...
												if (!l2sw.equals(xc)) {
													if (!l2sw.equals(n)) {
														if (!n.equals(n2xn)) {
															if (!n.equals(xn)) {
																if (!n.equals(xc)) {
																	return new Object[] { ruleresult, n2xn, xn, xc, c,
																			l2sw, n };
																}
															}
														}
	...
	public static final Object[] pattern_left2southwest_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject xn, EObject xc, EObject c, EObject l2sw, EObject n) {
		...
		n__c____l.setName(n__c____l_name_prime);
		return new Object[] { ruleresult, xn, xc, c, l2sw, n, xn__xc____sw, l2sw__xc____target, l2sw__c____source,
				n__c____l };
	}

	public static final void pattern_left2southwest_1_5_registerobjects_expressionBBBBBBBB(left2southwest _this,
			PerformRuleResult ruleresult, EObject n2xn, EObject xn, EObject xc, EObject c, EObject l2sw, EObject n) {
		_this.registerObjects_FWD(ruleresult, n2xn, xn, xc, c, l2sw, n);
	...
	public static final Iterable<Object[]> pattern_left2southwest_2_2_corematch_blackFFBBB(BTNode c, BTNode n,
			Match match) {
		...
		if (!c.equals(n)) {
			for (BTNode2XBTnode n2xn : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(n,
				...
				if (xn != null) {
					_result.add(new Object[] { n2xn, xn, c, n, match });
				}
	...
	public static final Iterable<Object[]> pattern_left2southwest_2_3_findcontext_blackBBBB(BTNode2XBTnode n2xn,
			XBTNode xn, BTNode c, BTNode n) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(n)) {
			if (xn.equals(n2xn.getTarget())) {
				if (n.equals(n2xn.getSource())) {
					if (c.equals(n.getL())) {
						_result.add(new Object[] { n2xn, xn, c, n });
					}
				}
			}
		}
	...
	public static final Object[] pattern_left2southwest_2_3_findcontext_greenBBBBFFFF(BTNode2XBTnode n2xn, XBTNode xn,
		...
		n__c____l.setName(n__c____l_name_prime);
		return new Object[] { n2xn, xn, c, n, isApplicableMatch, n2xn__xn____target, n2xn__n____source, n__c____l };
	}

	public static final Object[] pattern_left2southwest_2_4_solveCSP_bindingFBBBBBB(left2southwest _this,
			IsApplicableMatch isApplicableMatch, BTNode2XBTnode n2xn, XBTNode xn, BTNode c, BTNode n) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, n2xn, xn, c, n);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, n2xn, xn, c, n };
		}
		return null;
	}
	...
	public static final Object[] pattern_left2southwest_2_4_solveCSP_bindingAndBlackFBBBBBB(left2southwest _this,
		...
		Object[] result_pattern_left2southwest_2_4_solveCSP_binding = pattern_left2southwest_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, n2xn, xn, c, n);
		...
		if (tmpN2xn instanceof BTNode2XBTnode) {
			...
			if (tmpXn instanceof XBTNode) {
				...
				if (tmpXc instanceof XBTNode) {
					...
					if (tmpN instanceof BTNode) {
						BTNode n = (BTNode) tmpN;
						return new Object[] { n2xn, xn, xc, n, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_left2southwest_11_1_performtransformation_blackBBBBFBB(BTNode2XBTnode n2xn,
			XBTNode xn, XBTNode xc, BTNode n, left2southwest _this, IsApplicableMatch isApplicableMatch) {
		if (!xc.equals(xn)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { n2xn, xn, xc, n, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_left2southwest_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_left2southwest_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_left2southwest_11_1_performtransformation_black = pattern_left2southwest_11_1_performtransformation_blackBBBBFBB(
					n2xn, xn, xc, n, _this, isApplicableMatch);
	...
	public static final void pattern_left2southwest_11_5_registerobjects_expressionBBBBBBBB(left2southwest _this,
			PerformRuleResult ruleresult, EObject n2xn, EObject xn, EObject xc, EObject c, EObject l2sw, EObject n) {
		_this.registerObjects_BWD(ruleresult, n2xn, xn, xc, c, l2sw, n);
	...
	public static final Iterable<Object[]> pattern_left2southwest_12_2_corematch_blackFBBFB(XBTNode xn, XBTNode xc,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!xc.equals(xn)) {
			for (BTNode2XBTnode n2xn : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xn,
				...
				if (n != null) {
					_result.add(new Object[] { n2xn, xn, xc, n, match });
				}
	...
	public static final Iterable<Object[]> pattern_left2southwest_12_3_findcontext_blackBBBB(BTNode2XBTnode n2xn,
			XBTNode xn, XBTNode xc, BTNode n) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!xc.equals(xn)) {
			if (xn.equals(n2xn.getTarget())) {
				if (xc.equals(xn.getSw())) {
					if (n.equals(n2xn.getSource())) {
						_result.add(new Object[] { n2xn, xn, xc, n });
					}
				}
			}
		}
	...
	public static final Object[] pattern_left2southwest_12_3_findcontext_greenBBBBFFFF(BTNode2XBTnode n2xn, XBTNode xn,
			XBTNode xc, BTNode n) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge n2xn__xn____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge xn__xc____sw = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		xn__xc____sw.setName(xn__xc____sw_name_prime);
		n2xn__n____source.setName(n2xn__n____source_name_prime);
		return new Object[] { n2xn, xn, xc, n, isApplicableMatch, n2xn__xn____target, xn__xc____sw, n2xn__n____source };
	}

	public static final Object[] pattern_left2southwest_12_4_solveCSP_bindingFBBBBBB(left2southwest _this,
			IsApplicableMatch isApplicableMatch, BTNode2XBTnode n2xn, XBTNode xn, XBTNode xc, BTNode n) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, n2xn, xn, xc, n);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, n2xn, xn, xc, n };
		}
		return null;
	}
	...
	public static final Object[] pattern_left2southwest_12_4_solveCSP_bindingAndBlackFBBBBBB(left2southwest _this,
		...
		Object[] result_pattern_left2southwest_12_4_solveCSP_binding = pattern_left2southwest_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, n2xn, xn, xc, n);
	...
	public static final Object[] pattern_left2southwest_20_2_testcorematchandDECs_black_nac_0BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_w_108826 = xc.getW();
			if (__DEC_xc_w_108826 != null) {
				if (!xc.equals(__DEC_xc_w_108826)) {
					if (!xn.equals(__DEC_xc_w_108826)) {
	...
	public static final Object[] pattern_left2southwest_20_2_testcorematchandDECs_black_nac_1BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_e_434761 = xc.getE();
			if (__DEC_xc_e_434761 != null) {
				if (!xc.equals(__DEC_xc_e_434761)) {
					if (!xn.equals(__DEC_xc_e_434761)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_20_2_testcorematchandDECs_black_nac_2BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_w_360195 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "w")) {
				if (!xc.equals(__DEC_xc_w_360195)) {
					if (!xn.equals(__DEC_xc_w_360195)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_20_2_testcorematchandDECs_black_nac_3BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_se_932826 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "se")) {
				if (!xc.equals(__DEC_xc_se_932826)) {
					if (!xn.equals(__DEC_xc_se_932826)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_20_2_testcorematchandDECs_black_nac_4BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_e_671408 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "e")) {
				if (!xc.equals(__DEC_xc_e_671408)) {
					if (!xn.equals(__DEC_xc_e_671408)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_21_2_testcorematchandDECs_black_nac_0BB(BTNode c, BTNode n) {
		if (!c.equals(n)) {
			for (BTNode __DEC_c_r_231695 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					BTNode.class, "r")) {
				if (!c.equals(__DEC_c_r_231695)) {
					if (!n.equals(__DEC_c_r_231695)) {
		...
		if (tmpXn instanceof XBTNode) {
			...
			if (tmpXc instanceof XBTNode) {
				...
				if (tmpC instanceof BTNode) {
					...
					if (tmpN instanceof BTNode) {
						BTNode n = (BTNode) tmpN;
						return new Object[] { xn, xc, c, n, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_left2southwest_24_2_matchsrctrgcontext_blackBBBBBB(XBTNode xn, XBTNode xc,
			BTNode c, BTNode n, Match sourceMatch, Match targetMatch) {
		if (!xc.equals(xn)) {
			if (!c.equals(n)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { xn, xc, c, n, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_left2southwest_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(Match sourceMatch,
		...
		if (result_pattern_left2southwest_24_2_matchsrctrgcontext_binding != null) {
			XBTNode xn = (XBTNode) result_pattern_left2southwest_24_2_matchsrctrgcontext_binding[0];
			...
			Object[] result_pattern_left2southwest_24_2_matchsrctrgcontext_black = pattern_left2southwest_24_2_matchsrctrgcontext_blackBBBBBB(
					xn, xc, c, n, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_left2southwest_24_3_solvecsp_bindingFBBBBBBB(left2southwest _this, XBTNode xn,
			XBTNode xc, BTNode c, BTNode n, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(xn, xc, c, n, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, xn, xc, c, n, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_left2southwest_24_3_solvecsp_bindingAndBlackFBBBBBBB(left2southwest _this,
			XBTNode xn, XBTNode xc, BTNode c, BTNode n, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_left2southwest_24_3_solvecsp_binding = pattern_left2southwest_24_3_solvecsp_bindingFBBBBBBB(
				_this, xn, xc, c, n, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_left2southwest_24_6_createcorrespondence_blackBBBBB(XBTNode xn, XBTNode xc,
			BTNode c, BTNode n, CCMatch ccMatch) {
		if (!xc.equals(xn)) {
			if (!c.equals(n)) {
				return new Object[] { xn, xc, c, n, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_left2southwest_27_1_matchtggpattern_black_nac_0BB(BTNode c, BTNode n) {
		if (!c.equals(n)) {
			for (BTNode __DEC_c_r_195245 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					BTNode.class, "r")) {
				if (!c.equals(__DEC_c_r_195245)) {
					if (!n.equals(__DEC_c_r_195245)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_28_1_matchtggpattern_black_nac_0BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_w_463850 = xc.getW();
			if (__DEC_xc_w_463850 != null) {
				if (!xc.equals(__DEC_xc_w_463850)) {
					if (!xn.equals(__DEC_xc_w_463850)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_28_1_matchtggpattern_black_nac_1BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_e_225704 = xc.getE();
			if (__DEC_xc_e_225704 != null) {
				if (!xc.equals(__DEC_xc_e_225704)) {
					if (!xn.equals(__DEC_xc_e_225704)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_28_1_matchtggpattern_black_nac_2BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_w_38081 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "w")) {
				if (!xc.equals(__DEC_xc_w_38081)) {
					if (!xn.equals(__DEC_xc_w_38081)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_28_1_matchtggpattern_black_nac_3BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_se_77338 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "se")) {
				if (!xc.equals(__DEC_xc_se_77338)) {
					if (!xn.equals(__DEC_xc_se_77338)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_28_1_matchtggpattern_black_nac_4BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_e_157194 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "e")) {
				if (!xc.equals(__DEC_xc_e_157194)) {
					if (!xn.equals(__DEC_xc_e_157194)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_left2southwest_29_6_perform_greenBFFFBB(XBTNode xn, BTNode n,
			ModelgeneratorRuleResult ruleResult) {
		XBTNode xc = XbtreeFactory.eINSTANCE.createXBTNode();
		BTNode c = BtreeFactory.eINSTANCE.createBTNode();
		BTNode2XBTnode l2sw = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		...
		return new Object[] { xn, xc, c, l2sw, n, ruleResult };
	}
