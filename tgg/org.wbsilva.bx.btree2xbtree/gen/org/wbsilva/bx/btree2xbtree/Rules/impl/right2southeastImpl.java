...
public class right2southeastImpl extends AbstractRuleImpl implements right2southeast {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = right2southeastImpl
				.pattern_right2southeast_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c, n, n2xn, xc, l2se, xn);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c] = " + c + ", " + "[n] = " + n + ", " + "[n2xn] = " + n2xn + ", " + "[xc] = " + xc
					+ ", " + "[l2se] = " + l2se + ", " + "[xn] = " + xn + ".");
		}
		right2southeastImpl.pattern_right2southeast_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, c, n, xc, l2se,
				xn);
		//nothing EMoflonEdge l2se__xc____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge l2se__c____source = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge n__c____r = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge xn__xc____se = (EMoflonEdge) result3_green[9];

		// 
		// 
		right2southeastImpl.pattern_right2southeast_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, c, n, n2xn,
				xc, l2se, xn);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c, EObject n, EObject n2xn, EObject xc,
			EObject l2se, EObject xn) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		XBTNode xn = (XBTNode) result1_bindingAndBlack[3];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = right2southeastImpl.pattern_right2southeast_11_1_performtransformation_greenFBBF(n,
				xc);
		BTNode c = (BTNode) result1_green[0];
		BTNode2XBTnode l2se = (BTNode2XBTnode) result1_green[3];
		...
		Object[] result3_black = right2southeastImpl
				.pattern_right2southeast_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c, n, n2xn, xc, l2se, xn);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c] = " + c + ", " + "[n] = " + n + ", " + "[n2xn] = " + n2xn + ", " + "[xc] = " + xc
					+ ", " + "[l2se] = " + l2se + ", " + "[xn] = " + xn + ".");
		}
		right2southeastImpl.pattern_right2southeast_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, c, n, xc, l2se,
				xn);
		//nothing EMoflonEdge l2se__xc____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge l2se__c____source = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge n__c____r = (EMoflonEdge) result3_green[8];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : right2southeastImpl.pattern_right2southeast_12_2_corematch_blackFFBBB(xc, xn,
			...
			// ForEach 
			for (Object[] result3_black : right2southeastImpl.pattern_right2southeast_12_3_findcontext_blackBBBB(n,
					n2xn, xc, xn)) {
				...
				Object[] result4_bindingAndBlack = right2southeastImpl
						.pattern_right2southeast_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, n, n2xn,
								xc, xn);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c, EObject n, EObject n2xn, EObject xc,
			EObject l2se, EObject xn) {
		ruleresult.registerObject("c", c);
		ruleresult.registerObject("n", n);
		ruleresult.registerObject("n2xn", n2xn);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_114(EMoflonEdge _edge_se) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_122(EMoflonEdge _edge_r) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (right2southeastImpl.pattern_right2southeast_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : right2southeastImpl
				...
				right2southeastImpl.pattern_right2southeast_24_6_createcorrespondence_greenBBFB(c, xc, ccMatch);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BTNODE_BTNODE2XBTNODE_XBTNODE_XBTNODE:
		...
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_114__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_114((EMoflonEdge) arguments.get(0));
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_122__EMOFLONEDGE:
	...
	public static final Object[] pattern_right2southeast_1_1_performtransformation_greenBFFB(BTNode c, XBTNode xn) {
		...
		l2se.setTarget(xc);
		l2se.setSource(c);
		return new Object[] { c, xc, l2se, xn };
	}

	public static final Object[] pattern_right2southeast_1_2_collecttranslatedelements_blackBBB(BTNode c, XBTNode xc,
			BTNode2XBTnode l2se) {
		return new Object[] { c, xc, l2se };
	}

	public static final Object[] pattern_right2southeast_1_2_collecttranslatedelements_greenFBBB(BTNode c, XBTNode xc,
			BTNode2XBTnode l2se) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getTranslatedElements().add(c);
		ruleresult.getCreatedElements().add(xc);
		ruleresult.getCreatedLinkElements().add(l2se);
		return new Object[] { ruleresult, c, xc, l2se };
	}

	public static final Object[] pattern_right2southeast_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject c, EObject n, EObject n2xn, EObject xc, EObject l2se, EObject xn) {
		if (!c.equals(n)) {
			if (!c.equals(n2xn)) {
				if (!c.equals(xc)) {
					if (!c.equals(l2se)) {
												...
												if (!xc.equals(xn)) {
													if (!l2se.equals(n)) {
														if (!l2se.equals(n2xn)) {
															if (!l2se.equals(xc)) {
																if (!l2se.equals(xn)) {
																	return new Object[] { ruleresult, c, n, n2xn, xc,
																			l2se, xn };
																}
															}
														}
	...
	public static final Object[] pattern_right2southeast_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject c, EObject n, EObject xc, EObject l2se, EObject xn) {
		...
		return new Object[] { ruleresult, c, n, xc, l2se, xn, l2se__xc____target, l2se__c____source, n__c____r,
				xn__xc____se };
	}

	public static final void pattern_right2southeast_1_5_registerobjects_expressionBBBBBBBB(right2southeast _this,
			PerformRuleResult ruleresult, EObject c, EObject n, EObject n2xn, EObject xc, EObject l2se, EObject xn) {
		_this.registerObjects_FWD(ruleresult, c, n, n2xn, xc, l2se, xn);
	...
	public static final Object[] pattern_right2southeast_11_1_performtransformation_blackBBBBFBB(BTNode n,
			BTNode2XBTnode n2xn, XBTNode xc, XBTNode xn, right2southeast _this, IsApplicableMatch isApplicableMatch) {
		if (!xc.equals(xn)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_right2southeast_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_right2southeast_11_1_performtransformation_binding != null) {
			...
			BTNode2XBTnode n2xn = (BTNode2XBTnode) result_pattern_right2southeast_11_1_performtransformation_binding[1];
	...
	public static final Object[] pattern_right2southeast_11_1_performtransformation_greenFBBF(BTNode n, XBTNode xc) {
		BTNode c = BtreeFactory.eINSTANCE.createBTNode();
		BTNode2XBTnode l2se = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		n.setR(c);
		l2se.setTarget(xc);
		l2se.setSource(c);
		return new Object[] { c, n, xc, l2se };
	}

	public static final Object[] pattern_right2southeast_11_2_collecttranslatedelements_blackBBB(BTNode c, XBTNode xc,
			BTNode2XBTnode l2se) {
		return new Object[] { c, xc, l2se };
	}

	public static final Object[] pattern_right2southeast_11_2_collecttranslatedelements_greenFBBB(BTNode c, XBTNode xc,
			BTNode2XBTnode l2se) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_right2southeast_11_5_registerobjects_expressionBBBBBBBB(right2southeast _this,
			PerformRuleResult ruleresult, EObject c, EObject n, EObject n2xn, EObject xc, EObject l2se, EObject xn) {
		_this.registerObjects_BWD(ruleresult, c, n, n2xn, xc, l2se, xn);
	...
	public static final Iterable<Object[]> pattern_right2southeast_12_3_findcontext_blackBBBB(BTNode n,
	...
	public static final Object[] pattern_right2southeast_12_3_findcontext_greenBBBBFFFF(BTNode n, BTNode2XBTnode n2xn,
			XBTNode xc, XBTNode xn) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge n2xn__n____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge n2xn__xn____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		n2xn__xn____target.setName(n2xn__xn____target_name_prime);
		xn__xc____se.setName(xn__xc____se_name_prime);
		return new Object[] { n, n2xn, xc, xn, isApplicableMatch, n2xn__n____source, n2xn__xn____target, xn__xc____se };
	}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_0BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_w_975801 = xc.getW();
			if (__DEC_xc_w_975801 != null) {
				if (!xc.equals(__DEC_xc_w_975801)) {
					if (!xn.equals(__DEC_xc_w_975801)) {
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_1BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_e_620776 = xc.getE();
			if (__DEC_xc_e_620776 != null) {
				if (!xc.equals(__DEC_xc_e_620776)) {
					if (!xn.equals(__DEC_xc_e_620776)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_2BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_w_53931 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "w")) {
				if (!xc.equals(__DEC_xc_w_53931)) {
					if (!xn.equals(__DEC_xc_w_53931)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_3BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_sw_971096 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "sw")) {
				if (!xc.equals(__DEC_xc_sw_971096)) {
					if (!xn.equals(__DEC_xc_sw_971096)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_4BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_e_360091 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "e")) {
				if (!xc.equals(__DEC_xc_e_360091)) {
					if (!xn.equals(__DEC_xc_e_360091)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_21_2_testcorematchandDECs_black_nac_0BB(BTNode c, BTNode n) {
		if (!c.equals(n)) {
			for (BTNode __DEC_c_l_979520 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					BTNode.class, "l")) {
				if (!c.equals(__DEC_c_l_979520)) {
					if (!n.equals(__DEC_c_l_979520)) {
	...
	public static final Object[] pattern_right2southeast_24_6_createcorrespondence_greenBBFB(BTNode c, XBTNode xc,
			CCMatch ccMatch) {
		BTNode2XBTnode l2se = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		l2se.setTarget(xc);
		l2se.setSource(c);
		ccMatch.getCreateCorr().add(l2se);
		return new Object[] { c, xc, l2se, ccMatch };
	}
	...
	public static final Object[] pattern_right2southeast_27_1_matchtggpattern_black_nac_0BB(BTNode c, BTNode n) {
		if (!c.equals(n)) {
			for (BTNode __DEC_c_l_827268 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					BTNode.class, "l")) {
				if (!c.equals(__DEC_c_l_827268)) {
					if (!n.equals(__DEC_c_l_827268)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_0BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_w_480303 = xc.getW();
			if (__DEC_xc_w_480303 != null) {
				if (!xc.equals(__DEC_xc_w_480303)) {
					if (!xn.equals(__DEC_xc_w_480303)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_1BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_e_751030 = xc.getE();
			if (__DEC_xc_e_751030 != null) {
				if (!xc.equals(__DEC_xc_e_751030)) {
					if (!xn.equals(__DEC_xc_e_751030)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_2BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_w_412880 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "w")) {
				if (!xc.equals(__DEC_xc_w_412880)) {
					if (!xn.equals(__DEC_xc_w_412880)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_3BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_sw_968110 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "sw")) {
				if (!xc.equals(__DEC_xc_sw_968110)) {
					if (!xn.equals(__DEC_xc_sw_968110)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_4BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_e_268601 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "e")) {
				if (!xc.equals(__DEC_xc_e_268601)) {
					if (!xn.equals(__DEC_xc_e_268601)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_29_6_perform_greenFBFFBB(BTNode n, XBTNode xn,
		...
		return new Object[] { c, n, xc, l2se, xn, ruleResult };
	}
