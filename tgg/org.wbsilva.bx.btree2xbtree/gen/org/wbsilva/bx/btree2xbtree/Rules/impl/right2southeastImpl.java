...
public class right2southeastImpl extends AbstractRuleImpl implements right2southeast {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = right2southeastImpl.pattern_right2southeast_1_1_performtransformation_greenBFFB(xn, c);
		...
		Object[] result3_black = right2southeastImpl
				.pattern_right2southeast_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, n2xn, n, xn, xc, l2se, c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[n2xn] = " + n2xn + ", " + "[n] = " + n + ", " + "[xn] = " + xn + ", " + "[xc] = " + xc
					+ ", " + "[l2se] = " + l2se + ", " + "[c] = " + c + ".");
		}
		right2southeastImpl.pattern_right2southeast_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, n, xn, xc, l2se,
				c);
		//nothing EMoflonEdge n__c____r = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge xn__xc____se = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge l2se__xc____target = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge l2se__c____source = (EMoflonEdge) result3_green[9];

		// 
		// 
		right2southeastImpl.pattern_right2southeast_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, n2xn, n,
				xn, xc, l2se, c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : right2southeastImpl.pattern_right2southeast_2_2_corematch_blackFBFBB(n, c,
				match)) {
			BTNode2XBTnode n2xn = (BTNode2XBTnode) result2_black[0];
			XBTNode xn = (XBTNode) result2_black[2];
			// ForEach 
			for (Object[] result3_black : right2southeastImpl.pattern_right2southeast_2_3_findcontext_blackBBBB(n2xn, n,
					xn, c)) {
				Object[] result3_green = right2southeastImpl.pattern_right2southeast_2_3_findcontext_greenBBBBFFFF(n2xn,
						n, xn, c);
				...
				Object[] result4_bindingAndBlack = right2southeastImpl
						.pattern_right2southeast_2_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, n2xn, n,
								xn, c);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, BTNode2XBTnode n2xn, BTNode n, XBTNode xn,
			BTNode c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject n2xn, EObject n, EObject xn, EObject xc,
			EObject l2se, EObject c) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = right2southeastImpl.pattern_right2southeast_11_1_performtransformation_greenBBFF(n,
				xc);
		BTNode2XBTnode l2se = (BTNode2XBTnode) result1_green[2];
		...
		Object[] result3_black = right2southeastImpl
				.pattern_right2southeast_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, n2xn, n, xn, xc, l2se, c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[n2xn] = " + n2xn + ", " + "[n] = " + n + ", " + "[xn] = " + xn + ", " + "[xc] = " + xc
					+ ", " + "[l2se] = " + l2se + ", " + "[c] = " + c + ".");
		}
		right2southeastImpl.pattern_right2southeast_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, n, xn, xc,
				l2se, c);
		//nothing EMoflonEdge n__c____r = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge xn__xc____se = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge l2se__xc____target = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		right2southeastImpl.pattern_right2southeast_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, n2xn, n,
				xn, xc, l2se, c);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : right2southeastImpl.pattern_right2southeast_12_2_corematch_blackFFBBB(xn, xc,
			...
			for (Object[] result3_black : right2southeastImpl.pattern_right2southeast_12_3_findcontext_blackBBBB(n2xn,
				...
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				//nothing EMoflonEdge xn__xc____se = (EMoflonEdge) result3_green[5];
				//nothing EMoflonEdge n2xn__n____source = (EMoflonEdge) result3_green[6];
				//nothing EMoflonEdge n2xn__xn____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject n2xn, EObject n, EObject xn, EObject xc,
			EObject l2se, EObject c) {
		ruleresult.registerObject("n2xn", n2xn);
		ruleresult.registerObject("n", n);
		ruleresult.registerObject("xn", xn);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_49(EMoflonEdge _edge_se) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_49(EMoflonEdge _edge_r) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = right2southeastImpl
				.pattern_right2southeast_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, n, xn, xc, c, sourceMatch,
						targetMatch);
		...
		if (right2southeastImpl.pattern_right2southeast_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : right2southeastImpl
				...
				Object[] result6_black = right2southeastImpl
						.pattern_right2southeast_24_6_createcorrespondence_blackBBBBB(n, xn, xc, c, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[n] = " + n + ", " + "[xn] = " + xn + ", "
									+ "[xc] = " + xc + ", " + "[c] = " + c + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(BTNode n, XBTNode xn, XBTNode xc, BTNode c, Match sourceMatch,
		...
		for (Object[] result2_black : right2southeastImpl
			...
			if (right2southeastImpl.pattern_right2southeast_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					right2southeastImpl.pattern_right2southeast_29_6_perform_greenBBFFFB(n, xn, ruleResult);
					//nothing XBTNode xc = (XBTNode) result6_green[2];
					//nothing BTNode2XBTnode l2se = (BTNode2XBTnode) result6_green[3];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_BTNODE2XBTNODE_BTNODE_XBTNODE_BTNODE:
		...
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_49__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_49((EMoflonEdge) arguments.get(0));
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_49__EMOFLONEDGE:
		...
		case RulesPackage.RIGHT2SOUTHEAST___IS_APPLICABLE_SOLVE_CSP_CC__BTNODE_XBTNODE_XBTNODE_BTNODE_MATCH_MATCH:
			...
			if (tmpN instanceof BTNode) {
				...
				if (tmpXn instanceof XBTNode) {
					...
					if (tmpC instanceof BTNode) {
						...
						return new Object[] { n2xn, n, xn, c, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_right2southeast_1_1_performtransformation_blackBBBBFBB(BTNode2XBTnode n2xn,
			BTNode n, XBTNode xn, BTNode c, right2southeast _this, IsApplicableMatch isApplicableMatch) {
		if (!c.equals(n)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { n2xn, n, xn, c, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_right2southeast_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_right2southeast_1_1_performtransformation_binding != null) {
			BTNode2XBTnode n2xn = (BTNode2XBTnode) result_pattern_right2southeast_1_1_performtransformation_binding[0];
			BTNode n = (BTNode) result_pattern_right2southeast_1_1_performtransformation_binding[1];
			XBTNode xn = (XBTNode) result_pattern_right2southeast_1_1_performtransformation_binding[2];
			...
			Object[] result_pattern_right2southeast_1_1_performtransformation_black = pattern_right2southeast_1_1_performtransformation_blackBBBBFBB(
					n2xn, n, xn, c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_right2southeast_1_1_performtransformation_greenBFFB(XBTNode xn, BTNode c) {
		XBTNode xc = XbtreeFactory.eINSTANCE.createXBTNode();
		BTNode2XBTnode l2se = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		xn.setSe(xc);
		l2se.setTarget(xc);
		l2se.setSource(c);
		return new Object[] { xn, xc, l2se, c };
	}
	...
	public static final Object[] pattern_right2southeast_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject n2xn, EObject n, EObject xn, EObject xc, EObject l2se, EObject c) {
		if (!n2xn.equals(xn)) {
			if (!n2xn.equals(xc)) {
				if (!n.equals(n2xn)) {
					if (!n.equals(xn)) {
												...
												if (!c.equals(n2xn)) {
													if (!c.equals(n)) {
														if (!c.equals(xn)) {
															if (!c.equals(xc)) {
																if (!c.equals(l2se)) {
																	return new Object[] { ruleresult, n2xn, n, xn, xc,
																			l2se, c };
																}
															}
														}
	...
	public static final Object[] pattern_right2southeast_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject n, EObject xn, EObject xc, EObject l2se, EObject c) {
		EMoflonEdge n__c____r = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, n, xn, xc, l2se, c, n__c____r, xn__xc____se, l2se__xc____target,
				l2se__c____source };
	}

	public static final void pattern_right2southeast_1_5_registerobjects_expressionBBBBBBBB(right2southeast _this,
			PerformRuleResult ruleresult, EObject n2xn, EObject n, EObject xn, EObject xc, EObject l2se, EObject c) {
		_this.registerObjects_FWD(ruleresult, n2xn, n, xn, xc, l2se, c);
	...
	public static final Iterable<Object[]> pattern_right2southeast_2_2_corematch_blackFBFBB(BTNode n, BTNode c,
			Match match) {
		...
		if (!c.equals(n)) {
			for (BTNode2XBTnode n2xn : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(n,
				...
				if (xn != null) {
					_result.add(new Object[] { n2xn, n, xn, c, match });
				}
	...
	public static final Iterable<Object[]> pattern_right2southeast_2_3_findcontext_blackBBBB(BTNode2XBTnode n2xn,
			BTNode n, XBTNode xn, BTNode c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!c.equals(n)) {
			if (c.equals(n.getR())) {
				if (n.equals(n2xn.getSource())) {
					if (xn.equals(n2xn.getTarget())) {
						_result.add(new Object[] { n2xn, n, xn, c });
					}
				}
			}
		}
	...
	public static final Object[] pattern_right2southeast_2_3_findcontext_greenBBBBFFFF(BTNode2XBTnode n2xn, BTNode n,
			XBTNode xn, BTNode c) {
		...
		return new Object[] { n2xn, n, xn, c, isApplicableMatch, n__c____r, n2xn__n____source, n2xn__xn____target };
	}

	public static final Object[] pattern_right2southeast_2_4_solveCSP_bindingFBBBBBB(right2southeast _this,
			IsApplicableMatch isApplicableMatch, BTNode2XBTnode n2xn, BTNode n, XBTNode xn, BTNode c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, n2xn, n, xn, c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, n2xn, n, xn, c };
		}
		return null;
	}
	...
	public static final Object[] pattern_right2southeast_2_4_solveCSP_bindingAndBlackFBBBBBB(right2southeast _this,
		...
		Object[] result_pattern_right2southeast_2_4_solveCSP_binding = pattern_right2southeast_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, n2xn, n, xn, c);
	...
	public static final Object[] pattern_right2southeast_11_1_performtransformation_greenBBFF(BTNode n, XBTNode xc) {
		BTNode2XBTnode l2se = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		BTNode c = BtreeFactory.eINSTANCE.createBTNode();
		l2se.setTarget(xc);
		n.setR(c);
		l2se.setSource(c);
		return new Object[] { n, xc, l2se, c };
	}
	...
	public static final void pattern_right2southeast_11_5_registerobjects_expressionBBBBBBBB(right2southeast _this,
			PerformRuleResult ruleresult, EObject n2xn, EObject n, EObject xn, EObject xc, EObject l2se, EObject c) {
		_this.registerObjects_BWD(ruleresult, n2xn, n, xn, xc, l2se, c);
	...
	public static final Object[] pattern_right2southeast_12_3_findcontext_greenBBBBFFFF(BTNode2XBTnode n2xn, BTNode n,
		...
		n2xn__n____source.setName(n2xn__n____source_name_prime);
		n2xn__xn____target.setName(n2xn__xn____target_name_prime);
		return new Object[] { n2xn, n, xn, xc, isApplicableMatch, xn__xc____se, n2xn__n____source, n2xn__xn____target };
	}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_0BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_w_371613 = xc.getW();
			if (__DEC_xc_w_371613 != null) {
				if (!xc.equals(__DEC_xc_w_371613)) {
					if (!xn.equals(__DEC_xc_w_371613)) {
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_1BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_e_731777 = xc.getE();
			if (__DEC_xc_e_731777 != null) {
				if (!xc.equals(__DEC_xc_e_731777)) {
					if (!xn.equals(__DEC_xc_e_731777)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_2BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_w_718411 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "w")) {
				if (!xc.equals(__DEC_xc_w_718411)) {
					if (!xn.equals(__DEC_xc_w_718411)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_3BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_sw_105058 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "sw")) {
				if (!xc.equals(__DEC_xc_sw_105058)) {
					if (!xn.equals(__DEC_xc_sw_105058)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_20_2_testcorematchandDECs_black_nac_4BB(XBTNode xc,
			XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_e_856942 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "e")) {
				if (!xc.equals(__DEC_xc_e_856942)) {
					if (!xn.equals(__DEC_xc_e_856942)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_21_2_testcorematchandDECs_black_nac_0BB(BTNode c, BTNode n) {
		if (!c.equals(n)) {
			for (BTNode __DEC_c_l_439832 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					BTNode.class, "l")) {
				if (!c.equals(__DEC_c_l_439832)) {
					if (!n.equals(__DEC_c_l_439832)) {
		...
		if (tmpN instanceof BTNode) {
			...
			if (tmpXn instanceof XBTNode) {
				...
				if (tmpXc instanceof XBTNode) {
					...
					if (tmpC instanceof BTNode) {
						BTNode c = (BTNode) tmpC;
						return new Object[] { n, xn, xc, c, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_right2southeast_24_2_matchsrctrgcontext_blackBBBBBB(BTNode n, XBTNode xn,
			XBTNode xc, BTNode c, Match sourceMatch, Match targetMatch) {
		if (!xc.equals(xn)) {
			if (!c.equals(n)) {
	...
	public static final Object[] pattern_right2southeast_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_right2southeast_24_2_matchsrctrgcontext_binding != null) {
			BTNode n = (BTNode) result_pattern_right2southeast_24_2_matchsrctrgcontext_binding[0];
			XBTNode xn = (XBTNode) result_pattern_right2southeast_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_right2southeast_24_2_matchsrctrgcontext_black = pattern_right2southeast_24_2_matchsrctrgcontext_blackBBBBBB(
					n, xn, xc, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_right2southeast_24_3_solvecsp_bindingFBBBBBBB(right2southeast _this, BTNode n,
			XBTNode xn, XBTNode xc, BTNode c, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(n, xn, xc, c, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, n, xn, xc, c, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_right2southeast_24_3_solvecsp_bindingAndBlackFBBBBBBB(right2southeast _this,
			BTNode n, XBTNode xn, XBTNode xc, BTNode c, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_right2southeast_24_3_solvecsp_binding = pattern_right2southeast_24_3_solvecsp_bindingFBBBBBBB(
				_this, n, xn, xc, c, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_right2southeast_24_6_createcorrespondence_blackBBBBB(BTNode n, XBTNode xn,
			XBTNode xc, BTNode c, CCMatch ccMatch) {
		if (!xc.equals(xn)) {
			if (!c.equals(n)) {
				return new Object[] { n, xn, xc, c, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_right2southeast_27_1_matchtggpattern_black_nac_0BB(BTNode c, BTNode n) {
		if (!c.equals(n)) {
			for (BTNode __DEC_c_l_270712 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(c,
					BTNode.class, "l")) {
				if (!c.equals(__DEC_c_l_270712)) {
					if (!n.equals(__DEC_c_l_270712)) {
						return new Object[] { c, n };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_0BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_w_779156 = xc.getW();
			if (__DEC_xc_w_779156 != null) {
				if (!xc.equals(__DEC_xc_w_779156)) {
					if (!xn.equals(__DEC_xc_w_779156)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_1BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			XBTNode __DEC_xc_e_288648 = xc.getE();
			if (__DEC_xc_e_288648 != null) {
				if (!xc.equals(__DEC_xc_e_288648)) {
					if (!xn.equals(__DEC_xc_e_288648)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_2BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_w_797082 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "w")) {
				if (!xc.equals(__DEC_xc_w_797082)) {
					if (!xn.equals(__DEC_xc_w_797082)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_3BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_sw_127418 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "sw")) {
				if (!xc.equals(__DEC_xc_sw_127418)) {
					if (!xn.equals(__DEC_xc_sw_127418)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_28_1_matchtggpattern_black_nac_4BB(XBTNode xc, XBTNode xn) {
		if (!xc.equals(xn)) {
			for (XBTNode __DEC_xc_e_681484 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(xc,
					XBTNode.class, "e")) {
				if (!xc.equals(__DEC_xc_e_681484)) {
					if (!xn.equals(__DEC_xc_e_681484)) {
						return new Object[] { xc, xn };
					}
				}
			}
	...
	public static final Object[] pattern_right2southeast_29_6_perform_greenBBFFFB(BTNode n, XBTNode xn,
			ModelgeneratorRuleResult ruleResult) {
		XBTNode xc = XbtreeFactory.eINSTANCE.createXBTNode();
		BTNode2XBTnode l2se = Btree2xbtreeFactory.eINSTANCE.createBTNode2XBTnode();
		BTNode c = BtreeFactory.eINSTANCE.createBTNode();
		...
		return new Object[] { n, xn, xc, l2se, c, ruleResult };
	}
