...
public class Statemachine2whileSync extends SynchronizationHelper{

   public Statemachine2whileSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		Statemachine2whileSync helper = new Statemachine2whileSync();
