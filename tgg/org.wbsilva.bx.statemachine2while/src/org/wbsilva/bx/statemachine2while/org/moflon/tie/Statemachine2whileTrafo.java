...
public class Statemachine2whileTrafo extends SynchronizationHelper{

   public Statemachine2whileTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        Statemachine2whileTrafo helper = new Statemachine2whileTrafo();
		helper.performForward("instances/fwd.src.xmi");

		// Backward Transformation
		helper = new Statemachine2whileTrafo();
