...
public class Statemachine2petrinetSync extends SynchronizationHelper{

   public Statemachine2petrinetSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		Statemachine2petrinetSync helper = new Statemachine2petrinetSync();
