...
public class Statemachine2petrinetConsistencyCheck extends SynchronizationHelper{

   public Statemachine2petrinetConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        Statemachine2petrinetConsistencyCheck helper = new Statemachine2petrinetConsistencyCheck();
