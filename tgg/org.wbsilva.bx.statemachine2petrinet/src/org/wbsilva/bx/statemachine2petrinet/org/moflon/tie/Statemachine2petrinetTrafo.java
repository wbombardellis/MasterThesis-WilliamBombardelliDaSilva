...
public class Statemachine2petrinetTrafo extends SynchronizationHelper{

   public Statemachine2petrinetTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        Statemachine2petrinetTrafo helper = new Statemachine2petrinetTrafo();
		helper.performForward("instances/fwd.src.xmi");

		// Backward Transformation
		helper = new Statemachine2petrinetTrafo();
