...
public class state2placeImpl extends AbstractRuleImpl implements state2place {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		S2P s2p = (S2P) result1_green[0];
		Place p = (Place) result1_green[2];

		Object[] result2_black = state2placeImpl.pattern_state2place_1_2_collecttranslatedelements_blackBBB(s2p, s, p);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[s2p] = " + s2p + ", " + "[s] = "
					+ s + ", " + "[p] = " + p + ".");
		}
		Object[] result2_green = state2placeImpl.pattern_state2place_1_2_collecttranslatedelements_greenFBBB(s2p, s, p);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = state2placeImpl.pattern_state2place_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				s2p, sm2pn, s, sm, p, png);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[s2p] = " + s2p + ", " + "[sm2pn] = " + sm2pn + ", " + "[s] = " + s + ", " + "[sm] = "
					+ sm + ", " + "[p] = " + p + ", " + "[png] = " + png + ".");
		}
		state2placeImpl.pattern_state2place_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, s2p, s, sm, p, png);
		//nothing EMoflonEdge s2p__s____source = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge sm__s____states = (EMoflonEdge) result3_green[7];
		...
		// 
		// 
		state2placeImpl.pattern_state2place_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, s2p, sm2pn, s, sm,
				p, png);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject s2p, EObject sm2pn, EObject s, EObject sm,
			EObject p, EObject png) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Place p = (Place) result1_bindingAndBlack[2];
		PNGraph png = (PNGraph) result1_bindingAndBlack[3];
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = state2placeImpl.pattern_state2place_11_1_performtransformation_greenFFBBB(sm, p, csp);
		S2P s2p = (S2P) result1_green[0];
		State s = (State) result1_green[1];

		Object[] result2_black = state2placeImpl.pattern_state2place_11_2_collecttranslatedelements_blackBBB(s2p, s, p);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[s2p] = " + s2p + ", " + "[s] = "
					+ s + ", " + "[p] = " + p + ".");
		}
		Object[] result2_green = state2placeImpl.pattern_state2place_11_2_collecttranslatedelements_greenFBBB(s2p, s,
				p);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		state2placeImpl.pattern_state2place_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, s2p, s, sm, p, png);
		//nothing EMoflonEdge s2p__s____source = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge sm__s____states = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge s2p__p____target = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge png__p____places = (EMoflonEdge) result3_green[9];
		...
		// 
		// 
		state2placeImpl.pattern_state2place_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, s2p, sm2pn, s, sm,
				p, png);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : state2placeImpl.pattern_state2place_12_2_corematch_blackFFBBB(p, png, match)) {
			SM2PN sm2pn = (SM2PN) result2_black[0];
			SM sm = (SM) result2_black[1];
			// ForEach 
			for (Object[] result3_black : state2placeImpl.pattern_state2place_12_3_findcontext_blackBBBB(sm2pn, sm, p,
					png)) {
				Object[] result3_green = state2placeImpl.pattern_state2place_12_3_findcontext_greenBBBBFFFF(sm2pn, sm,
						p, png);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				//nothing EMoflonEdge sm2pn__sm____source = (EMoflonEdge) result3_green[5];
				//nothing EMoflonEdge sm2pn__png____target = (EMoflonEdge) result3_green[6];
				//nothing EMoflonEdge png__p____places = (EMoflonEdge) result3_green[7];

				Object[] result4_bindingAndBlack = state2placeImpl
						.pattern_state2place_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, sm2pn, sm, p,
								png);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[sm2pn] = " + sm2pn + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, SM2PN sm2pn, SM sm, Place p,
			PNGraph png) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject s2p, EObject sm2pn, EObject s, EObject sm,
			EObject p, EObject png) {
		ruleresult.registerObject("s2p", s2p);
		ruleresult.registerObject("sm2pn", sm2pn);
		ruleresult.registerObject("s", s);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_110(EMoflonEdge _edge_places) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_117(EMoflonEdge _edge_states) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Place p = (Place) result2_bindingAndBlack[2];
		...
		Object[] result3_bindingAndBlack = state2placeImpl.pattern_state2place_24_3_solvecsp_bindingAndBlackFBBBBBBB(
				this, s, sm, p, png, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[s] = " + s + ", " + "[sm] = " + sm + ", " + "[p] = " + p + ", " + "[png] = " + png + ", "
		...
		if (state2placeImpl.pattern_state2place_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : state2placeImpl.pattern_state2place_24_5_matchcorrcontext_blackFBBBB(sm, png,
				...
				Object[] result6_black = state2placeImpl.pattern_state2place_24_6_createcorrespondence_blackBBBBB(s, sm,
						p, png, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[s] = " + s + ", " + "[sm] = " + sm + ", "
									+ "[p] = " + p + ", " + "[png] = " + png + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				state2placeImpl.pattern_state2place_24_6_createcorrespondence_greenFBBB(s, p, ccMatch);
				//nothing S2P s2p = (S2P) result6_green[0];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(State s, SM sm, Place p, PNGraph png, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : state2placeImpl
			...
			if (state2placeImpl.pattern_state2place_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					//nothing Place p = (Place) result6_green[3];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.STATE2PLACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_SM2PN_SM_PLACE_PNGRAPH:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (SM2PN) arguments.get(1),
					(SM) arguments.get(2), (Place) arguments.get(3), (PNGraph) arguments.get(4));
		...
		case RulesPackage.STATE2PLACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_110__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_110((EMoflonEdge) arguments.get(0));
		case RulesPackage.STATE2PLACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_117__EMOFLONEDGE:
		...
		case RulesPackage.STATE2PLACE___IS_APPLICABLE_SOLVE_CSP_CC__STATE_SM_PLACE_PNGRAPH_MATCH_MATCH:
			return isApplicable_solveCsp_CC((State) arguments.get(0), (SM) arguments.get(1), (Place) arguments.get(2),
	...
	public static final Object[] pattern_state2place_1_1_performtransformation_greenFBFBB(State s, PNGraph png,
		...
		p.setId(p_id_prime);
		return new Object[] { s2p, s, p, png, csp };
	}

	public static final Object[] pattern_state2place_1_2_collecttranslatedelements_blackBBB(S2P s2p, State s, Place p) {
		return new Object[] { s2p, s, p };
	}

	public static final Object[] pattern_state2place_1_2_collecttranslatedelements_greenFBBB(S2P s2p, State s,
			Place p) {
												...
												if (!p.equals(png)) {
													if (!png.equals(s2p)) {
														if (!png.equals(sm2pn)) {
															if (!png.equals(s)) {
																if (!png.equals(sm)) {
																	return new Object[] { ruleresult, s2p, sm2pn, s, sm,
																			p, png };
																}
															}
														}
	...
	public static final Object[] pattern_state2place_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject s2p, EObject s, EObject sm, EObject p, EObject png) {
		...
		return new Object[] { ruleresult, s2p, s, sm, p, png, s2p__s____source, sm__s____states, s2p__p____target,
				png__p____places };
	}

	public static final void pattern_state2place_1_5_registerobjects_expressionBBBBBBBB(state2place _this,
			PerformRuleResult ruleresult, EObject s2p, EObject sm2pn, EObject s, EObject sm, EObject p, EObject png) {
		_this.registerObjects_FWD(ruleresult, s2p, sm2pn, s, sm, p, png);
	...
	public static final Object[] pattern_state2place_2_3_findcontext_greenBBBBFFFF(SM2PN sm2pn, State s, SM sm,
		...
		return new Object[] { sm2pn, s, sm, png, isApplicableMatch, sm__s____states, sm2pn__sm____source,
		...
		if (tmpSm2pn instanceof SM2PN) {
			...
			if (tmpSm instanceof SM) {
				...
				if (tmpP instanceof Place) {
					...
					if (tmpPng instanceof PNGraph) {
						PNGraph png = (PNGraph) tmpPng;
						return new Object[] { sm2pn, sm, p, png, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_state2place_11_1_performtransformation_blackBBBBFBB(SM2PN sm2pn, SM sm,
			Place p, PNGraph png, state2place _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { sm2pn, sm, p, png, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_state2place_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_state2place_11_1_performtransformation_binding != null) {
			SM2PN sm2pn = (SM2PN) result_pattern_state2place_11_1_performtransformation_binding[0];
			SM sm = (SM) result_pattern_state2place_11_1_performtransformation_binding[1];
			Place p = (Place) result_pattern_state2place_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_state2place_11_1_performtransformation_black = pattern_state2place_11_1_performtransformation_blackBBBBFBB(
					sm2pn, sm, p, png, _this, isApplicableMatch);
	...
	public static final Object[] pattern_state2place_11_1_performtransformation_greenFFBBB(SM sm, Place p, CSP csp) {
		S2P s2p = Statemachine2petrinetFactory.eINSTANCE.createS2P();
		...
		s.setId(s_id_prime);
		return new Object[] { s2p, s, sm, p, csp };
	}

	public static final Object[] pattern_state2place_11_2_collecttranslatedelements_blackBBB(S2P s2p, State s,
			Place p) {
		return new Object[] { s2p, s, p };
	}

	public static final Object[] pattern_state2place_11_2_collecttranslatedelements_greenFBBB(S2P s2p, State s,
			Place p) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(s2p);
	...
	public static final void pattern_state2place_11_5_registerobjects_expressionBBBBBBBB(state2place _this,
			PerformRuleResult ruleresult, EObject s2p, EObject sm2pn, EObject s, EObject sm, EObject p, EObject png) {
		_this.registerObjects_BWD(ruleresult, s2p, sm2pn, s, sm, p, png);
	...
	public static final Iterable<Object[]> pattern_state2place_12_2_corematch_blackFFBBB(Place p, PNGraph png,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (SM2PN sm2pn : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(png, SM2PN.class,
			...
			if (sm != null) {
				_result.add(new Object[] { sm2pn, sm, p, png, match });
			}
	...
	public static final Iterable<Object[]> pattern_state2place_12_3_findcontext_blackBBBB(SM2PN sm2pn, SM sm, Place p,
			PNGraph png) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (sm.equals(sm2pn.getSource())) {
			if (png.equals(sm2pn.getTarget())) {
				if (png.getPlaces().contains(p)) {
					_result.add(new Object[] { sm2pn, sm, p, png });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_state2place_12_3_findcontext_greenBBBBFFFF(SM2PN sm2pn, SM sm, Place p,
			PNGraph png) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge sm2pn__sm____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge sm2pn__png____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		sm2pn__png____target.setName(sm2pn__png____target_name_prime);
		png__p____places.setName(png__p____places_name_prime);
		return new Object[] { sm2pn, sm, p, png, isApplicableMatch, sm2pn__sm____source, sm2pn__png____target,
				png__p____places };
	}

	public static final Object[] pattern_state2place_12_4_solveCSP_bindingFBBBBBB(state2place _this,
			IsApplicableMatch isApplicableMatch, SM2PN sm2pn, SM sm, Place p, PNGraph png) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, sm2pn, sm, p, png);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, sm2pn, sm, p, png };
		}
		return null;
	}
	...
	public static final Object[] pattern_state2place_12_4_solveCSP_bindingAndBlackFBBBBBB(state2place _this,
		...
		Object[] result_pattern_state2place_12_4_solveCSP_binding = pattern_state2place_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, sm2pn, sm, p, png);
	...
	public static final Object[] pattern_state2place_24_2_matchsrctrgcontext_bindingFFFFBB(Match sourceMatch,
		...
		EObject _localVariable_2 = targetMatch.getObject("p");
		...
		if (tmpS instanceof State) {
			...
			if (tmpSm instanceof SM) {
				...
				if (tmpP instanceof Place) {
					...
					if (tmpPng instanceof PNGraph) {
						PNGraph png = (PNGraph) tmpPng;
						return new Object[] { s, sm, p, png, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_state2place_24_2_matchsrctrgcontext_blackBBBBBB(State s, SM sm, Place p,
	...
	public static final Object[] pattern_state2place_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(Match sourceMatch,
		...
		if (result_pattern_state2place_24_2_matchsrctrgcontext_binding != null) {
			State s = (State) result_pattern_state2place_24_2_matchsrctrgcontext_binding[0];
			SM sm = (SM) result_pattern_state2place_24_2_matchsrctrgcontext_binding[1];
			Place p = (Place) result_pattern_state2place_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_state2place_24_2_matchsrctrgcontext_black = pattern_state2place_24_2_matchsrctrgcontext_blackBBBBBB(
					s, sm, p, png, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_state2place_24_3_solvecsp_bindingFBBBBBBB(state2place _this, State s, SM sm,
			Place p, PNGraph png, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(s, sm, p, png, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, s, sm, p, png, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_state2place_24_3_solvecsp_bindingAndBlackFBBBBBBB(state2place _this, State s,
			SM sm, Place p, PNGraph png, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_state2place_24_3_solvecsp_binding = pattern_state2place_24_3_solvecsp_bindingFBBBBBBB(
				_this, s, sm, p, png, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_state2place_24_6_createcorrespondence_blackBBBBB(State s, SM sm, Place p,
			PNGraph png, CCMatch ccMatch) {
		return new Object[] { s, sm, p, png, ccMatch };
	}

	public static final Object[] pattern_state2place_24_6_createcorrespondence_greenFBBB(State s, Place p,
			CCMatch ccMatch) {
		S2P s2p = Statemachine2petrinetFactory.eINSTANCE.createS2P();
		s2p.setSource(s);
		s2p.setTarget(p);
		ccMatch.getCreateCorr().add(s2p);
		return new Object[] { s2p, s, p, ccMatch };
	}
	...
	public static final Object[] pattern_state2place_29_6_perform_greenFFBFBBB(SM sm, PNGraph png,
		...
		Place p = PetrinetFactory.eINSTANCE.createPlace();
		Object _localVariable_0 = csp.getValue("s", "id");
		Object _localVariable_1 = csp.getValue("p", "id");
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		String s_id_prime = (String) _localVariable_0;
		String p_id_prime = (String) _localVariable_1;
		ruleResult.setSuccess(Boolean.valueOf(ruleResult_success_prime));
		int ruleResult_performCount_prime = Integer.valueOf(_localVariable_2);
		s.setId(s_id_prime);
		p.setId(p_id_prime);
		ruleResult.setPerformCount(Integer.valueOf(ruleResult_performCount_prime));
		return new Object[] { s2p, s, sm, p, png, ruleResult, csp };
	}
