...
\begin{document}
	...
	\begin{frame}{The Model Transformation Problem}
		%TODO: IMAGE - Relation between models. Models in relation of correctly-transformed models
	\end{frame}
	...
	\begin{frame}{The Triple Graph Grammar Approach}
		\begin{itemize}
			...
			\begin{itemize}
				\item $G \ct T \text{ iff } (G \ms{} C \mt{} T) \in L(TGG)$
			\end{itemize}
		\end{itemize}
	\end{frame}
	
	%TODO: Pure TGG example of pseudo2code
