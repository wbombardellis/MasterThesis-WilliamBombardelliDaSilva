...
public class DerivationImpl extends MinimalEObjectImpl.Container implements Derivation {
	 ...
	 * @ordered
	 */
	protected EList<DerivationStep> steps;
	 ...
	 * @generated
	 */
	public EList<DerivationStep> getSteps() {
		if (steps == null) {
			steps = new EObjectContainmentEList<DerivationStep>(DerivationStep.class, this,
					GraphgrammarPackage.DERIVATION__STEPS);
		}
		return steps;
	}
