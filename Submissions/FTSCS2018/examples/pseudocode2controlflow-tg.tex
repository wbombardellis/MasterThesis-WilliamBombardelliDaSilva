...
\begin{minipage}[h]{.5\textwidth}
	...
	\end{tikzpicture}
\end{minipage}%
\caption{A program written in pseudo-code on the left and its correspondent triple graph with the \emph{PseudoCode} and the \emph{ControlFlow} graphs on the right}
\label{fig:p2c-tg}
\end{figure}