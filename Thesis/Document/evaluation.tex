...
%TODO: Add citation for TGG with AC: Scholar -> Completeness and Correctness of Model Transformations Based on Triple Graph Grammars with Negative Application Conditions.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PERFORMANCE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%==================================================================%%%
%TODO: fix clipped chart (i.e. shallo instead of shallow) -> Regenerate PDFs
\section{Performance}
...
%TODO: Remove eMoflon Shallow from deep chart
...
%TODO: Check the definition of PSPACE-complete
