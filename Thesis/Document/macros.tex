...
\tikzstyle{t}=[circle, inner sep=3pt, draw, fill=white, minimum width=5pt]
\tikzstyle{g}=[inner sep=3pt, fill=white]
\tikzstyle{lhs}=[inner sep=3pt, fill=white]
\tikzstyle{w}=[circle, inner sep=1pt, below=8pt, draw, fill=white]
