...
%TODO: IMPORTANT: ADD CONDITION FOR TRIPLE RULE APPLICATION - THREE VERTICES NEED TO BE CONNECTED BY THE MORPHISM - Does not change transformer, but it is important for transformer's completeness
\begin{definition}
	\label{def:tgg_dstep}
