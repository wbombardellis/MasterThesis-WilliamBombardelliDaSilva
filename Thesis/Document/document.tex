...
\begin{definition}
	...
	\begin{align*}
		& \forall v \in \dom s \. s(v) \neq v \text{ and } \phi_G(s(v)) = \phi_G(v) \text{ and}\\
...
\begin{definition}
	...
	\begin{equation*}
		L(GG) = \{ H \text{ is a graph over } \Delta \text{ and } \startG{GG} \derivn{n}{} H' \resolvn{n}{} H \}
	\end{equation*}
	where $\derivn{n}{}$ and $\resolvn{n}{}$ denote a sequence of $n$ derivation steps and $n$ resolution steps, respectively.
\end{definition}


%TODO: Notice if W = emptyset, then it is the same as before
%TODO: Claim All pacs are resolved
