...
\begin{minipage}[h]{.5\textwidth}
	...
	\draw[edge] (s5) to [bend left] (s7) node [above=15pt, right=3pt] {$l$};
	...
	\draw (5.5,-1.4) node[t] (t3) {c};
	\draw (4.5,-1.4) node[t] (t4) {c};
	...
	\draw[edge] (t2) -- (t4) node [vledgeLabel] {$n$};
